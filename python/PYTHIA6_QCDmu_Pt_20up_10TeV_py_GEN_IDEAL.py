...
# with command line options: Configuration/GenProduction/python/PYTHIA6_QCDmu_Pt_20up_10TeV.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 1000 --no_exec
