...
# with command line options: SingleMuPt100_cfi -s GEN:ProductionFilterSequence,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,RECO --number 1000 --eventcontent FEVTSIM --conditions FrontierConditions_GlobalTag,MC_31X_V5::All --datatier GEN-SIM-DIGI-RAW-RECO --no_exec --magField=38T_ToscaMap090322
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleMuMinusOneOverPt_NewField_GEN_SIM_DIGI_L1_DIGI2RAW_RAW2DIGI_RECO_MC.root'),
