...
generator = cms.EDFilter(
    ...
    crossSection     = cms.untracked.double(0.0136),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /cvs_server/repositories/CMSSW/UserCode/SchieferD/GenProduction/python/HERWIGPP_POWHEG_H130_bbbar_Z_ll_7TeV_cff.py,v $'),
	annotation = cms.untracked.string('HERWIGPP/POWHEG: (H->bb)(Z->ll), m(H)=130 GeV, l=e or mu')
)
