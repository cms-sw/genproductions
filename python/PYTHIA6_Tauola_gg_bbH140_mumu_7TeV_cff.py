...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_gg_bbH140_mumu_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 - SUSY gg->bbH(140)->2mu, with Tauola at 7TeV')
    )
