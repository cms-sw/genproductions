...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/MCatNLO_LHE_tW_subtraction_7TeV_cff.py,v $'),
	annotation = cms.untracked.string('Summer09: Showering of MC@NLO 3.4 tW events with Herwig+Jimmy, Diagram subtraction, 7 TeV')
)

generator = cms.EDFilter("Herwig6HadronizerFilter",
	comEnergy = cms.double(7000.0),
	crossSection = cms.untracked.double(0.1782),
