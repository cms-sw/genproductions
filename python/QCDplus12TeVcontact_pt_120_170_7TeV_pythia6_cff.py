...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(117000),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDplus12TeVcontact_pt_120_170_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+12TeVcontact-pt-120-170 at 7TeV')
)
