...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.0126),
    crossSection = cms.untracked.double(61160000),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_InclusiveE5_pt30_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-MinBias at 7TeV, pthat>30, with INCLUSIVE electron preselection (pt(e) > 5)')
)

ProductionFilterSequence = cms.Sequence(generator*egenfilter)
