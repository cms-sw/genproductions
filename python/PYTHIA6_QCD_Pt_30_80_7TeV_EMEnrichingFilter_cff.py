...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.059),
    crossSection = cms.untracked.double(59300000.),                         
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCD_Pt_30_80_7TeV_EMEnrichingFilter_cff.py,v $'),
    annotation = cms.untracked.string('em-enriching filtered QCD pthat 30-80, 7 TeV')
)
