...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(1.548),
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0  !User selected',
            ...
            'MSUB(147)=1            ! dg--> d*',
            'MSUB(148)=1            ! ug--> u*',
            'PMAS(343,1) = 1200.     ! d* mass',
            'PMAS(344,1) = 1200.     ! u* mass', 
            'RTCM(41) = 1200.        ! Scale parameter Lambda',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/QstarToGJ_M_1200_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('qstar Mass = 1.2 TeV at 8 TeV')
)
