...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_EWK_Zee_10TeV_cff.py,v $'),
    annotation = cms.untracked.string('Z/gamma* to ee sample, M(ee) gt40 GeV -- sqrt(s) = 10TeV')
)

ProductionFilterSequence = cms.Sequence(eegenfilter)
