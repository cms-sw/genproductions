...
# with command line options: step3 -s ALCA:MuAlCalIsolatedMu+DQM --conditions FrontierConditions_GlobalTag,STARTUP31X_V3::All --scenario cosmics --no_exec --python_filename MuAlCalIsolatedMu_cfg.py
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('step3 MuAlCalIsolatedMu')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.pathALCARECOMuAlCalIsolatedMu,process.pathALCARECODQM,process.endjob_step,process.ALCARECOStreamMuAlCalIsolatedMuOutPath)
