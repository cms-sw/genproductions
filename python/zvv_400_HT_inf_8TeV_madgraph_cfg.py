...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/ZJetsToNuNu_400_HT_inf_8TeV-madgraph/v2',
    'ZJetsToNuNu_400_HT_inf_8TeV-madgraph','false','true','zjets','5','20','true','1','4'),
