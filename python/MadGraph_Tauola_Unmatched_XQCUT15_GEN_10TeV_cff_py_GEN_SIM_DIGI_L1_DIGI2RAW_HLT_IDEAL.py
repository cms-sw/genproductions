...
# with command line options: Configuration/GenProduction/python/MadGraph_Tauola_Unmatched_XQCUT15_GEN_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Unmatched MadGraph-PYTHIA6 with Tauola at 10TeV, qcut 15'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MadGraph_Tauola_Unmatched_XQCUT15_GEN_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
