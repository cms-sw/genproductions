...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/ZH_HToWW_ZToLL_M_180_TuneZ2_7TeV_pythia6_tauola_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 WH/ZH/ttH, H->WW mH=180GeV with TAUOLA at 7TeV')
)
