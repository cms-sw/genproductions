...
generator = cms.EDFilter(
    ...
    'set /Herwig/Particles/h0:NominalMass 105.*GeV',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/HERWIGPP_POWHEG_H110_bbbar_W_lnu_7TeV_cff.py,v $'),
	annotation = cms.untracked.string('HERWIGPP/POWHEG: (H->bb)(W->lnu), m(H)=105 GeV, l=e or mu or tau')
)
