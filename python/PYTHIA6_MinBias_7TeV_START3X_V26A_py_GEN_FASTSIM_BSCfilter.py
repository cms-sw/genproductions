...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MinBias7TeV nevts:10'),
...
#--- FastSim BSC-emulating filter
process.filterFastBSC = cms.EDFilter("FastSimDataFilter")
process.pbsc          = cms.Path(process.filterFastBSC)

# Output definition
process.output = cms.OutputModule("PoolOutputModule",
    splitLevel = cms.untracked.int32(0),
    outputCommands = process.RECODEBUGEventContent.outputCommands,
    fileName = cms.untracked.string('MinBias7TeV_GEN_FASTSIM_RECOSIM_BSC.root'),
    dataset = cms.untracked.PSet(
        dataTier = cms.untracked.string('GEN-SIM-DIGI-RECO'),
        filterName = cms.untracked.string('')
    ),
    SelectEvents = cms.untracked.PSet(
        SelectEvents = cms.vstring('pbsc')
    )
)
...
process.famosSimHits.VertexGenerator.SigmaZ = 4.5
process.famosPileUp.VertexGenerator.SigmaZ = 4.5
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0         ! User defined processes', 
            ...
            'MSUB(94)=1     ! Min bias process, double diffraccive', 
...
process.schedule.extend([process.reconstruction,process.pbsc,process.out_step])
