...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/Summer08_QCDmu_Pt_20up_10TeV_py'),
...
process.source = cms.Source("PythiaSource",
    ...
    filterEfficiency = cms.untracked.double(0.0041),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Summer08_QCDmu_Pt_20up_10TeV_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
