...
# with command line options: Configuration/GenProduction/python/HerwigJimmy_QCD_Pt_470.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All --no_exec -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/HerwigJimmy_QCD_Pt_470.py nevts:1000'),
...
process.source = cms.Source("Herwig6Source",
    HerwigParameters = cms.PSet(
        herwigQCDjets = cms.vstring('IPROC      = 1500       ! QCD 2->2 processes', 
            'PTMIN      = 470.       ! minimum pt in hadronic jet', 
    ...
    crossSection = cms.untracked.double(277.8),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('HerwigJimmy_QCD_Pt_470_py_GEN.root'),
