...
MASS_HIGGS = 200 # GeV (mass of resonance that decays to long-lived particle pair)
MASS_LL    = '50GeV' # (mass with units of long-lived particle)
CTAU_LL    = '200mm' # (c*tau with units of long-lived particle)
