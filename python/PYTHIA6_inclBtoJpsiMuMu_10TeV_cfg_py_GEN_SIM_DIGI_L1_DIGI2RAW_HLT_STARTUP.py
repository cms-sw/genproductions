...
# with command line options: Configuration/GenProduction/PYTHIA6_inclBtoJpsiMuMu_10TeV_cfg -s GEN:ProductionFilterSequence,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,STARTUP_V5::All -n 10 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_inclBtoJpsiMuMu_10TeV_cfg_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
...
process.HLT_IsoMu11 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuIso+process.hltPreIsoMu11+process.hltSingleMuIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltSingleMuIsoL2PreFiltered+process.HLTL2muonisorecoSequence+process.hltSingleMuIsoL2IsoFiltered+process.HLTL3muonrecoSequence+process.hltSingleMuIsoL3PreFiltered+process.HLTL3muonisorecoSequence+process.hltSingleMuIsoL3IsoFiltered+process.HLTEndSequence))
...
process.HLT_Mu11 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuNoIso+process.hltPreMu11+process.hltSingleMuNoIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltSingleMuNoIsoL2PreFiltered9+process.HLTL3muonrecoSequence+process.hltSingleMuNoIsoL3PreFiltered11+process.HLTEndSequence))
...
process.HLT_L2Mu9 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuNoIso+process.hltPreL2Mu9+process.hltSingleMuNoIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltSingleMuLevel2NoIsoL2PreFiltered+process.HLTEndSequence))
...
process.HLT_MET35_HT350 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMET35HT350+process.hltPreMET35HT350+process.HLTRecoJetMETSequence+process.hlt1MET65+process.hlt1HT350+process.HLTEndSequence))
...
process.HLTriggerFirstPath = cms.Path(process.ProductionFilterSequence*(process.hltGetRaw+process.HLTBeginSequence+process.hltPreFirstPath+process.hltBoolFirstPath+process.HLTEndSequence))
...
process.HLT_Mu15_L1Mu7 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuNoIso+process.hltPreMu15L1Mu7+process.hltSingleMuNoIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltSingleMuNoIsoL2PreFiltered+process.HLTL3muonrecoSequence+process.hltSingleMuNoIsoL3PreFiltered+process.HLTEndSequence))
...
process.HLT_L1MuOpen = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltPreL1MuOpen+process.hltL1sL1MuOpen+process.hltMuLevel1PathL1OpenFiltered+process.HLTEndSequence))
...
process.HLT_DoubleMu3_Vtx2cm = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDiMuonNoIso+process.hltPreDoubleMu3Vtx2cm+process.hltDiMuonNoIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltDiMuonNoIsoL2PreFiltered+process.HLTL3muonrecoSequence+process.hltDiMuonNoIsoL3PreFilteredRelaxedVtx2cm+process.HLTEndSequence))
...
process.HLT_IsoMu9 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuIso+process.hltPreIsoMu9+process.hltSingleMuIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltSingleMuIsoL2PreFiltered7+process.HLTL2muonisorecoSequence+process.hltSingleMuIsoL2IsoFiltered7+process.HLTL3muonrecoSequence+process.hltSingleMuIsoL3PreFiltered9+process.HLTL3muonisorecoSequence+process.hltSingleMuIsoL3IsoFiltered9+process.HLTEndSequence))
...
process.HLT_Mu15_Vtx2cm = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuNoIso+process.hltPreMu15Vtx2cm+process.hltSingleMuNoIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltSingleMuNoIsoL2PreFiltered+process.HLTL3muonrecoSequence+process.hltSingleMuNoIsoL3PreFilteredRelaxedVtx2cm+process.HLTEndSequence))
...
process.HLT_Mu15_Vtx2mm = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuNoIso+process.hltPreMu15Vtx2mm+process.hltSingleMuNoIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltSingleMuNoIsoL2PreFiltered+process.HLTL3muonrecoSequence+process.hltSingleMuNoIsoL3PreFilteredRelaxedVtx2mm+process.HLTEndSequence))
...
process.HLT_Mu9 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuNoIso+process.hltPreMu9+process.hltSingleMuNoIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltSingleMuNoIsoL2PreFiltered7+process.HLTL3muonrecoSequence+process.hltSingleMuNoIsoL3PreFiltered9+process.HLTEndSequence))
