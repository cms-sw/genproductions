...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(0.1328),
    ...
    HerwigParameters = cms.PSet(
        ...
        herwigPowheg = cms.vstring(
            ...
            'IPROC      = -1610     ! - = dont generate hard event, 1600 = ggH   10 = H->WW'
            ),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_HERWIG6_qqH150_WW_lnutaunu_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('POWHEG + HERWIG6 - ggF Higgs -> WW -> lnutaunu at 7TeV - MCDB 1000 - Xsec in pb')
    )
