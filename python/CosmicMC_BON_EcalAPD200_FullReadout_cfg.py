...
#
# Special sample for ECAL: FullReadout Gain=200, limited to tracker acceptance
# Global tag for ECAL gain COSMMC_G200V2
# Other settings as in CosmicMC_BON_100GeV_AllCMS_cfg.py
#-----------------------------------------------------------------------
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source:/cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring09Production/data/CosmicMC_BON_EcalAPD200_FullReadout_cfg.py'),
...
process.RandomNumberGeneratorService.theSource.initialSeed = cms.untracked.uint32(12345677)
...
#-------- SPECIAL stuff for subsystems: use FullReadout_fromPhilippe/DigiCosmics_G50_nozs_cff.py
...
simEcalUnsuppressedDigis.cosmicsPhase = True
...
process.output = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('CosmicMC_BON_EcalAPD200_FullReadout_TKOnly.root'),
