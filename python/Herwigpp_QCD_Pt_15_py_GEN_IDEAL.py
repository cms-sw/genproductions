...
# with command line options: Configuration/GenProduction/python/Herwigpp_QCD_Pt_15.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 750000 --no_exec
