...
# with command line options: Configuration/GenProduction/python/MadGraph_PYTHIA6_SM_H_2Z_4l_mH200_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MadGraph Pythia6 SM ggH 2Z 4l mH200 at 10TeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MadGraph_PYTHIA6_SM_H_2Z_4l_mH200_10TeV_cff.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MadGraph_PYTHIA6_SM_H_2Z_4l_mH200_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
