...
# with command line options: step2 -s RAW2DIGI,RECO,ALCA:TkAlMuonIsolated --datatier GEN-SIM-RECO --eventcontent RECOSIM --conditions FrontierConditions_GlobalTag,MC_31X_V3::All --no_exec --python_filename TKDPG_31X_step2_3_MuonsPt5_cff.py
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('TKDPG MuonsPt11')
)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:TKDPG_31X_MuonsPt11_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.pathALCARECOTkAlMuonIsolated,process.endjob_step,process.out_step,process.ALCARECOStreamTkAlMuonIsolatedOutPath)
