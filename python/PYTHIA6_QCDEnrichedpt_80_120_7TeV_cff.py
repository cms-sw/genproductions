...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.00032),
    comEnergy = cms.double(7000.0),
    crossSection = cms.untracked.double(7.861e+05),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDEnrichedpt_80_120_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCDEnrichedpt-80-120 at 7TeV')
)
