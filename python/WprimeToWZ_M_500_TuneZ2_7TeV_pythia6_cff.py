...
generator = cms.EDFilter("Pythia6GeneratorFilter",
	...
	crossSection = cms.untracked.double(2.455),
	
	PythiaParameters = cms.PSet(
	        pythiaUESettingsBlock,
                processParameters = cms.vstring(
        'MSEL=0 ! (D=1) 0 to select full user control',
        'PMAS(34,1)=500 ! mass of Wprime',
...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /cvs/CMSSW/UserCode/hinzmann/production/WprimeToWZ_M_500_TuneZ2_7TeV_pythia6_cff.py,v $'),
