...
# with command line options: step3 -sALCA:TkAlCosmics0T+DQM --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:Reco_TKCosmicMC_BOFF_220.root')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.pathALCARECOTkAlCosmicsCTF0T,process.pathALCARECOTkAlCosmicsCosmicTF0T,process.pathALCARECOTkAlCosmicsRS0T,process.pathALCARECODQM,process.ALCARECOStreamTkAlCosmics0TOutPath)
