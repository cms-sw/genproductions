...
# with command line options: Configuration/GenProduction/python/PYTHIA6_EWK_Zgamma_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('PYTHIA6-EWK Zgamma at 10TeV'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_EWK_Zgamma_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
