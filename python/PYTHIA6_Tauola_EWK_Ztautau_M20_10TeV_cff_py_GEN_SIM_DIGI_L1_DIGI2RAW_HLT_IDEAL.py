...
# with command line options: Configuration/GenProduction/python/PYTHIA6_Tauola_EWK_Ztautau_M20_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Z/gamma* to tautau sample, M(tautau) > 20 GeV -- sqrt(s) = 10TeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_EWK_Ztautau_M20_10TeV_cff.py,v $')
)
...
process.source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(1944.0),
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0            !User defined processes', 
            ...
            'CKIN(1)=20.       !lower cut on M_ll mass'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Tauola_EWK_Ztautau_M20_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
