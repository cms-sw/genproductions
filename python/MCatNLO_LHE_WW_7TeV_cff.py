...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MCatNLO_LHE_WW_7TeV_cff.py,v $'),
	annotation = cms.untracked.string('Summer09: Showering of MC@NLO 3.4 WW->ee events with Herwig+Jimmy, 7 TeV')
)
