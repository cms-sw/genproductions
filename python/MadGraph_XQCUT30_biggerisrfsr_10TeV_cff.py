...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MadGraph_XQCUT30_biggerisrfsr_10TeV_cff.py,v $'),
        annotation = cms.untracked.string('MadGraph-PYTHIA6 at 10TeV, bigger amount of isr and fsr')
)
