...
# with command line options: Configuration/GenProduction/python/MCatNLO_TTbar_10TeV_cff.py --customise Configuration/GenProduction/MCatNLO_custom.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 1000 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MCatNLO_TTbar_10TeV_cff_py_GEN.root'),
