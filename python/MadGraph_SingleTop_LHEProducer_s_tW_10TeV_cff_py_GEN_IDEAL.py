...
# with command line options: Configuration/GenProduction/MadGraph_SingleTop_LHEProducer_s_tW_10TeV_cff.py -s GEN:ProducerSourceSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 100 --no_exec --customise=Configuration/GenProduction/generatorProducer.py
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MadGraph_SingleTop_LHEProducer_s_tW_10TeV_cff.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MadGraph_SingleTop_LHEProducer_s_tW_10TeV_cff_py_GEN.root'),
