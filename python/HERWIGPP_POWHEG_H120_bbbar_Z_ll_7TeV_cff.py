...
generator = cms.EDFilter(
    ...
    crossSection     = cms.untracked.double(0.0230),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /cvs_server/repositories/CMSSW/UserCode/SchieferD/GenProduction/python/HERWIGPP_POWHEG_H120_bbbar_Z_ll_7TeV_cff.py,v $'),
