...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source:/cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring09Production/data/CosmicMC_BON_100GeV_EcalG200_SelReadout_cfg.py'),
...
process.RandomNumberGeneratorService.theSource.initialSeed = cms.untracked.uint32(12345645)
...
process.output = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('CosmicMC_BON_100GeV_EcalG200_SelReadout_TKOnly.root'),
