...
# with command line options: Configuration/GenProduction/python/PYTHIA8_PhotonJetpt15_20_10TeV_cff.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec --customise Configuration/GenProduction/PYTHIA8_custom.py
