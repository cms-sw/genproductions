...
# using: 
# $Revision: 1.3 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/Herwig_QCD_Pt_3000_py__GEN_SIM_DIGI_L1_DIGI2RAW_HLT.py,v $
...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValHerwig_QCD_Pt_3000.pyGEN,SIM,DIGI,L1,DIGI2RAW,HLT'),
    totalNumberOfEvents = cms.untracked.int32(5000),
    eventsPerJob = cms.untracked.int32(250)
)
process.configurationMetadata = cms.untracked.PSet(
    version = cms.untracked.string('$Revision: 1.3 $'),
    annotation = cms.untracked.string('Summer08 CSA: Herwig++ generation of QCD events, CTEQ6L used, MinKT=3000 GeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/Herwig_QCD_Pt_3000_py__GEN_SIM_DIGI_L1_DIGI2RAW_HLT.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Herwig_QCD_Pt_3000_py__GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
