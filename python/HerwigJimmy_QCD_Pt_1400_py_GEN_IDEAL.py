...
# with command line options: Configuration/GenProduction/python/HerwigJimmy_QCD_Pt_1400.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All --no_exec -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/HerwigJimmy_QCD_Pt_1400.py nevts:1000'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('HerwigJimmy_QCD_Pt_1400_py_GEN.root'),
