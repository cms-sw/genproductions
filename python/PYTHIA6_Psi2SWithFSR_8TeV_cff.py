...
configurationMetadata = cms.untracked.PSet(
        ...
        annotation = cms.untracked.string('Summer09: Pythia6 generation of prompt Psi2S, 8TeV, Z2 tune')
)
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(29000.0),
    # TrigReport    Visited        Run     Passed     Failed      Error Name
    # TrigReport      50000      50000      50000          0          0 generator
    # TrigReport      50000      50000      50000          0          0 oniafilter
    # TrigReport      50000      50000      10645      39355          0 mumugenfilter
    filterEfficiency = cms.untracked.double(0.213),
