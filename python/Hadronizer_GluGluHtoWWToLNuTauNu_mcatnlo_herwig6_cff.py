...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/Hadronizer_GluGluHtoWWToLNuTauNu_mcatnlo_herwig6_cff.py,v $'),
	...
	HerwigParameters = cms.PSet(
		herwigUEsettings = cms.vstring(
			...
			'PTMIN      = 0.5    ! minimum pt in hadronic jet',
                        ...
                        'MODBOS(2)  = 4      ! Second W should decay to tau + nu'
		),
