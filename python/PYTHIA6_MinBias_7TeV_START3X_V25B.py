...
# with command line options: Configuration/GenProduction/python/PYTHIA6_MinBias_7TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT:GRun --conditions START3X_V25B::All --datatier GEN-SIM-RAW --eventcontent RAWDEBUG -n 10 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_MinBias_7TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
