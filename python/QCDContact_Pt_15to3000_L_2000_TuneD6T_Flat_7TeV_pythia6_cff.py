...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(3.630689e+10),
	...
	PythiaParameters = cms.PSet(
		...
		processParameters = cms.vstring(
			...
			'RTCM(41)=2000 ! Set Contact Scale Lambda to 2 TeV',
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Summer2011 sample with PYTHIA6: QCD + 2TeV contact interaction, pThat = 15 .. 3000 GeV, weighted, TuneD6T')
)
