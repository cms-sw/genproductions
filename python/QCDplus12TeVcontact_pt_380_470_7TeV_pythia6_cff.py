...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(229.2),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDplus12TeVcontact_pt_380_470_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+12TeVcontact-pt-380-470 at 7TeV')
)
