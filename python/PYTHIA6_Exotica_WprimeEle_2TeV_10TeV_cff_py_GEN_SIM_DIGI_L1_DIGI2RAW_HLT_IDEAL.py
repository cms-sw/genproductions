...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('PYTHIA6-Wprime of 2 TeV mass decaying into electron and neutrino at 10TeV  '),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_WprimeEle_2TeV_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
