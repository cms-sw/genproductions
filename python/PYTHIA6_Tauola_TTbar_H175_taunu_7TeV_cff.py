...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0         ! User defined processes',
            ...
            'PMAS(37,1) = 175  ! charged Higgs mass ',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_TTbar_H175_taunu_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TTbar Hplus175 To TauNu, with Tauola at 7TeV')
    )
