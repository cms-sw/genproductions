...
# with command line options: Configuration/GenProduction/python/PYTHIA6_Exotica_ZprimeTautau_3000_cff.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/PYTHIA6_Exotica_ZprimeTautau_3000_cff_py_GEN_IDEAL.py,v $'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Exotica_ZprimeTautau_3000_cff_py_GEN.root'),
