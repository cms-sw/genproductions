...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.0101),
    crossSection = cms.untracked.double(111800.),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EWK_DYee_M1to10_10TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 Z/gamma* to ee, 1 GeV < M(e+e-) < 10 GeV at sqrt(s) = 10TeV')
)
