...
source = cms.Source("MadGraphSource",
                    ...
                    PythiaParameters = cms.PSet( pythiaUESettingsBlock,
                                                 ...
                                                 TtDecaySteer = cms.vstring('MDME(46,1)=3 ! activate t->Wb for the anti-particle only',
                                                                            'MDME(45,1)=2 ! activate t->Ws for the particle only',
                                                                            'MDME(44,1)=2 ! activate t->Wd for the particle only'
                                                                            ),
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MadGraph-PYTHIA6 at 10TeV, qcut 30, cteq6l, R=0.50 (top forced to decay to light quarks only)')
    )
