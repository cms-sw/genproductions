...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Summer09: Herwig+Jimmy generation of QCD events, 10TeV, CTEQ6L, pthat > 470 GeV')
)

source = cms.Source("EmptySource")
generator = cms.EDFilter("Herwig6GeneratorFilter",
	comEnergy = cms.double(10000.0),
	crossSection = cms.untracked.double(2.7755858523e+02),
