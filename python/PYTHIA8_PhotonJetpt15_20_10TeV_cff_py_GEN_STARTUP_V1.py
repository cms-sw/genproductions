...
# using: 
# $Revision: 1.1 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA8_PhotonJetpt15_20_10TeV_cff_py_GEN_STARTUP_V1.py,v $
...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/PYTHIA8_PhotonJetpt15_20_10TeV_cff_py'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA8_PhotonJetpt15_20_10TeV_cff_py_GEN_STARTUP_V1.py,v $')
)
...
process.source = cms.Source("Pythia8Source",
    ...
    crossSection = cms.untracked.double(180000.0),
