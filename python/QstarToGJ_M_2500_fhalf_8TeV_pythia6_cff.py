...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(2.442e-03),
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0  !User selected',
            ...
            'MSUB(147)=1            ! dg--> d*',
            'MSUB(148)=1            ! ug--> u*',
            'PMAS(343,1) = 2500.     ! d* mass',
            'PMAS(344,1) = 2500.     ! u* mass', 
            'RTCM(41) = 2500.        ! Scale parameter Lambda',
            #Below the couplings
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/QstarToGJ_M_2500_fhalf_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('qstar Mass = 2.5 TeV fhalf at 8 TeV')
)
