...
# with command line options: Configuration/GenProduction/python/HerwigJimmy_QCD_Pt_80.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All --no_exec -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/HerwigJimmy_QCD_Pt_80.py nevts:1000'),
...
process.source = cms.Source("Herwig6Source",
    ...
    crossSection = cms.untracked.double(1597300.0),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('HerwigJimmy_QCD_Pt_80_py_GEN.root'),
