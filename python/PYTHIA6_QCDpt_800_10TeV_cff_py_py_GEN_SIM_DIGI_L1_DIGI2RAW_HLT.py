...
# using: 
# $Revision: 1.2 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDpt_800_10TeV_cff_py_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL_V6.py,v $
...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/PYTHIA6_QCDpt_800_10TeV_cff_py_py'),
    totalNumberOfEvents = cms.untracked.int32(5000),
    eventsPerJob = cms.untracked.int32(250)
)
process.configurationMetadata = cms.untracked.PSet(
    version = cms.untracked.string('$Revision: 1.2 $'),
    annotation = cms.untracked.string('QCDpt-800 at 10TeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDpt_800_10TeV_cff_py_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL_V6.py,v $')
)
...
process.source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(11.9419745),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_QCDpt_800_10TeV_cff_py_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
