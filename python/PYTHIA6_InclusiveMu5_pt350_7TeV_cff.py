...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.086),
    crossSection = cms.untracked.double(529.),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_InclusiveMu5_pt350_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-MinBias at 7TeV, pthat>350, with INCLUSIVE muon preselection (pt(mu) > 5)')
)
