...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/Herwigpp_QCD_Pt_470_py'),
...
process.source = cms.Source("ThePEGSource",
    ...
    crossSection = cms.untracked.double(0.000354328),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Herwigpp_QCD_Pt_470_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
