...
source = cms.Source("PythiaSource",
    ...
    filterEfficiency = cms.untracked.double(0.10),
    comEnergy = cms.untracked.double(10000.0),
    crossSection = cms.untracked.double(9000.),
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('PYTHIA6-MinBias at 10TeV, pthat>250, with INCLUSIVE muon preselection (pt(mu) > 5) - FastSim version')
)
