...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(1.085929e-02),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Fall2010 sample with PYTHIA6: QCD dijet production, pThat = 1400 .. 1800 GeV, TuneD6T')
)
