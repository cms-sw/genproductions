...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(5.793e+08),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDEnrichedpt_15_20_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCDEnrichedpt-15-20 at 7TeV')
)
