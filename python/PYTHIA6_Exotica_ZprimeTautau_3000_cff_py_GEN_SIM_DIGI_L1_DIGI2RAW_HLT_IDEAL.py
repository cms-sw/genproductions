...
# with command line options: Configuration/GenProduction/python/PYTHIA6_Exotica_ZprimeTautau_3000_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/PYTHIA6_Exotica_ZprimeTautau_3000_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL.py,v $'),
...
process.source = cms.Source("PythiaSource",
    ...
    PythiaParameters = cms.PSet(
        pythiaUESettings = cms.vstring('MSTJ(11)=3     ! Choice of the fragmentation function', 
            ...
            'PARP(93)=15.0  ! '),
        processParameters = cms.vstring('PMAS(32,1)= 3000.           !mass of Zprime', 
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Exotica_ZprimeTautau_3000_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
