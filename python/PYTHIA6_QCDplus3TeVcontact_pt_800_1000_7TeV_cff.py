...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(5.982),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_QCDplus3TeVcontact_pt_800_1000_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+3TeVcontact-pt-800-1000 at 7TeV')
)
