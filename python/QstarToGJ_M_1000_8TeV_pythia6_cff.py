...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(4.191),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/QstarToGJ_M_1000_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('qstar Mass = 1 TeV at 8 TeV')
)
