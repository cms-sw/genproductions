...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(0.06127),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_QCDplus3TeVcontact_pt_1800_inf_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+3TeVcontact-pt-1800-inf at 7TeV')
)
