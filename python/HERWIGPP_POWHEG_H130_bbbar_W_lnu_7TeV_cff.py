...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /cvs_server/repositories/CMSSW/UserCode/SchieferD/GenProduction/python/HERWIGPP_POWHEG_H130_bbbar_W_lnu_7TeV_cff.py,v $'),
	annotation = cms.untracked.string('HERWIGPP/POWHEG: (H->bb)(W->lnu), m(H)=130 GeV, l=e or mu or tau')
)
