...
# with command line options: step2 -s RAW2DIGI,L1Reco,RECO:reconstruction_withPixellessTk --datatier GEN-SIM-RECO --eventcontent RECOSIM --conditions STARTUP3X_V8J::All --no_exec
...
# Other statements
process.GlobalTag.globaltag = 'STARTUP3X_V8J::All'
