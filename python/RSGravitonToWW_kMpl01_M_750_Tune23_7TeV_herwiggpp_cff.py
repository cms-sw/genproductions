...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	herwigDefaultsBlock,
	crossSection = cms.untracked.double(15.22),
	...
	productionParameters = cms.vstring(
                ...
                'set RS/Model:Lambda_pi 1388*GeV',
                'set /Herwig/Particles/Graviton:NominalMass 750*GeV',
	),
)

configurationMetadata = cms.untracked.PSet(
	version = cms.untracked.string('\$Revision: 1.1 $'),
	name = cms.untracked.string('\$Source: /cvs/CMSSW/UserCode/hinzmann/production/RSGravitonToWW_kMpl01_M_750_Tune23_7TeV_herwiggpp_cff.py,v $'),
