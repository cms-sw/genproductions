...
# with command line options: Configuration/GenProduction/python/ALPGEN_bb_0jet_10TeV_cff.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/sergei/final_cfg/ALPGEN_bb_0jet_10TeV_cff_py_GEN_IDEAL.py,v $')
)
...
process.source = cms.Source("AlpgenSource",
    ...
    crossSection = cms.untracked.double(1357980.0),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ALPGEN_bb_0jet_10TeV_cff_py_GEN.root'),
