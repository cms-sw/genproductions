...
# with command line options: Configuration/GenProduction/GG2WW_LHEProducer_10TeV_cff.py -s GEN:ProducerSourceSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V11::All -n 100 --no_exec --customise=Configuration/GenProduction/generatorProducer.py
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/GG2WW_LHEProducer_10TeV_cff_py_GEN_IDEAL.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('GG2WW_LHEProducer_10TeV_cff_py_GEN.root'),
...
process.endjob_step = cms.Path(process.ProducerSourceSequence*process.endOfProcess)
