...
# with command line options: step2 -s RAW2DIGI,RECO,ALCA:TkAlCosmics0T+DQM,ALCA:MuAlCalIsolatedMu+DQM,ALCA:MuAlGlobalCosmics+DQM --datatier GEN-SIM-RECO --eventcontent RECOSIM --conditions FrontierConditions_GlobalTag,STARTUP31X_V3::All --scenario cosmics --no_exec --python_filename RECOCOS_STARTUP31X_V3.py
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('TKcosmics step2_step3 BOFF')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('step2_RAW2DIGI_RECO_ALCA_ALCA_ALCA.root'),
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.pathALCARECOTkAlCosmicsCTF0T,process.pathALCARECOTkAlCosmicsCosmicTF0T,process.pathALCARECOTkAlCosmicsRS0T,process.pathALCARECODQM,process.pathALCARECOMuAlCalIsolatedMu,process.pathALCARECODQM,process.pathALCARECODQM,process.pathALCARECOMuAlGlobalCosmics,process.endjob_step,process.out_step,process.ALCARECOStreamMuAlGlobalCosmicsOutPath,process.ALCARECOStreamTkAlCosmics0TOutPath,process.ALCARECOStreamMuAlCalIsolatedMuOutPath)
