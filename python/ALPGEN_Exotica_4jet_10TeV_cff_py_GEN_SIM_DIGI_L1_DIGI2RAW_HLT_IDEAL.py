...
# with command line options: Configuration/GenProduction/python/ALPGEN_Exotica_4jet_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V12::All -n 10 --no_exec
...
# fraction of events that fail fragmentation cuts = 0.91071
# 1547.576u 18.562s 27:15.29 95.7% 0+0k 17968+32672io 283pf+0w
# output rootfile size for 10 events is 16M
