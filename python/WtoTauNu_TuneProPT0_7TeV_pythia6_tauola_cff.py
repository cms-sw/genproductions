...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Tauola_EWK_Wtaunu_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 Wtaunu at 7TeV, Tune ProPT0')
)
