...
# with command line options: Configuration/GenProduction/python/PYTHIA6_ZeeJetpt_0_15_10TeV_cff.py.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 200000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/PYTHIA6_ZeeJetpt_0_15_10TeV_cff.py,v $')
)
...
process.source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(6433.0),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_ZeeJetpt_0_15_10TeV_cff_py_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
