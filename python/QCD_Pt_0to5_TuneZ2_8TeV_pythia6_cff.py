...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	filterEfficiency = cms.untracked.double(0.980005),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Spring2011 sample with PYTHIA6: QCD dijet production, pThat = 0 .. 5 GeV, TuneZ2')
)
