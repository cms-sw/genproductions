...
source = cms.Source("MadGraphSource",
                    ...
                    PythiaParameters = cms.PSet( pythiaUESettingsBlock,
                                                 ...
                                                 TtDecaySteer = cms.vstring('MDME(46,1)=2 ! activate t->Wb for the particle only',
                                                                            'MDME(45,1)=3 ! activate t->Ws for the anti-particle only',
                                                                            'MDME(44,1)=3 ! activate t->Wd for the anti-particle only'
                                                                            ),
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MadGraph-PYTHIA6 at 10TeV, qcut 30, cteq6l, R=0.50 (anti-top forced to decay to light quarks only)')
    )
