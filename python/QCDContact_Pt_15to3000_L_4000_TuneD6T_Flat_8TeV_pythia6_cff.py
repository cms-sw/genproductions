...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(3.170930e+10),
	...
	PythiaParameters = cms.PSet(
		...
		processParameters = cms.vstring(
			...
			'RTCM(41)=4000 ! Set Contact Scale Lambda to 4 TeV',
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Spring2011 sample with PYTHIA6: QCD + 4TeV contact interaction, pThat = 15 .. 3000 GeV, weighted, TuneD6T')
)
