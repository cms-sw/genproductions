...
# using: 
# $Revision: 1.1 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_incBBmu_Pt_20up_10TeV_py_GEN_STARTUP_V5.py,v $
...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/PYTHIA6_incBBmu_Pt_20up_10TeV_py'),
...
process.source = cms.Source("PythiaSource",
    ...
    filterEfficiency = cms.untracked.double(0.0037),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_incBBmu_Pt_20up_10TeV_py_GEN.root'),
...
process.ProductionFilterSequence = cms.Sequence(process.mugenfilter*process.bbFilter)
