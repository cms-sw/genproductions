...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(0.0702),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_PYTHIA6_qqH200_WW_taunujj_7TeV_cff.py,v $'),
