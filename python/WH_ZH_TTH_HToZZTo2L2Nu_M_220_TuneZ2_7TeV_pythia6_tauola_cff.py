...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_SM_H_2Z_4l_wh_zh_tth_mH220_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 WH/ZH/ttH, H->ZZ->2l2nu mH=220GeV with TAUOLA at 7TeV')
)
