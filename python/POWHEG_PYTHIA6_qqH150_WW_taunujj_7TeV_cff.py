...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(0.0505),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_PYTHIA6_qqH150_WW_taunujj_7TeV_cff.py,v $'),
