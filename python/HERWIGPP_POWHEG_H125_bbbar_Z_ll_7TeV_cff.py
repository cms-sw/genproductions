...
generator = cms.EDFilter(
    ...
    'set /Herwig/Particles/h0/h0->b,bbar;:BranchingRatio 0.5948',
    ...
    crossSection     = cms.untracked.double(0.0180),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /cvs_server/repositories/CMSSW/UserCode/SchieferD/GenProduction/python/HERWIGPP_POWHEG_H125_bbbar_Z_ll_7TeV_cff.py,v $'),
	annotation = cms.untracked.string('HERWIGPP/POWHEG: (H->bb)(Z->ll), m(H)=125 GeV, l=e or mu')
)
