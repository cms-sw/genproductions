...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.7774),
    crossSection = cms.untracked.double(7856.),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EWK_Wenu_TuneDW_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-Wenu Tune DW at 7TeV')
)
