...
generator = cms.EDFilter(
    ...
    filterEfficiency = cms.untracked.double(7.0e-4),
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/LambdaB_ppi.dec'),
...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_LambdaB2PPi_TuneZ2_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('Lambda_b -> p+ pi- at 7TeV')
    )
