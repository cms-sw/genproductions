...
source = cms.Source("MCatNLOSource",
    ...
    processNumber = cms.untracked.int32(-1473), #W-->tau+nu
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MCatNLO_WminusT_10TeV_cff.py,v $'),
