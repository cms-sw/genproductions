...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(1.812),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDplus12TeVcontact_pt_800_1000_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+12TeVcontact-pt-800-1000 at 7TeV')
)
