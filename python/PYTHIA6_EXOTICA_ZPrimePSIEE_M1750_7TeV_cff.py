...
generator = cms.EDFilter("Pythia6GeneratorFilter",   
    ...
    crossSection  = cms.untracked.double(00.000932),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EXOTICA_ZPrimePSIEE_MZMPRIMEMASS_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA ZPRIME PSI ee, mass = 1750 at sqrt(s) = 7TeV')
)
