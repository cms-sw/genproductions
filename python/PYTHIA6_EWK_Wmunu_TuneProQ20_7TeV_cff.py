...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.7400),
    crossSection = cms.untracked.double(7801.),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EWK_Wmunu_TuneProQ20_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-Wmunu Tune ProQ20 at 7TeV')
)
