...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(14.35),
...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/Configuration/GenProduction/python/PYTHIA6_Exotica_LQ_ue_175_7TeV_enuejjFilter_cff.py,v $'),
        annotation = cms.untracked.string('default documentation string for PYTHIA6_Exotica_LQ_ue_175_7TeV_enuejjFilter_cff.py')
)
