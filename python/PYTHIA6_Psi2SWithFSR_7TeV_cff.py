...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Psi2SWithFSR_7TeV_cff.py,v $'),
        annotation = cms.untracked.string('Summer09: Pythia6 generation of prompt Psi2S, 7TeV, D6T tune')
)
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    # I   0 All included subprocesses    I       100000       1964771 I  4.952E-03 I   0.0076 I
    crossSection = cms.untracked.double(37600.0),
    # TrigReport  Trig Bit#    Visited     Passed     Failed      Error Name
    # TrigReport     1    0     100000     100000          0          0 generator
    # TrigReport     1    0     100000     100000          0          0 oniafilter
    # TrigReport     1    0     100000      19669      80331          0 mumugenfilter
    filterEfficiency = cms.untracked.double(0.197),
