...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(0.00377),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_HERWIG6_qqH250_WW_taunutaunu_7TeV_cff.py,v $'),
