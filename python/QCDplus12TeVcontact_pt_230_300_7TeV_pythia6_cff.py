...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(4030),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDplus12TeVcontact_pt_230_300_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+12TeVcontact-pt-230-300 at 7TeV')
)
