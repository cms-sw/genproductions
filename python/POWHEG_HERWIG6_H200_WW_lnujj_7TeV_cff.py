...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(0.0665),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_HERWIG6_H200_WW_lnujj_7TeV_cff.py,v $'),
