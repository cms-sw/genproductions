...
# with command line options: Configuration/GenProduction/python/PYTHIA8_PhotonJetpt30_35_10TeV_cff.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 100 --no_exec
