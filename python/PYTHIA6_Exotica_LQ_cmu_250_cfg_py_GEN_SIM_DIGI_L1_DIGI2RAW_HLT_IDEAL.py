...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('default documentation string for LQ_cmu_250_cfg.py'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Exotica_LQ_cmu_250_cfg_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Exotica_LQ_cmu_250_cfg_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
