...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_JPsiWithFSR_7TeV_cff.py,v $'),
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
            ...
            user_decay_file = cms.FileInPath('Configuration/GenProduction/python/Onia_mumu_fix_for_wrong_alias.dec'),
