...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/CosmicMC_BON_RECO.py,v $'),
...
process.GlobalTag.globaltag = "COSMMC_22X_V7::All"
