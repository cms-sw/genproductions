...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(1.217e-05),
    PythiaParameters = cms.PSet(
	    ...
	    'RTCM(41)=12000  ! Set Contact Scale Lambda to 12 TeV',
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDplus12TeVcontact_pt_2200_2600_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+12TeVcontact-pt-2200-2600 at 7TeV')
)
