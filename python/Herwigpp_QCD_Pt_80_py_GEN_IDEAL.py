...
# with command line options: Configuration/GenProduction/python/Herwigpp_QCD_Pt_80.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec --customise Configuration/GenProduction/Herwigpp_custom.py
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Herwigpp_QCD_Pt_80_GEN.root'),
