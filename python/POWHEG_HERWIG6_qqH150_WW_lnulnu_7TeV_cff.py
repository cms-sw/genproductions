...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(0.0302),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_HERWIG6_qqH150_WW_lnulnu_7TeV_cff.py,v $'),
