...
# with command line options: Configuration/GenProduction/python/PYTHIA6_Tauola_SM_VBF_H_WW_lnu2jets_mH160_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('PYTHIA6 Tauola SM VBF H->WW->l nu 2jets at 10TeV with mH=160 GeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_SM_VBF_H_WW_lnu2jets_mH160_10TeV_cff.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Tauola_SM_VBF_H_WW_lnu2jets_mH160_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
