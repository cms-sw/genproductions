...
# with command line options: step3 -s ALCA:MuAlGlobalCosmics+DQM --conditions FrontierConditions_GlobalTag,STARTUP31X_V3::All --scenario cosmics --no_exec --python_filename MuAlGlobalCosmics_cfg.py
...
# Schedule definition
process.schedule = cms.Schedule(process.pathALCARECODQM,process.pathALCARECOMuAlGlobalCosmics,process.endjob_step,process.ALCARECOStreamMuAlGlobalCosmicsOutPath)
