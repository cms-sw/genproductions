...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_nMSSM_a_mumu_m12_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('nMSSM a->mumu, mA0=12 GeV')
)
