...
# with command line options: Configuration/GenProduction/python/MCatNLO_WplusT_10TeV_cff.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 1000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MCatNLO_WplusT_10TeV_cff_py_GEN_IDEAL.py,v $')
)
...
process.source = cms.Source("MCatNLOSource",
    ...
    processNumber = cms.untracked.int32(-1463)
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MCatNLO_WplusT_10TeV_cff_py_GEN.root'),
