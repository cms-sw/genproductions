...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(3.061498e+03),
	filterEfficiency = cms.untracked.double(0.676706),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Spring2011 sample with PYTHIA6: Drell-Yan Z/g* -> cc, m > 50 GeV, TuneZ2')
)
