...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(2800.0),
    # TrigReport    Visited        Run     Passed     Failed      Error Name
    # TrigReport      10000      10000      10000          0          0 generator
    # TrigReport      10000      10000      10000          0          0 oniafilter
    # TrigReport      10000      10000       5689       4311          0 mumugenfilter
    filterEfficiency = cms.untracked.double(0.570),
