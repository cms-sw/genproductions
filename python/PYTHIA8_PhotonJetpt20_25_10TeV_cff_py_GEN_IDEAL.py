...
# with command line options: Configuration/GenProduction/python/PYTHIA8_PhotonJetpt20_25_10TeV_cff.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec --customise Configuration/GenProduction/PYTHIA8_custom.py
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA8_PhotonJetpt20_25_10TeV_cff_GEN.root'),
