...
# with command line options: Configuration/GenProduction/python/PYTHIA6_Exotica_bprime_cW_m250_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Exotica_bprime_cW_m250_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL.py,v $'),
    annotation = cms.untracked.string('PYTHIA6_Exotica_bprime_cW_m250 at 10TeV')
)
...
process.source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(3.146e-08),
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSTP(1) = 4', 
            ...
            'PMAS(7,1) = 250.0D0  ! bprime quarks mass', 
            'PMAS(7,2) = 1.0D0', 
            'PMAS(7,3) = 10.0D0', 
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Exotica_bprime_cW_m250_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
