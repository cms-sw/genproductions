...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Bc to J/psi pi+ from BCVEGPY LHE file and EvtGen'),
    name = cms.untracked.string('$Source: genbcjpsiPi_EvtGen.py')
)
                         ...
                         comEnergy = cms.double(7000.),
                                 ExternalDecays = cms.PSet(
                                                           EvtGen = cms.untracked.PSet(
                                                                                       ...
                                                                                       user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bc_Jpsi3pi.dec'),
                                 ...
                                 PythiaParameters = cms.PSet(
                                                             ...
                                                             processParameters = cms.vstring(
                                                                                             ...
                                                                                             'MDME(1025,1) = 3', 
                                                                                             'MDME(1026,1) = 3',
                                                                                             'MDME(1027,1) = 2        ! on for Bc+ -> J/psi 3pi only, particle'), 	
