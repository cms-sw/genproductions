...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/PYTHIA6_Tauola_gg_bbH100_bb_MuEnrichedPt14_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 - SUSY gg->bbH(100)->bb MuEnriched w/ pT>=14. |eta|<=2.5, with Tauola at 7TeV')
    )
