...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string(process_name + '_unweighted_events.lhe'),
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/' + process_name + '/v1', process_name, 'false','false','zjets','5','7','false','0','2'),
