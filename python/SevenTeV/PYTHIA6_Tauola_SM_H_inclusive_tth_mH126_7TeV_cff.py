...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/PYTHIA6_Tauola_SM_H_inclusive_tth_mH126_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 ttH, inclusive decay mH=126GeV with TAUOLA at 7TeV')
)
