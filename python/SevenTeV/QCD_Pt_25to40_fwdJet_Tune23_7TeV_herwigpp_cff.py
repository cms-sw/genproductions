...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	...
	productionParameters = cms.vstring(
		...
		'cd /',
		'set /Herwig/Cuts/JetKtCut:MinKT 25  *GeV',
		'set /Herwig/Cuts/JetKtCut:MaxKT 40  *GeV',
...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/QCD_Pt_25to40_fwdJet_Tune23_7TeV_herwigpp_cff.py,v $'),
	annotation = cms.untracked.string('LowPU2010 sample with HERWIGPP: QCD dijet production, pThat = 25 .. 40 GeV, Tune23')
)
