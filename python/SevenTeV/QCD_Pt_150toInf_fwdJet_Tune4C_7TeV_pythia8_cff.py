...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/QCD_Pt_150toInf_fwdJet_Tune4C_7TeV_pythia8_cff.py,v $'),
	annotation = cms.untracked.string('Sample with PYTHIA8: QCD dijet production, pThat = 150 .. inf GeV, Tune4C')
)
