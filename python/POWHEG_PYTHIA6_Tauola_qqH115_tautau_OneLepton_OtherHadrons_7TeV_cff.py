...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(1.330),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_PYTHIA6_Tauola_qqH115_tautau_OneLepton_OtherHadrons_7TeV_cff.py,v $'),
