...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('default documentation string for LQ_ue_1500_cfg.py'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Exotica_LQ_ue_1500_cfg_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL.py,v $')
)
...
process.source = cms.Source("PythiaSource",
    ...
    PythiaParameters = cms.PSet(
        pythiaUESettings = cms.vstring('MSTJ(11)=3     ! Choice of the fragmentation function', 
            ...
            'PARP(93)=15.0  ! '),
        processParameters = cms.vstring('PMAS(42,1)=1500.0        !LQ mass', 
            'KFDP(539,1)=2           !LQ->u+e', 
            'KFDP(539,2)=11          !e', 
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('LQ_ue_1500_cfg_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
