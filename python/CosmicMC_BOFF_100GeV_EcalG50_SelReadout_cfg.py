...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source:/cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring09Production/data/CosmicMC_BOFF_100GeV_EcalG50_SelReadout_cfg.py'),
...
process.output = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('CosmicMC_BOFF_100GeV_EcalG50_SelReadout_TKOnly.root'),
