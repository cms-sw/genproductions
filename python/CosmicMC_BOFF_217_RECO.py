...
# local file
    fileNames=cms.untracked.vstring('file:////local/hoepfner/CMSSW/cosmicMC/CMSSW_2_1_7/src/GeneratorInterface/CosmicMuonGenerator/test/CosmicMC_BOFF_RAW_10GeV.root'
                            )
)
...
process.FEVT = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_CosmicMC_BOFF_217.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: CosmicMC_BOFF_217_RECO.py,v $'),
    annotation = cms.untracked.string('Reco of simulated cosmics without magnetic field')
)
