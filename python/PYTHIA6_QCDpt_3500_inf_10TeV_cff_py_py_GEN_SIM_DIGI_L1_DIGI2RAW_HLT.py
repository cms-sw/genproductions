...
# using: 
# $Revision: 1.2 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDpt_3500_inf_10TeV_cff_py_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL_V6.py,v $
...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/PYTHIA6_QCDpt_3500_inf_10TeV_cff_py_py'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDpt_3500_inf_10TeV_cff_py_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL_V6.py,v $')
)
...
process.source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(1.8146e-07),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_QCDpt_3500_inf_10TeV_cff_py_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
