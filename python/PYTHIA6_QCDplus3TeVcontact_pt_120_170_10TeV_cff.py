...
source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(256500),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDplus3TeVcontact_pt_120_170_10TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+3TeVcontact-pt-120-170 at 10TeV')
)
