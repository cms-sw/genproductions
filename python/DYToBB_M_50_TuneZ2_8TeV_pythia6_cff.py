...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(3.841406e+03),
	filterEfficiency = cms.untracked.double(0.674624),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Spring2011 sample with PYTHIA6: Drell-Yan Z/g* -> bb, m > 50 GeV, TuneZ2')
)
