...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/Py6HadFilter_mgmatching_cfg_frag_900GeV.py nevts:10'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Py6HadFilter_mgmatching_cfg_frag_900GeV_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
