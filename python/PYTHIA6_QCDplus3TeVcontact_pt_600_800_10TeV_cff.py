...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(82.33),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_QCDplus3TeVcontact_pt_600_800_10TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+3TeVcontact-pt-600-800 at 10TeV')
)
