...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	herwigDefaultsBlock,
	crossSection = cms.untracked.double(7.678),
...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /cvs/CMSSW/UserCode/hinzmann/production/RSGravitonToZZ_kMpl01_M_750_Tune23_7TeV_herwiggpp_cff.py,v $'),
