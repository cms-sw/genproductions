...
# with command line options: Configuration/GenProduction/python/PYTHIA6_Bs2PhiMuMu_10TeV_cff.py -s GEN:ProductionFilterSequence,FASTSIM --pileup=NoPileUp --conditions FrontierConditions_GlobalTag,IDEAL_V11::All --beamspot=Early10TeVCollision --datatier GEN-SIM-DIGI-RECO --eventcontent AODSIM -n 1000
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Bs2PhiMuMu_10TeV_cff_py_GEN_FASTSIM.root'),
...
process.generation_step = cms.Path(process.ProductionFilterSequence*(cms.SequencePlaceholder("randomEngineStateProducer")+process.GeneInfo+process.genJetMET))
process.HLT_TripleJet60_MET60 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sTripleJet60MET60+process.hltPreTripleJet60MET60+process.HLTRecoJetMETSequence+process.hlt1MET60+process.hlt3jet60+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_BTagMu_QuadJet30_Relaxed = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sBSoftmuonNjet+process.hltPreBTagMuQuadJet30Relaxed+process.HLTBCommonL2recoSequence+process.hltBSoftmuon4jetL2filter30+process.HLTBSoftmuonL25recoSequence+process.hltBSoftmuonL25filter+process.HLTBSoftmuonL3recoSequence+process.hltBSoftmuonL3filterRelaxed+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_MinBiasPixel_Trk5 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMinBiasPixel+process.hltPreMinBiasPixelTrk5+process.HLTDoLocalPixelSequence+process.HLTPixelTrackingForMinBiasSequence+process.hltPixelCands+process.hltPixelMBForAlignment+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoEle12_Jet40 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sEJet+process.hltPreIsoEle12Jet40+process.HLTEJetElectronSequence+process.HLTDoCaloSequence+process.HLTDoJetRecoSequence+process.hltej1jet40+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_Jet250 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sJet250+process.hltPreJet250+process.HLTRecoJetRegionalSequence+process.hlt1jet250+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoMu15 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuIso10+process.hltPreIsoMu15+process.hltSingleMuIsoL1Filtered10+process.HLTL2muonrecoSequence+process.hltSingleMuIsoL2PreFiltered12+process.HLTL2muonisorecoSequence+process.hltSingleMuIsoL2IsoFiltered12+process.HLTL3muonrecoSequence+process.hltSingleMuIsoL3PreFiltered15+process.HLTL3muonisorecoSequence+process.hltSingleMuIsoL3IsoFiltered15+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleEle5_SW_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedDoubleEgammaEt5+process.hltPreDoubleEle5SWL1R+process.HLTDoubleElectronEt5L1NonIsoHLTnonIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoMu11 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuIso7+process.hltPreIsoMu11+process.hltSingleMuIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltSingleMuIsoL2PreFiltered+process.HLTL2muonisorecoSequence+process.hltSingleMuIsoL2IsoFiltered+process.HLTL3muonrecoSequence+process.hltSingleMuIsoL3PreFiltered+process.HLTL3muonisorecoSequence+process.hltSingleMuIsoL3IsoFiltered+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_MET75 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMET75+process.hltPreMET75+process.HLTRecoJetMETSequence+process.hlt1MET75+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_Ele15_SW_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgammaEt12+process.hltPreEle15SWL1R+process.HLTSingleElectronEt15L1NonIsoHLTNonIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoMu7_BTagIP_Jet35 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMuB+process.hltPreIsoMu7BTagIPJet35+process.hltMuBLifetimeL1Filtered+process.HLTL2muonrecoSequence+process.hltMuBLifetimeIsoL2PreFiltered+process.HLTL2muonisorecoSequence+process.hltMuBLifetimeIsoL2IsoFiltered+process.HLTBCommonL2recoSequence+process.HLTBLifetimeL25recoSequence+process.hltBLifetimeL25filter+process.HLTL3muonrecoSequence+process.hltMuBLifetimeIsoL3PreFiltered+process.HLTL3muonisorecoSequence+process.hltMuBLifetimeIsoL3IsoFiltered+process.HLTBLifetimeL3recoSequence+process.hltBLifetimeL3filter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DiJetAve50 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDiJetAve50+process.hltPreDiJetAve50+process.HLTRecoJetMETSequence+process.hltdijetave50+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoEle12_IsoTau_Trk3 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sElectronTau+process.hltPreIsoEle12IsoTauTrk3+process.HLTETauSingleElectronL1IsolatedHOneOEMinusOneOPFilterSequence+process.HLTL2TauJetsElectronTauSequnce+process.hltL2ElectronTauIsolationProducer+process.hltL2ElectronTauIsolationSelector+process.hltFilterEcalIsolatedTauJetsElectronTau+process.HLTRecopixelvertexingSequence+process.hltJetTracksAssociatorAtVertexL25ElectronTau+process.hltConeIsolationL25ElectronTau+process.hltIsolatedTauJetsSelectorL25ElectronTauPtLeadTk+process.hltFilterIsolatedTauJetsL25ElectronTauPtLeadTk+process.hltIsolatedTauJetsSelectorL25ElectronTau+process.hltFilterIsolatedTauJetsL25ElectronTau+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DiJetAve220 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDiJetAve220+process.hltPreDiJetAve220+process.HLTRecoJetMETSequence+process.hltdijetave220+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoTau_MET35_Trk15_L1MET = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleTauMET+process.hltPreIsoTauMET35Trk15L1MET+process.HLTCaloTausCreatorSequence+process.hltMet+process.hlt1METSingleTauMET+process.hltL2SingleTauMETJets+process.hltL2SingleTauMETIsolationProducer+process.hltL2SingleTauMETIsolationSelector+process.hltFilterSingleTauMETEcalIsolation+process.HLTDoLocalPixelSequence+process.HLTRecopixelvertexingSequence+process.hltAssociatorL25SingleTauMET+process.hltConeIsolationL25SingleTauMET+process.hltIsolatedL25SingleTauMET+process.hltFilterL25SingleTauMET+process.HLTDoLocalStripSequence+process.hltL3SingleTauMETPixelSeeds+process.hltCkfTrackCandidatesL3SingleTauMET+process.hltCtfWithMaterialTracksL3SingleTauMET+process.hltAssociatorL3SingleTauMET+process.hltConeIsolationL3SingleTauMET+process.hltIsolatedL3SingleTauMET+process.hltFilterL3SingleTauMET+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleIsoEle12_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedDoubleEgamma+process.hltPreDoubleIsoEle12L1R+process.HLTDoRegionalEgammaEcalSequence+process.HLTL1IsolatedEcalClustersSequence+process.HLTL1NonIsolatedEcalClustersSequence+process.hltL1IsoRecoEcalCandidate+process.hltL1NonIsoRecoEcalCandidate+process.hltL1NonIsoDoubleElectronL1MatchFilterRegional+process.hltL1NonIsoDoubleElectronEtFilter+process.HLTDoLocalHcalWithoutHOSequence+process.hltL1IsolatedElectronHcalIsol+process.hltL1NonIsolatedElectronHcalIsol+process.hltL1NonIsoDoubleElectronHcalIsolFilter+process.HLTDoLocalPixelSequence+process.HLTDoLocalStripSequence+process.HLTPixelMatchElectronL1IsoSequence+process.HLTPixelMatchElectronL1NonIsoSequence+process.hltL1NonIsoDoubleElectronPixelMatchFilter+process.HLTPixelMatchElectronL1IsoTrackingSequence+process.HLTPixelMatchElectronL1NonIsoTrackingSequence+process.hltL1NonIsoDoubleElectronEoverpFilter+process.HLTL1IsoElectronsRegionalRecoTrackerSequence+process.HLTL1NonIsoElectronsRegionalRecoTrackerSequence+process.hltL1IsoElectronTrackIsol+process.hltL1NonIsoElectronTrackIsol+process.hltL1NonIsoDoubleElectronTrackIsolFilter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_MET25 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMET25+process.hltPreMET25+process.HLTRecoJetMETSequence+process.hlt1MET25+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleMu4_BJPsi = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sJpsitoMumu+process.hltPreDoubleMu4BJPsi+process.hltJpsitoMumuL1Filtered+process.HLTL2muonrecoSequence+process.HLTL3displacedMumurecoSequence+process.hltDisplacedJpsitoMumuFilter+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_MET65 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMET65+process.hltPreMET65+process.HLTRecoJetMETSequence+process.hlt1MET65+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_Ele15_LW_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgammaEt10+process.hltPreEle15LWL1R+process.HLTSingleElectronLWEt15L1NonIsoHLTNonIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_BTagMu_TripleJet40_Relaxed = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sBSoftmuonNjet+process.hltPreBTagMuTripleJet40Relaxed+process.HLTBCommonL2recoSequence+process.hltBSoftmuon3jetL2filter40+process.HLTBSoftmuonL25recoSequence+process.hltBSoftmuonL25filter+process.HLTBSoftmuonL3recoSequence+process.hltBSoftmuonL3filterRelaxed+cms.SequencePlaceholder("HLTEndSequence")))
process.AlCa_IsoTrack = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sAlCaIsoTrack+process.hltPreAlCaIsoTrack+process.HLTL3PixelIsolFilterSequence+process.HLTIsoTrRegFEDSelection+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_EM200 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgamma+process.hltPreEM200+process.HLTDoRegionalEgammaEcalSequence+process.HLTL1IsolatedEcalClustersSequence+process.HLTL1NonIsolatedEcalClustersSequence+process.hltL1IsoRecoEcalCandidate+process.hltL1NonIsoRecoEcalCandidate+process.hltL1NonIsoSingleEMVeryHighEtL1MatchFilterRegional+process.hltL1NonIsoSinglePhotonEMVeryHighEtEtFilter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleJet60_MET60_Aco = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDoubleJet60MET60Aco+process.hltPreDoubleJet60MET60Aco+process.HLTRecoJetMETSequence+process.hlt1MET60+process.hltPhi2metAco+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_Jet30 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sJet30+process.hltPreJet30+process.HLTRecoJetMETSequence+process.hlt1jet30+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleMu3_Psi2S = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sJpsiMM+process.hltPreDoubleMu3Psi2S+process.hltJpsiMML1Filtered+process.HLTL2muonrecoSequence+process.hltPsi2SMML2Filtered+process.HLTL3muonrecoSequence+process.hltPsi2SMML3Filtered+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_CSCBeamHaloOverlapRing1 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sCSCBeamHaloOverlapRing1+process.hltPreCSCBeamHaloOverlapRing1+cms.SequencePlaceholder("simMuonCSCDigis")+process.hltCsc2DRecHits+process.hltOverlapsHLTCSCBeamHaloOverlapRing1+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_CSCBeamHaloOverlapRing2 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sCSCBeamHaloOverlapRing2+process.hltPreCSCBeamHaloOverlapRing2+cms.SequencePlaceholder("simMuonCSCDigis")+process.hltCsc2DRecHits+process.hltOverlapsHLTCSCBeamHaloOverlapRing2+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_QuadJet35_MET60 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sQuadJet35MET60+process.hltPreQuadJet35MET60+process.HLTRecoJetMETSequence+process.hlt1MET60+process.hlt4jet35+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_TripleMu3_TauTo3Mu = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMuMuk+process.hltPreTripleMu3TauTo3Mu+process.hltMuMukL1Filtered+process.HLTL2muonrecoSequence+process.HLTL3displacedMumurecoSequence+process.hltDisplacedMuMukFilter+process.HLTDoLocalPixelSequence+process.HLTDoLocalStripSequence+process.HLTRecopixelvertexingSequence+process.hltMumukPixelSeedFromL2Candidate+process.hltCkfTrackCandidatesMumuk+process.hltCtfWithMaterialTracksMumuk+process.hltMumukAllConeTracks+process.hltmmkFilter+cms.SequencePlaceholder("HLTEndSequence")))
...
process.AlCa_EcalPhiSym = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sAlCaEcalPhiSym+process.hltPreAlCaEcalPhiSym+process.hltEcalDigis+process.hltEcalWeightUncalibRecHit+process.hltEcalRecHit+process.hltAlCaPhiSymStream+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleEle10_Z = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDoubleEgamma+process.hltPreDoubleEle10Z+process.HLTDoRegionalEgammaEcalSequence+process.HLTL1IsolatedEcalClustersSequence+process.hltL1IsoRecoEcalCandidate+process.hltL1IsoDoubleElectronZeeL1MatchFilterRegional+process.hltL1IsoDoubleElectronZeeEtFilter+process.HLTDoLocalHcalWithoutHOSequence+process.hltL1IsolatedElectronHcalIsol+process.hltL1IsoDoubleElectronZeeHcalIsolFilter+process.HLTDoLocalPixelSequence+process.HLTDoLocalStripSequence+process.HLTPixelMatchElectronL1IsoSequence+process.hltL1IsoDoubleElectronZeePixelMatchFilter+process.HLTPixelMatchElectronL1IsoTrackingSequence+process.hltL1IsoDoubleElectronZeeEoverpFilter+process.HLTL1IsoElectronsRegionalRecoTrackerSequence+process.hltL1IsoElectronTrackIsol+process.hltL1IsoDoubleElectronZeeTrackIsolFilter+process.hltL1IsoDoubleElectronZeePMMassFilter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_Photon15_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgammaEt10+process.hltPrePhoton15L1R+process.HLTSinglePhoton15L1NonIsolatedHLTNonIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoPhoton25_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgammaEt15+process.hltPreIsoPhoton25L1R+process.HLTSinglePhoton25L1NonIsolatedHLTIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_TrackerCosmics = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sTrackerCosmics+process.hltPreTrackerCosmics+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoMu13 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuIso10+process.hltPreIsoMu13+process.hltSingleMuIsoL1Filtered10+process.HLTL2muonrecoSequence+process.hltSingleMuIsoL2PreFiltered11+process.HLTL2muonisorecoSequence+process.hltSingleMuIsoL2IsoFiltered11+process.HLTL3muonrecoSequence+process.hltSingleMuIsoL3PreFiltered13+process.HLTL3muonisorecoSequence+process.hltSingleMuIsoL3IsoFiltered13+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoEle12_DoubleJet80 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sEJet+process.hltPreIsoEle12DoubleJet80+process.HLTEJetElectronSequence+process.HLTDoCaloSequence+process.HLTDoJetRecoSequence+process.hltej2jet80+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DiJetAve70 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDiJetAve70+process.hltPreDiJetAve70+process.HLTRecoJetMETSequence+process.hltdijetave70+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_QuadJet60 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sQuadJet60+process.hltPreQuadJet60+process.HLTRecoJetMETSequence+process.hlt4jet60+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleJet50_MET70_Aco = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDoubleJet50MET70Aco+process.hltPreDoubleJet50MET70Aco+process.HLTRecoJetMETSequence+process.hlt1MET70+process.hltPhiJet2metAco+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_L2Mu9 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuNoIso7+process.hltPreL2Mu9+process.hltSingleMuNoIsoL1Filtered7+process.HLTL2muonrecoSequence+process.hltSingleMuLevel2NoIsoL2PreFiltered+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleEle6_Exclusive = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sExclusiveDoubleEgamma+process.hltPreDoubleEle6Exclusive+process.HLTDoRegionalEgammaEcalSequence+process.HLTL1IsolatedEcalClustersSequence+process.hltL1IsoRecoEcalCandidate+process.hltL1IsoDoubleExclElectronL1MatchFilterRegional+process.hltL1IsoDoubleExclElectronEtPhiFilter+process.HLTDoLocalHcalWithoutHOSequence+process.hltL1IsolatedElectronHcalIsol+process.hltL1IsoDoubleExclElectronHcalIsolFilter+process.HLTDoLocalPixelSequence+process.HLTDoLocalStripSequence+process.HLTPixelMatchElectronL1IsoSequence+process.hltL1IsoDoubleExclElectronPixelMatchFilter+process.HLTPixelMatchElectronL1IsoTrackingSequence+process.hltL1IsoDoubleExclElectronEoverpFilter+process.HLTL1IsoElectronsRegionalRecoTrackerSequence+process.hltL1IsoElectronTrackIsol+process.hltL1IsoDoubleExclElectronTrackIsolFilter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_Photon25_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgammaEt15+process.hltPrePhoton25L1R+process.HLTSinglePhoton25L1NonIsolatedHLTNonIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleMu3_SameSign = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSameSignMu+process.hltPreDoubleMu3SameSign+process.hltSameSignMuL1Filtered+process.HLTL2muonrecoSequence+process.hltSameSignMuL2PreFiltered+process.HLTL3muonrecoSequence+process.hltSameSignMuL3PreFiltered+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoMu14_IsoTau_Trk3 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMuonTau+process.hltPreIsoMu14IsoTauTrk3+process.hltMuonTauL1Filtered+process.HLTL2muonrecoSequence+process.hltMuonTauIsoL2PreFiltered+process.HLTL2muonisorecoSequence+process.hltMuonTauIsoL2IsoFiltered+process.HLTDoLocalStripSequence+process.HLTL3muonrecoSequence+process.HLTL3muonisorecoSequence+process.hltMuonTauIsoL3PreFiltered+process.hltMuonTauIsoL3IsoFiltered+process.HLTCaloTausCreatorRegionalSequence+process.hltL2TauJetsProviderMuonTau+process.hltL2MuonTauIsolationProducer+process.hltL2MuonTauIsolationSelector+process.hltFilterEcalIsolatedTauJetsMuonTau+process.HLTDoLocalPixelSequence+process.HLTRecopixelvertexingSequence+process.hltJetsPixelTracksAssociatorMuonTau+process.hltPixelTrackConeIsolationMuonTau+process.hltIsolatedTauJetsSelectorL25MuonTauPtLeadTk+process.hltFilterL25MuonTauPtLeadTk+process.hltPixelTrackIsolatedTauJetsSelectorMuonTau+process.hltFilterPixelTrackIsolatedTauJetsMuonTau+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleMu7_Z = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sZMM+process.hltPreDoubleMu7Z+process.hltZMML1Filtered+process.HLTL2muonrecoSequence+process.hltZMML2Filtered+process.HLTL3muonrecoSequence+process.hltZMML3Filtered+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_Jet100_MET60_Aco = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sJet100MET60Aco+process.hltPreJet100MET60Aco+process.HLTRecoJetMETSequence+process.hlt1MET60+process.hlt1jet100+process.hlt1jet1METAco+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_BTagMu_DoubleJet60_Relaxed = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sBSoftmuonNjet+process.hltPreBtagMuDoubleJet60Relaxed+process.HLTBCommonL2recoSequence+process.hltBSoftmuon2jetL2filter60+process.HLTBSoftmuonL25recoSequence+process.hltBSoftmuonL25filter+process.HLTBSoftmuonL3recoSequence+process.hltBSoftmuonL3filterRelaxed+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleFwdJet40_MET60 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDoubleFwdJet40MET60+process.hltPreDoubleFwdJet40MET60+process.HLTRecoJetMETSequence+process.hlt1MET60+process.hlt2jetvbf+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DiJetAve15 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDiJetAve15+process.hltPreDiJetAve15+process.HLTRecoJetMETSequence+process.hltdijetave15+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleEle10_LW_OnlyPixelM_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedDoubleEgammaEt5+process.hltPreDoubleEle10LWOnlyPixelML1R+process.HLTDoubleElectronLWonlyPMEt10L1NonIsoHLTNonIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_MET65_HT350 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMET35HT350+process.hltPreMET35HT350+process.HLTRecoJetMETSequence+process.hlt1MET65+process.hlt1HT350+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_MinBiasHcal = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMinBiasHcal+process.hltPreMinBiasHcal+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_L1Jet15 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sL1Jet15+process.hltPreL1Jet15+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_Jet50 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sJet50+process.hltPreJet50+process.HLTRecoJetMETSequence+process.hlt1jet50+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_LooseIsoEle15_LW_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgammaEt12+process.hltPreLooseIsoEle15LWL1R+process.HLTSingleElectronLWEt15L1NonIsoHLTLooseIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.HLTriggerFirstPath = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltGetRaw+process.hltPreFirstPath+process.hltBoolFirstPath+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_Ele10_SW_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgammaEt8+process.hltPreEle10SWL1R+process.HLTSingleElectronEt10L1NonIsoHLTnonIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_MinBiasPixel = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMinBiasPixel+process.hltPreMinBiasPixel+process.HLTDoLocalPixelSequence+process.HLTPixelTrackingForMinBiasSequence+process.hltPixelCands+process.hltMinBiasPixelFilter+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_DoubleJet40_MET70_Aco = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDoubleJet40MET70Aco+process.hltPreDoubleJet40MET70Aco+process.HLTRecoJetMETSequence+process.hlt1MET70+process.hltPhiJet1Jet2Aco+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleJet125_MET60 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDoubleJet125MET60+process.hltPreDoubleJet125MET60+process.HLTRecoJetMETSequence+process.hlt1MET60+process.hlt2jet125New+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_L1MET20 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sL1MET20+process.hltPreL1MET20+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_Jet180_MET60 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sJet180MET60+process.hltPreJet180MET60+process.HLTRecoJetMETSequence+process.hlt1MET60+process.hlt1jet180+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoEle5_TripleJet30 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sEJet30+process.hltPreIsoEle5TripleJet30+process.HLTE3Jet30ElectronSequence+process.HLTDoCaloSequence+process.HLTDoJetRecoSequence+process.hltej3jet30+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_NoL2IsoMu8_Jet40 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMuNoL2IsoJets+process.hltPreNoL2IsoMu8Jet40+process.hltMuNoL2IsoJetsL1Filtered+process.HLTL2muonrecoSequence+process.hltMuNoL2IsoJetsL2PreFiltered+process.HLTL3muonrecoSequence+process.hltMuNoL2IsoJetsL3PreFiltered+process.HLTL3muonisorecoSequence+process.hltMuNoL2IsoJetsL3IsoFiltered+process.HLTDoCaloSequence+process.HLTDoJetRecoSequence+process.hltMuNoL2IsoJetsHLT1jet40+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_IsoPhoton20_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgammaEt15+process.hltPreIsoPhoton20L1R+process.HLTSinglePhoton20L1NonIsolatedHLTIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_QuadJet30 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sQuadJet30+process.hltPreQuadJet30+process.HLTRecoJetMETSequence+process.hlt4jet30+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_BackwardBSC = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sBackwardBSC+process.hltPreBackwardBSC+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoMu7_Jet40 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMuJets+process.hltPreIsoMu7Jet40+process.hltMuJetsL1Filtered+process.HLTL2muonrecoSequence+process.hltMuJetsL2PreFiltered+process.HLTL2muonisorecoSequence+process.hltMuJetsL2IsoFiltered+process.HLTL3muonrecoSequence+process.hltMuJetsL3PreFiltered+process.HLTL3muonisorecoSequence+process.hltMuJetsL3IsoFiltered+process.HLTDoCaloSequence+process.HLTDoJetRecoSequence+process.hltMuJetsHLT1jet40+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_FwdJet20 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sFwdJet20+process.hltPreFwdJet20+process.HLTRecoJetMETSequence+process.hltRapGap+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_MinBiasEcal = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMinBiasEcal+process.hltPreMinBiasEcal+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_MinBias = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMinBias+process.hltPreMinBias+cms.SequencePlaceholder("HLTEndSequence")))
process.AlCa_EcalPi0 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sAlCaEcalPi0+process.hltPreAlCaEcalPi0+process.HLTDoRegionalEgammaEcalSequence+process.hltAlCaPi0RegRecHits+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_SumET120 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSumET120+process.hltPreSumET120+process.HLTRecoJetMETSequence+process.hlt1SumET120+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleMu3_Upsilon = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sUpsilonMM+process.hltPreDoubleMu3Upsilon+process.hltUpsilonMML1Filtered+process.HLTL2muonrecoSequence+process.hltUpsilonMML2Filtered+process.HLTL3muonrecoSequence+process.hltUpsilonMML3Filtered+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleIsoPhoton20_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedDoubleEgamma+process.hltPreDoubleIsoPhoton20L1R+process.HLTDoRegionalEgammaEcalSequence+process.HLTL1IsolatedEcalClustersSequence+process.HLTL1NonIsolatedEcalClustersSequence+process.hltL1IsoRecoEcalCandidate+process.hltL1NonIsoRecoEcalCandidate+process.hltL1NonIsoDoublePhotonL1MatchFilterRegional+process.hltL1NonIsoDoublePhotonEtFilter+process.hltL1IsolatedPhotonEcalIsol+process.hltL1NonIsolatedPhotonEcalIsol+process.hltL1NonIsoDoublePhotonEcalIsolFilter+process.HLTDoLocalHcalWithoutHOSequence+process.hltL1IsolatedPhotonHcalIsol+process.hltL1NonIsolatedPhotonHcalIsol+process.hltL1NonIsoDoublePhotonHcalIsolFilter+process.HLTDoLocalTrackerSequence+process.HLTL1IsoEgammaRegionalRecoTrackerSequence+process.HLTL1NonIsoEgammaRegionalRecoTrackerSequence+process.hltL1IsoPhotonTrackIsol+process.hltL1NonIsoPhotonTrackIsol+process.hltL1NonIsoDoublePhotonTrackIsolFilter+process.hltL1NonIsoDoublePhotonDoubleEtFilter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_Jet80 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sJet80+process.hltPreJet80+process.HLTRecoJetRegionalSequence+process.hlt1jet80+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoEle12_QuadJet35 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sEJet+process.hltPreIsoEle12QuadJet35+process.HLTEJetElectronSequence+process.HLTDoCaloSequence+process.HLTDoJetRecoSequence+process.hltej4jet35+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_Jet180 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sJet180+process.hltPreJet180+process.HLTRecoJetRegionalSequence+process.hlt1jet180regional+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DiJetAve30 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDiJetAve30+process.hltPrediJetAve30+process.HLTRecoJetMETSequence+process.hltdijetave30+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_BTagMu_Jet20_Calib = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sBSoftmuonNjet+process.hltPreBTagMuJet20Calib+process.HLTBCommonL2recoSequence+process.hltBSoftmuon1jetL2filter+process.HLTBSoftmuonL25recoSequence+process.hltBSoftmuonL25filter+process.HLTBSoftmuonL3recoSequence+process.hltBSoftmuonByDRL3filter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_BTagMu_DoubleJet120 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sBSoftmuonNjet+process.hltPreBTagMuDoubleJet120+process.HLTBCommonL2recoSequence+process.hltBSoftmuon2jetL2filter+process.HLTBSoftmuonL25recoSequence+process.hltBSoftmuonL25filter+process.HLTBSoftmuonL3recoSequence+process.hltBSoftmuonL3filter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoMu9 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleMuIso7+process.hltPreIsoMu9+process.hltSingleMuIsoL1Filtered+process.HLTL2muonrecoSequence+process.hltSingleMuIsoL2PreFiltered7+process.HLTL2muonisorecoSequence+process.hltSingleMuIsoL2IsoFiltered7+process.HLTL3muonrecoSequence+process.hltSingleMuIsoL3PreFiltered9+process.HLTL3muonisorecoSequence+process.hltSingleMuIsoL3IsoFiltered9+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoTau_MET65_Trk20 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleTau+process.hltPreIsoTauMET65Trk20+process.HLTCaloTausCreatorSequence+process.hltMet+process.hlt1METSingleTau+process.hltL2SingleTauJets+process.hltL2SingleTauIsolationProducer+process.hltL2SingleTauIsolationSelector+process.hltFilterSingleTauEcalIsolation+process.HLTDoLocalPixelSequence+process.HLTRecopixelvertexingSequence+process.hltAssociatorL25SingleTau+process.hltConeIsolationL25SingleTau+process.hltIsolatedL25SingleTau+process.hltFilterL25SingleTau+process.HLTDoLocalStripSequence+process.hltL3SingleTauPixelSeeds+process.hltCkfTrackCandidatesL3SingleTau+process.hltCtfWithMaterialTracksL3SingleTau+process.hltAssociatorL3SingleTau+process.hltConeIsolationL3SingleTau+process.hltIsolatedL3SingleTau+process.hltFilterL3SingleTau+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_MET50 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMET50+process.hltPreMET50+process.HLTRecoJetMETSequence+process.hlt1MET50+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleLooseIsoTau = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDoubleTauRelaxed+process.hltPreDoubleLooseIsoTau+process.HLTCaloTausCreatorRegionalSequence+process.hltL2DoubleTauJetsRelaxed+process.hltL2DoubleTauIsolationProducerRelaxed+process.hltL2DoubleTauIsolationSelectorRelaxed+process.hltFilterDoubleTauEcalIsolationRelaxed+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_EM80 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgamma+process.hltPreEM80+process.HLTDoRegionalEgammaEcalSequence+process.HLTL1IsolatedEcalClustersSequence+process.HLTL1NonIsolatedEcalClustersSequence+process.hltL1IsoRecoEcalCandidate+process.hltL1NonIsoRecoEcalCandidate+process.hltL1NonIsoSingleEMHighEtL1MatchFilterRegional+process.hltL1NonIsoSinglePhotonEMHighEtEtFilter+process.hltL1IsolatedPhotonEcalIsol+process.hltL1NonIsolatedPhotonEcalIsol+process.hltL1NonIsoSingleEMHighEtEcalIsolFilter+process.HLTDoLocalHcalWithoutHOSequence+process.hltL1NonIsolatedElectronHcalIsol+process.hltL1IsolatedElectronHcalIsol+process.hltL1NonIsoSingleEMHighEtHOEFilter+process.hltHcalDoubleCone+process.hltL1NonIsoEMHcalDoubleCone+process.hltL1NonIsoSingleEMHighEtHcalDBCFilter+process.HLTDoLocalTrackerSequence+process.HLTL1IsoEgammaRegionalRecoTrackerSequence+process.HLTL1NonIsoEgammaRegionalRecoTrackerSequence+process.hltL1IsoPhotonTrackIsol+process.hltL1NonIsoPhotonTrackIsol+process.hltL1NonIsoSingleEMHighEtTrackIsolFilter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoEle12_TripleJet60 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sEJet+process.hltPreIsoEle12TripleJet60+process.HLTEJetElectronSequence+process.HLTDoCaloSequence+process.HLTDoJetRecoSequence+process.hltej3jet60+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_Jet60_MET70_Aco = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sJet60MET70Aco+process.hltPreJet60MET70Aco+process.HLTRecoJetMETSequence+process.hlt1MET70+process.hltPhiJet1metAco+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleJet150 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDoubleJet150+process.hltPreDoubleJet150+process.HLTRecoJetRegionalSequence+process.hlt2jet150+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoMu7_BTagMu_Jet20 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sMuB+process.hltPreIsoMu7BTagMuJet20+process.hltMuBSoftL1Filtered+process.HLTL2muonrecoSequence+process.hltMuBSoftIsoL2PreFiltered+process.HLTL2muonisorecoSequence+process.hltMuBSoftIsoL2IsoFiltered+process.HLTBCommonL2recoSequence+process.HLTBSoftmuonL25recoSequence+process.hltBSoftmuonL25filter+process.HLTL3muonrecoSequence+process.hltMuBSoftIsoL3PreFiltered+process.HLTL3muonisorecoSequence+process.hltMuBSoftIsoL3IsoFiltered+process.HLTBSoftmuonL3recoSequence+process.hltBSoftmuonL3filter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoPhoton10_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgammaEt8+process.hltPreIsoPhoton10L1R+process.HLTSinglePhotonEt10L1NonIsolatedSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_DoubleJet125_Aco = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDoubleJet125Aco+process.hltPreDoubleJet125Aco+process.HLTRecoJetRegionalSequence+process.hlt2jet125+process.hlt2jetAco+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_DoubleFwdJet50 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sDoubleFwdJet50+process.hltPreDoubleFwdJet50+process.HLTRecoJetMETSequence+process.hlt2jetGapFilter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_BTagMu_HT250_Relaxed = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sBSoftmuonHTLowEnergy+process.hltPreBTagMuHT250Relaxed+process.HLTBCommonL2recoSequence+process.hltBSoftmuonHTL2filter250+process.HLTBSoftmuonL25recoSequence+process.hltBSoftmuonL25filter+process.HLTBSoftmuonL3recoSequence+process.hltBSoftmuonL3filterRelaxed+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_IsoPhoton30_L1I = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sSingleEgamma+process.hltPreIsoPhoton30L1I+process.HLTDoRegionalEgammaEcalSequence+process.HLTL1IsolatedEcalClustersSequence+process.hltL1IsoRecoEcalCandidate+process.hltL1IsoSinglePhotonL1MatchFilter+process.hltL1IsoSinglePhotonEtFilter+process.hltL1IsolatedPhotonEcalIsol+process.hltL1IsoSinglePhotonEcalIsolFilter+process.HLTDoLocalHcalWithoutHOSequence+process.hltL1IsolatedPhotonHcalIsol+process.hltL1IsoSinglePhotonHcalIsolFilter+process.HLTDoLocalTrackerSequence+process.HLTL1IsoEgammaRegionalRecoTrackerSequence+process.hltL1IsoPhotonTrackIsol+process.hltL1IsoSinglePhotonTrackIsolFilter+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_ZeroBias = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sZeroBias+process.hltPreZeroBias+cms.SequencePlaceholder("HLTEndSequence")))
process.HLT_BTagMu_HT370 = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sBSoftMuonHT+process.hltPreBTagMuHT370+process.HLTBCommonL2recoSequence+process.hltBSoftmuonHTL2filter+process.HLTBSoftmuonL25recoSequence+process.hltBSoftmuonL25filter+process.HLTBSoftmuonL3recoSequence+process.hltBSoftmuonL3filter+cms.SequencePlaceholder("HLTEndSequence")))
...
process.HLT_IsoPhoton15_L1R = cms.Path(process.ProductionFilterSequence*(process.HLTBeginSequence+process.hltL1sRelaxedSingleEgammaEt12+process.hltPreIsoPhoton15L1R+process.HLTSinglePhoton15L1NonIsolatedHLTIsoSequence+cms.SequencePlaceholder("HLTEndSequence")))
process.reconstruction = cms.Path(process.ProductionFilterSequence*process.reconstructionWithFamos)
