...
# with command line options: Configuration/GenProduction/python/PYTHIA6_Exotica_ZprimeTautau_1200_cff.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10000 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Exotica_ZprimeTautau_1200_cff_py_GEN.root'),
