...
generator = cms.EDFilter(
    ...
    crossSection     = cms.untracked.double(194.6),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /cvs/CMSSW/UserCode/SchieferD/GenProduction/python/WJetsToLNu_ptW100toInf_7TeV_herwigpp_cff.py,v $'),
