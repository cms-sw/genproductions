...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Drell-Yan -> mumu w/ Mmumu > 1000 GeV at sqrt{s} = 10 TeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_DYmumu_M1000_filter_10TeV_cff_py_GEN_STARTUP_V5.py,v $')
)
...
process.source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(0.00283),
