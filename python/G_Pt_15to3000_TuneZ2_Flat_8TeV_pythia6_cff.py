...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(2.065092e+07),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Spring2011 sample with PYTHIA6: Prompt photon production, pThat = 15 .. 3000 GeV, weighted, TuneZ2')
)
