...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(0.3206),
    PythiaParameters = cms.PSet(
	    ...
	    'RTCM(41)=12000  ! Set Contact Scale Lambda to 8 TeV',
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDplus12TeVcontact_pt_1000_1400_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+12TeVcontact-pt-1000-1400 at 7TeV')
)
