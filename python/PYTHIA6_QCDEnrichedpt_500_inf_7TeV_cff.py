...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(5.981e+01),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDEnrichedpt_500_inf_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCDEnrichedpt-500-inf at 7TeV')
)
