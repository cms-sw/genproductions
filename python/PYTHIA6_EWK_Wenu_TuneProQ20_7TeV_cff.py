...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.7873),
    crossSection = cms.untracked.double(7795.),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EWK_Wenu_TuneProQ20_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-Wenu Tune ProQ20 at 7TeV')
)
