...
# with command line options: Configuration/GenProduction/python/ALPGEN_1ph_1jet_180_240_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V12::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/ALPGEN_1ph_1jet_180_240_10TeV_cff.py nevts:10'),
...
process.source = cms.Source("AlpgenSource",
    ...
    fileNames = cms.untracked.vstring('file:1ph_1jet_180_240'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ALPGEN_1ph_1jet_180_240_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
