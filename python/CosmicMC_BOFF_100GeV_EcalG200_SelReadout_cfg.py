...
# B-field OFF, Global tag for ECAL gain 200 and no field: COSMMC_G2BOV2
# Pmin = 100 GeV
#-----------------------------------------------------------------------
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source:/cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring09Production/data/CosmicMC_BOFF_100GeV_EcalG200_SelReadout_cfg.py'),
...
process.output = cms.OutputModule("PoolOutputModule",
    fileName = cms.untracked.string('CosmicMC_BOFF_100GeV_EcalG200_SelReadout_TKOnly.root'),
