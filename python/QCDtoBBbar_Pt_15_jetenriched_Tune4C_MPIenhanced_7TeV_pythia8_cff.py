...
generator = cms.EDFilter("Pythia8GeneratorFilter",
    crossSection = cms.untracked.double(120000),
    maxEventsToPrint = cms.untracked.int32(0),
    pythiaPylistVerbosity = cms.untracked.int32(1),
    filterEfficiency = cms.untracked.double(0.33),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/QCDtoBBbar_Pt_15_jetenriched_Tune4C_MPIenhanced_7TeV_pythia8_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA8 QCD to BBbar, pThat > 15GeV at sqrt(s) = 7TeV, Tune 4C MPI enhanced, 4 genjets filtering')
)
