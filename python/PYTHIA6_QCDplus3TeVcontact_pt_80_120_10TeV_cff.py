...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(1604000),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_QCDplus3TeVcontact_pt_80_120_10TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+3TeVcontact-pt-80-120 at 10TeV')
)
