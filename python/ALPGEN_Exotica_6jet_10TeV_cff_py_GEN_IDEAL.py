...
# with command line options: Configuration/GenProduction/python/ALPGEN_Exotica_6jet_10TeV_cff.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V12::All -n 1000 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ALPGEN_Exotica_6jet_10TeV_cff_py_GEN.root'),
