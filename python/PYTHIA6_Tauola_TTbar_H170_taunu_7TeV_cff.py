...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Tauola_TTbar_H170_taunu_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TTbar Hplus170 To TauNu, with Tauola at 7TeV')
    )
