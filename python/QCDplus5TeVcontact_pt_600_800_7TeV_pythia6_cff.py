...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(15.49),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDplus5TeVcontact_pt_600_800_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+5TeVcontact-pt-600-800 at 7TeV')
)
