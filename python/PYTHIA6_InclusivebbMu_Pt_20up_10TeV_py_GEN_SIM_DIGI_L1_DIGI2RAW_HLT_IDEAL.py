...
# using: 
# $Revision: 1.1 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_InclusivebbMu_Pt_20up_10TeV_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_STARTUP.py,v $
