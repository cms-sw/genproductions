...
source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(2.368),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDplus3TeVcontact_pt_1800_inf_10TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCD+3TeVcontact-pt-1800-inf at 10TeV')
)
