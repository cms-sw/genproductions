...
generator = cms.EDFilter("Pythia6GeneratorFilter", 
    ...
    crossSection = cms.untracked.double(69.12),
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0                    !(D=1) to select between full user control (0, then use MSUB) and some preprogrammed alternative', 
            ...
            'PMAS(343,1)=1200.0         ! d* mass', 
            'PMAS(344,1)=1200.0         ! u* mass', 
            'RTCM(41)=1200.0            ! Lambda Scale equals qstar mass', 
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('default documentation string for QstarDijet_1200_7TeV_TuneD6T_cff.py'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCD_QstarDijet_1200_8TeV_TuneD6T_cff.py,v $')
)
