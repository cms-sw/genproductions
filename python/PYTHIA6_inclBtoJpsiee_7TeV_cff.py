...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/PYTHIA6_inclBtoJpsiee_7TeV_cff.py,v $'),
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(66640000.0),
    filterEfficiency = cms.untracked.double(0.000466),
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/incl_BtoJpsi_ee.dec'),
...
ProductionFilterSequence = cms.Sequence(generator*bfilter*oniafilter*eegenfilter)
