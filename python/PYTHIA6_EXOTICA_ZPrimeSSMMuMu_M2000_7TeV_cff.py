...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EXOTICA_ZPrimeSSMMuMu_M2000_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA ZPRIME SSM mu mu, mass = 2000 at sqrt(s) = 7TeV')
)
