...
# with command line options: Configuration/GenProduction/python/Herwigpp_QCD_Pt_1400.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 75000 --no_exec
