...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source:/cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring09Production/data/CosmicMC_BON_100GeV_AllCMS_newBfield_cfg.py'),
...
process.CosMuoGenSource.MinP = 100.
...
##    outputCommands = process.FEVTEventContent.outputCommands,
    fileName = cms.untracked.string('CosmicMC_BON_229_RAW_100GeV_newBfield.root'),
