...
# with command line options: Configuration/GenProduction/python/PYTHIA6_MinBias_2360GeV_cff.py -s GEN,FASTSIM,VALIDATION --pileup=NoPileUp --conditions=START3X_V22B::All --eventcontent=FEVTDEBUGHLT --beamspot=Early10TeVCollision --datatier GEN-SIM-DIGI-RECO -n 10 --no_exec
...
process.famosSimHits.VertexGenerator.SigmaZ = 2.752
process.famosPileUp.VertexGenerator = process.Early10TeVCollisionVtxSmearingParameters
process.famosPileUp.VertexGenerator.SigmaZ = 2.752
...
process.GlobalTag.globaltag = 'START3X_V22B::All'
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    pythiaPylistVerbosity = cms.untracked.int32(1),
    filterEfficiency = cms.untracked.double(1.0),
    pythiaHepMCVerbosity = cms.untracked.bool(False),
    comEnergy = cms.double(2360.0),
    crossSection = cms.untracked.double(59960000000.0),
