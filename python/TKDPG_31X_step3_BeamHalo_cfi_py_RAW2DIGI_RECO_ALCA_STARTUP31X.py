...
# with command line options: BeamHalo_cfi_py_RAW2DIGI_RECO_STARTUP31X -s ALCA:TkAlBeamHalo+DQM --filein file:BeamHalo_cfi_py_RECO.root --eventcontent RECOSIM --datatier GEN-SIM-RECO --conditions FrontierConditions_GlobalTag,STARTUP31X_V4::All --scenario nocoll -n -1 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:BeamHalo_cfi_py_RAW.root')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.pathALCARECOTkAlBeamHalo,process.pathALCARECODQM,process.endjob_step,process.ALCARECOStreamTkAlBeamHaloOutPath)
