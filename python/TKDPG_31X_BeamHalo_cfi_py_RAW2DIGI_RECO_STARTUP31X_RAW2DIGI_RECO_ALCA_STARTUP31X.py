...
# with command line options: BeamHalo_cfi_py_RAW2DIGI_RECO_STARTUP31X -s RAW2DIGI,RECO,ALCA:TkAlBeamHalo+DQM --filein file:BeamHalo_cfi_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root --eventcontent RECOSIM --datatier GEN-SIM-RECO --conditions FrontierConditions_GlobalTag,STARTUP31X_V4::All --scenario nocoll -n -1 --no_exec
...
# Output definition
process.RecoTrackerRECO.outputCommands.extend(
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    outputCommands = process.RecoTrackerRECO.outputCommands,
    fileName = cms.untracked.string('BeamHalo_cfi_py_RAW2DIGI_RECO_STARTUP31X_RAW2DIGI_RECO_ALCA.root'),
...
# Schedule definition
process.schedule = cms.Schedule(process.raw2digi_step,process.reconstruction_step,process.pathALCARECOTkAlBeamHalo,process.pathALCARECODQM,process.endjob_step,process.out_step,process.ALCARECOStreamTkAlBeamHaloOutPath)
