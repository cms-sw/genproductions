...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source:/cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/CosmicMC_BON_217_10GeV_cfg.py'),
...
process.RandomNumberGeneratorService.theSource.initialSeed = cms.untracked.uint32(123457)
...
##    outputCommands = process.FEVTEventContent.outputCommands,
    fileName = cms.untracked.string('CosmicMC_BON_RAW_10GeV.root'),
