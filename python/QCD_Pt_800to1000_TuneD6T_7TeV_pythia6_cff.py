...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(1.845066e+00),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Fall2010 sample with PYTHIA6: QCD dijet production, pThat = 800 .. 1000 GeV, TuneD6T')
)
