...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POMWIG_SingleDiffractiveZmumuPlus_10TeV_M40_cff_py_GEN_STARTUP_V5.py,v $')
)
...
process.source = cms.Source("PomwigSource",
    HerwigParameters = cms.PSet(
        ...
        SD1InclusiveZmumu = cms.vstring('NSTRU      = 14         ! H1 Pomeron Fit B', 
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('POMWIG_SingleDiffractiveZmumuPlus_10TeV_M40_cff_py_GEN.root'),
