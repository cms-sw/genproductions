...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('PYTHIA6-EWK W to electron and neutrino at 10TeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EWK_Wenu_10TeV_cff_py_GEN_STARTUP_V5.py,v $')
)
...
process.source = cms.Source("PythiaSource",
    ...
    filterEfficiency = cms.untracked.double(0.738),
    pythiaHepMCVerbosity = cms.untracked.bool(False),
    comEnergy = cms.untracked.double(10000.0),
    crossSection = cms.untracked.double(11865.0),
...
process.elegenfilter = cms.EDFilter("PythiaFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.elegenfilter)
