...
source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(0.01170),
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('default documentation string for QstarZeeJet_2000_cff.py'),
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/PYTHIA6_Exotica_QstarZeeJet_2000_cff.py,v $')
)
