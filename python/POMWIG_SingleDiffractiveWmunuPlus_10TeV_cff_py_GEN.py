...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('POMWIG SD plus W->munu at 10TeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POMWIG_SingleDiffractiveWmunuPlus_10TeV_cff_py_GEN_STARTUP_V5.py,v $')
)
...
process.source = cms.Source("PomwigSource",
    HerwigParameters = cms.PSet(
        parameterSets = cms.vstring('SD1InclusiveWmunu'),
        SD1InclusiveWmunu = cms.vstring('NSTRU      = 14         ! H1 Pomeron Fit B', 
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('POMWIG_SingleDiffractiveWmunuPlus_10TeV_cff_py_GEN.root'),
