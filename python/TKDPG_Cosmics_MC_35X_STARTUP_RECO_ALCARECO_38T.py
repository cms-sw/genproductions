...
# with command line options: step2 -s RAW2DIGI,RECO,ALCA:TkAlCosmics0T+DQM -n -1 --datatier GEN-SIM-RECO --eventcontent RECOSIM --conditions FrontierConditions_GlobalTag,COSMC3X_V1::All --scenario cosmics --magField 38T --no_exec --python_filename TKDPG_Cosmics_MC_35X_STARTUP_RECO_ALCARECO_38T.py
#slighlty modified: Tracking Particle added in the event content
