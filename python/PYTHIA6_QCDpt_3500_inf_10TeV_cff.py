...
source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(0.00000018146),
...
('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDpt_3500_inf_10TeV_cff.py,v $'),
