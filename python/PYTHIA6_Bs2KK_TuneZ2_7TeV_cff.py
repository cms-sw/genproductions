...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(1598520.),
    filterEfficiency = cms.untracked.double(1e-3),
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bs_KK.dec'),
...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Bs2KK_TuneZ2_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('Bs -> K+ K- at 7TeV')
    )
