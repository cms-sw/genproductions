...
# local file
    fileNames=cms.untracked.vstring('file:////local/hoepfner/CMSSW/cosmicMC/CMSSW_2_1_7/src/GeneratorInterface/CosmicMuonGenerator/test/CosmicMC_BON_RAW_10GeV.root'
                            )
)
...
process.FEVT = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_CosmicMC_BON_217.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: CosmicMC_BON_217_RECO.py,v $'),
