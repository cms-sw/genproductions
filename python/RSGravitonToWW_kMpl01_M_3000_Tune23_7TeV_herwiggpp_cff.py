...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	herwigDefaultsBlock,
	crossSection = cms.untracked.double(72.38e-6),
	...
	productionParameters = cms.vstring(
                ...
                'set /Herwig/Particles/Graviton:NominalMass 5553*GeV',
	),
)

configurationMetadata = cms.untracked.PSet(
	version = cms.untracked.string('\$Revision: 1.1 $'),
	name = cms.untracked.string('\$Source: /cvs/CMSSW/UserCode/hinzmann/production/RSGravitonToWW_kMpl01_M_3000_Tune23_7TeV_herwiggpp_cff.py,v $'),
