...
configurationMetadata = cms.untracked.PSet(
  ...
  name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/ZH_ZToLL_HToBB_M-115_7TeV-mcatnlo-herwig6.py,v $'),
  annotation = cms.untracked.string('Fall 10: MC@NLO 3.4 Z->ll H(bb), mH=115 events with Herwig+Jimmy, 7 TeV')
)
