...
# with command line options: step3 -sALCA:TkAlMuonIsolated+DQM -n -1 --no_exec --conditions FrontierConditions_GlobalTag,STARTUP_V8::All --mc --datatier ALCARECO --eventcontent FEVTSIM --filein file:TKDPG_22X_MuonPt11_cff_py_RAW2DIGI_RECO.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:TKDPG_22X_MuonPt11_cff_py_RAW2DIGI_RECO.root')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.pathALCARECOTkAlMuonIsolated,process.pathALCARECODQM,process.endjob_step,process.ALCARECOStreamTkAlMuonIsolatedOutPath)
