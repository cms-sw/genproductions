...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: PYTHIA6_EXOTICA_RSGravMuMu_kMpl001_M750_TuneZ2_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 RS Graviton to mumu, k/Mpl = 0.01, mass = 750 at sqrt(s) = 7TeV')
)
