...
E_BEAM     = 8000 # GeV (beam energy)
MASS_HIGGS =  400 # GeV (mass of resonance that decays to long-lived particle pair)
MASS_LL    = '500MeV' # (mass with units of long-lived particle)
CTAU_LL    = '1mm' # (c*tau with units of long-lived particle)
FERMION    = 'L' # type of fermions produced when long-lived exotic decays
