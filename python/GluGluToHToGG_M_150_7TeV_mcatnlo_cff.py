...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/MCatNLO_LHE_H_150_2gamma_7TeV_cff.py,v $'),
	annotation = cms.untracked.string('Fall10: Showering of MC@NLO 3.4 Higgs(150 GeV) events with Herwig+Jimmy, 7 TeV')
)

generator = cms.EDFilter("Herwig6HadronizerFilter",
	comEnergy = cms.double(7000.0),
	crossSection = cms.untracked.double(0.0095598),
