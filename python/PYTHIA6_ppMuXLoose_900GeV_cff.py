...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_ppMuXLoose_900GeV_cff.py,v $'),
        annotation = cms.untracked.string('Summer09: Pythia6-MinBias at 900 GeV with Muon preselection (Loose cut), +decay-inflight, 900 GeV, D6T tune')
)
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(34390000000.0),
