...
generator = cms.EDFilter("Pythia6GeneratorFilter",
                         ...
                         crossSection = cms.untracked.double(1.348e+04), #pb
...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('PYTHIA6, b-jets from flavor creation (MSEL=5), pt-hat > 50 GeV, at sqrt(s) = 5.02 TeV')
    )
