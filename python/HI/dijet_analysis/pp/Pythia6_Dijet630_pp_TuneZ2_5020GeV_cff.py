...
generator = cms.EDFilter("Pythia6GeneratorFilter",
                         ...
                         crossSection = cms.untracked.double(2.412e-09), #PYTHIA6 100 evtestimate, accuracy 10% level
...
configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('PYTHIA6 QCD, pt-hat > 630 GeV, at sqrt(s) = 5.02 TeV')
    )
