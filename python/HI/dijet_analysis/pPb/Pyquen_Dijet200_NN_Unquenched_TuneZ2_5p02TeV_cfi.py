...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/HI/Pyquen_Dijet200_NN_Unquenched_TuneZ2_5p02TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYQUEN UNquenched dijets (pt-hat > 200 GeV) at sqrt(s) = 5.02TeV')
    )
