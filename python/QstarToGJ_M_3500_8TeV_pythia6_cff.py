...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(3.224e-04),
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0  !User selected',
            ...
            'MSUB(147)=1            ! dg--> d*',
            'MSUB(148)=1            ! ug--> u*',
            'PMAS(343,1) = 3500.     ! d* mass',
            'PMAS(344,1) = 3500.     ! u* mass', 
            'RTCM(41) = 3500.        ! Scale parameter Lambda',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/QstarToGJ_M_3500_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('qstar Mass = 3.5 TeV at 8 TeV')
)
