...
# with command line options: step3 -sALCA:TkAlCosmics0T+DQM -n 1 --no_exec --magField=38T --conditions FrontierConditions_GlobalTag,COSMMC_21X_V1::All --mc --datatier ALCARECO --eventcontent FEVTSIM --filein file:Reco_TKCosmicMC_BON_225.root
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:Reco_TKCosmicMC_BON_225.root')
)
...
# Schedule definition
process.schedule = cms.Schedule(process.pathALCARECOTkAlCosmicsCTF0T,process.pathALCARECOTkAlCosmicsCosmicTF0T,process.pathALCARECOTkAlCosmicsRS0T,process.pathALCARECODQM,process.endjob_step,process.ALCARECOStreamTkAlCosmics0TOutPath)
