...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/PYTHIA6_QCDmu_Pt_30-50_10TeV_py'),
    totalNumberOfEvents = cms.untracked.int32(5000),
    eventsPerJob = cms.untracked.int32(250)
)
process.configurationMetadata = cms.untracked.PSet(
    version = cms.untracked.string('$Revision: 1.3 $'),
    annotation = cms.untracked.string('PYTHIA6-QCD->mu pthat30-50 at 10TeV with Muon preselection (pt > 5 |eta| < 2.5)')
)
...
process.source = cms.Source("PythiaSource",
    ...
    filterEfficiency = cms.untracked.double(0.0061),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_QCDmu_Pt_30-50_10TeV_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
