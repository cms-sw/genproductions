...
# with command line options: Configuration/GenProduction/PYTHIA6_QCDpt_2200_2600_10TeV_cff -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDpt_2200_2600_10TeV_cff.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_QCDpt_2200_2600_10TeV_cff_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
