...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.00035),
    comEnergy = cms.double(7000.0),
    crossSection = cms.untracked.double(1.154e+05),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDEnrichedpt_120_170_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCDEnrichedpt-120-170 at 7TeV')
)
