...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(1.220734e+02),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Spring2011 sample with PYTHIA6: QCD + 3TeV contact interaction, pThat = 470 .. 600 GeV, TuneD6T')
)
