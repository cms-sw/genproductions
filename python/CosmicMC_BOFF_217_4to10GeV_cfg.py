...
# - E_min = 4 GeV, E_max = 10 GeV, angular acceptance <60, 20M events
# - Global tag = COSMMC_21X incl. ECAL gain and DT calib 
# - keep special tracker TOF shift
# - Removed HCAl ZS 
# - ECAL settings cosmics digitization
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source:/cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring08Production/data/CosmicMC_BOFF_217_4to10GeV_cfg.py'),
...
process.RandomNumberGeneratorService.theSource.initialSeed = cms.untracked.uint32(12345666)
...
process.CosMuoGenSource.MaxP = 10.
...
#    outputCommands = process.FEVTEventContent.outputCommands,
    fileName = cms.untracked.string("CosmicMC_BOFF_RAW_4to10GeV.root"),
