...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/Herwigpp_QCD_Pt_170_py'),
    totalNumberOfEvents = cms.untracked.int32(5000),
    eventsPerJob = cms.untracked.int32(250)
)
process.configurationMetadata = cms.untracked.PSet(
    version = cms.untracked.string('$Revision: 1.6 $'),
    annotation = cms.untracked.string('Summer08 CSA: Herwig++ generation of QCD events, MRST2001 used, MinKT=170 GeV'),
...
process.source = cms.Source("ThePEGSource",
    ...
    crossSection = cms.untracked.double(0.0679802),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Herwigpp_QCD_Pt_170_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
