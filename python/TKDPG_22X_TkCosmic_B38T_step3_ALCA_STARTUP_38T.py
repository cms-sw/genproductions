...
# with command line options: step3 -sALCA:TkAlCosmics+DQM --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:Reco_TKCosmicMC_BON_220.root')
)
...
process.ALCARECOStreamTkAlCosmics = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ALCARECOTkAlCosmics38T.root'),
...
# Schedule definition
process.schedule = cms.Schedule(process.pathALCARECODQM,process.pathALCARECOTkAlCosmicsCTF,process.pathALCARECOTkAlCosmicsCosmicTF,process.pathALCARECOTkAlCosmicsRS,process.ALCARECOStreamTkAlCosmicsOutPath)
