...
source = cms.Source("Pythia8Source",
    ...
    crossSection = cms.untracked.double(27000.),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA8_PhotonJetpt25_30_10TeV_cff.py,v $'),
