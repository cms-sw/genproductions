...
# using: 
# $Revision: 1.3 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/Herwig_QCD_Pt_2200_py__GEN_SIM_DIGI_L1_DIGI2RAW_HLT.py,v $
...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValHerwig_QCD_Pt_2200.pyGEN,SIM,DIGI,L1,DIGI2RAW,HLT'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/Herwig_QCD_Pt_2200_py__GEN_SIM_DIGI_L1_DIGI2RAW_HLT.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Herwig_QCD_Pt_2200_py__GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
