...
# with command line options: Configuration/GenProduction/python/MCatNLO_HiggsSM_H_2gamma_mH80_10TeV_cff.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 1000 --no_exec --customise Configuration/GenProduction/MCatNLO_custom.py
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MC@NLO HiggsSM H 2gamma mH80 at 10TeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MCatNLO_HiggsSM_H_2gamma_mH80_10TeV_cff.py,v $')
)
...
process.source = cms.Source("MCatNLOSource",
    ...
    crossSection = cms.untracked.double(0.0919),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MCatNLO_HiggsSM_H_2gamma_mH80_10TeV_cff_py_GEN.root'),
