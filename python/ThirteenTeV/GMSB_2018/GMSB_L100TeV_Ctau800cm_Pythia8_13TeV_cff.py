...
Block MINPAR   # SUSY breaking input parameters
     ...
     6     2.85703003E+02   # c_grav gravitino mass factor
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.38548973E-11    2      1000039        21                       # GLSS   -->  GVSS   GL                 
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      3.20226142E-15    2           11   1000039                       # EL-    -->  E-     GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      2.94128146E-15    2           12   1000039                       # NUEL   -->  NUE    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      2.94128231E-15    2           14   1000039                       # NUML   -->  NUM    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      2.70444830E-15    2           16   1000039                       # NUTL   -->  NUT    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      8.53566695E-16    2           11   1000039                       # ER-    -->  E-     GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      8.53569395E-16    2           13   1000039                       # MUR-   -->  MU-    GVSS               
#         PDG         Width
...
#         PDG         Width
DECAY   1000022  2.46544308E-17   # Z1SS  decays
#          BR          NDA       ID1       ID2       ID3       ID4
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      2.37213030E-01    2     -1000015        15                       # Z2SS   -->  TAU1+  TAU-               
      6.02947698E-15    2      1000039        22                       # Z2SS   -->  GVSS   GM                 
      1.31439635E-16    3      1000039        11       -11             # Z2SS   -->  GVSS   E-     E+          
      8.47713538E-15    2      1000039        23                       # Z2SS   -->  GVSS   Z0                 
      1.57949026E-16    2      1000039        25                       # Z2SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      5.28717873E-19    2      1000039        22                       # Z3SS   -->  GVSS   GM                 
      1.19327452E-20    3      1000039        11       -11             # Z3SS   -->  GVSS   E-     E+          
      9.14126851E-16    2      1000039        23                       # Z3SS   -->  GVSS   Z0                 
      1.04169319E-15    2      1000039        25                       # Z3SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      2.88860834E-17    2      1000039        22                       # Z4SS   -->  GVSS   GM                 
      6.54285389E-19    3      1000039        11       -11             # Z4SS   -->  GVSS   E-     E+          
      1.47035200E-15    2      1000039        23                       # Z4SS   -->  GVSS   Z0                 
      6.81073305E-16    2      1000039        25                       # Z4SS   -->  GVSS   HL0                
#         PDG         Width
