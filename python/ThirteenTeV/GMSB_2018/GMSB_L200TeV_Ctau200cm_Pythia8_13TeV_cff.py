...
Block MINPAR   # SUSY breaking input parameters
     ...
     6     2.33807999E+02   # c_grav gravitino mass factor
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.36109388E-11    2      1000039        21                       # GLSS   -->  GVSS   GL                 
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      5.09439962E-15    2           11   1000039                       # EL-    -->  E-     GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      4.98075702E-15    2           12   1000039                       # NUEL   -->  NUE    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      4.98075786E-15    2           14   1000039                       # NUML   -->  NUM    GVSS               
#         PDG         Width
...
#         PDG         Width
DECAY   1000022  9.87972943E-17   # Z1SS  decays
#          BR          NDA       ID1       ID2       ID3       ID4
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.35369882E-01    2     -1000015        15                       # Z2SS   -->  TAU1+  TAU-               
      1.43428258E-14    2      1000039        22                       # Z2SS   -->  GVSS   GM                 
      3.30015392E-16    3      1000039        11       -11             # Z2SS   -->  GVSS   E-     E+          
      3.75816084E-14    2      1000039        23                       # Z2SS   -->  GVSS   Z0                 
      5.46625354E-16    2      1000039        25                       # Z2SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.56093738E-19    2      1000039        22                       # Z3SS   -->  GVSS   GM                 
      3.67469777E-21    3      1000039        11       -11             # Z3SS   -->  GVSS   E-     E+          
      9.36954918E-16    2      1000039        23                       # Z3SS   -->  GVSS   Z0                 
      1.16730277E-15    2      1000039        25                       # Z3SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      2.24997990E-17    2      1000039        22                       # Z4SS   -->  GVSS   GM                 
      5.30449058E-19    3      1000039        11       -11             # Z4SS   -->  GVSS   E-     E+          
      1.35015337E-15    2      1000039        23                       # Z4SS   -->  GVSS   Z0                 
      7.88314770E-16    2      1000039        25                       # Z4SS   -->  GVSS   HL0                
#         PDG         Width
