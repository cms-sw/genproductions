...
Block MINPAR   # SUSY breaking input parameters
     ...
     6     1.36526001E+02   # c_grav gravitino mass factor
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      4.65256479E-11    2      1000039        21                       # GLSS   -->  GVSS   GL                 
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.46849018E-14    2           11   1000039                       # EL-    -->  E-     GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.41208880E-14    2           12   1000039                       # NUEL   -->  NUE    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.41208905E-14    2           14   1000039                       # NUML   -->  NUM    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.27468887E-14    2           16   1000039                       # NUTL   -->  NUT    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      4.24705411E-15    2           11   1000039                       # ER-    -->  E-     GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      4.24706428E-15    2           13   1000039                       # MUR-   -->  MU-    GVSS               
#         PDG         Width
...
#         PDG         Width
DECAY   1000022  1.97215581E-16   # Z1SS  decays
#          BR          NDA       ID1       ID2       ID3       ID4
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.61142647E-01    2     -1000015        15                       # Z2SS   -->  TAU1+  TAU-               
      3.27823807E-14    2      1000039        22                       # Z2SS   -->  GVSS   GM                 
      7.38123939E-16    3      1000039        11       -11             # Z2SS   -->  GVSS   E-     E+          
      7.32464219E-14    2      1000039        23                       # Z2SS   -->  GVSS   Z0                 
      1.21521329E-15    2      1000039        25                       # Z2SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      8.73035163E-19    2      1000039        22                       # Z3SS   -->  GVSS   GM                 
      2.02015132E-20    3      1000039        11       -11             # Z3SS   -->  GVSS   E-     E+          
      3.17349258E-15    2      1000039        23                       # Z3SS   -->  GVSS   Z0                 
      3.85136394E-15    2      1000039        25                       # Z3SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      8.48460198E-17    2      1000039        22                       # Z4SS   -->  GVSS   GM                 
      1.96742634E-18    3      1000039        11       -11             # Z4SS   -->  GVSS   E-     E+          
      4.80083451E-15    2      1000039        23                       # Z4SS   -->  GVSS   Z0                 
      2.59345776E-15    2      1000039        25                       # Z4SS   -->  GVSS   HL0                
#         PDG         Width
