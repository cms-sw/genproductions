...
Block MINPAR   # SUSY breaking input parameters
     ...
     6     6.00781006E+02   # c_grav gravitino mass factor
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.87352607E-12    2      1000039        21                       # GLSS   -->  GVSS   GL                 
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      7.76495061E-16    2           11   1000039                       # EL-    -->  E-     GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      7.65358113E-16    2           12   1000039                       # NUEL   -->  NUE    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      7.65358166E-16    2           14   1000039                       # NUML   -->  NUM    GVSS               
#         PDG         Width
...
#         PDG         Width
DECAY   1000022  1.97346137E-17   # Z1SS  decays
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.52524066E-04    2      1000039        25                       # Z1SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.19262993E-01    2     -1000015        15                       # Z2SS   -->  TAU1+  TAU-               
      2.61192350E-15    2      1000039        22                       # Z2SS   -->  GVSS   GM                 
      6.10823715E-17    3      1000039        11       -11             # Z2SS   -->  GVSS   E-     E+          
      7.38080793E-15    2      1000039        23                       # Z2SS   -->  GVSS   Z0                 
      9.72668117E-17    2      1000039        25                       # Z2SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.47261026E-20    2      1000039        22                       # Z3SS   -->  GVSS   GM                 
      3.51247727E-22    3      1000039        11       -11             # Z3SS   -->  GVSS   E-     E+          
      1.29140853E-16    2      1000039        23                       # Z3SS   -->  GVSS   Z0                 
      1.63119964E-16    2      1000039        25                       # Z3SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      2.91150329E-18    2      1000039        22                       # Z4SS   -->  GVSS   GM                 
      6.95212218E-20    3      1000039        11       -11             # Z4SS   -->  GVSS   E-     E+          
      1.79469036E-16    2      1000039        23                       # Z4SS   -->  GVSS   Z0                 
      1.09604363E-16    2      1000039        25                       # Z4SS   -->  GVSS   HL0                
#         PDG         Width
