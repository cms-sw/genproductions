...
Block MINPAR   # SUSY breaking input parameters
     ...
     6     4.31733002E+02   # c_grav gravitino mass factor
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      4.65256783E-12    2      1000039        21                       # GLSS   -->  GVSS   GL                 
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.46849107E-15    2           11   1000039                       # EL-    -->  E-     GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.41208979E-15    2           12   1000039                       # NUEL   -->  NUE    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.41209000E-15    2           14   1000039                       # NUML   -->  NUM    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.27468972E-15    2           16   1000039                       # NUTL   -->  NUT    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      4.24705655E-16    2           11   1000039                       # ER-    -->  E-     GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      4.24706661E-16    2           13   1000039                       # MUR-   -->  MU-    GVSS               
#         PDG         Width
...
#         PDG         Width
DECAY   1000022  1.97215690E-17   # Z1SS  decays
#          BR          NDA       ID1       ID2       ID3       ID4
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.61142647E-01    2     -1000015        15                       # Z2SS   -->  TAU1+  TAU-               
      3.27824006E-15    2      1000039        22                       # Z2SS   -->  GVSS   GM                 
      7.38124363E-17    3      1000039        11       -11             # Z2SS   -->  GVSS   E-     E+          
      7.32464626E-15    2      1000039        23                       # Z2SS   -->  GVSS   Z0                 
      1.21521395E-16    2      1000039        25                       # Z2SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      8.73035628E-20    2      1000039        22                       # Z3SS   -->  GVSS   GM                 
      2.02015257E-21    3      1000039        11       -11             # Z3SS   -->  GVSS   E-     E+          
      3.17349470E-16    2      1000039        23                       # Z3SS   -->  GVSS   Z0                 
      3.85136617E-16    2      1000039        25                       # Z3SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      8.48460744E-18    2      1000039        22                       # Z4SS   -->  GVSS   GM                 
      1.96742776E-19    3      1000039        11       -11             # Z4SS   -->  GVSS   E-     E+          
      4.80083716E-16    2      1000039        23                       # Z4SS   -->  GVSS   Z0                 
      2.59345924E-16    2      1000039        25                       # Z4SS   -->  GVSS   HL0                
#         PDG         Width
