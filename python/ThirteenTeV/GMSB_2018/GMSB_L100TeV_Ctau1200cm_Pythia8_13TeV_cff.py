...
Block MINPAR   # SUSY breaking input parameters
     ...
     6     3.49912994E+02   # c_grav gravitino mass factor
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      9.23661581E-12    2      1000039        21                       # GLSS   -->  GVSS   GL                 
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      2.13484490E-15    2           11   1000039                       # EL-    -->  E-     GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.96085777E-15    2           12   1000039                       # NUEL   -->  NUE    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.96085840E-15    2           14   1000039                       # NUML   -->  NUM    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.80296892E-15    2           16   1000039                       # NUTL   -->  NUT    GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      5.69045522E-16    2           11   1000039                       # ER-    -->  E-     GVSS               
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      5.69047322E-16    2           13   1000039                       # MUR-   -->  MU-    GVSS               
#         PDG         Width
...
#         PDG         Width
DECAY   1000022  1.64363187E-17   # Z1SS  decays
#          BR          NDA       ID1       ID2       ID3       ID4
      9.44338381E-01    2      1000039        22                       # Z1SS   -->  GVSS   GM                 
      1.95958521E-02    3      1000039        11       -11             # Z1SS   -->  GVSS   E-     E+          
      3.60501595E-02    2      1000039        23                       # Z1SS   -->  GVSS   Z0                 
      1.54944628E-05    2      1000039        25                       # Z1SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      2.37213030E-01    2     -1000015        15                       # Z2SS   -->  TAU1+  TAU-               
      4.01965880E-15    2      1000039        22                       # Z2SS   -->  GVSS   GM                 
      8.76265775E-17    3      1000039        11       -11             # Z2SS   -->  GVSS   E-     E+          
      5.65143432E-15    2      1000039        23                       # Z2SS   -->  GVSS   Z0                 
      1.05299556E-16    2      1000039        25                       # Z2SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      3.52479237E-19    2      1000039        22                       # Z3SS   -->  GVSS   GM                 
      7.95517770E-21    3      1000039        11       -11             # Z3SS   -->  GVSS   E-     E+          
      6.09418977E-16    2      1000039        23                       # Z3SS   -->  GVSS   Z0                 
      6.94463414E-16    2      1000039        25                       # Z3SS   -->  GVSS   HL0                
#         PDG         Width
...
#          BR          NDA       ID1       ID2       ID3       ID4
      ...
      1.92574248E-17    2      1000039        22                       # Z4SS   -->  GVSS   GM                 
      4.36191052E-19    3      1000039        11       -11             # Z4SS   -->  GVSS   E-     E+          
      9.80236607E-16    2      1000039        23                       # Z4SS   -->  GVSS   Z0                 
      4.54049682E-16    2      1000039        25                       # Z4SS   -->  GVSS   HL0                
#         PDG         Width
