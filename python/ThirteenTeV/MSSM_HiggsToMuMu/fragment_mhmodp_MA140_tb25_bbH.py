...
BLOCK MASS
   ...
   2000005     1.00778084E+03   # MSf(2,4,3)
        25     1.23892736E+02   # Mh0
        35     1.41301907E+02   # MHH
        36     1.40000000E+02   # MA0
        37     1.63594127E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.14140457E-01   # Delta Mh0
        35     1.75912435E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.09573855E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -2.81771468E-01   # Alpha
BLOCK DALPHA
               2.69491091E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.83131900E-01   # UH(1,1)
     1   2     1.82897969E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.82897969E-01   # UH(2,1)
     2   2     9.83131900E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.07063610E-01   # Gamma(h0)
     8.75979605E-05   2        22        22   # BR(h0 -> photon photon)
     4.74190234E-05   2        22        23   # BR(h0 -> photon Z)
     8.21409549E-04   2        23        23   # BR(h0 -> Z Z)
     6.93739142E-03   2       -24        24   # BR(h0 -> W W)
     1.69065130E-03   2        21        21   # BR(h0 -> gluon gluon)
     9.34504981E-09   2       -11        11   # BR(h0 -> Electron electron)
     4.15683361E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.17277118E-01   2       -15        15   # BR(h0 -> Tau tau)
     6.90413361E-09   2        -2         2   # BR(h0 -> Up up)
     9.56287180E-04   2        -4         4   # BR(h0 -> Charm charm)
     1.42095916E-06   2        -1         1   # BR(h0 -> Down down)
     3.56824322E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.71408180E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.34670322E+00   # Gamma(HH)
    -2.26471889E-07   2        22        22   # BR(HH -> photon photon)
    -6.89154585E-07   2        22        23   # BR(HH -> photon Z)
    -2.71941081E-05   2        23        23   # BR(HH -> Z Z)
    -1.93930030E-04   2       -24        24   # BR(HH -> W W)
    -1.02820129E-03   2        21        21   # BR(HH -> gluon gluon)
    -9.87421903E-09   2       -11        11   # BR(HH -> Electron electron)
     4.39239208E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.23552576E-01   2       -15        15   # BR(HH -> Tau tau)
    -5.12600164E-11   2        -2         2   # BR(HH -> Up up)
    -7.10106703E-06   2        -4         4   # BR(HH -> Charm charm)
    -1.44682758E-06   2        -1         1   # BR(HH -> Down down)
    -3.63317202E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.74386069E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -2.83837862E-12   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.44626603E+00   # Gamma(A0)
     2.23452997E-07   2        22        22   # BR(A0 -> photon photon)
     3.56747196E-08   2        22        23   # BR(A0 -> photon Z)
     8.85108979E-04   2        21        21   # BR(A0 -> gluon gluon)
     9.83417736E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.37457795E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.23142892E-01   2       -15        15   # BR(A0 -> Tau tau)
     8.37172067E-13   2        -2         2   # BR(A0 -> Up up)
     1.19842558E-07   2        -4         4   # BR(A0 -> Charm charm)
     1.44447515E-06   2        -1         1   # BR(A0 -> Down down)
     3.62726886E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.75169941E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     4.02031198E-08   2        23        25   # BR(A0 -> Z h0)
DECAY        37     2.07945176E-01   # Gamma(Hp)
     8.13783878E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47917674E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.83911812E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.06716054E-05   2        -1         2   # BR(Hp -> Down up)
     1.19491015E-04   2        -3         2   # BR(Hp -> Strange up)
     6.86706473E-05   2        -5         2   # BR(Hp -> Bottom up)
     5.19675913E-07   2        -1         4   # BR(Hp -> Down charm)
     2.67114001E-03   2        -3         4   # BR(Hp -> Strange charm)
     9.61515947E-03   2        -5         4   # BR(Hp -> Bottom charm)
     2.54081049E-05   2        -5         6   # BR(Hp -> Bottom top)
     2.90428943E-05   2        24        25   # BR(Hp -> W h0)
     2.86969967E-05   2        24        35   # BR(Hp -> W HH)
     4.01295569E-05   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.37394247E+00   # Gamma(top)
     9.98058775E-01   2         5        24   # BR(top -> bottom W)
     1.94122526E-03   2         5        37   # BR(top -> bottom Hp)
"""
