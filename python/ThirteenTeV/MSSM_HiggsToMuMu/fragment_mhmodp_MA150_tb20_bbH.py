...
BLOCK MASS
   ...
   2000005     1.00594745E+03   # MSf(2,4,3)
        25     1.23853481E+02   # Mh0
        35     1.51242651E+02   # MHH
        36     1.50000000E+02   # MA0
        37     1.71428659E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.22824973E-01   # Delta Mh0
        35     1.53998498E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     2.22657809E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -2.29394457E-01   # Alpha
BLOCK DALPHA
               1.37931701E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.92545770E-01   # UH(1,1)
     1   2     1.21872453E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.21872453E-01   # UH(2,1)
     2   2     9.92545770E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     4.70633966E-02   # Gamma(h0)
     1.96386582E-04   2        22        22   # BR(h0 -> photon photon)
     1.10261764E-04   2        22        23   # BR(h0 -> photon Z)
     1.90952357E-03   2        23        23   # BR(h0 -> Z Z)
     1.61400570E-02   2       -24        24   # BR(h0 -> W W)
     4.22921219E-03   2        21        21   # BR(h0 -> gluon gluon)
     8.83188308E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.92856802E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.11463686E-01   2       -15        15   # BR(h0 -> Tau tau)
     1.61756361E-08   2        -2         2   # BR(h0 -> Up up)
     2.24047170E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.37309700E-06   2        -1         1   # BR(h0 -> Down down)
     3.44814341E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.62971332E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     9.67685504E-01   # Gamma(HH)
    -2.01897989E-07   2        22        22   # BR(HH -> photon photon)
    -9.72793714E-07   2        22        23   # BR(HH -> photon Z)
    -5.25933153E-05   2        23        23   # BR(HH -> Z Z)
    -4.94834693E-04   2       -24        24   # BR(HH -> W W)
    -9.74075208E-04   2        21        21   # BR(HH -> gluon gluon)
    -9.62044292E-09   2       -11        11   # BR(HH -> Electron electron)
     4.27959112E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.20982676E-01   2       -15        15   # BR(HH -> Tau tau)
    -4.90489164E-11   2        -2         2   # BR(HH -> Up up)
    -6.79587521E-06   2        -4         4   # BR(HH -> Charm charm)
    -1.42002227E-06   2        -1         1   # BR(HH -> Down down)
    -3.56595192E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.76701867E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -3.21873737E-12   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.00702920E+00   # Gamma(A0)
     1.97323796E-07   2        22        22   # BR(A0 -> photon photon)
     1.11747018E-07   2        22        23   # BR(A0 -> photon Z)
     7.87164323E-04   2        21        21   # BR(A0 -> gluon gluon)
     9.59286177E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.26731987E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.20708016E-01   2       -15        15   # BR(A0 -> Tau tau)
     2.00374156E-12   2        -2         2   # BR(A0 -> Up up)
     2.83759483E-07   2        -4         4   # BR(A0 -> Charm charm)
     1.41875372E-06   2        -1         1   # BR(A0 -> Down down)
     3.56276939E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.77719452E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     3.37861000E-07   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.39511643E-01   # Gamma(Hp)
     8.13473053E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47784813E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.83556738E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.06862010E-05   2        -1         2   # BR(Hp -> Down up)
     1.19784586E-04   2        -3         2   # BR(Hp -> Strange up)
     7.02111196E-05   2        -5         2   # BR(Hp -> Bottom up)
     5.82926382E-07   2        -1         4   # BR(Hp -> Down charm)
     2.67626064E-03   2        -3         4   # BR(Hp -> Strange charm)
     9.83096365E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.31357759E-04   2        -5         6   # BR(Hp -> Bottom top)
     6.03451809E-05   2        24        25   # BR(Hp -> W h0)
     2.73383493E-05   2        24        35   # BR(Hp -> W HH)
     3.78019877E-05   2        24        36   # BR(Hp -> W A0)
