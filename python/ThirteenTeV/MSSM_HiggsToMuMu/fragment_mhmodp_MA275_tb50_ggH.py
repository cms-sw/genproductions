...
BLOCK MASS
   ...
   2000005     1.01617952E+03   # MSf(2,4,3)
        25     1.25331384E+02   # Mh0
        35     2.75110382E+02   # MHH
        36     2.75000000E+02   # MA0
        37     2.90596548E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.66300871E-01   # Delta Mh0
        35     1.52716780E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     4.54339863E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -3.04318716E-02   # Alpha
BLOCK DALPHA
               1.78414556E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99984869E-01   # UH(1,1)
     1   2     5.50110911E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -5.50110911E-03   # UH(2,1)
     2   2     9.99984869E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     6.48210001E-03   # Gamma(h0)
     1.43780328E-03   2        22        22   # BR(h0 -> photon photon)
     9.34112717E-04   2        22        23   # BR(h0 -> photon Z)
     1.72489726E-02   2        23        23   # BR(h0 -> Z Z)
     1.41560465E-01   2       -24        24   # BR(h0 -> W W)
     4.21969138E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.15392912E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.18219427E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.99552003E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.24582961E-07   2        -2         2   # BR(h0 -> Up up)
     1.72561571E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.10218953E-06   2        -1         1   # BR(h0 -> Down down)
     2.76779482E-04   2        -3         3   # BR(h0 -> Strange strange)
     6.88814142E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     9.16901034E+00   # Gamma(HH)
    -5.66026623E-07   2        22        22   # BR(HH -> photon photon)
    -4.31202453E-07   2        22        23   # BR(HH -> photon Z)
    -2.16271496E-05   2        23        23   # BR(HH -> Z Z)
    -4.94232030E-05   2       -24        24   # BR(HH -> W W)
    -3.56287068E-04   2        21        21   # BR(HH -> gluon gluon)
    -1.26355011E-08   2       -11        11   # BR(HH -> Electron electron)
     5.62183441E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.54450004E-01   2       -15        15   # BR(HH -> Tau tau)
    -1.17877329E-13   2        -2         2   # BR(HH -> Up up)
    -1.63065095E-08   2        -4         4   # BR(HH -> Charm charm)
    -1.50975247E-06   2        -1         1   # BR(HH -> Down down)
    -3.79093620E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.37421679E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -3.68069973E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
    -2.86351856E-03   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
    -2.12948441E-04   2        25        25   # BR(HH -> h0 h0)
DECAY        36     9.28010320E+00   # Gamma(A0)
     1.49706439E-07   2        22        22   # BR(A0 -> photon photon)
     6.04807002E-07   2        22        23   # BR(A0 -> photon Z)
     3.48054930E-04   2        21        21   # BR(A0 -> gluon gluon)
     1.24791629E-08   2       -11        11   # BR(A0 -> Electron electron)
     5.55227831E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.52527482E-01   2       -15        15   # BR(A0 -> Tau tau)
     3.75519285E-14   2        -2         2   # BR(A0 -> Up up)
     5.30320798E-09   2        -4         4   # BR(A0 -> Charm charm)
     1.49078244E-06   2        -1         1   # BR(A0 -> Down down)
     3.74330365E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.27245212E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     6.52200943E-03   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     1.24070906E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
     1.83303866E-05   2        23        25   # BR(A0 -> Z h0)
     6.54548145E-37   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     4.92429538E+00   # Gamma(Hp)
     2.44172398E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.04391281E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.95266158E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     2.76881995E-06   2        -1         2   # BR(Hp -> Down up)
     3.13655661E-05   2        -3         2   # BR(Hp -> Strange up)
     1.64452815E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.25734322E-07   2        -1         4   # BR(Hp -> Down charm)
     6.92797527E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.30283834E-03   2        -5         4   # BR(Hp -> Bottom charm)
     3.44766327E-08   2        -1         6   # BR(Hp -> Down top)
     1.16548996E-06   2        -3         6   # BR(Hp -> Strange top)
     6.71390357E-01   2        -5         6   # BR(Hp -> Bottom top)
     2.91910465E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     6.04872224E-05   2        24        25   # BR(Hp -> W h0)
     2.31901750E-07   2        24        35   # BR(Hp -> W HH)
     2.40244462E-07   2        24        36   # BR(Hp -> W A0)
