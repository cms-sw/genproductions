...
BLOCK MASS
   ...
   2000005     1.00226018E+03   # MSf(2,4,3)
        25     1.18889829E+02   # Mh0
        35     2.78745164E+02   # MHH
        36     2.75000000E+02   # MA0
        37     2.86657912E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     9.13757034E-01   # Delta Mh0
        35     7.45997235E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.13734907E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -2.69221079E-01   # Alpha
BLOCK DALPHA
               1.94081343E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99561547E-01   # UH(1,1)
     1   2     2.96093500E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -2.96093500E-02   # UH(2,1)
     2   2     9.99561547E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     5.09861154E-03   # Gamma(h0)
     1.56338504E-03   2        22        22   # BR(h0 -> photon photon)
     6.60729951E-04   2        22        23   # BR(h0 -> photon Z)
     9.31972926E-03   2        23        23   # BR(h0 -> Z Z)
     8.69815224E-02   2       -24        24   # BR(h0 -> W W)
     4.47430232E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.80056277E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.02496555E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.70401414E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.46694929E-07   2        -2         2   # BR(h0 -> Up up)
     2.03167228E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.12454538E-06   2        -1         1   # BR(h0 -> Down down)
     2.82413643E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.48788558E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     3.05844381E-01   # Gamma(HH)
     1.02552191E-05   2        22        22   # BR(HH -> photon photon)
     1.38229569E-05   2        22        23   # BR(HH -> photon Z)
     3.24024907E-02   2        23        23   # BR(HH -> Z Z)
     7.37840685E-02   2       -24        24   # BR(HH -> W W)
     1.61807503E-03   2        21        21   # BR(HH -> gluon gluon)
     3.43013666E-09   2       -11        11   # BR(HH -> Electron electron)
     1.52615391E-04   2       -13        13   # BR(HH -> Muon muon)
     4.37752483E-02   2       -15        15   # BR(HH -> Tau tau)
     3.57879256E-10   2        -2         2   # BR(HH -> Up up)
     4.95153161E-05   2        -4         4   # BR(HH -> Charm charm)
     4.84644057E-07   2        -1         1   # BR(HH -> Down down)
     1.21713665E-04   2        -3         3   # BR(HH -> Strange strange)
     3.17651986E-01   2        -5         5   # BR(HH -> Bottom bottom)
     4.69082698E-03   2  -1000024   1000024   # BR(HH -> Chargino1 chargino1)
     1.28840015E-01   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     8.87424701E-02   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     2.58400475E-09   2        23        36   # BR(HH -> Z A0)
     3.08146406E-01   2        25        25   # BR(HH -> h0 h0)
DECAY        36     3.93381141E-01   # Gamma(A0)
    -4.05021504E-05   2        22        22   # BR(A0 -> photon photon)
    -7.16151652E-05   2        22        23   # BR(A0 -> photon Z)
    -7.54401727E-04   2        21        21   # BR(A0 -> gluon gluon)
    -2.72613291E-09   2       -11        11   # BR(A0 -> Electron electron)
     1.21292069E-04   2       -13        13   # BR(A0 -> Muon muon)
    -3.47851809E-02   2       -15        15   # BR(A0 -> Tau tau)
    -1.39892498E-10   2        -2         2   # BR(A0 -> Up up)
    -1.94186919E-05   2        -4         4   # BR(A0 -> Charm charm)
    -3.85922036E-07   2        -1         1   # BR(A0 -> Down down)
    -9.69206082E-05   2        -3         3   # BR(A0 -> Strange strange)
    -2.53174558E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -2.75254520E-01   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -4.12035927E-01   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -2.36452745E-02   2        23        25   # BR(A0 -> Z h0)
    -4.37028977E-35   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     4.91753898E-01   # Gamma(Hp)
     2.41193908E-09   2       -11        12   # BR(Hp -> Electron nu_e)
     1.03117883E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.91663807E-02   2       -15        16   # BR(Hp -> Tau nu_tau)
     2.99901394E-07   2        -1         2   # BR(Hp -> Down up)
     3.39574889E-06   2        -3         2   # BR(Hp -> Strange up)
     2.11700900E-06   2        -5         2   # BR(Hp -> Bottom up)
     7.57838877E-07   2        -1         4   # BR(Hp -> Down charm)
     9.14857207E-05   2        -3         4   # BR(Hp -> Strange charm)
     2.96469152E-04   2        -5         4   # BR(Hp -> Bottom charm)
     3.30165728E-05   2        -1         6   # BR(Hp -> Down top)
     7.19906797E-04   2        -3         6   # BR(Hp -> Strange top)
     5.96786938E-01   2        -5         6   # BR(Hp -> Bottom top)
     3.27838652E-01   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     1.57006709E-02   2   1000023   1000024   # BR(Hp -> neutralino2 chargino1)
     2.92561395E-02   2        24        25   # BR(Hp -> W h0)
     8.23917474E-08   2        24        35   # BR(Hp -> W HH)
     5.67199361E-07   2        24        36   # BR(Hp -> W A0)
