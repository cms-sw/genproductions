...
BLOCK MASS
   ...
   2000005     1.01296833E+03   # MSf(2,4,3)
        25     1.25186095E+02   # Mh0
        35     2.50192333E+02   # MHH
        36     2.50000000E+02   # MA0
        37     2.65717420E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.40825249E-01   # Delta Mh0
        35     7.18312855E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     3.03407769E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -4.08622996E-02   # Alpha
BLOCK DALPHA
               3.31468447E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99966254E-01   # UH(1,1)
     1   2     8.21526995E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -8.21526995E-03   # UH(2,1)
     2   2     9.99966254E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     7.28837093E-03   # Gamma(h0)
     1.27649181E-03   2        22        22   # BR(h0 -> photon photon)
     8.21327720E-04   2        22        23   # BR(h0 -> photon Z)
     1.50637888E-02   2        23        23   # BR(h0 -> Z Z)
     1.23981282E-01   2       -24        24   # BR(h0 -> W W)
     3.69889845E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.32139389E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.25668615E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.22664011E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.10639049E-07   2        -2         2   # BR(h0 -> Up up)
     1.53247236E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.13536742E-06   2        -1         1   # BR(h0 -> Down down)
     2.85113551E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.13664965E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     5.65419353E+00   # Gamma(HH)
     5.97027307E-07   2        22        22   # BR(HH -> photon photon)
     3.77899478E-07   2        22        23   # BR(HH -> photon Z)
     5.35928654E-05   2        23        23   # BR(HH -> Z Z)
     1.26662679E-04   2       -24        24   # BR(HH -> W W)
     4.12614152E-04   2        21        21   # BR(HH -> gluon gluon)
     1.17434645E-08   2       -11        11   # BR(HH -> Electron electron)
     5.22479528E-04   2       -13        13   # BR(HH -> Muon muon)
     1.44922266E-01   2       -15        15   # BR(HH -> Tau tau)
     3.44168460E-13   2        -2         2   # BR(HH -> Up up)
     4.76163266E-08   2        -4         4   # BR(HH -> Charm charm)
     1.47877033E-06   2        -1         1   # BR(HH -> Down down)
     3.71326573E-04   2        -3         3   # BR(HH -> Strange strange)
     8.48566917E-01   2        -5         5   # BR(HH -> Bottom bottom)
     4.29364224E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     7.27986121E-04   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
DECAY        36     5.72763086E+00   # Gamma(A0)
    -1.40533819E-07   2        22        22   # BR(A0 -> photon photon)
    -4.68593988E-07   2        22        23   # BR(A0 -> photon Z)
    -3.94082456E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.15753644E-08   2       -11        11   # BR(A0 -> Electron electron)
     5.15000821E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.42845470E-01   2       -15        15   # BR(A0 -> Tau tau)
    -1.02069247E-13   2        -2         2   # BR(A0 -> Up up)
    -1.43717077E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.45746691E-06   2        -1         1   # BR(A0 -> Down down)
    -3.65977250E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.36773074E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -9.03088511E-03   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -1.00458725E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -2.75452257E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     2.60453408E+00   # Gamma(Hp)
     2.70159455E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.15501548E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     3.26686290E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     3.16917897E-06   2        -1         2   # BR(Hp -> Down up)
     3.58438925E-05   2        -3         2   # BR(Hp -> Strange up)
     1.94806899E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.44877691E-07   2        -1         4   # BR(Hp -> Down charm)
     7.93025139E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.72786663E-03   2        -5         4   # BR(Hp -> Bottom charm)
     7.49524428E-08   2        -1         6   # BR(Hp -> Down top)
     2.00979404E-06   2        -3         6   # BR(Hp -> Strange top)
     6.33249748E-01   2        -5         6   # BR(Hp -> Bottom top)
     3.51814591E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     1.44936362E-04   2        24        25   # BR(Hp -> W h0)
     4.40436174E-07   2        24        35   # BR(Hp -> W HH)
     4.68247569E-07   2        24        36   # BR(Hp -> W A0)
