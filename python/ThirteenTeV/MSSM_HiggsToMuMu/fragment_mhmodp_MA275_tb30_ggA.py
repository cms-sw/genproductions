...
BLOCK MASS
   ...
   2000005     1.00956179E+03   # MSf(2,4,3)
        25     1.25017147E+02   # Mh0
        35     2.75261252E+02   # MHH
        36     2.75000000E+02   # MA0
        37     2.88239239E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.20355937E-01   # Delta Mh0
        35     5.72285894E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.18481414E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -4.90081093E-02   # Alpha
BLOCK DALPHA
               3.44340767E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99971961E-01   # UH(1,1)
     1   2     7.48843798E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -7.48843798E-03   # UH(2,1)
     2   2     9.99971961E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     6.32490556E-03   # Gamma(h0)
     1.46382685E-03   2        22        22   # BR(h0 -> photon photon)
     9.33837469E-04   2        22        23   # BR(h0 -> photon Z)
     1.69963614E-02   2        23        23   # BR(h0 -> Z Z)
     1.40355170E-01   2       -24        24   # BR(h0 -> W W)
     4.29882844E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.79648540E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.02319708E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.61749169E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.27320460E-07   2        -2         2   # BR(h0 -> Up up)
     1.76352202E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.07795937E-06   2        -1         1   # BR(h0 -> Down down)
     2.70704007E-04   2        -3         3   # BR(h0 -> Strange strange)
     6.92878147E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     3.66850885E+00   # Gamma(HH)
     8.93393225E-07   2        22        22   # BR(HH -> photon photon)
     8.85244884E-07   2        22        23   # BR(HH -> photon Z)
     1.22448519E-04   2        23        23   # BR(HH -> Z Z)
     2.79781222E-04   2       -24        24   # BR(HH -> W W)
     3.86502380E-04   2        21        21   # BR(HH -> gluon gluon)
     1.10003226E-08   2       -11        11   # BR(HH -> Electron electron)
     4.89430215E-04   2       -13        13   # BR(HH -> Muon muon)
     1.37038382E-01   2       -15        15   # BR(HH -> Tau tau)
     8.53189521E-13   2        -2         2   # BR(HH -> Up up)
     1.18040666E-07   2        -4         4   # BR(HH -> Charm charm)
     1.41651323E-06   2        -1         1   # BR(HH -> Down down)
     3.55708756E-04   2        -3         3   # BR(HH -> Strange strange)
     8.43424655E-01   2        -5         5   # BR(HH -> Bottom bottom)
     9.44412303E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     7.30750791E-03   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     1.14813742E-03   2        25        25   # BR(HH -> h0 h0)
DECAY        36     3.77651185E+00   # Gamma(A0)
    -5.46199289E-07   2        22        22   # BR(A0 -> photon photon)
    -1.89297793E-06   2        22        23   # BR(A0 -> photon Z)
    -3.14412422E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.06599444E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.74286115E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.32787883E-01   2       -15        15   # BR(A0 -> Tau tau)
    -3.22981861E-13   2        -2         2   # BR(A0 -> Up up)
    -4.51913074E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.37254729E-06   2        -1         1   # BR(A0 -> Down down)
    -3.44668265E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.17603737E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.68470870E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -3.15214900E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -1.02568651E-04   2        23        25   # BR(A0 -> Z h0)
    -5.97858342E-36   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     1.97131904E+00   # Gamma(Hp)
     2.17795499E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     9.31143370E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.63369495E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     2.57206844E-06   2        -1         2   # BR(Hp -> Down up)
     2.91348208E-05   2        -3         2   # BR(Hp -> Strange up)
     1.64388879E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.21265856E-07   2        -1         4   # BR(Hp -> Down charm)
     6.43718457E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.30194161E-03   2        -5         4   # BR(Hp -> Bottom charm)
     2.32834661E-07   2        -1         6   # BR(Hp -> Down top)
     5.45289679E-06   2        -3         6   # BR(Hp -> Strange top)
     6.60592136E-01   2        -5         6   # BR(Hp -> Bottom top)
     7.17805381E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     3.26545829E-04   2        24        25   # BR(Hp -> W h0)
     2.40937272E-07   2        24        35   # BR(Hp -> W HH)
     2.66041391E-07   2        24        36   # BR(Hp -> W A0)
