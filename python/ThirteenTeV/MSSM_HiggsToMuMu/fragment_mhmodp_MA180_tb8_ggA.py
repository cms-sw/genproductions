...
BLOCK MASS
   ...
   2000005     1.00173863E+03   # MSf(2,4,3)
        25     1.21052567E+02   # Mh0
        35     1.83229685E+02   # MHH
        36     1.80000000E+02   # MA0
        37     1.97105509E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.98706560E-01   # Delta Mh0
        35     6.11423846E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.14353057E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -2.87824362E-01   # Alpha
BLOCK DALPHA
               7.01053104E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.96384777E-01   # UH(1,1)
     1   2     8.49551391E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -8.49551391E-02   # UH(2,1)
     2   2     9.96384777E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.30458822E-02   # Gamma(h0)
     6.45347558E-04   2        22        22   # BR(h0 -> photon photon)
     3.08513582E-04   2        22        23   # BR(h0 -> photon Z)
     4.79789369E-03   2        23        23   # BR(h0 -> Z Z)
     4.29169929E-02   2       -24        24   # BR(h0 -> W W)
     1.62925371E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.72039061E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.43413399E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.85067656E-02   2       -15        15   # BR(h0 -> Tau tau)
     5.62634386E-08   2        -2         2   # BR(h0 -> Up up)
     7.79269244E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.25732440E-06   2        -1         1   # BR(h0 -> Down down)
     3.15756450E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.28078766E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.12532708E-01   # Gamma(HH)
     3.98351256E-06   2        22        22   # BR(HH -> photon photon)
     1.98900721E-05   2        22        23   # BR(HH -> photon Z)
     1.04789107E-02   2        23        23   # BR(HH -> Z Z)
     8.24110527E-02   2       -24        24   # BR(HH -> W W)
     1.45936053E-03   2        21        21   # BR(HH -> gluon gluon)
     8.15940236E-09   2       -11        11   # BR(HH -> Electron electron)
     3.62986602E-04   2       -13        13   # BR(HH -> Muon muon)
     1.03839493E-01   2       -15        15   # BR(HH -> Tau tau)
     4.11573817E-10   2        -2         2   # BR(HH -> Up up)
     5.70155664E-05   2        -4         4   # BR(HH -> Charm charm)
     1.21966278E-06   2        -1         1   # BR(HH -> Down down)
     3.06299507E-04   2        -3         3   # BR(HH -> Strange strange)
     7.91621837E-01   2        -5         5   # BR(HH -> Bottom bottom)
     9.43794027E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     1.72398929E-09   2        23        36   # BR(HH -> Z A0)
DECAY        36     2.22781987E-01   # Gamma(A0)
    -2.68473166E-06   2        22        22   # BR(A0 -> photon photon)
    -3.15133477E-06   2        22        23   # BR(A0 -> photon Z)
    -3.25043101E-04   2        21        21   # BR(A0 -> gluon gluon)
    -8.13706492E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.61991448E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.03594555E-01   2       -15        15   # BR(A0 -> Tau tau)
    -6.89811492E-11   2        -2         2   # BR(A0 -> Up up)
    -9.62188533E-06   2        -4         4   # BR(A0 -> Charm charm)
    -1.22041324E-06   2        -1         1   # BR(A0 -> Down down)
    -3.06488139E-04   2        -3         3   # BR(A0 -> Strange strange)
    -7.93476170E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.01847849E-01   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -7.12164318E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     4.16594515E-02   # Gamma(Hp)
     5.01158838E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     2.14260896E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     6.05974538E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     6.58356504E-06   2        -1         2   # BR(Hp -> Down up)
     7.40448867E-05   2        -3         2   # BR(Hp -> Strange up)
     4.55738799E-05   2        -5         2   # BR(Hp -> Bottom up)
     2.78652351E-06   2        -1         4   # BR(Hp -> Down charm)
     1.70286815E-03   2        -3         4   # BR(Hp -> Strange charm)
     6.38150216E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.42339708E-05   2        -1         6   # BR(Hp -> Down top)
     3.10421475E-04   2        -3         6   # BR(Hp -> Strange top)
     3.80421482E-01   2        -5         6   # BR(Hp -> Bottom top)
     2.86539315E-03   2        24        25   # BR(Hp -> W h0)
     1.49426768E-05   2        24        35   # BR(Hp -> W HH)
     4.29709155E-05   2        24        36   # BR(Hp -> W A0)
