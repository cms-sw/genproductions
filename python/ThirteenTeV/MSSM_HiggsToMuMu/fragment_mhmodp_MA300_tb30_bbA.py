...
BLOCK MASS
   ...
   2000005     1.00956179E+03   # MSf(2,4,3)
        25     1.25026219E+02   # Mh0
        35     3.00343942E+02   # MHH
        36     3.00000000E+02   # MA0
        37     3.12317819E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.18194474E-01   # Delta Mh0
        35     5.71038045E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.04402056E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -4.59672208E-02   # Alpha
BLOCK DALPHA
               2.65605503E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99982660E-01   # UH(1,1)
     1   2     5.88889089E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -5.88889089E-03   # UH(2,1)
     2   2     9.99982660E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     5.77359730E-03   # Gamma(h0)
     1.60220652E-03   2        22        22   # BR(h0 -> photon photon)
     1.02360660E-03   2        22        23   # BR(h0 -> photon Z)
     1.86420372E-02   2        23        23   # BR(h0 -> Z Z)
     1.53917431E-01   2       -24        24   # BR(h0 -> W W)
     4.74945066E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.55079697E-09   2       -11        11   # BR(h0 -> Electron electron)
     2.91391057E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.31594185E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.39525302E-07   2        -2         2   # BR(h0 -> Up up)
     1.93257190E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.04407835E-06   2        -1         1   # BR(h0 -> Down down)
     2.62196790E-04   2        -3         3   # BR(h0 -> Strange strange)
     6.74280297E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     3.99811139E+00   # Gamma(HH)
     1.17271238E-06   2        22        22   # BR(HH -> photon photon)
     1.53752345E-06   2        22        23   # BR(HH -> photon Z)
     1.04353304E-04   2        23        23   # BR(HH -> Z Z)
     2.33720940E-04   2       -24        24   # BR(HH -> W W)
     3.49788675E-04   2        21        21   # BR(HH -> gluon gluon)
     1.09935617E-08   2       -11        11   # BR(HH -> Electron electron)
     4.89142188E-04   2       -13        13   # BR(HH -> Muon muon)
     1.36927482E-01   2       -15        15   # BR(HH -> Tau tau)
     7.23806249E-13   2        -2         2   # BR(HH -> Up up)
     1.00141283E-07   2        -4         4   # BR(HH -> Charm charm)
     1.39612725E-06   2        -1         1   # BR(HH -> Down down)
     3.50590662E-04   2        -3         3   # BR(HH -> Strange strange)
     8.31468088E-01   2        -5         5   # BR(HH -> Bottom bottom)
     6.38970724E-04   2  -1000024   1000024   # BR(HH -> Chargino1 chargino1)
     1.11238430E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     1.37528086E-02   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     3.38792555E-03   2   1000022   1000025   # BR(HH -> neutralino1 neutralino3)
     1.16906925E-03   2        25        25   # BR(HH -> h0 h0)
DECAY        36     4.24013649E+00   # Gamma(A0)
    -2.39402665E-06   2        22        22   # BR(A0 -> photon photon)
    -7.20119523E-06   2        22        23   # BR(A0 -> photon Z)
    -2.54014033E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.03484409E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.60438592E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.28856053E-01   2       -15        15   # BR(A0 -> Tau tau)
    -2.93646752E-13   2        -2         2   # BR(A0 -> Up up)
    -4.10981272E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.31381777E-06   2        -1         1   # BR(A0 -> Down down)
    -3.29921433E-04   2        -3         3   # BR(A0 -> Strange strange)
    -7.82747395E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -3.17093534E-02   2  -1000024   1000024   # BR(A0 -> Chargino1 chargino1)
    -1.72629085E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -3.82376253E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -2.21208016E-05   2   1000022   1000025   # BR(A0 -> neutralino1 neutralino3)
    -1.09209896E-04   2        23        25   # BR(A0 -> Z h0)
    -1.53375728E-36   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     2.41100556E+00   # Gamma(Hp)
     1.92952881E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     8.24933498E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.33331155E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     2.24985501E-06   2        -1         2   # BR(Hp -> Down up)
     2.55216044E-05   2        -3         2   # BR(Hp -> Strange up)
     1.44010735E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.06227439E-07   2        -1         4   # BR(Hp -> Down charm)
     5.63080587E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.01659788E-03   2        -5         4   # BR(Hp -> Bottom charm)
     2.39565098E-07   2        -1         6   # BR(Hp -> Down top)
     5.61089924E-06   2        -3         6   # BR(Hp -> Strange top)
     6.79492911E-01   2        -5         6   # BR(Hp -> Bottom top)
     7.87307768E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     4.71735871E-03   2   1000023   1000024   # BR(Hp -> neutralino2 chargino1)
     2.74751726E-04   2        24        25   # BR(Hp -> W h0)
     1.32780602E-07   2        24        35   # BR(Hp -> W HH)
     1.52858461E-07   2        24        36   # BR(Hp -> W A0)
