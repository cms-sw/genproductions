...
BLOCK MASS
   ...
   2000005     1.01459737E+03   # MSf(2,4,3)
        25     1.25260936E+02   # Mh0
        35     2.75149238E+02   # MHH
        36     2.75000000E+02   # MA0
        37     2.89947513E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.50033541E-01   # Delta Mh0
        35     9.30814339E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     3.57154826E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -3.35311959E-02   # Alpha
BLOCK DALPHA
               2.09408104E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99982987E-01   # UH(1,1)
     1   2     5.83313216E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -5.83313216E-03   # UH(2,1)
     2   2     9.99982987E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     6.44600576E-03   # Gamma(h0)
     1.44331984E-03   2        22        22   # BR(h0 -> photon photon)
     9.33972161E-04   2        22        23   # BR(h0 -> photon Z)
     1.71939298E-02   2        23        23   # BR(h0 -> Z Z)
     1.41304560E-01   2       -24        24   # BR(h0 -> W W)
     4.23811917E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.06177375E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.14120221E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.89862040E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.25209550E-07   2        -2         2   # BR(h0 -> Up up)
     1.73429211E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.09610958E-06   2        -1         1   # BR(h0 -> Down down)
     2.75255059E-04   2        -3         3   # BR(h0 -> Strange strange)
     6.89823298E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     7.61100965E+00   # Gamma(HH)
    -6.12594135E-07   2        22        22   # BR(HH -> photon photon)
    -4.95996284E-07   2        22        23   # BR(HH -> photon Z)
    -3.06418893E-05   2        23        23   # BR(HH -> Z Z)
    -7.00212687E-05   2       -24        24   # BR(HH -> W W)
    -3.61022526E-04   2        21        21   # BR(HH -> gluon gluon)
    -1.22319345E-08   2       -11        11   # BR(HH -> Electron electron)
     5.44227685E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.50221273E-01   2       -15        15   # BR(HH -> Tau tau)
    -1.77471885E-13   2        -2         2   # BR(HH -> Up up)
    -2.45515695E-08   2        -4         4   # BR(HH -> Charm charm)
    -1.48894847E-06   2        -1         1   # BR(HH -> Down down)
    -3.73876861E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.40178400E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -4.45505813E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
    -3.46451839E-03   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
    -2.98326627E-04   2        25        25   # BR(HH -> h0 h0)
DECAY        36     7.71755362E+00   # Gamma(A0)
     1.88922736E-07   2        22        22   # BR(A0 -> photon photon)
     7.67355118E-07   2        22        23   # BR(A0 -> photon Z)
     3.44238061E-04   2        21        21   # BR(A0 -> gluon gluon)
     1.20493542E-08   2       -11        11   # BR(A0 -> Electron electron)
     5.36104485E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.47967804E-01   2       -15        15   # BR(A0 -> Tau tau)
     5.94515956E-14   2        -2         2   # BR(A0 -> Up up)
     8.37322654E-09   2        -4         4   # BR(A0 -> Charm charm)
     1.46647283E-06   2        -1         1   # BR(A0 -> Down down)
     3.68233246E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.27842954E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     7.90855902E-03   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     1.50037132E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
     2.59510988E-05   2        23        25   # BR(A0 -> Z h0)
     3.96192105E-36   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     4.06917466E+00   # Gamma(Hp)
     2.38807679E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.02097697E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.88778760E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     2.73550660E-06   2        -1         2   # BR(Hp -> Down up)
     3.09875577E-05   2        -3         2   # BR(Hp -> Strange up)
     1.65393849E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.24594945E-07   2        -1         4   # BR(Hp -> Down charm)
     6.84483972E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.31601526E-03   2        -5         4   # BR(Hp -> Bottom charm)
     5.11178798E-08   2        -1         6   # BR(Hp -> Down top)
     1.52116412E-06   2        -3         6   # BR(Hp -> Strange top)
     6.71957958E-01   2        -5         6   # BR(Hp -> Bottom top)
     3.51043955E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     8.49682471E-05   2        24        25   # BR(Hp -> W h0)
     2.23958289E-07   2        24        35   # BR(Hp -> W HH)
     2.35418169E-07   2        24        36   # BR(Hp -> W A0)
