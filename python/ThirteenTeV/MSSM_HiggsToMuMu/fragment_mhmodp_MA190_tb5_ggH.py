...
BLOCK MASS
   ...
   2000005     1.00226018E+03   # MSf(2,4,3)
        25     1.16596828E+02   # Mh0
        35     1.96407271E+02   # MHH
        36     1.90000000E+02   # MA0
        37     2.06090203E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     9.26337475E-01   # Delta Mh0
        35     1.30870787E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.30878998E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -3.84235502E-01   # Alpha
BLOCK DALPHA
               7.03337096E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.95912667E-01   # UH(1,1)
     1   2     9.03214223E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -9.03214223E-02   # UH(2,1)
     2   2     9.95912667E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     8.94097018E-03   # Gamma(h0)
     8.26636688E-04   2        22        22   # BR(h0 -> photon photon)
     2.78697599E-04   2        22        23   # BR(h0 -> photon Z)
     3.71180123E-03   2        23        23   # BR(h0 -> Z Z)
     3.61184558E-02   2       -24        24   # BR(h0 -> W W)
     2.09610865E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.56016994E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.36282739E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.66589597E-02   2       -15        15   # BR(h0 -> Tau tau)
     7.62074231E-08   2        -2         2   # BR(h0 -> Up up)
     1.05543631E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.24961840E-06   2        -1         1   # BR(h0 -> Down down)
     3.13823514E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.30238560E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.27677597E-01   # Gamma(HH)
    -1.05014723E-05   2        22        22   # BR(HH -> photon photon)
    -5.50389512E-05   2        22        23   # BR(HH -> photon Z)
    -8.74278672E-02   2        23        23   # BR(HH -> Z Z)
    -2.61500267E-01   2       -24        24   # BR(HH -> W W)
    -2.53066620E-03   2        21        21   # BR(HH -> gluon gluon)
    -5.40333785E-09   2       -11        11   # BR(HH -> Electron electron)
     2.40382818E-04   2       -13        13   # BR(HH -> Muon muon)
    -6.89643490E-02   2       -15        15   # BR(HH -> Tau tau)
    -1.30485652E-09   2        -2         2   # BR(HH -> Up up)
    -1.80658943E-04   2        -4         4   # BR(HH -> Charm charm)
    -8.07484339E-07   2        -1         1   # BR(HH -> Down down)
    -2.02790076E-04   2        -3         3   # BR(HH -> Strange strange)
    -5.30253765E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -4.86328135E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
    -8.56650442E-08   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.28563672E-01   # Gamma(A0)
     1.05732066E-05   2        22        22   # BR(A0 -> photon photon)
     1.01821316E-05   2        22        23   # BR(A0 -> photon Z)
     3.98715128E-04   2        21        21   # BR(A0 -> gluon gluon)
     5.78411825E-09   2       -11        11   # BR(A0 -> Electron electron)
     2.57320675E-04   2       -13        13   # BR(A0 -> Muon muon)
     7.38499303E-02   2       -15        15   # BR(A0 -> Tau tau)
     3.24946085E-10   2        -2         2   # BR(A0 -> Up up)
     4.52022077E-05   2        -4         4   # BR(A0 -> Charm charm)
     8.69534446E-07   2        -1         1   # BR(A0 -> Down down)
     2.18373327E-04   2        -3         3   # BR(A0 -> Strange strange)
     5.72158792E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     3.52511810E-01   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     5.38225448E-04   2        23        25   # BR(A0 -> Z h0)
DECAY        37     5.72775017E-02   # Gamma(Hp)
     1.48875590E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     6.36489199E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     1.80014919E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.95369652E-06   2        -1         2   # BR(Hp -> Down up)
     2.19850274E-05   2        -3         2   # BR(Hp -> Strange up)
     1.37007141E-05   2        -5         2   # BR(Hp -> Bottom up)
     4.90627688E-06   2        -1         4   # BR(Hp -> Down charm)
     5.95956519E-04   2        -3         4   # BR(Hp -> Strange charm)
     1.91859225E-03   2        -5         4   # BR(Hp -> Bottom charm)
     4.57413810E-05   2        -1         6   # BR(Hp -> Down top)
     9.97328281E-04   2        -3         6   # BR(Hp -> Strange top)
     7.73854674E-01   2        -5         6   # BR(Hp -> Bottom top)
     4.18686413E-02   2        24        25   # BR(Hp -> W h0)
     1.83361020E-06   2        24        35   # BR(Hp -> W HH)
     2.32643300E-05   2        24        36   # BR(Hp -> W A0)
