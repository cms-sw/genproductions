...
BLOCK MASS
   ...
   2000005     1.00482428E+03   # MSf(2,4,3)
        25     1.23769571E+02   # Mh0
        35     1.61246712E+02   # MHH
        36     1.60000000E+02   # MA0
        37     1.79857688E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.29006541E-01   # Delta Mh0
        35     1.66811998E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     4.32481923E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -2.04649305E-01   # Alpha
BLOCK DALPHA
               8.71770220E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.95877241E-01   # UH(1,1)
     1   2     9.07111977E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -9.07111977E-02   # UH(2,1)
     2   2     9.95877241E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     2.80783124E-02   # Gamma(h0)
     3.26270572E-04   2        22        22   # BR(h0 -> photon photon)
     1.85608287E-04   2        22        23   # BR(h0 -> photon Z)
     3.20156115E-03   2        23        23   # BR(h0 -> Z Z)
     2.71067051E-02   2       -24        24   # BR(h0 -> W W)
     7.65434607E-03   2        21        21   # BR(h0 -> gluon gluon)
     8.45523150E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.76102635E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.07076091E-01   2       -15        15   # BR(h0 -> Tau tau)
     2.74228823E-08   2        -2         2   # BR(h0 -> Up up)
     3.79830739E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.33244166E-06   2        -1         1   # BR(h0 -> Down down)
     3.34610072E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.49939029E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     7.61399847E-01   # Gamma(HH)
     3.63206036E-07   2        22        22   # BR(HH -> photon photon)
     2.40914073E-06   2        22        23   # BR(HH -> photon Z)
     9.86690857E-05   2        23        23   # BR(HH -> Z Z)
     3.10364065E-03   2       -24        24   # BR(HH -> W W)
     9.38378179E-04   2        21        21   # BR(HH -> gluon gluon)
     9.48055136E-09   2       -11        11   # BR(HH -> Electron electron)
     4.21744249E-04   2       -13        13   # BR(HH -> Muon muon)
     1.19586219E-01   2       -15        15   # BR(HH -> Tau tau)
     5.20366530E-11   2        -2         2   # BR(HH -> Up up)
     7.21533423E-06   2        -4         4   # BR(HH -> Charm charm)
     1.40001154E-06   2        -1         1   # BR(HH -> Down down)
     3.51575786E-04   2        -3         3   # BR(HH -> Strange strange)
     8.75488376E-01   2        -5         5   # BR(HH -> Bottom bottom)
     4.20718937E-12   2        23        36   # BR(HH -> Z A0)
DECAY        36     7.80335430E-01   # Gamma(A0)
    -2.35649045E-07   2        22        22   # BR(A0 -> photon photon)
    -2.63910347E-07   2        22        23   # BR(A0 -> photon Z)
    -6.95832645E-04   2        21        21   # BR(A0 -> gluon gluon)
    -9.48369046E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.21883654E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.19685070E-01   2       -15        15   # BR(A0 -> Tau tau)
    -3.79412844E-12   2        -2         2   # BR(A0 -> Up up)
    -5.34136315E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.40291017E-06   2        -1         1   # BR(A0 -> Down down)
    -3.52303945E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.78841047E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.41611885E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.08118102E-01   # Gamma(Hp)
     7.95680364E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.40177913E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.62062821E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.04242196E-05   2        -1         2   # BR(Hp -> Down up)
     1.17029915E-04   2        -3         2   # BR(Hp -> Strange up)
     6.94286293E-05   2        -5         2   # BR(Hp -> Bottom up)
     6.62906475E-07   2        -1         4   # BR(Hp -> Down charm)
     2.61278943E-03   2        -3         4   # BR(Hp -> Strange charm)
     9.72150172E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.14265064E-07   2        -1         6   # BR(Hp -> Down top)
     2.50455221E-06   2        -3         6   # BR(Hp -> Strange top)
     2.18188842E-02   2        -5         6   # BR(Hp -> Bottom top)
     1.23872823E-04   2        24        25   # BR(Hp -> W h0)
     2.41785275E-05   2        24        35   # BR(Hp -> W HH)
     3.39292019E-05   2        24        36   # BR(Hp -> W A0)
