...
BLOCK MASS
   ...
   2000005     1.00226018E+03   # MSf(2,4,3)
        25     1.12385815E+02   # Mh0
        35     1.60954269E+02   # MHH
        36     1.50000000E+02   # MA0
        37     1.69854968E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     8.84100385E-01   # Delta Mh0
        35     2.00502293E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.53428938E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -5.75860057E-01   # Alpha
BLOCK DALPHA
               1.80349639E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.78440027E-01   # UH(1,1)
     1   2     2.06531143E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -2.06531143E-01   # UH(2,1)
     2   2     9.78440027E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.73050341E-02   # Gamma(h0)
     3.51202889E-04   2        22        22   # BR(h0 -> photon photon)
     6.65245698E-05   2        22        23   # BR(h0 -> photon Z)
     9.00705954E-04   2        23        23   # BR(h0 -> Z Z)
     9.31613367E-03   2       -24        24   # BR(h0 -> W W)
     7.19558066E-03   2        21        21   # BR(h0 -> gluon gluon)
     7.96635050E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.54346029E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.01757174E-01   2       -15        15   # BR(h0 -> Tau tau)
     3.12833103E-08   2        -2         2   # BR(h0 -> Up up)
     4.33252248E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.32134974E-06   2        -1         1   # BR(h0 -> Down down)
     3.31836598E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.75392613E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     6.36242066E-02   # Gamma(HH)
     6.87385917E-05   2        22        22   # BR(HH -> photon photon)
     2.89680447E-04   2        22        23   # BR(HH -> photon Z)
     8.01708120E-03   2        23        23   # BR(HH -> Z Z)
     1.57093653E-01   2       -24        24   # BR(HH -> W W)
     5.49641819E-03   2        21        21   # BR(HH -> gluon gluon)
     7.25088917E-09   2       -11        11   # BR(HH -> Electron electron)
     3.22557092E-04   2       -13        13   # BR(HH -> Muon muon)
     9.25101121E-02   2       -15        15   # BR(HH -> Tau tau)
     4.73024699E-09   2        -2         2   # BR(HH -> Up up)
     6.55792575E-04   2        -4         4   # BR(HH -> Charm charm)
     1.11993530E-06   2        -1         1   # BR(HH -> Down down)
     2.81256130E-04   2        -3         3   # BR(HH -> Strange strange)
     7.35261441E-01   2        -5         5   # BR(HH -> Bottom bottom)
     2.13725551E-06   2        23        36   # BR(HH -> Z A0)
DECAY        36     6.83328870E-02   # Gamma(A0)
    -7.33005492E-06   2        22        22   # BR(A0 -> photon photon)
    -4.01175424E-06   2        22        23   # BR(A0 -> photon Z)
    -5.19396824E-04   2        21        21   # BR(A0 -> gluon gluon)
    -8.61234532E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.83114351E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.09960859E-01   2       -15        15   # BR(A0 -> Tau tau)
    -5.12097724E-10   2        -2         2   # BR(A0 -> Up up)
    -7.14981720E-05   2        -4         4   # BR(A0 -> Charm charm)
    -1.34844021E-06   2        -1         1   # BR(A0 -> Down down)
    -3.38642033E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.88592168E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.21621876E-04   2        23        25   # BR(A0 -> Z h0)
DECAY        37     8.99268070E-03   # Gamma(Hp)
     7.81518556E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.34123275E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.44917306E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.06036970E-05   2        -1         2   # BR(Hp -> Down up)
     1.18794709E-04   2        -3         2   # BR(Hp -> Strange up)
     7.40024658E-05   2        -5         2   # BR(Hp -> Bottom up)
     2.65097870E-05   2        -1         4   # BR(Hp -> Down charm)
     3.23443047E-03   2        -3         4   # BR(Hp -> Strange charm)
     1.03625998E-02   2        -5         4   # BR(Hp -> Bottom charm)
     2.69446587E-02   2        -5         6   # BR(Hp -> Bottom top)
     1.05596111E-02   2        24        25   # BR(Hp -> W h0)
     6.78855740E-06   2        24        35   # BR(Hp -> W HH)
     4.03383301E-04   2        24        36   # BR(Hp -> W A0)
