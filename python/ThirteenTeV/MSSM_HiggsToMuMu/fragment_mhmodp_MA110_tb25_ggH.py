...
BLOCK MASS
   ...
   2000005     1.00778084E+03   # MSf(2,4,3)
        25     1.08963780E+02   # Mh0
        35     1.26245982E+02   # MHH
        36     1.10000000E+02   # MA0
        37     1.38703754E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     8.13642360E-02   # Delta Mh0
        35     6.33422597E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.13235485E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.31407523E+00   # Alpha
BLOCK DALPHA
               3.49738085E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     4.44576368E-01   # UH(1,1)
     1   2     8.95740952E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1     8.95740952E-01   # UH(2,1)
     2   2    -4.44576368E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.10945997E+00   # Gamma(h0)
     1.85921581E-06   2        22        22   # BR(h0 -> photon photon)
     5.87955979E-10   2        22        23   # BR(h0 -> photon Z)
     7.90910804E-07   2        23        23   # BR(h0 -> Z Z)
     8.40762091E-06   2       -24        24   # BR(h0 -> W W)
     9.86144892E-04   2        21        21   # BR(h0 -> gluon gluon)
     9.46768569E-09   2       -11        11   # BR(h0 -> Electron electron)
     4.21122024E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.18443811E-01   2       -15        15   # BR(h0 -> Tau tau)
     3.86474999E-11   2        -2         2   # BR(h0 -> Up up)
     5.35255637E-06   2        -4         4   # BR(h0 -> Charm charm)
     1.45654205E-06   2        -1         1   # BR(h0 -> Down down)
     3.65752059E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.79765294E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     7.67470117E-02   # Gamma(HH)
    -9.18302871E-05   2        22        22   # BR(HH -> photon photon)
    -9.19986145E-05   2        22        23   # BR(HH -> photon Z)
    -1.49147391E-03   2        23        23   # BR(HH -> Z Z)
    -1.20246910E-02   2       -24        24   # BR(HH -> W W)
    -7.39560781E-03   2        21        21   # BR(HH -> gluon gluon)
    -9.76699082E-09   2       -11        11   # BR(HH -> Electron electron)
     4.34454626E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.21785819E-01   2       -15        15   # BR(HH -> Tau tau)
    -9.96796564E-09   2        -2         2   # BR(HH -> Up up)
    -1.38067872E-03   2        -4         4   # BR(HH -> Charm charm)
    -1.43998610E-06   2        -1         1   # BR(HH -> Down down)
    -3.61591029E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.54939242E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -1.15346531E-06   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.18160045E+00   # Gamma(A0)
     3.45114568E-07   2        22        22   # BR(A0 -> photon photon)
     2.36605632E-09   2        22        23   # BR(A0 -> photon Z)
     1.20671934E-03   2        21        21   # BR(A0 -> gluon gluon)
     9.47765051E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.21568041E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.18655042E-01   2       -15        15   # BR(A0 -> Tau tau)
     9.90079786E-13   2        -2         2   # BR(A0 -> Up up)
     1.49262054E-07   2        -4         4   # BR(A0 -> Charm charm)
     1.45382927E-06   2        -1         1   # BR(A0 -> Down down)
     3.65070939E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.79349639E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     1.00210532E-12   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.76370952E-01   # Gamma(Hp)
     8.13488429E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47791247E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.83463812E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.09886143E-05   2        -1         2   # BR(Hp -> Down up)
     1.22564990E-04   2        -3         2   # BR(Hp -> Strange up)
     7.04016127E-05   2        -5         2   # BR(Hp -> Bottom up)
     5.33019182E-07   2        -1         4   # BR(Hp -> Down charm)
     2.75035438E-03   2        -3         4   # BR(Hp -> Strange charm)
     9.85704745E-03   2        -5         4   # BR(Hp -> Bottom charm)
     3.72021060E-06   2        -5         6   # BR(Hp -> Bottom top)
     1.26103794E-04   2        24        25   # BR(Hp -> W h0)
     1.74714381E-07   2        24        35   # BR(Hp -> W HH)
     1.16305746E-04   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.39985715E+00   # Gamma(top)
     9.79582338E-01   2         5        24   # BR(top -> bottom W)
     2.04176616E-02   2         5        37   # BR(top -> bottom Hp)
"""
