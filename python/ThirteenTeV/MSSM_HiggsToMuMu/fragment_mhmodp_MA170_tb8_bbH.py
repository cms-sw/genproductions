...
BLOCK MASS
   ...
   2000005     1.00173863E+03   # MSf(2,4,3)
        25     1.20580207E+02   # Mh0
        35     1.73729131E+02   # MHH
        36     1.70000000E+02   # MA0
        37     1.87998211E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.97721943E-01   # Delta Mh0
        35     7.06332460E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.19036822E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -3.23716982E-01   # Alpha
BLOCK DALPHA
               9.51389882E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.94119708E-01   # UH(1,1)
     1   2     1.08286689E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.08286689E-01   # UH(2,1)
     2   2     9.94119708E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.60107457E-02   # Gamma(h0)
     5.16319518E-04   2        22        22   # BR(h0 -> photon photon)
     2.35121897E-04   2        22        23   # BR(h0 -> photon Z)
     3.61955146E-03   2        23        23   # BR(h0 -> Z Z)
     3.26839835E-02   2       -24        24   # BR(h0 -> W W)
     1.24933727E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.87716611E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.50386571E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.00470474E-01   2       -15        15   # BR(h0 -> Tau tau)
     4.46820701E-08   2        -2         2   # BR(h0 -> Up up)
     6.18861701E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.28194315E-06   2        -1         1   # BR(h0 -> Down down)
     3.21938611E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.43118900E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.96313896E-01   # Gamma(HH)
    -5.65323657E-06   2        22        22   # BR(HH -> photon photon)
    -2.92301288E-05   2        22        23   # BR(HH -> photon Z)
    -2.62372004E-03   2        23        23   # BR(HH -> Z Z)
    -9.05752983E-02   2       -24        24   # BR(HH -> W W)
    -1.61451261E-03   2        21        21   # BR(HH -> gluon gluon)
    -8.16848043E-09   2       -11        11   # BR(HH -> Electron electron)
     3.63384645E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.03946892E-01   2       -15        15   # BR(HH -> Tau tau)
    -5.35963624E-10   2        -2         2   # BR(HH -> Up up)
    -7.42591198E-05   2        -4         4   # BR(HH -> Charm charm)
    -1.23167922E-06   2        -1         1   # BR(HH -> Down down)
    -3.09316687E-04   2        -3         3   # BR(HH -> Strange strange)
    -7.99407713E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -1.04877594E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
    -3.75922669E-09   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.90845987E-01   # Gamma(A0)
     2.41676858E-06   2        22        22   # BR(A0 -> photon photon)
     2.54793159E-06   2        22        23   # BR(A0 -> photon Z)
     4.22715013E-04   2        21        21   # BR(A0 -> gluon gluon)
     8.97691981E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.99347062E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.14287514E-01   2       -15        15   # BR(A0 -> Tau tau)
     7.71771731E-11   2        -2         2   # BR(A0 -> Up up)
     1.07739983E-05   2        -4         4   # BR(A0 -> Charm charm)
     1.36001352E-06   2        -1         1   # BR(A0 -> Down down)
     3.41545656E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.84482180E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     4.95903762E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     3.02676085E-02   # Gamma(Hp)
     6.57908939E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     2.81276394E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     7.95495565E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     8.71208630E-06   2        -1         2   # BR(Hp -> Down up)
     9.78926765E-05   2        -3         2   # BR(Hp -> Strange up)
     6.02466276E-05   2        -5         2   # BR(Hp -> Bottom up)
     3.68395385E-06   2        -1         4   # BR(Hp -> Down charm)
     2.25339992E-03   2        -3         4   # BR(Hp -> Strange charm)
     8.43598691E-03   2        -5         4   # BR(Hp -> Bottom charm)
     8.28999933E-06   2        -1         6   # BR(Hp -> Down top)
     1.80772534E-04   2        -3         6   # BR(Hp -> Strange top)
     1.88155866E-01   2        -5         6   # BR(Hp -> Bottom top)
     2.38818142E-03   2        24        25   # BR(Hp -> W h0)
     2.31634088E-05   2        24        35   # BR(Hp -> W HH)
     7.54091460E-05   2        24        36   # BR(Hp -> W A0)
