...
BLOCK MASS
   ...
   2000005     1.00594745E+03   # MSf(2,4,3)
        25     1.24625784E+02   # Mh0
        35     2.25468154E+02   # MHH
        36     2.25000000E+02   # MA0
        37     2.39840127E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.19810984E-01   # Delta Mh0
        35     1.04089156E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.42404597E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -8.78636621E-02   # Alpha
BLOCK DALPHA
               1.04157549E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99829162E-01   # UH(1,1)
     1   2     1.84836953E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.84836953E-02   # UH(2,1)
     2   2     9.99829162E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     8.41552875E-03   # Gamma(h0)
     1.09666558E-03   2        22        22   # BR(h0 -> photon photon)
     6.80488999E-04   2        22        23   # BR(h0 -> photon Z)
     1.21475848E-02   2        23        23   # BR(h0 -> Z Z)
     1.01097664E-01   2       -24        24   # BR(h0 -> W W)
     3.10396770E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.26078055E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.22972139E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.22191235E-02   2       -15        15   # BR(h0 -> Tau tau)
     9.50817203E-08   2        -2         2   # BR(h0 -> Up up)
     1.31697375E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.15735659E-06   2        -1         1   # BR(h0 -> Down down)
     2.90645112E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.47934182E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.43634576E+00   # Gamma(HH)
     9.27463165E-07   2        22        22   # BR(HH -> photon photon)
     5.89787330E-07   2        22        23   # BR(HH -> photon Z)
     7.31705027E-04   2        23        23   # BR(HH -> Z Z)
     1.83403787E-03   2       -24        24   # BR(HH -> W W)
     5.45954813E-04   2        21        21   # BR(HH -> gluon gluon)
     1.00570645E-08   2       -11        11   # BR(HH -> Electron electron)
     4.47435603E-04   2       -13        13   # BR(HH -> Muon muon)
     1.26523653E-01   2       -15        15   # BR(HH -> Tau tau)
     6.38551015E-12   2        -2         2   # BR(HH -> Up up)
     8.83643522E-07   2        -4         4   # BR(HH -> Charm charm)
     1.38879882E-06   2        -1         1   # BR(HH -> Down down)
     3.48760584E-04   2        -3         3   # BR(HH -> Strange strange)
     8.58799414E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.07652384E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     1.46088336E+00   # Gamma(A0)
    -4.61599133E-07   2        22        22   # BR(A0 -> photon photon)
    -1.23634447E-06   2        22        23   # BR(A0 -> photon Z)
    -4.00206354E-04   2        21        21   # BR(A0 -> gluon gluon)
    -9.87142657E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.39176762E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.24200832E-01   2       -15        15   # BR(A0 -> Tau tau)
    -1.81220753E-12   2        -2         2   # BR(A0 -> Up up)
    -2.53257531E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.36351674E-06   2        -1         1   # BR(A0 -> Down down)
    -3.42411743E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.43770227E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -3.07634276E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -8.03939586E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     5.23860665E-01   # Gamma(Hp)
     3.03093241E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.29581754E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     3.66503523E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     3.76163645E-06   2        -1         2   # BR(Hp -> Down up)
     4.24671549E-05   2        -3         2   # BR(Hp -> Strange up)
     2.49062466E-05   2        -5         2   # BR(Hp -> Bottom up)
     2.06675885E-07   2        -1         4   # BR(Hp -> Down charm)
     9.42119583E-04   2        -3         4   # BR(Hp -> Strange charm)
     3.48756668E-03   2        -5         4   # BR(Hp -> Bottom charm)
     9.44342506E-07   2        -1         6   # BR(Hp -> Down top)
     2.08928108E-05   2        -3         6   # BR(Hp -> Strange top)
     5.66983230E-01   2        -5         6   # BR(Hp -> Bottom top)
     5.90449238E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     1.64639633E-03   2        24        25   # BR(Hp -> W h0)
     1.47884434E-06   2        24        35   # BR(Hp -> W HH)
     1.73526982E-06   2        24        36   # BR(Hp -> W A0)
