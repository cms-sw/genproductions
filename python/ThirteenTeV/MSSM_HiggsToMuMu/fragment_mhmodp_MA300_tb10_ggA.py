...
BLOCK MASS
   ...
   2000005     1.00222830E+03   # MSf(2,4,3)
        25     1.23495308E+02   # Mh0
        35     3.01087580E+02   # MHH
        36     3.00000000E+02   # MA0
        37     3.11010691E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.52460177E-01   # Delta Mh0
        35     1.95313633E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     7.36303658E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.32618091E-01   # Alpha
BLOCK DALPHA
               7.59152450E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99910790E-01   # UH(1,1)
     1   2     1.33571212E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.33571212E-02   # UH(2,1)
     2   2     9.99910790E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     5.41678677E-03   # Gamma(h0)
     1.65783364E-03   2        22        22   # BR(h0 -> photon photon)
     9.63699383E-04   2        22        23   # BR(h0 -> photon Z)
     1.63501939E-02   2        23        23   # BR(h0 -> Z Z)
     1.39201422E-01   2       -24        24   # BR(h0 -> W W)
     4.86056832E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.38503755E-09   2       -11        11   # BR(h0 -> Electron electron)
     2.84016804E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.16119563E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.46250855E-07   2        -2         2   # BR(h0 -> Up up)
     2.02567322E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.04363513E-06   2        -1         1   # BR(h0 -> Down down)
     2.62092778E-04   2        -3         3   # BR(h0 -> Strange strange)
     6.90805173E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     6.68774128E-01   # Gamma(HH)
     5.88278229E-06   2        22        22   # BR(HH -> photon photon)
     8.88414010E-06   2        22        23   # BR(HH -> photon Z)
     4.27573579E-03   2        23        23   # BR(HH -> Z Z)
     9.57203740E-03   2       -24        24   # BR(HH -> W W)
     6.54608759E-04   2        21        21   # BR(HH -> gluon gluon)
     7.02358574E-09   2       -11        11   # BR(HH -> Electron electron)
     3.12504184E-04   2       -13        13   # BR(HH -> Muon muon)
     8.91913000E-02   2       -15        15   # BR(HH -> Tau tau)
     4.05824500E-11   2        -2         2   # BR(HH -> Up up)
     5.61493686E-06   2        -4         4   # BR(HH -> Charm charm)
     9.62071689E-07   2        -1         1   # BR(HH -> Down down)
     2.41610910E-04   2        -3         3   # BR(HH -> Strange strange)
     6.18281000E-01   2        -5         5   # BR(HH -> Bottom bottom)
     2.85138396E-02   2  -1000024   1000024   # BR(HH -> Chargino1 chargino1)
     7.25962233E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     7.99858701E-02   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     5.10527376E-02   2   1000022   1000025   # BR(HH -> neutralino1 neutralino3)
     3.30241942E-04   2   1000023   1000023   # BR(HH -> neutralino2 neutralino2)
     2.48477786E-12   2        23        36   # BR(HH -> Z A0)
     4.49709391E-02   2        25        25   # BR(HH -> h0 h0)
DECAY        36     1.06365034E+00   # Gamma(A0)
    -1.54429757E-05   2        22        22   # BR(A0 -> photon photon)
    -3.42877372E-05   2        22        23   # BR(A0 -> photon Z)
    -8.71506286E-05   2        21        21   # BR(A0 -> gluon gluon)
    -4.42690437E-09   2       -11        11   # BR(A0 -> Electron electron)
     1.96968529E-04   2       -13        13   # BR(A0 -> Muon muon)
    -5.62039493E-02   2       -15        15   # BR(A0 -> Tau tau)
    -1.30643804E-11   2        -2         2   # BR(A0 -> Up up)
    -1.81601482E-06   2        -4         4   # BR(A0 -> Charm charm)
    -6.06518712E-07   2        -1         1   # BR(A0 -> Down down)
    -1.52318754E-04   2        -3         3   # BR(A0 -> Strange strange)
    -3.89971711E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -2.76407932E-01   2  -1000024   1000024   # BR(A0 -> Chargino1 chargino1)
    -8.66346546E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -1.71970950E-01   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -5.89783420E-04   2   1000022   1000025   # BR(A0 -> neutralino1 neutralino3)
    -1.47049130E-02   2   1000023   1000023   # BR(A0 -> neutralino2 neutralino2)
    -3.02751156E-03   2        23        25   # BR(A0 -> Z h0)
    -3.45230634E-36   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     5.59610040E-01   # Gamma(Hp)
     9.19814022E-09   2       -11        12   # BR(Hp -> Electron nu_e)
     3.93249064E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     1.11229825E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.11715882E-06   2        -1         2   # BR(Hp -> Down up)
     1.26724654E-05   2        -3         2   # BR(Hp -> Strange up)
     7.74002897E-06   2        -5         2   # BR(Hp -> Bottom up)
     2.25868106E-07   2        -1         4   # BR(Hp -> Down charm)
     2.83435981E-04   2        -3         4   # BR(Hp -> Strange charm)
     1.08384955E-03   2        -5         4   # BR(Hp -> Bottom charm)
     9.18395176E-06   2        -1         6   # BR(Hp -> Down top)
     2.00426110E-04   2        -3         6   # BR(Hp -> Strange top)
     4.97431295E-01   2        -5         6   # BR(Hp -> Bottom top)
     3.50128661E-01   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     3.12104560E-02   2   1000023   1000024   # BR(Hp -> neutralino2 chargino1)
     8.00725105E-03   2        24        25   # BR(Hp -> W h0)
     2.24724656E-07   2        24        35   # BR(Hp -> W HH)
     3.77148259E-07   2        24        36   # BR(Hp -> W A0)
