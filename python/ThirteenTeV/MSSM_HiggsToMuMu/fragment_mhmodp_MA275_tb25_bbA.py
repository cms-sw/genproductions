...
BLOCK MASS
   ...
   2000005     1.00778084E+03   # MSf(2,4,3)
        25     1.24895620E+02   # Mh0
        35     2.75317950E+02   # MHH
        36     2.75000000E+02   # MA0
        37     2.87772960E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.16609285E-01   # Delta Mh0
        35     6.34882296E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     5.72588554E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -5.82726065E-02   # Alpha
BLOCK DALPHA
               4.17576052E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99964087E-01   # UH(1,1)
     1   2     8.47499959E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -8.47499959E-03   # UH(2,1)
     2   2     9.99964087E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     6.27425313E-03   # Gamma(h0)
     1.47273788E-03   2        22        22   # BR(h0 -> photon photon)
     9.32650008E-04   2        22        23   # BR(h0 -> photon Z)
     1.68734975E-02   2        23        23   # BR(h0 -> Z Z)
     1.39676735E-01   2       -24        24   # BR(h0 -> W W)
     4.32146966E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.71445895E-09   2       -11        11   # BR(h0 -> Electron electron)
     2.98670971E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.53040352E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.28182628E-07   2        -2         2   # BR(h0 -> Up up)
     1.77545997E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.07241448E-06   2        -1         1   # BR(h0 -> Down down)
     2.69313748E-04   2        -3         3   # BR(h0 -> Strange strange)
     6.94201856E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.63214458E+00   # Gamma(HH)
     1.10036708E-06   2        22        22   # BR(HH -> photon photon)
     1.17136170E-06   2        22        23   # BR(HH -> photon Z)
     2.32286597E-04   2        23        23   # BR(HH -> Z Z)
     5.30718479E-04   2       -24        24   # BR(HH -> W W)
     4.04647277E-04   2        21        21   # BR(HH -> gluon gluon)
     1.05537043E-08   2       -11        11   # BR(HH -> Electron electron)
     4.69559093E-04   2       -13        13   # BR(HH -> Muon muon)
     1.32109316E-01   2       -15        15   # BR(HH -> Tau tau)
     1.72531914E-12   2        -2         2   # BR(HH -> Up up)
     2.38705440E-07   2        -4         4   # BR(HH -> Charm charm)
     1.38493023E-06   2        -1         1   # BR(HH -> Down down)
     3.47784571E-04   2        -3         3   # BR(HH -> Strange strange)
     8.40161785E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.33211532E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     1.02689764E-02   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     2.14986756E-03   2        25        25   # BR(HH -> h0 h0)
DECAY        36     2.74345796E+00   # Gamma(A0)
    -8.98546011E-07   2        22        22   # BR(A0 -> photon photon)
    -2.82294691E-06   2        22        23   # BR(A0 -> photon Z)
    -2.90815618E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.01009465E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.49414938E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.26432018E-01   2       -15        15   # BR(A0 -> Tau tau)
    -6.72418720E-13   2        -2         2   # BR(A0 -> Up up)
    -9.39140108E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.32543654E-06   2        -1         1   # BR(A0 -> Down down)
    -3.32844521E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.04432250E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -2.37682603E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -4.40966801E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -1.92565069E-04   2        23        25   # BR(A0 -> Z h0)
    -4.91072803E-37   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     1.43825193E+00   # Gamma(Hp)
     2.06968971E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     8.84856600E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.50277440E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     2.46928876E-06   2        -1         2   # BR(Hp -> Down up)
     2.79703399E-05   2        -3         2   # BR(Hp -> Strange up)
     1.60884328E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.21655377E-07   2        -1         4   # BR(Hp -> Down charm)
     6.18123708E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.25286710E-03   2        -5         4   # BR(Hp -> Bottom charm)
     4.57160614E-07   2        -1         6   # BR(Hp -> Down top)
     1.03268573E-05   2        -3         6   # BR(Hp -> Strange top)
     6.46697168E-01   2        -5         6   # BR(Hp -> Bottom top)
     9.86076752E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     6.03841168E-04   2        24        25   # BR(Hp -> W h0)
     2.69228324E-07   2        24        35   # BR(Hp -> W HH)
     3.05194258E-07   2        24        36   # BR(Hp -> W A0)
