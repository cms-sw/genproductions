...
BLOCK MASS
   ...
   2000005     1.00778084E+03   # MSf(2,4,3)
        25     1.24698471E+02   # Mh0
        35     1.80484132E+02   # MHH
        36     1.80000000E+02   # MA0
        37     1.98907271E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.24926783E-01   # Delta Mh0
        35     1.07397398E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.04602079E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.04585312E-01   # Alpha
BLOCK DALPHA
               2.48982585E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99305665E-01   # UH(1,1)
     1   2     3.72584048E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -3.72584048E-02   # UH(2,1)
     2   2     9.99305665E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.63466213E-02   # Gamma(h0)
     5.70530922E-04   2        22        22   # BR(h0 -> photon photon)
     3.51692744E-04   2        22        23   # BR(h0 -> photon Z)
     6.29397527E-03   2        23        23   # BR(h0 -> Z Z)
     5.23054412E-02   2       -24        24   # BR(h0 -> W W)
     1.48595281E-02   2        21        21   # BR(h0 -> gluon gluon)
     8.32085908E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.70126334E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.04995786E-01   2       -15        15   # BR(h0 -> Tau tau)
     4.87793593E-08   2        -2         2   # BR(h0 -> Up up)
     6.75643131E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.29273642E-06   2        -1         1   # BR(h0 -> Down down)
     3.24633845E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.13170505E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.78237606E+00   # Gamma(HH)
     4.87356375E-07   2        22        22   # BR(HH -> photon photon)
     1.96703611E-07   2        22        23   # BR(HH -> photon Z)
     1.06219328E-04   2        23        23   # BR(HH -> Z Z)
     1.40613000E-03   2       -24        24   # BR(HH -> W W)
     6.68772154E-04   2        21        21   # BR(HH -> gluon gluon)
     1.02071636E-08   2       -11        11   # BR(HH -> Electron electron)
     4.54083161E-04   2       -13        13   # BR(HH -> Muon muon)
     1.27780074E-01   2       -15        15   # BR(HH -> Tau tau)
     6.13274017E-12   2        -2         2   # BR(HH -> Up up)
     8.49610543E-07   2        -4         4   # BR(HH -> Charm charm)
     1.43422336E-06   2        -1         1   # BR(HH -> Down down)
     3.60157148E-04   2        -3         3   # BR(HH -> Strange strange)
     8.68951749E-01   2        -5         5   # BR(HH -> Bottom bottom)
     2.69837233E-04   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     1.79731761E+00   # Gamma(A0)
    -1.61285483E-07   2        22        22   # BR(A0 -> photon photon)
    -1.99507573E-07   2        22        23   # BR(A0 -> photon Z)
    -6.04640477E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.01466405E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.51390956E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.27061352E-01   2       -15        15   # BR(A0 -> Tau tau)
    -7.81374907E-13   2        -2         2   # BR(A0 -> Up up)
    -1.10160998E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.42645465E-06   2        -1         1   # BR(A0 -> Down down)
    -3.58206459E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.65234403E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -6.28709209E-03   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -1.00731688E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     3.47006081E-01   # Gamma(Hp)
     5.92930507E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     2.53496124E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     7.16942047E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     7.51527438E-06   2        -1         2   # BR(Hp -> Down up)
     8.45380376E-05   2        -3         2   # BR(Hp -> Strange up)
     4.86037503E-05   2        -5         2   # BR(Hp -> Bottom up)
     3.67677301E-07   2        -1         4   # BR(Hp -> Down charm)
     1.88117520E-03   2        -3         4   # BR(Hp -> Strange charm)
     6.80569654E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.98587471E-07   2        -1         6   # BR(Hp -> Down top)
     4.48124813E-06   2        -3         6   # BR(Hp -> Strange top)
     2.71630008E-01   2        -5         6   # BR(Hp -> Bottom top)
     4.44895844E-05   2        24        25   # BR(Hp -> W h0)
     7.40800555E-06   2        24        35   # BR(Hp -> W HH)
     8.45036590E-06   2        24        36   # BR(Hp -> W A0)
