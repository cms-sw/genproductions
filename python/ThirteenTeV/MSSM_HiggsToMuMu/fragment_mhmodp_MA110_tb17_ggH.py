...
BLOCK MASS
   ...
   2000005     1.00482428E+03   # MSf(2,4,3)
        25     1.07977745E+02   # Mh0
        35     1.27079509E+02   # MHH
        36     1.10000000E+02   # MA0
        37     1.37172592E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     1.40485654E-01   # Delta Mh0
        35     5.69269432E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     7.44643302E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.24263974E+00   # Alpha
BLOCK DALPHA
               3.94280212E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     5.74236977E-01   # UH(1,1)
     1   2     8.18689131E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1     8.18689131E-01   # UH(2,1)
     2   2    -5.74236977E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     5.11945980E-01   # Gamma(h0)
     3.78883366E-06   2        22        22   # BR(h0 -> photon photon)
     3.04972463E-09   2        22        23   # BR(h0 -> photon Z)
     2.40893765E-06   2        23        23   # BR(h0 -> Z Z)
     2.56880558E-05   2       -24        24   # BR(h0 -> W W)
     9.14891207E-04   2        21        21   # BR(h0 -> gluon gluon)
     8.91429004E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.96505891E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.12396325E-01   2       -15        15   # BR(h0 -> Tau tau)
     1.39810130E-10   2        -2         2   # BR(h0 -> Up up)
     1.93632739E-05   2        -4         4   # BR(h0 -> Charm charm)
     1.41660523E-06   2        -1         1   # BR(h0 -> Down down)
     3.55736676E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.85883864E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     6.38528909E-02   # Gamma(HH)
    -1.05821722E-04   2        22        22   # BR(HH -> photon photon)
    -1.21738979E-04   2        22        23   # BR(HH -> photon Z)
    -1.86001872E-03   2        23        23   # BR(HH -> Z Z)
    -1.47615361E-02   2       -24        24   # BR(HH -> W W)
    -8.16148292E-03   2        21        21   # BR(HH -> gluon gluon)
    -9.12528801E-09   2       -11        11   # BR(HH -> Electron electron)
     4.05911179E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.14770314E-01   2       -15        15   # BR(HH -> Tau tau)
    -1.15474462E-08   2        -2         2   # BR(HH -> Up up)
    -1.59945450E-03   2        -4         4   # BR(HH -> Charm charm)
    -1.39057900E-06   2        -1         1   # BR(HH -> Down down)
    -3.49198836E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.57860168E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -2.94375185E-06   2        23        36   # BR(HH -> Z A0)
DECAY        36     5.70916200E-01   # Gamma(A0)
     2.92499699E-07   2        22        22   # BR(A0 -> photon photon)
     7.54238142E-09   2        22        23   # BR(A0 -> photon Z)
     1.17235442E-03   2        21        21   # BR(A0 -> gluon gluon)
     8.94289810E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.97782102E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.12832547E-01   2       -15        15   # BR(A0 -> Tau tau)
     4.41441415E-12   2        -2         2   # BR(A0 -> Up up)
     6.51231063E-07   2        -4         4   # BR(A0 -> Charm charm)
     1.41413568E-06   2        -1         1   # BR(A0 -> Down down)
     3.55116619E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.85239825E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     5.43289687E-11   2        23        25   # BR(A0 -> Z h0)
DECAY        37     8.07142062E-02   # Gamma(Hp)
     8.12878082E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47530296E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.82718691E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.11803343E-05   2        -1         2   # BR(Hp -> Down up)
     1.24673980E-04   2        -3         2   # BR(Hp -> Strange up)
     7.39066085E-05   2        -5         2   # BR(Hp -> Bottom up)
     7.06153792E-07   2        -1         4   # BR(Hp -> Down charm)
     2.80209814E-03   2        -3         4   # BR(Hp -> Strange charm)
     1.03477479E-02   2        -5         4   # BR(Hp -> Bottom charm)
     1.53233705E-05   2        -5         6   # BR(Hp -> Bottom top)
     2.35485415E-04   2        24        25   # BR(Hp -> W h0)
     2.26676491E-07   2        24        35   # BR(Hp -> W HH)
     1.94576027E-04   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.38723037E+00   # Gamma(top)
     9.88498641E-01   2         5        24   # BR(top -> bottom W)
     1.15013593E-02   2         5        37   # BR(top -> bottom Hp)
"""
