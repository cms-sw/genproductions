...
BLOCK MASS
   ...
   2000005     1.00222830E+03   # MSf(2,4,3)
        25     1.22829050E+02   # Mh0
        35     2.01743039E+02   # MHH
        36     2.00000000E+02   # MA0
        37     2.15680563E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.63493457E-01   # Delta Mh0
        35     3.21988840E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     9.35333646E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.97424047E-01   # Alpha
BLOCK DALPHA
               3.50063860E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.98847775E-01   # UH(1,1)
     1   2     4.79908649E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -4.79908649E-02   # UH(2,1)
     2   2     9.98847775E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.01754405E-02   # Gamma(h0)
     8.71426325E-04   2        22        22   # BR(h0 -> photon photon)
     4.78531891E-04   2        22        23   # BR(h0 -> photon Z)
     7.91764389E-03   2        23        23   # BR(h0 -> Z Z)
     6.83246963E-02   2       -24        24   # BR(h0 -> W W)
     2.34461049E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.44240699E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.31049768E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.49142417E-02   2       -15        15   # BR(h0 -> Tau tau)
     7.58913538E-08   2        -2         2   # BR(h0 -> Up up)
     1.05114292E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.20680375E-06   2        -1         1   # BR(h0 -> Down down)
     3.03068258E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.92900518E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     3.54001005E-01   # Gamma(HH)
    -1.81338151E-06   2        22        22   # BR(HH -> photon photon)
    -4.50329968E-06   2        22        23   # BR(HH -> photon Z)
    -1.06077199E-02   2        23        23   # BR(HH -> Z Z)
    -2.97209443E-02   2       -24        24   # BR(HH -> W W)
    -9.79646133E-04   2        21        21   # BR(HH -> gluon gluon)
    -8.77895232E-09   2       -11        11   # BR(HH -> Electron electron)
     3.90559750E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.11519292E-01   2       -15        15   # BR(HH -> Tau tau)
    -1.25144473E-10   2        -2         2   # BR(HH -> Up up)
    -1.73246038E-05   2        -4         4   # BR(HH -> Charm charm)
    -1.28215354E-06   2        -1         1   # BR(HH -> Down down)
    -3.21991455E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.25360556E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -2.10743584E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
    -4.88512284E-11   2        23        36   # BR(HH -> Z A0)
DECAY        36     3.75766657E-01   # Gamma(A0)
     2.02440062E-06   2        22        22   # BR(A0 -> photon photon)
     3.19962463E-06   2        22        23   # BR(A0 -> photon Z)
     3.08441767E-04   2        21        21   # BR(A0 -> gluon gluon)
     8.39321339E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.73398378E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.06645144E-01   2       -15        15   # BR(A0 -> Tau tau)
     2.79146677E-11   2        -2         2   # BR(A0 -> Up up)
     3.89072945E-06   2        -4         4   # BR(A0 -> Charm charm)
     1.22776330E-06   2        -1         1   # BR(A0 -> Down down)
     3.08332382E-04   2        -3         3   # BR(A0 -> Strange strange)
     7.91285464E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     1.00997518E-01   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     7.13506613E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     9.57437921E-02   # Gamma(Hp)
     3.72829776E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.59396270E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     4.50817960E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     4.80482476E-06   2        -1         2   # BR(Hp -> Down up)
     5.41357827E-05   2        -3         2   # BR(Hp -> Strange up)
     3.30520348E-05   2        -5         2   # BR(Hp -> Bottom up)
     9.64855352E-07   2        -1         4   # BR(Hp -> Down charm)
     1.21899303E-03   2        -3         4   # BR(Hp -> Strange charm)
     4.62815964E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.03965320E-05   2        -1         6   # BR(Hp -> Down top)
     2.26867285E-04   2        -3         6   # BR(Hp -> Strange top)
     5.29796536E-01   2        -5         6   # BR(Hp -> Bottom top)
     1.15949804E-02   2        24        25   # BR(Hp -> W h0)
     6.82603974E-06   2        24        35   # BR(Hp -> W HH)
     1.23233520E-05   2        24        36   # BR(Hp -> W A0)
