...
BLOCK MASS
   ...
   2000005     1.00956179E+03   # MSf(2,4,3)
        25     1.25004815E+02   # Mh0
        35     2.50272714E+02   # MHH
        36     2.50000000E+02   # MA0
        37     2.64477132E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.23233456E-01   # Delta Mh0
        35     6.31557413E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.35811625E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -5.33869077E-02   # Alpha
BLOCK DALPHA
               4.67989191E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99951148E-01   # UH(1,1)
     1   2     9.88441988E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -9.88441988E-03   # UH(2,1)
     2   2     9.99951148E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     7.17786187E-03   # Gamma(h0)
     1.29157609E-03   2        22        22   # BR(h0 -> photon photon)
     8.22202295E-04   2        22        23   # BR(h0 -> photon Z)
     1.49512457E-02   2        23        23   # BR(h0 -> Z Z)
     1.23496860E-01   2       -24        24   # BR(h0 -> W W)
     3.74227433E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.10778885E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.16167035E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.99879105E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.12133209E-07   2        -2         2   # BR(h0 -> Up up)
     1.55316268E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.12050166E-06   2        -1         1   # BR(h0 -> Down down)
     2.81385847E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.15897043E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     3.35235833E+00   # Gamma(HH)
     7.54236504E-07   2        22        22   # BR(HH -> photon photon)
     5.53464150E-07   2        22        23   # BR(HH -> photon Z)
     1.44756771E-04   2        23        23   # BR(HH -> Z Z)
     3.42073258E-04   2       -24        24   # BR(HH -> W W)
     4.32877291E-04   2        21        21   # BR(HH -> gluon gluon)
     1.09583992E-08   2       -11        11   # BR(HH -> Electron electron)
     4.87551021E-04   2       -13        13   # BR(HH -> Muon muon)
     1.36531150E-01   2       -15        15   # BR(HH -> Tau tau)
     1.03990198E-12   2        -2         2   # BR(HH -> Up up)
     1.43878779E-07   2        -4         4   # BR(HH -> Charm charm)
     1.43272484E-06   2        -1         1   # BR(HH -> Down down)
     3.59778418E-04   2        -3         3   # BR(HH -> Strange strange)
     8.52815866E-01   2        -5         5   # BR(HH -> Bottom bottom)
     7.37102856E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     1.34056177E-03   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     1.71461645E-04   2        25        25   # BR(HH -> h0 h0)
DECAY        36     3.42769174E+00   # Gamma(A0)
    -2.66997710E-07   2        22        22   # BR(A0 -> photon photon)
    -9.12990220E-07   2        22        23   # BR(A0 -> photon Z)
    -3.73980166E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.06907108E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.75641470E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.33194134E-01   2       -15        15   # BR(A0 -> Tau tau)
    -3.35556411E-13   2        -2         2   # BR(A0 -> Up up)
    -4.70234153E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.39768566E-06   2        -1         1   # BR(A0 -> Down down)
    -3.50979626E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.32403275E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.55799797E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -1.75451963E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -7.41784927E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.54122453E+00   # Gamma(Hp)
     2.55608286E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.09280472E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     3.09090246E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     3.06060355E-06   2        -1         2   # BR(Hp -> Down up)
     3.46143301E-05   2        -3         2   # BR(Hp -> Strange up)
     1.95290921E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.44071766E-07   2        -1         4   # BR(Hp -> Down charm)
     7.65979678E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.73464318E-03   2        -5         4   # BR(Hp -> Bottom charm)
     2.21035269E-07   2        -1         6   # BR(Hp -> Down top)
     5.17602354E-06   2        -3         6   # BR(Hp -> Strange top)
     6.26949098E-01   2        -5         6   # BR(Hp -> Bottom top)
     5.89238287E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     3.79624038E-04   2        24        25   # BR(Hp -> W h0)
     4.78930167E-07   2        24        35   # BR(Hp -> W HH)
     5.26446091E-07   2        24        36   # BR(Hp -> W A0)
