...
BLOCK MASS
   ...
   2000005     1.01129043E+03   # MSf(2,4,3)
        25     1.25088715E+02   # Mh0
        35     2.25222043E+02   # MHH
        36     2.25000000E+02   # MA0
        37     2.41639216E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.31805625E-01   # Delta Mh0
        35     6.76176125E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     2.44663481E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -5.21969575E-02   # Alpha
BLOCK DALPHA
               5.71505465E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99922542E-01   # UH(1,1)
     1   2     1.24463222E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.24463222E-02   # UH(2,1)
     2   2     9.99922542E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     8.71852468E-03   # Gamma(h0)
     1.06766297E-03   2        22        22   # BR(h0 -> photon photon)
     6.81521324E-04   2        22        23   # BR(h0 -> photon Z)
     1.24369474E-02   2        23        23   # BR(h0 -> Z Z)
     1.02558381E-01   2       -24        24   # BR(h0 -> W W)
     3.03066174E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.63894044E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.39793637E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.62800218E-02   2       -15        15   # BR(h0 -> Tau tau)
     9.23541441E-08   2        -2         2   # BR(h0 -> Up up)
     1.27920430E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.18371505E-06   2        -1         1   # BR(h0 -> Down down)
     2.97254731E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.43238473E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     4.04681935E+00   # Gamma(HH)
    -5.88511323E-07   2        22        22   # BR(HH -> photon photon)
    -2.69094623E-07   2        22        23   # BR(HH -> photon Z)
    -1.00428764E-04   2        23        23   # BR(HH -> Z Z)
    -2.51921435E-04   2       -24        24   # BR(HH -> W W)
    -4.77735301E-04   2        21        21   # BR(HH -> gluon gluon)
    -1.12263253E-08   2       -11        11   # BR(HH -> Electron electron)
     4.99455596E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.39208879E-01   2       -15        15   # BR(HH -> Tau tau)
    -7.50666793E-13   2        -2         2   # BR(HH -> Up up)
    -1.03875939E-07   2        -4         4   # BR(HH -> Charm charm)
    -1.46503444E-06   2        -1         1   # BR(HH -> Down down)
    -3.67882879E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.55468361E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -3.62289817E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     4.06691830E+00   # Gamma(A0)
     1.32988094E-07   2        22        22   # BR(A0 -> photon photon)
     3.24596530E-07   2        22        23   # BR(A0 -> photon Z)
     4.57136947E-04   2        21        21   # BR(A0 -> gluon gluon)
     1.11501519E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.96066988E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.38277199E-01   2       -15        15   # BR(A0 -> Tau tau)
     1.87274895E-13   2        -2         2   # BR(A0 -> Up up)
     2.63573129E-08   2        -4         4   # BR(A0 -> Charm charm)
     1.45514646E-06   2        -1         1   # BR(A0 -> Down down)
     3.65400005E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.50244069E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     1.01477801E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     1.03977732E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.48650288E+00   # Gamma(Hp)
     3.29570215E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.40901482E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     3.98520407E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     3.96510477E-06   2        -1         2   # BR(Hp -> Down up)
     4.47678223E-05   2        -3         2   # BR(Hp -> Strange up)
     2.47829022E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.82712897E-07   2        -1         4   # BR(Hp -> Down charm)
     9.92240272E-04   2        -3         4   # BR(Hp -> Strange charm)
     3.47029741E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.12984987E-07   2        -1         6   # BR(Hp -> Down top)
     2.79776425E-06   2        -3         6   # BR(Hp -> Strange top)
     5.75526151E-01   2        -5         6   # BR(Hp -> Bottom top)
     1.97626915E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     2.40471042E-04   2        24        25   # BR(Hp -> W h0)
     1.00762809E-06   2        24        35   # BR(Hp -> W HH)
     1.07740709E-06   2        24        36   # BR(Hp -> W A0)
