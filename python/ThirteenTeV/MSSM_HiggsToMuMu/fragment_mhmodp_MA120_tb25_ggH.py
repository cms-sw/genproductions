...
BLOCK MASS
   ...
   2000005     1.00778084E+03   # MSf(2,4,3)
        25     1.17600825E+02   # Mh0
        35     1.27605902E+02   # MHH
        36     1.20000000E+02   # MA0
        37     1.46794042E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     2.41651115E-01   # Delta Mh0
        35     4.73991474E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.10691244E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.03476217E+00   # Alpha
BLOCK DALPHA
               9.93040905E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     6.29851030E-01   # UH(1,1)
     1   2     7.76715958E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1     7.76715958E-01   # UH(2,1)
     2   2    -6.29851030E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     9.63477839E-01   # Gamma(h0)
     4.64350414E-06   2        22        22   # BR(h0 -> photon photon)
     7.03309977E-07   2        22        23   # BR(h0 -> photon Z)
     1.22465014E-05   2        23        23   # BR(h0 -> Z Z)
     1.17073627E-04   2       -24        24   # BR(h0 -> W W)
     7.43763022E-04   2        21        21   # BR(h0 -> gluon gluon)
     9.55578840E-09   2       -11        11   # BR(h0 -> Electron electron)
     4.25050688E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.19605812E-01   2       -15        15   # BR(h0 -> Tau tau)
     1.89449466E-10   2        -2         2   # BR(h0 -> Up up)
     2.62395064E-05   2        -4         4   # BR(h0 -> Charm charm)
     1.45139717E-06   2        -1         1   # BR(h0 -> Down down)
     3.64462265E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.78698544E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     3.13683832E-01   # Gamma(HH)
    -1.55596408E-05   2        22        22   # BR(HH -> photon photon)
    -1.80857058E-05   2        22        23   # BR(HH -> photon Z)
    -3.30722630E-04   2        23        23   # BR(HH -> Z Z)
    -2.59938375E-03   2       -24        24   # BR(HH -> W W)
    -2.89741613E-03   2        21        21   # BR(HH -> gluon gluon)
    -9.78601089E-09   2       -11        11   # BR(HH -> Electron electron)
     4.35302030E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.22261966E-01   2       -15        15   # BR(HH -> Tau tau)
    -1.99542859E-09   2        -2         2   # BR(HH -> Up up)
    -2.76392578E-04   2        -4         4   # BR(HH -> Charm charm)
    -1.45196096E-06   2        -1         1   # BR(HH -> Down down)
    -3.64601824E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.70799081E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -2.42515773E-08   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.27087734E+00   # Gamma(A0)
     2.96460266E-07   2        22        22   # BR(A0 -> photon photon)
     7.99605528E-09   2        22        23   # BR(A0 -> photon Z)
     1.08107487E-03   2        21        21   # BR(A0 -> gluon gluon)
     9.60617809E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.27296031E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.20274692E-01   2       -15        15   # BR(A0 -> Tau tau)
     9.04140975E-13   2        -2         2   # BR(A0 -> Up up)
     1.32508134E-07   2        -4         4   # BR(A0 -> Charm charm)
     1.45036956E-06   2        -1         1   # BR(A0 -> Down down)
     3.64203992E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.77850836E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     4.69326851E-11   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.86630404E-01   # Gamma(Hp)
     8.13609959E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47843248E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.83645352E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.08779266E-05   2        -1         2   # BR(Hp -> Down up)
     1.21494236E-04   2        -3         2   # BR(Hp -> Strange up)
     6.98000326E-05   2        -5         2   # BR(Hp -> Bottom up)
     5.28372325E-07   2        -1         4   # BR(Hp -> Down charm)
     2.72270080E-03   2        -3         4   # BR(Hp -> Strange charm)
     9.77300040E-03   2        -5         4   # BR(Hp -> Bottom charm)
     7.03384001E-06   2        -5         6   # BR(Hp -> Bottom top)
     8.55440050E-05   2        24        25   # BR(Hp -> W h0)
     4.74125897E-06   2        24        35   # BR(Hp -> W HH)
     8.04134064E-05   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.38914546E+00   # Gamma(top)
     9.87135887E-01   2         5        24   # BR(top -> bottom W)
     1.28641129E-02   2         5        37   # BR(top -> bottom Hp)
"""
