...
BLOCK MASS
   ...
   2000005     1.00226018E+03   # MSf(2,4,3)
        25     1.15947049E+02   # Mh0
        35     1.87132208E+02   # MHH
        36     1.80000000E+02   # MA0
        37     1.96897189E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     9.24875874E-01   # Delta Mh0
        35     1.43822223E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.34601557E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -4.15582970E-01   # Alpha
BLOCK DALPHA
               8.73142537E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.94091881E-01   # UH(1,1)
     1   2     1.08541845E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.08541845E-01   # UH(2,1)
     2   2     9.94091881E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.01681242E-02   # Gamma(h0)
     7.08404226E-04   2        22        22   # BR(h0 -> photon photon)
     2.21776301E-04   2        22        23   # BR(h0 -> photon Z)
     2.92734451E-03   2        23        23   # BR(h0 -> Z Z)
     2.87981412E-02   2       -24        24   # BR(h0 -> W W)
     1.73616606E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.67165174E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.41240962E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.80647929E-02   2       -15        15   # BR(h0 -> Tau tau)
     6.49694623E-08   2        -2         2   # BR(h0 -> Up up)
     8.99793750E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.26842735E-06   2        -1         1   # BR(h0 -> Down down)
     3.18546918E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.42258814E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.18106603E-01   # Gamma(HH)
    -1.41208883E-05   2        22        22   # BR(HH -> photon photon)
    -7.56514396E-05   2        22        23   # BR(HH -> photon Z)
    -6.44006644E-02   2        23        23   # BR(HH -> Z Z)
    -2.96846111E-01   2       -24        24   # BR(HH -> W W)
    -2.71034383E-03   2        21        21   # BR(HH -> gluon gluon)
    -5.42483581E-09   2       -11        11   # BR(HH -> Electron electron)
     2.41335710E-04   2       -13        13   # BR(HH -> Muon muon)
    -6.92348078E-02   2       -15        15   # BR(HH -> Tau tau)
    -1.57736081E-09   2        -2         2   # BR(HH -> Up up)
    -2.18460185E-04   2        -4         4   # BR(HH -> Charm charm)
    -8.17088957E-07   2        -1         1   # BR(HH -> Down down)
    -2.05201859E-04   2        -3         3   # BR(HH -> Strange strange)
    -5.36606744E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -2.94455797E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
    -1.55038997E-07   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.13424369E-01   # Gamma(A0)
     9.44145157E-06   2        22        22   # BR(A0 -> photon photon)
     8.22609058E-06   2        22        23   # BR(A0 -> photon Z)
     3.89913911E-04   2        21        21   # BR(A0 -> gluon gluon)
     6.21462822E-09   2       -11        11   # BR(A0 -> Electron electron)
     2.76468516E-04   2       -13        13   # BR(A0 -> Muon muon)
     7.93474863E-02   2       -15        15   # BR(A0 -> Tau tau)
     3.53526931E-10   2        -2         2   # BR(A0 -> Up up)
     4.92142790E-05   2        -4         4   # BR(A0 -> Charm charm)
     9.42650535E-07   2        -1         1   # BR(A0 -> Down down)
     2.36735226E-04   2        -3         3   # BR(A0 -> Strange strange)
     6.20499189E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     2.98803287E-01   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     3.79088982E-04   2        23        25   # BR(A0 -> Z h0)
DECAY        37     3.45904551E-02   # Gamma(Hp)
     2.35523071E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.00693393E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.84781837E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     3.11453340E-06   2        -1         2   # BR(Hp -> Down up)
     3.50167144E-05   2        -3         2   # BR(Hp -> Strange up)
     2.18201520E-05   2        -5         2   # BR(Hp -> Bottom up)
     7.81442842E-06   2        -1         4   # BR(Hp -> Down charm)
     9.50051247E-04   2        -3         4   # BR(Hp -> Strange charm)
     3.05558117E-03   2        -5         4   # BR(Hp -> Bottom charm)
     4.32193107E-05   2        -1         6   # BR(Hp -> Down top)
     9.42317774E-04   2        -3         6   # BR(Hp -> Strange top)
     6.99248605E-01   2        -5         6   # BR(Hp -> Bottom top)
     9.85183006E-03   2        24        25   # BR(Hp -> W h0)
     3.11438911E-06   2        24        35   # BR(Hp -> W HH)
     4.87202816E-05   2        24        36   # BR(Hp -> W A0)
