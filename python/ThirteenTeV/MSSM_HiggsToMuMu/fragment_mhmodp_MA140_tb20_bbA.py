...
BLOCK MASS
   ...
   2000005     1.00594745E+03   # MSf(2,4,3)
        25     1.23262103E+02   # Mh0
        35     1.41840717E+02   # MHH
        36     1.40000000E+02   # MA0
        37     1.62737436E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.03861081E-01   # Delta Mh0
        35     2.94630895E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     2.00753662E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -3.31276802E-01   # Alpha
BLOCK DALPHA
               3.02175733E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.78086296E-01   # UH(1,1)
     1   2     2.08199899E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -2.08199899E-01   # UH(2,1)
     2   2     9.78086296E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     9.51141634E-02   # Gamma(h0)
     9.51042263E-05   2        22        22   # BR(h0 -> photon photon)
     4.89628256E-05   2        22        23   # BR(h0 -> photon Z)
     8.34851647E-04   2        23        23   # BR(h0 -> Z Z)
     7.14133673E-03   2       -24        24   # BR(h0 -> W W)
     1.82532259E-03   2        21        21   # BR(h0 -> gluon gluon)
     9.03907380E-09   2       -11        11   # BR(h0 -> Electron electron)
     4.02072414E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.13936499E-01   2       -15        15   # BR(h0 -> Tau tau)
     7.50979100E-09   2        -2         2   # BR(h0 -> Up up)
     1.04017020E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.39933172E-06   2        -1         1   # BR(h0 -> Down down)
     3.51400361E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.74322864E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     8.62467281E-01   # Gamma(HH)
     4.01435131E-07   2        22        22   # BR(HH -> photon photon)
     1.72943883E-06   2        22        23   # BR(HH -> photon Z)
     6.01318831E-05   2        23        23   # BR(HH -> Z Z)
     4.31176506E-04   2       -24        24   # BR(HH -> W W)
     1.14034259E-03   2        21        21   # BR(HH -> gluon gluon)
     9.53566309E-09   2       -11        11   # BR(HH -> Electron electron)
     4.24179536E-04   2       -13        13   # BR(HH -> Muon muon)
     1.19891693E-01   2       -15        15   # BR(HH -> Tau tau)
     1.09447059E-10   2        -2         2   # BR(HH -> Up up)
     1.51617209E-05   2        -4         4   # BR(HH -> Charm charm)
     1.42281489E-06   2        -1         1   # BR(HH -> Down down)
     3.57295186E-04   2        -3         3   # BR(HH -> Strange strange)
     8.77676457E-01   2        -5         5   # BR(HH -> Bottom bottom)
     2.43795169E-11   2        23        36   # BR(HH -> Z A0)
DECAY        36     9.50526339E-01   # Gamma(A0)
    -2.11500479E-07   2        22        22   # BR(A0 -> photon photon)
    -6.68156567E-08   2        22        23   # BR(A0 -> photon Z)
    -8.65856058E-04   2        21        21   # BR(A0 -> gluon gluon)
    -9.49219203E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.22245096E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.19437623E-01   2       -15        15   # BR(A0 -> Tau tau)
    -2.03919404E-12   2        -2         2   # BR(A0 -> Up up)
    -2.90212485E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.42095817E-06   2        -1         1   # BR(A0 -> Down down)
    -3.56829340E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.78915348E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -9.90599113E-08   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.32441987E-01   # Gamma(Hp)
     8.13452089E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47775821E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.83508209E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.07844805E-05   2        -1         2   # BR(Hp -> Down up)
     1.20742701E-04   2        -3         2   # BR(Hp -> Strange up)
     7.07635723E-05   2        -5         2   # BR(Hp -> Bottom up)
     5.87581764E-07   2        -1         4   # BR(Hp -> Down charm)
     2.70084018E-03   2        -3         4   # BR(Hp -> Strange charm)
     9.90819502E-03   2        -5         4   # BR(Hp -> Bottom charm)
     5.78396722E-05   2        -5         6   # BR(Hp -> Bottom top)
     5.94717740E-05   2        24        25   # BR(Hp -> W h0)
     3.21625775E-05   2        24        35   # BR(Hp -> W HH)
     5.25638058E-05   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.37348268E+00   # Gamma(top)
     9.98392884E-01   2         5        24   # BR(top -> bottom W)
     1.60711612E-03   2         5        37   # BR(top -> bottom Hp)
"""
