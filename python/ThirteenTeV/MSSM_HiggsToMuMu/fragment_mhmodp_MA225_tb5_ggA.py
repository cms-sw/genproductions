...
BLOCK MASS
   ...
   2000005     1.00226018E+03   # MSf(2,4,3)
        25     1.17983943E+02   # Mh0
        35     2.29816072E+02   # MHH
        36     2.25000000E+02   # MA0
        37     2.38807305E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     9.21863572E-01   # Delta Mh0
        35     9.99572906E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.21465394E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -3.15676193E-01   # Alpha
BLOCK DALPHA
               3.73991278E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.98610682E-01   # UH(1,1)
     1   2     5.26944516E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -5.26944516E-02   # UH(2,1)
     2   2     9.98610682E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     6.51611506E-03   # Gamma(h0)
     1.19081910E-03   2        22        22   # BR(h0 -> photon photon)
     4.63186359E-04   2        22        23   # BR(h0 -> photon Z)
     6.35816867E-03   2        23        23   # BR(h0 -> Z Z)
     6.03585266E-02   2       -24        24   # BR(h0 -> W W)
     3.24781865E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.19507850E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.20044309E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.20419871E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.10957939E-07   2        -2         2   # BR(h0 -> Up up)
     1.53672253E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.18913172E-06   2        -1         1   # BR(h0 -> Down down)
     2.98633504E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.91121915E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.49824158E-01   # Gamma(HH)
     8.28114283E-06   2        22        22   # BR(HH -> photon photon)
     2.37710010E-05   2        22        23   # BR(HH -> photon Z)
     7.48351138E-02   2        23        23   # BR(HH -> Z Z)
     1.85169140E-01   2       -24        24   # BR(HH -> W W)
     2.40690094E-03   2        21        21   # BR(HH -> gluon gluon)
     5.64558773E-09   2       -11        11   # BR(HH -> Electron electron)
     2.51171830E-04   2       -13        13   # BR(HH -> Muon muon)
     7.20612918E-02   2       -15        15   # BR(HH -> Tau tau)
     8.60116840E-10   2        -2         2   # BR(HH -> Up up)
     1.19019398E-04   2        -4         4   # BR(HH -> Charm charm)
     8.22583998E-07   2        -1         1   # BR(HH -> Down down)
     2.06583070E-04   2        -3         3   # BR(HH -> Strange strange)
     5.39828927E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.24926945E-01   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     1.62008065E-04   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     1.81884202E-08   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.73308605E-01   # Gamma(A0)
    -1.78457748E-05   2        22        22   # BR(A0 -> photon photon)
    -2.21547799E-05   2        22        23   # BR(A0 -> photon Z)
    -5.66185643E-04   2        21        21   # BR(A0 -> gluon gluon)
    -5.07193379E-09   2       -11        11   # BR(A0 -> Electron electron)
     2.25648775E-04   2       -13        13   # BR(A0 -> Muon muon)
    -6.47484527E-02   2       -15        15   # BR(A0 -> Tau tau)
    -2.74097237E-10   2        -2         2   # BR(A0 -> Up up)
    -3.80740240E-05   2        -4         4   # BR(A0 -> Charm charm)
    -7.41667739E-07   2        -1         1   # BR(A0 -> Down down)
    -1.86261900E-04   2        -3         3   # BR(A0 -> Strange strange)
    -4.87400917E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -4.32090699E-01   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -1.47030134E-02   2        23        25   # BR(A0 -> Z h0)
DECAY        37     2.28454886E-01   # Gamma(Hp)
     4.32511213E-09   2       -11        12   # BR(Hp -> Electron nu_e)
     1.84911948E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     5.22996593E-02   2       -15        16   # BR(Hp -> Tau nu_tau)
     5.53909131E-07   2        -1         2   # BR(Hp -> Down up)
     6.25075892E-06   2        -3         2   # BR(Hp -> Strange up)
     3.89618219E-06   2        -5         2   # BR(Hp -> Bottom up)
     1.39497488E-06   2        -1         4   # BR(Hp -> Down charm)
     1.68968274E-04   2        -3         4   # BR(Hp -> Strange charm)
     5.45616999E-04   2        -5         4   # BR(Hp -> Bottom charm)
     3.38681778E-05   2        -1         6   # BR(Hp -> Down top)
     7.38468180E-04   2        -3         6   # BR(Hp -> Strange top)
     6.02140810E-01   2        -5         6   # BR(Hp -> Bottom top)
     2.98611228E-01   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     4.52612555E-02   2        24        25   # BR(Hp -> W h0)
     3.28444846E-07   2        24        35   # BR(Hp -> W HH)
     2.78436012E-06   2        24        36   # BR(Hp -> W A0)
