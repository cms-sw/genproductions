...
BLOCK MASS
   ...
   2000005     1.00594745E+03   # MSf(2,4,3)
        25     1.08468242E+02   # Mh0
        35     1.26653809E+02   # MHH
        36     1.10000000E+02   # MA0
        37     1.37695116E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     1.12279852E-01   # Delta Mh0
        35     5.97817639E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     3.37372837E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.27422638E+00   # Alpha
BLOCK DALPHA
               3.80042371E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     5.17927180E-01   # UH(1,1)
     1   2     8.55424711E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1     8.55424711E-01   # UH(2,1)
     2   2    -5.17927180E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     7.12608138E-01   # Gamma(h0)
     2.73805029E-06   2        22        22   # BR(h0 -> photon photon)
     5.76019404E-10   2        22        23   # BR(h0 -> photon Z)
     1.52637363E-06   2        23        23   # BR(h0 -> Z Z)
     1.62561343E-05   2       -24        24   # BR(h0 -> W W)
     9.47963478E-04   2        21        21   # BR(h0 -> gluon gluon)
     9.12134439E-09   2       -11        11   # BR(h0 -> Electron electron)
     4.05716204E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.14668961E-01   2       -15        15   # BR(h0 -> Tau tau)
     8.16299370E-11   2        -2         2   # BR(h0 -> Up up)
     1.13054991E-05   2        -4         4   # BR(h0 -> Charm charm)
     1.43162746E-06   2        -1         1   # BR(h0 -> Down down)
     3.59504061E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.83584588E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     6.96753830E-02   # Gamma(HH)
    -9.89240411E-05   2        22        22   # BR(HH -> photon photon)
    -1.06437475E-04   2        22        23   # BR(HH -> photon Z)
    -1.67010962E-03   2        23        23   # BR(HH -> Z Z)
    -1.33606902E-02   2       -24        24   # BR(HH -> W W)
    -7.76682662E-03   2        21        21   # BR(HH -> gluon gluon)
    -9.36662913E-09   2       -11        11   # BR(HH -> Electron electron)
     4.16646122E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.17423328E-01   2       -15        15   # BR(HH -> Tau tau)
    -1.07660718E-08   2        -2         2   # BR(HH -> Up up)
    -1.49122513E-03   2        -4         4   # BR(HH -> Charm charm)
    -1.40995083E-06   2        -1         1   # BR(HH -> Down down)
    -3.54057981E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.57308391E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -1.93378559E-06   2        23        36   # BR(HH -> Z A0)
DECAY        36     7.77173468E-01   # Gamma(A0)
     3.11142231E-07   2        22        22   # BR(A0 -> photon photon)
     4.68415593E-09   2        22        23   # BR(A0 -> photon Z)
     1.19046885E-03   2        21        21   # BR(A0 -> gluon gluon)
     9.14106009E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.06596400E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.14996713E-01   2       -15        15   # BR(A0 -> Tau tau)
     2.34644130E-12   2        -2         2   # BR(A0 -> Up up)
     3.48998900E-07   2        -4         4   # BR(A0 -> Charm charm)
     1.42906061E-06   2        -1         1   # BR(A0 -> Down down)
     3.58859567E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.83045259E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     1.03327526E-11   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.12104978E-01   # Gamma(Hp)
     8.13137207E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47641083E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.83034457E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.11090163E-05   2        -1         2   # BR(Hp -> Down up)
     1.23888662E-04   2        -3         2   # BR(Hp -> Strange up)
     7.25696692E-05   2        -5         2   # BR(Hp -> Bottom up)
     6.02861430E-07   2        -1         4   # BR(Hp -> Down charm)
     2.78197693E-03   2        -3         4   # BR(Hp -> Strange charm)
     1.01605745E-02   2        -5         4   # BR(Hp -> Bottom charm)
     8.35600177E-06   2        -5         6   # BR(Hp -> Bottom top)
     1.76059915E-04   2        24        25   # BR(Hp -> W h0)
     2.05372815E-07   2        24        35   # BR(Hp -> W HH)
     1.53707983E-04   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.39166778E+00   # Gamma(top)
     9.85346757E-01   2         5        24   # BR(top -> bottom W)
     1.46532428E-02   2         5        37   # BR(top -> bottom Hp)
"""
