...
BLOCK MASS
   ...
   2000005     1.00257434E+03   # MSf(2,4,3)
        25     1.20171339E+02   # Mh0
        35     1.44592273E+02   # MHH
        36     1.40000000E+02   # MA0
        37     1.61581218E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.06705067E-01   # Delta Mh0
        35     8.49009840E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.17769863E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -4.79612173E-01   # Alpha
BLOCK DALPHA
               3.19334239E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.64638600E-01   # UH(1,1)
     1   2     2.63576121E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -2.63576121E-01   # UH(2,1)
     2   2     9.64638600E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     5.93205238E-02   # Gamma(h0)
     1.30433619E-04   2        22        22   # BR(h0 -> photon photon)
     5.14019328E-05   2        22        23   # BR(h0 -> photon Z)
     8.23373428E-04   2        23        23   # BR(h0 -> Z Z)
     7.49549055E-03   2       -24        24   # BR(h0 -> W W)
     2.46362630E-03   2        21        21   # BR(h0 -> gluon gluon)
     8.47693979E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.77064897E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.07698508E-01   2       -15        15   # BR(h0 -> Tau tau)
     1.04468534E-08   2        -2         2   # BR(h0 -> Up up)
     1.44694013E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.35953311E-06   2        -1         1   # BR(h0 -> Down down)
     3.41418228E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.79170364E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.47602578E-01   # Gamma(HH)
     4.73081262E-06   2        22        22   # BR(HH -> photon photon)
     1.70533257E-05   2        22        23   # BR(HH -> photon Z)
     5.07281396E-04   2        23        23   # BR(HH -> Z Z)
     3.79854852E-03   2       -24        24   # BR(HH -> W W)
     1.93366961E-03   2        21        21   # BR(HH -> gluon gluon)
     8.92984506E-09   2       -11        11   # BR(HH -> Electron electron)
     3.97232927E-04   2       -13        13   # BR(HH -> Muon muon)
     1.13254038E-01   2       -15        15   # BR(HH -> Tau tau)
     7.82030574E-10   2        -2         2   # BR(HH -> Up up)
     1.08335945E-04   2        -4         4   # BR(HH -> Charm charm)
     1.37362534E-06   2        -1         1   # BR(HH -> Down down)
     3.44956608E-04   2        -3         3   # BR(HH -> Strange strange)
     8.79632762E-01   2        -5         5   # BR(HH -> Bottom bottom)
     7.40856432E-09   2        23        36   # BR(HH -> Z A0)
DECAY        36     3.01970164E-01   # Gamma(A0)
    -4.71366810E-07   2        22        22   # BR(A0 -> photon photon)
    -3.24508448E-07   2        22        23   # BR(A0 -> photon Z)
    -7.46551251E-04   2        21        21   # BR(A0 -> gluon gluon)
    -8.89657063E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.95749804E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.12929164E-01   2       -15        15   # BR(A0 -> Tau tau)
    -2.21489720E-11   2        -2         2   # BR(A0 -> Up up)
    -3.11999885E-06   2        -4         4   # BR(A0 -> Charm charm)
    -1.37826473E-06   2        -1         1   # BR(A0 -> Down down)
    -3.46122048E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.85575790E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.31973204E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     3.98450123E-02   # Gamma(Hp)
     8.12105568E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47200138E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.81876829E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.09775879E-05   2        -1         2   # BR(Hp -> Down up)
     1.22887239E-04   2        -3         2   # BR(Hp -> Strange up)
     7.46773741E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.65339517E-06   2        -1         4   # BR(Hp -> Down charm)
     2.77287549E-03   2        -3         4   # BR(Hp -> Strange charm)
     1.04562035E-02   2        -5         4   # BR(Hp -> Bottom charm)
     5.75435809E-04   2        -5         6   # BR(Hp -> Bottom top)
     4.64983699E-04   2        24        25   # BR(Hp -> W h0)
     3.60848515E-05   2        24        35   # BR(Hp -> W HH)
     1.35309943E-04   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.37253493E+00   # Gamma(top)
     9.99082288E-01   2         5        24   # BR(top -> bottom W)
     9.17711591E-04   2         5        37   # BR(top -> bottom Hp)
"""
