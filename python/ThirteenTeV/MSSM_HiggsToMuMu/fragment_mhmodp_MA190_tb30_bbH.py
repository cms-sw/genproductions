...
BLOCK MASS
   ...
   2000005     1.00956179E+03   # MSf(2,4,3)
        25     1.24917391E+02   # Mh0
        35     1.90332757E+02   # MHH
        36     1.90000000E+02   # MA0
        37     2.08727603E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.28455774E-01   # Delta Mh0
        35     8.57492447E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.90092357E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -7.89365209E-02   # Alpha
BLOCK DALPHA
               1.43672362E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99667364E-01   # UH(1,1)
     1   2     2.57907091E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -2.57907091E-02   # UH(2,1)
     2   2     9.99667364E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.35549999E-02   # Gamma(h0)
     6.89067002E-04   2        22        22   # BR(h0 -> photon photon)
     4.32358489E-04   2        22        23   # BR(h0 -> photon Z)
     7.81795610E-03   2        23        23   # BR(h0 -> Z Z)
     6.46881199E-02   2       -24        24   # BR(h0 -> W W)
     1.84859381E-02   2        21        21   # BR(h0 -> gluon gluon)
     8.25965207E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.67403902E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.04005973E-01   2       -15        15   # BR(h0 -> Tau tau)
     5.91518428E-08   2        -2         2   # BR(h0 -> Up up)
     8.19314879E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.27349954E-06   2        -1         1   # BR(h0 -> Down down)
     3.19800116E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.94998894E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.62771232E+00   # Gamma(HH)
    -5.18433662E-07   2        22        22   # BR(HH -> photon photon)
    -1.25281160E-07   2        22        23   # BR(HH -> photon Z)
    -1.79110546E-04   2        23        23   # BR(HH -> Z Z)
    -6.50161310E-04   2       -24        24   # BR(HH -> W W)
    -6.01773853E-04   2        21        21   # BR(HH -> gluon gluon)
    -1.06378638E-08   2       -11        11   # BR(HH -> Electron electron)
     4.73251180E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.32538747E-01   2       -15        15   # BR(HH -> Tau tau)
    -2.41700040E-12   2        -2         2   # BR(HH -> Up up)
    -3.34736528E-07   2        -4         4   # BR(HH -> Charm charm)
    -1.45399415E-06   2        -1         1   # BR(HH -> Down down)
    -3.65115179E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.64179382E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -1.01001583E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     2.64627833E+00   # Gamma(A0)
     1.44305618E-07   2        22        22   # BR(A0 -> photon photon)
     1.71571041E-07   2        22        23   # BR(A0 -> photon Z)
     5.71535081E-04   2        21        21   # BR(A0 -> gluon gluon)
     1.05608655E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.69826078E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.31611813E-01   2       -15        15   # BR(A0 -> Tau tau)
     3.68076250E-13   2        -2         2   # BR(A0 -> Up up)
     5.19507884E-08   2        -4         4   # BR(A0 -> Charm charm)
     1.44388011E-06   2        -1         1   # BR(A0 -> Down down)
     3.62575561E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.58998743E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     7.98287135E-03   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     8.13962123E-07   2        23        25   # BR(A0 -> Z h0)
DECAY        37     6.13509593E-01   # Gamma(Hp)
     5.06770403E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     2.16660027E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     6.12770527E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     6.30848115E-06   2        -1         2   # BR(Hp -> Down up)
     7.10283259E-05   2        -3         2   # BR(Hp -> Strange up)
     4.00615366E-05   2        -5         2   # BR(Hp -> Bottom up)
     2.95625667E-07   2        -1         4   # BR(Hp -> Down charm)
     1.57878304E-03   2        -3         4   # BR(Hp -> Strange charm)
     5.60962389E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.34874845E-07   2        -1         6   # BR(Hp -> Down top)
     3.15581399E-06   2        -3         6   # BR(Hp -> Strange top)
     3.77689564E-01   2        -5         6   # BR(Hp -> Bottom top)
     5.50776555E-05   2        24        25   # BR(Hp -> W h0)
     4.19621625E-06   2        24        35   # BR(Hp -> W HH)
     4.59286414E-06   2        24        36   # BR(Hp -> W A0)
