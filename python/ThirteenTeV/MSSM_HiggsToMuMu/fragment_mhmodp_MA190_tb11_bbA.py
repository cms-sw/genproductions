...
BLOCK MASS
   ...
   2000005     1.00257434E+03   # MSf(2,4,3)
        25     1.23050454E+02   # Mh0
        35     1.91637737E+02   # MHH
        36     1.90000000E+02   # MA0
        37     2.06499150E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.54433494E-01   # Delta Mh0
        35     2.94669072E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     8.95390164E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.97202169E-01   # Alpha
BLOCK DALPHA
               4.15768144E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.98506481E-01   # UH(1,1)
     1   2     5.46333930E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -5.46333930E-02   # UH(2,1)
     2   2     9.98506481E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.19939132E-02   # Gamma(h0)
     7.44055025E-04   2        22        22   # BR(h0 -> photon photon)
     4.12946171E-04   2        22        23   # BR(h0 -> photon Z)
     6.90074648E-03   2        23        23   # BR(h0 -> Z Z)
     5.92827622E-02   2       -24        24   # BR(h0 -> W W)
     1.96304382E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.62880047E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.39341023E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.71967262E-02   2       -15        15   # BR(h0 -> Tau tau)
     6.43796447E-08   2        -2         2   # BR(h0 -> Up up)
     8.91702389E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.23200403E-06   2        -1         1   # BR(h0 -> Down down)
     3.09395691E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.06265261E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     3.98853608E-01   # Gamma(HH)
     1.42694118E-06   2        22        22   # BR(HH -> photon photon)
     4.17665715E-06   2        22        23   # BR(HH -> photon Z)
     7.08230741E-03   2        23        23   # BR(HH -> Z Z)
     2.41616479E-02   2       -24        24   # BR(HH -> W W)
     9.49414778E-04   2        21        21   # BR(HH -> gluon gluon)
     8.96535858E-09   2       -11        11   # BR(HH -> Electron electron)
     3.98846488E-04   2       -13        13   # BR(HH -> Muon muon)
     1.13772881E-01   2       -15        15   # BR(HH -> Tau tau)
     1.06031931E-10   2        -2         2   # BR(HH -> Up up)
     1.46834366E-05   2        -4         4   # BR(HH -> Charm charm)
     1.31540653E-06   2        -1         1   # BR(HH -> Down down)
     3.30340466E-04   2        -3         3   # BR(HH -> Strange strange)
     8.43383822E-01   2        -5         5   # BR(HH -> Bottom bottom)
     9.89912844E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     3.16971520E-11   2        23        36   # BR(HH -> Z A0)
DECAY        36     4.18000171E-01   # Gamma(A0)
    -1.25697027E-06   2        22        22   # BR(A0 -> photon photon)
    -1.98646777E-06   2        22        23   # BR(A0 -> photon Z)
    -3.84814996E-04   2        21        21   # BR(A0 -> gluon gluon)
    -8.69341453E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.86747854E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.10354047E-01   2       -15        15   # BR(A0 -> Tau tau)
    -1.98343547E-11   2        -2         2   # BR(A0 -> Up up)
    -2.76844788E-06   2        -4         4   # BR(A0 -> Charm charm)
    -1.27757428E-06   2        -1         1   # BR(A0 -> Down down)
    -3.20839737E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.20185046E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -6.83286197E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -3.25866240E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     8.76015745E-02   # Gamma(Hp)
     4.72065140E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     2.01822451E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     5.70804241E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     6.11555625E-06   2        -1         2   # BR(Hp -> Down up)
     6.88460380E-05   2        -3         2   # BR(Hp -> Strange up)
     4.18585744E-05   2        -5         2   # BR(Hp -> Bottom up)
     9.26339406E-07   2        -1         4   # BR(Hp -> Down charm)
     1.54483167E-03   2        -3         4   # BR(Hp -> Strange charm)
     5.86126107E-03   2        -5         4   # BR(Hp -> Bottom charm)
     6.30808135E-06   2        -1         6   # BR(Hp -> Down top)
     1.37702085E-04   2        -3         6   # BR(Hp -> Strange top)
     4.17727329E-01   2        -5         6   # BR(Hp -> Bottom top)
     1.75492180E-03   2        24        25   # BR(Hp -> W h0)
     1.01717501E-05   2        24        35   # BR(Hp -> W HH)
     1.72161829E-05   2        24        36   # BR(Hp -> W A0)
