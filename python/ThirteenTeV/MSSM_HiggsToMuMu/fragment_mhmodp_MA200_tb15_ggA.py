...
BLOCK MASS
   ...
   2000005     1.00406865E+03   # MSf(2,4,3)
        25     1.24063869E+02   # Mh0
        35     2.00869581E+02   # MHH
        36     2.00000000E+02   # MA0
        37     2.16065516E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.30840392E-01   # Delta Mh0
        35     1.78654649E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     5.51896292E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.35951163E-01   # Alpha
BLOCK DALPHA
               2.37956220E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99379680E-01   # UH(1,1)
     1   2     3.52172649E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -3.52172649E-02   # UH(2,1)
     2   2     9.99379680E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.08200328E-02   # Gamma(h0)
     8.45398283E-04   2        22        22   # BR(h0 -> photon photon)
     5.03757258E-04   2        22        23   # BR(h0 -> photon Z)
     8.76984208E-03   2        23        23   # BR(h0 -> Z Z)
     7.38128674E-02   2       -24        24   # BR(h0 -> W W)
     2.29932607E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.55792324E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.36189117E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.61159246E-02   2       -15        15   # BR(h0 -> Tau tau)
     7.30441898E-08   2        -2         2   # BR(h0 -> Up up)
     1.01172522E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.21060322E-06   2        -1         1   # BR(h0 -> Down down)
     3.04018742E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.86200198E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     7.49852876E-01   # Gamma(HH)
     9.49836894E-07   2        22        22   # BR(HH -> photon photon)
     9.77730124E-07   2        22        23   # BR(HH -> photon Z)
     2.45466367E-03   2        23        23   # BR(HH -> Z Z)
     6.93200170E-03   2       -24        24   # BR(HH -> W W)
     7.11813200E-04   2        21        21   # BR(HH -> gluon gluon)
     9.50832450E-09   2       -11        11   # BR(HH -> Electron electron)
     4.23007654E-04   2       -13        13   # BR(HH -> Muon muon)
     1.20199699E-01   2       -15        15   # BR(HH -> Tau tau)
     2.74243836E-11   2        -2         2   # BR(HH -> Up up)
     3.79667385E-06   2        -4         4   # BR(HH -> Charm charm)
     1.36354209E-06   2        -1         1   # BR(HH -> Down down)
     3.42423685E-04   2        -3         3   # BR(HH -> Strange strange)
     8.60137516E-01   2        -5         5   # BR(HH -> Bottom bottom)
     8.79177824E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     7.73054188E-01   # Gamma(A0)
    -6.15980062E-07   2        22        22   # BR(A0 -> photon photon)
    -1.26232906E-06   2        22        23   # BR(A0 -> photon Z)
    -4.31263552E-04   2        21        21   # BR(A0 -> gluon gluon)
    -9.25939807E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.11933324E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.17078914E-01   2       -15        15   # BR(A0 -> Tau tau)
    -5.82142283E-12   2        -2         2   # BR(A0 -> Up up)
    -8.13402836E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.32887973E-06   2        -1         1   # BR(A0 -> Down down)
    -3.33719121E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.39123520E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -4.26007634E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -1.58570070E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.89152826E-01   # Gamma(Hp)
     4.25368520E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.81858210E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     5.14346959E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     5.42511062E-06   2        -1         2   # BR(Hp -> Down up)
     6.11265816E-05   2        -3         2   # BR(Hp -> Strange up)
     3.65684780E-05   2        -5         2   # BR(Hp -> Bottom up)
     4.12324950E-07   2        -1         4   # BR(Hp -> Down charm)
     1.36130342E-03   2        -3         4   # BR(Hp -> Strange charm)
     5.12053717E-03   2        -5         4   # BR(Hp -> Bottom charm)
     2.37283761E-06   2        -1         6   # BR(Hp -> Down top)
     5.19696723E-05   2        -3         6   # BR(Hp -> Strange top)
     4.74512446E-01   2        -5         6   # BR(Hp -> Bottom top)
     2.66990482E-03   2        24        25   # BR(Hp -> W h0)
     5.31854994E-06   2        24        35   # BR(Hp -> W HH)
     7.03144559E-06   2        24        36   # BR(Hp -> W A0)
