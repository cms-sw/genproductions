...
BLOCK MASS
   ...
   2000005     1.00406865E+03   # MSf(2,4,3)
        25     1.24351888E+02   # Mh0
        35     2.75604689E+02   # MHH
        36     2.75000000E+02   # MA0
        37     2.87043663E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.25274716E-01   # Delta Mh0
        35     1.16309998E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     4.85262583E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -9.51041948E-02   # Alpha
BLOCK DALPHA
               6.84244086E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99923632E-01   # UH(1,1)
     1   2     1.23583693E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.23583693E-02   # UH(2,1)
     2   2     9.99923632E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     6.10915708E-03   # Gamma(h0)
     1.49821637E-03   2        22        22   # BR(h0 -> photon photon)
     9.17603422E-04   2        22        23   # BR(h0 -> photon Z)
     1.61751082E-02   2        23        23   # BR(h0 -> Z Z)
     1.35355700E-01   2       -24        24   # BR(h0 -> W W)
     4.37494868E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.58003297E-09   2       -11        11   # BR(h0 -> Electron electron)
     2.92691122E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.39178363E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.30813362E-07   2        -2         2   # BR(h0 -> Up up)
     1.81188124E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.06573149E-06   2        -1         1   # BR(h0 -> Down down)
     2.67639724E-04   2        -3         3   # BR(h0 -> Strange strange)
     6.99705702E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.05102151E+00   # Gamma(HH)
    -2.22103714E-06   2        22        22   # BR(HH -> photon photon)
    -2.70635278E-06   2        22        23   # BR(HH -> photon Z)
    -1.42143437E-03   2        23        23   # BR(HH -> Z Z)
    -3.24669176E-03   2       -24        24   # BR(HH -> W W)
    -5.08440486E-04   2        21        21   # BR(HH -> gluon gluon)
    -9.33392098E-09   2       -11        11   # BR(HH -> Electron electron)
     4.15288187E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.17979366E-01   2       -15        15   # BR(HH -> Tau tau)
    -1.21209723E-11   2        -2         2   # BR(HH -> Up up)
    -1.67701891E-06   2        -4         4   # BR(HH -> Charm charm)
    -1.27215944E-06   2        -1         1   # BR(HH -> Down down)
    -3.19478109E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.02021716E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -3.48011239E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
    -2.63949012E-02   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
    -1.28836745E-02   2        25        25   # BR(HH -> h0 h0)
DECAY        36     1.16939301E+00   # Gamma(A0)
     3.43087971E-06   2        22        22   # BR(A0 -> photon photon)
     8.38823926E-06   2        22        23   # BR(A0 -> photon Z)
     1.85515334E-04   2        21        21   # BR(A0 -> gluon gluon)
     8.38267351E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.72964883E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.05947345E-01   2       -15        15   # BR(A0 -> Tau tau)
     4.80245496E-12   2        -2         2   # BR(A0 -> Up up)
     6.68564509E-07   2        -4         4   # BR(A0 -> Charm charm)
     1.14265766E-06   2        -1         1   # BR(A0 -> Down down)
     2.86956309E-04   2        -3         3   # BR(A0 -> Strange strange)
     7.20743230E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     6.13673218E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     1.09969758E-01   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
     1.11326922E-03   2        23        25   # BR(A0 -> Z h0)
     8.39922026E-35   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     6.52567633E-01   # Gamma(Hp)
     1.63800475E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     7.00297881E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     1.98075816E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.99464653E-06   2        -1         2   # BR(Hp -> Down up)
     2.25937331E-05   2        -3         2   # BR(Hp -> Strange up)
     1.35208590E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.52409074E-07   2        -1         4   # BR(Hp -> Down charm)
     5.00525023E-04   2        -3         4   # BR(Hp -> Strange charm)
     1.89333021E-03   2        -5         4   # BR(Hp -> Bottom charm)
     2.77626888E-06   2        -1         6   # BR(Hp -> Down top)
     6.08169861E-05   2        -3         6   # BR(Hp -> Strange top)
     5.73053216E-01   2        -5         6   # BR(Hp -> Bottom top)
     2.22457481E-01   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     3.21657178E-03   2        24        25   # BR(Hp -> W h0)
     3.88763569E-07   2        24        35   # BR(Hp -> W HH)
     5.02390012E-07   2        24        36   # BR(Hp -> W A0)
