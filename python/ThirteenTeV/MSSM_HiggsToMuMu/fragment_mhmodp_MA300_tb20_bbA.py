...
BLOCK MASS
   ...
   2000005     1.00594745E+03   # MSf(2,4,3)
        25     1.24731788E+02   # Mh0
        35     3.00472212E+02   # MHH
        36     3.00000000E+02   # MA0
        37     3.11539111E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.15096350E-01   # Delta Mh0
        35     7.34570436E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.80637531E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -6.78356901E-02   # Alpha
BLOCK DALPHA
               4.01330463E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99969615E-01   # UH(1,1)
     1   2     7.79544992E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -7.79544992E-03   # UH(2,1)
     2   2     9.99969615E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     5.67974117E-03   # Gamma(h0)
     1.62117529E-03   2        22        22   # BR(h0 -> photon photon)
     1.01736907E-03   2        22        23   # BR(h0 -> photon Z)
     1.82607393E-02   2        23        23   # BR(h0 -> Z Z)
     1.51653343E-01   2       -24        24   # BR(h0 -> W W)
     4.79402652E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.42311784E-09   2       -11        11   # BR(h0 -> Electron electron)
     2.85711514E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.18254502E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.41403428E-07   2        -2         2   # BR(h0 -> Up up)
     1.95857530E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.03628354E-06   2        -1         1   # BR(h0 -> Down down)
     2.60243023E-04   2        -3         3   # BR(h0 -> Strange strange)
     6.77548767E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.94529079E+00   # Gamma(HH)
     2.05642575E-06   2        22        22   # BR(HH -> photon photon)
     3.02619409E-06   2        22        23   # BR(HH -> photon Z)
     4.29315107E-04   2        23        23   # BR(HH -> Z Z)
     9.61464507E-04   2       -24        24   # BR(HH -> W W)
     3.99269183E-04   2        21        21   # BR(HH -> gluon gluon)
     9.86423630E-09   2       -11        11   # BR(HH -> Electron electron)
     4.38894511E-04   2       -13        13   # BR(HH -> Muon muon)
     1.24053472E-01   2       -15        15   # BR(HH -> Tau tau)
     3.43676196E-12   2        -2         2   # BR(HH -> Up up)
     4.75501090E-07   2        -4         4   # BR(HH -> Charm charm)
     1.30107088E-06   2        -1         1   # BR(HH -> Down down)
     3.26733075E-04   2        -3         3   # BR(HH -> Strange strange)
     8.04362335E-01   2        -5         5   # BR(HH -> Bottom bottom)
     3.11437341E-03   2  -1000024   1000024   # BR(HH -> Chargino1 chargino1)
     2.34897382E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     2.82019326E-02   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     9.55873730E-03   2   1000022   1000025   # BR(HH -> neutralino1 neutralino3)
     4.65686566E-03   2        25        25   # BR(HH -> h0 h0)
DECAY        36     2.23859390E+00   # Gamma(A0)
    -5.47072480E-06   2        22        22   # BR(A0 -> photon photon)
    -1.45877890E-05   2        22        23   # BR(A0 -> photon Z)
    -1.78092035E-04   2        21        21   # BR(A0 -> gluon gluon)
    -8.55966148E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.80849436E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.07618324E-01   2       -15        15   # BR(A0 -> Tau tau)
    -1.40043138E-12   2        -2         2   # BR(A0 -> Up up)
    -1.95283574E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.12878244E-06   2        -1         1   # BR(A0 -> Down down)
    -2.83466966E-04   2        -3         3   # BR(A0 -> Strange strange)
    -6.98131266E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -8.33309634E-02   2  -1000024   1000024   # BR(A0 -> Chargino1 chargino1)
    -3.47210745E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -7.48283845E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -9.08664471E-05   2   1000022   1000025   # BR(A0 -> neutralino1 neutralino3)
    -4.15321248E-04   2        23        25   # BR(A0 -> Z h0)
    -3.90202527E-35   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     1.23838899E+00   # Gamma(Hp)
     1.66542734E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     7.12021919E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.01394226E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.98181709E-06   2        -1         2   # BR(Hp -> Down up)
     2.24809702E-05   2        -3         2   # BR(Hp -> Strange up)
     1.31879283E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.09411215E-07   2        -1         4   # BR(Hp -> Down charm)
     4.96367175E-04   2        -3         4   # BR(Hp -> Strange charm)
     1.84671991E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.04226633E-06   2        -1         6   # BR(Hp -> Down top)
     2.30632348E-05   2        -3         6   # BR(Hp -> Strange top)
     6.30214072E-01   2        -5         6   # BR(Hp -> Bottom top)
     1.54051649E-01   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     1.01640466E-02   2   1000023   1000024   # BR(Hp -> neutralino2 chargino1)
     1.05862469E-03   2        24        25   # BR(Hp -> W h0)
     1.74753764E-07   2        24        35   # BR(Hp -> W HH)
     2.15130537E-07   2        24        36   # BR(Hp -> W A0)
