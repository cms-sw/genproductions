...
BLOCK MASS
   ...
   2000005     1.00173863E+03   # MSf(2,4,3)
        25     1.21396096E+02   # Mh0
        35     1.92863061E+02   # MHH
        36     1.90000000E+02   # MA0
        37     2.06292854E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.97981397E-01   # Delta Mh0
        35     5.39492860E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.10303155E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -2.61377544E-01   # Alpha
BLOCK DALPHA
               5.35466986E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.97651186E-01   # UH(1,1)
     1   2     6.84989802E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -6.84989802E-02   # UH(2,1)
     2   2     9.97651186E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.10547238E-02   # Gamma(h0)
     7.70636118E-04   2        22        22   # BR(h0 -> photon photon)
     3.80965284E-04   2        22        23   # BR(h0 -> photon Z)
     5.97683063E-03   2        23        23   # BR(h0 -> Z Z)
     5.30945242E-02   2       -24        24   # BR(h0 -> W W)
     2.00756781E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.56598560E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.36545541E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.65683966E-02   2       -15        15   # BR(h0 -> Tau tau)
     6.75401040E-08   2        -2         2   # BR(h0 -> Up up)
     9.35456697E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.23313191E-06   2        -1         1   # BR(h0 -> Down down)
     3.09681251E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.13130867E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.28318725E-01   # Gamma(HH)
    -3.22031875E-06   2        22        22   # BR(HH -> photon photon)
    -1.39358113E-05   2        22        23   # BR(HH -> photon Z)
    -2.20931261E-02   2        23        23   # BR(HH -> Z Z)
    -7.20171897E-02   2       -24        24   # BR(HH -> W W)
    -1.34537719E-03   2        21        21   # BR(HH -> gluon gluon)
    -8.10605502E-09   2       -11        11   # BR(HH -> Electron electron)
     3.60618893E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.03166346E-01   2       -15        15   # BR(HH -> Tau tau)
    -3.29979304E-10   2        -2         2   # BR(HH -> Up up)
    -4.56931009E-05   2        -4         4   # BR(HH -> Charm charm)
    -1.20159676E-06   2        -1         1   # BR(HH -> Down down)
    -3.01763002E-04   2        -3         3   # BR(HH -> Strange strange)
    -7.79854203E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -2.07973151E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
    -8.89227812E-10   2        23        36   # BR(HH -> Z A0)
DECAY        36     2.42845160E-01   # Gamma(A0)
     3.17193155E-06   2        22        22   # BR(A0 -> photon photon)
     4.05729098E-06   2        22        23   # BR(A0 -> photon Z)
     2.77791375E-04   2        21        21   # BR(A0 -> gluon gluon)
     7.87466731E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.50323875E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.00252913E-01   2       -15        15   # BR(A0 -> Tau tau)
     6.58673624E-11   2        -2         2   # BR(A0 -> Up up)
     9.17840147E-06   2        -4         4   # BR(A0 -> Charm charm)
     1.17053813E-06   2        -1         1   # BR(A0 -> Down down)
     2.93963236E-04   2        -3         3   # BR(A0 -> Strange strange)
     7.60837944E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     1.37863871E-01   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     1.05606658E-04   2        23        25   # BR(A0 -> Z h0)
DECAY        37     5.67835731E-02   # Gamma(Hp)
     3.84814694E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.64520186E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     4.65303992E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     5.01669133E-06   2        -1         2   # BR(Hp -> Down up)
     5.64726422E-05   2        -3         2   # BR(Hp -> Strange up)
     3.47610375E-05   2        -5         2   # BR(Hp -> Bottom up)
     2.12524478E-06   2        -1         4   # BR(Hp -> Down charm)
     1.29759927E-03   2        -3         4   # BR(Hp -> Strange charm)
     4.86746623E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.82090303E-05   2        -1         6   # BR(Hp -> Down top)
     3.97130401E-04   2        -3         6   # BR(Hp -> Strange top)
     5.18353222E-01   2        -5         6   # BR(Hp -> Bottom top)
     7.98435033E-03   2        24        25   # BR(Hp -> W h0)
     9.45325730E-06   2        24        35   # BR(Hp -> W HH)
     2.49613570E-05   2        24        36   # BR(Hp -> W A0)
