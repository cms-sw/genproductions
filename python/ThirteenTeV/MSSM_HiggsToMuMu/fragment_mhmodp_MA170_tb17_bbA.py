...
BLOCK MASS
   ...
   2000005     1.00482428E+03   # MSf(2,4,3)
        25     1.23985683E+02   # Mh0
        35     1.71027508E+02   # MHH
        36     1.70000000E+02   # MA0
        37     1.88820486E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.29249005E-01   # Delta Mh0
        35     1.75053143E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     4.05725072E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.70607955E-01   # Alpha
BLOCK DALPHA
               5.51125213E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.97857638E-01   # UH(1,1)
     1   2     6.54227421E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -6.54227421E-02   # UH(2,1)
     2   2     9.97857638E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     2.00863986E-02   # Gamma(h0)
     4.57433969E-04   2        22        22   # BR(h0 -> photon photon)
     2.67149529E-04   2        22        23   # BR(h0 -> photon Z)
     4.64133968E-03   2        23        23   # BR(h0 -> Z Z)
     3.91261257E-02   2       -24        24   # BR(h0 -> W W)
     1.13822523E-02   2        21        21   # BR(h0 -> gluon gluon)
     8.23328321E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.66230192E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.04358120E-01   2       -15        15   # BR(h0 -> Tau tau)
     3.88810459E-08   2        -2         2   # BR(h0 -> Up up)
     5.38536934E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.30178418E-06   2        -1         1   # BR(h0 -> Down down)
     3.26912466E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.33687718E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     8.12806814E-01   # Gamma(HH)
     5.21099585E-07   2        22        22   # BR(HH -> photon photon)
     1.47950685E-06   2        22        23   # BR(HH -> photon Z)
     1.52293724E-04   2        23        23   # BR(HH -> Z Z)
     6.00248340E-03   2       -24        24   # BR(HH -> W W)
     8.52098023E-04   2        21        21   # BR(HH -> gluon gluon)
     9.53405015E-09   2       -11        11   # BR(HH -> Electron electron)
     4.24131671E-04   2       -13        13   # BR(HH -> Muon muon)
     1.20272792E-01   2       -15        15   # BR(HH -> Tau tau)
     3.52745948E-11   2        -2         2   # BR(HH -> Up up)
     4.88819058E-06   2        -4         4   # BR(HH -> Charm charm)
     1.39393132E-06   2        -1         1   # BR(HH -> Down down)
     3.50049850E-04   2        -3         3   # BR(HH -> Strange strange)
     8.71937859E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.51585614E-12   2        23        36   # BR(HH -> Z A0)
DECAY        36     8.20943839E-01   # Gamma(A0)
    -2.62395813E-07   2        22        22   # BR(A0 -> photon photon)
    -3.83617449E-07   2        22        23   # BR(A0 -> photon Z)
    -6.34704808E-04   2        21        21   # BR(A0 -> gluon gluon)
    -9.57155539E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.25800023E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.20794525E-01   2       -15        15   # BR(A0 -> Tau tau)
    -3.75674339E-12   2        -2         2   # BR(A0 -> Up up)
    -5.27710413E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.40121763E-06   2        -1         1   # BR(A0 -> Down down)
    -3.51879820E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.77787920E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -2.58542866E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.28583867E-01   # Gamma(Hp)
     7.02377637E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.00288137E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     8.49265195E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     9.12609822E-06   2        -1         2   # BR(Hp -> Down up)
     1.02555731E-04   2        -3         2   # BR(Hp -> Strange up)
     6.08477751E-05   2        -5         2   # BR(Hp -> Bottom up)
     5.80924133E-07   2        -1         4   # BR(Hp -> Down charm)
     2.28744235E-03   2        -3         4   # BR(Hp -> Strange charm)
     8.52007888E-03   2        -5         4   # BR(Hp -> Bottom charm)
     4.77107155E-07   2        -1         6   # BR(Hp -> Down top)
     1.04735849E-05   2        -3         6   # BR(Hp -> Strange top)
     1.36560005E-01   2        -5         6   # BR(Hp -> Bottom top)
     1.41569379E-04   2        24        25   # BR(Hp -> W h0)
     1.65813073E-05   2        24        35   # BR(Hp -> W HH)
     2.21153068E-05   2        24        36   # BR(Hp -> W A0)
