...
BLOCK MASS
   ...
   2000005     1.00778084E+03   # MSf(2,4,3)
        25     1.22566371E+02   # Mh0
        35     1.32638374E+02   # MHH
        36     1.30000000E+02   # MA0
        37     1.55102659E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     6.01716747E-01   # Delta Mh0
        35     1.13206380E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.09240919E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -5.25554420E-01   # Alpha
BLOCK DALPHA
               7.89048634E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.17127957E-01   # UH(1,1)
     1   2     3.98592913E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -3.98592913E-01   # UH(2,1)
     2   2     9.17127957E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     3.52858033E-01   # Gamma(h0)
     2.42338287E-05   2        22        22   # BR(h0 -> photon photon)
     1.04066010E-05   2        22        23   # BR(h0 -> photon Z)
     1.74230311E-04   2        23        23   # BR(h0 -> Z Z)
     1.51153790E-03   2       -24        24   # BR(h0 -> W W)
     6.34503161E-04   2        21        21   # BR(h0 -> gluon gluon)
     9.52342015E-09   2       -11        11   # BR(h0 -> Electron electron)
     4.23616215E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.19328298E-01   2       -15        15   # BR(h0 -> Tau tau)
     1.65445439E-09   2        -2         2   # BR(h0 -> Up up)
     2.29155512E-04   2        -4         4   # BR(h0 -> Charm charm)
     1.44152371E-06   2        -1         1   # BR(h0 -> Down down)
     3.61985491E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.77300580E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.01364815E+00   # Gamma(HH)
     1.01581398E-06   2        22        22   # BR(HH -> photon photon)
     2.35005011E-06   2        22        23   # BR(HH -> photon Z)
     5.63388684E-05   2        23        23   # BR(HH -> Z Z)
     4.09883565E-04   2       -24        24   # BR(HH -> W W)
     1.35036944E-03   2        21        21   # BR(HH -> gluon gluon)
     9.79918020E-09   2       -11        11   # BR(HH -> Electron electron)
     4.35892896E-04   2       -13        13   # BR(HH -> Muon muon)
     1.22564887E-01   2       -15        15   # BR(HH -> Tau tau)
     2.21820550E-10   2        -2         2   # BR(HH -> Up up)
     3.07261896E-05   2        -4         4   # BR(HH -> Charm charm)
     1.45032718E-06   2        -1         1   # BR(HH -> Down down)
     3.64194252E-04   2        -3         3   # BR(HH -> Strange strange)
     8.74782881E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.05273343E-10   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.35906781E+00   # Gamma(A0)
    -2.56180763E-07   2        22        22   # BR(A0 -> photon photon)
    -1.86264301E-08   2        22        23   # BR(A0 -> photon Z)
    -9.75292916E-04   2        21        21   # BR(A0 -> gluon gluon)
    -9.72450315E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.32569587E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.21764000E-01   2       -15        15   # BR(A0 -> Tau tau)
    -8.62462364E-13   2        -2         2   # BR(A0 -> Up up)
    -1.24564118E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.44727138E-06   2        -1         1   # BR(A0 -> Down down)
    -3.63427616E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.76462850E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -3.67809467E-09   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.97170222E-01   # Gamma(Hp)
     8.13707167E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47884845E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.83792944E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.07722402E-05   2        -1         2   # BR(Hp -> Down up)
     1.20469289E-04   2        -3         2   # BR(Hp -> Strange up)
     6.92227817E-05   2        -5         2   # BR(Hp -> Bottom up)
     5.23923242E-07   2        -1         4   # BR(Hp -> Down charm)
     2.69629145E-03   2        -3         4   # BR(Hp -> Strange charm)
     9.69233303E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.31545058E-05   2        -5         6   # BR(Hp -> Bottom top)
     4.31929208E-05   2        24        25   # BR(Hp -> W h0)
     2.57484912E-05   2        24        35   # BR(Hp -> W HH)
     5.64180105E-05   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.38027797E+00   # Gamma(top)
     9.93477667E-01   2         5        24   # BR(top -> bottom W)
     6.52233298E-03   2         5        37   # BR(top -> bottom Hp)
"""
