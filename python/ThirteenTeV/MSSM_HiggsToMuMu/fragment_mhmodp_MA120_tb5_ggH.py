...
BLOCK MASS
   ...
   2000005     1.00226018E+03   # MSf(2,4,3)
        25     1.02829162E+02   # Mh0
        35     1.40925046E+02   # MHH
        36     1.20000000E+02   # MA0
        37     1.43991655E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     6.56664587E-01   # Delta Mh0
        35     2.69173519E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.83616182E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -8.97434951E-01   # Alpha
BLOCK DALPHA
               2.92221360E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.21946305E-01   # UH(1,1)
     1   2     3.87317714E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -3.87317714E-01   # UH(2,1)
     2   2     9.21946305E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     3.23634976E-02   # Gamma(h0)
     1.03322749E-04   2        22        22   # BR(h0 -> photon photon)
     4.52503623E-07   2        22        23   # BR(h0 -> photon Z)
     6.09551847E-05   2        23        23   # BR(h0 -> Z Z)
     6.32823872E-04   2       -24        24   # BR(h0 -> W W)
     1.63769191E-03   2        21        21   # BR(h0 -> gluon gluon)
     8.03903050E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.57569168E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.02587563E-01   2       -15        15   # BR(h0 -> Tau tau)
     8.59146284E-09   2        -2         2   # BR(h0 -> Up up)
     1.18981703E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.35194968E-06   2        -1         1   # BR(h0 -> Down down)
     3.39519204E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.93088917E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.84769094E-02   # Gamma(HH)
    -1.62785898E-04   2        22        22   # BR(HH -> photon photon)
    -4.51938665E-04   2        22        23   # BR(HH -> photon Z)
    -8.97553462E-03   2        23        23   # BR(HH -> Z Z)
    -6.37975978E-02   2       -24        24   # BR(HH -> W W)
    -1.40187840E-02   2        21        21   # BR(HH -> gluon gluon)
    -7.83417201E-09   2       -11        11   # BR(HH -> Electron electron)
     3.48490588E-04   2       -13        13   # BR(HH -> Muon muon)
    -9.98778958E-02   2       -15        15   # BR(HH -> Tau tau)
    -1.97472818E-08   2        -2         2   # BR(HH -> Up up)
    -2.73529663E-03   2        -4         4   # BR(HH -> Charm charm)
    -1.23574112E-06   2        -1         1   # BR(HH -> Down down)
    -3.10336755E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.09246182E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -7.38941819E-05   2        23        36   # BR(HH -> Z A0)
DECAY        36     5.67997433E-02   # Gamma(A0)
     3.67544632E-06   2        22        22   # BR(A0 -> photon photon)
     6.40031745E-07   2        22        23   # BR(A0 -> photon Z)
     6.65282638E-04   2        21        21   # BR(A0 -> gluon gluon)
     8.30531793E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.69431938E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.06026962E-01   2       -15        15   # BR(A0 -> Tau tau)
     5.29650862E-10   2        -2         2   # BR(A0 -> Up up)
     7.46821380E-05   2        -4         4   # BR(A0 -> Charm charm)
     1.35293476E-06   2        -1         1   # BR(A0 -> Down down)
     3.39767959E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.92508427E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     9.76897134E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     7.42026941E-03   # Gamma(Hp)
     8.02911844E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.43269462E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.70700267E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.12198276E-05   2        -1         2   # BR(Hp -> Down up)
     1.25215805E-04   2        -3         2   # BR(Hp -> Strange up)
     7.79658163E-05   2        -5         2   # BR(Hp -> Bottom up)
     2.79414460E-05   2        -1         4   # BR(Hp -> Down charm)
     3.42220472E-03   2        -3         4   # BR(Hp -> Strange charm)
     1.09170692E-02   2        -5         4   # BR(Hp -> Bottom charm)
     3.49626390E-03   2        -5         6   # BR(Hp -> Bottom top)
     6.60925122E-03   2        24        25   # BR(Hp -> W h0)
     2.82064918E-08   2        24        35   # BR(Hp -> W HH)
     1.17979765E-03   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.37884050E+00   # Gamma(top)
     9.94513386E-01   2         5        24   # BR(top -> bottom W)
     5.48661404E-03   2         5        37   # BR(top -> bottom Hp)
"""
