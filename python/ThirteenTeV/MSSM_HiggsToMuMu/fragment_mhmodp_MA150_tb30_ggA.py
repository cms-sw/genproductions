...
BLOCK MASS
   ...
   2000005     1.00956179E+03   # MSf(2,4,3)
        25     1.24609106E+02   # Mh0
        35     1.50653663E+02   # MHH
        36     1.50000000E+02   # MA0
        37     1.73166695E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.34594258E-01   # Delta Mh0
        35     7.54374566E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     2.24483785E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.63716244E-01   # Alpha
BLOCK DALPHA
               9.51698705E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.95796315E-01   # UH(1,1)
     1   2     9.15952968E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -9.15952968E-02   # UH(2,1)
     2   2     9.95796315E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     5.23789559E-02   # Gamma(h0)
     1.81887883E-04   2        22        22   # BR(h0 -> photon photon)
     1.07870729E-04   2        22        23   # BR(h0 -> photon Z)
     1.91743793E-03   2        23        23   # BR(h0 -> Z Z)
     1.59630919E-02   2       -24        24   # BR(h0 -> W W)
     3.93096430E-03   2        21        21   # BR(h0 -> gluon gluon)
     9.38065035E-09   2       -11        11   # BR(h0 -> Electron electron)
     4.17267642E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.17425773E-01   2       -15        15   # BR(h0 -> Tau tau)
     1.49670147E-08   2        -2         2   # BR(h0 -> Up up)
     2.07308459E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.41178280E-06   2        -1         1   # BR(h0 -> Down down)
     3.54516091E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.57626670E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.10556846E+00   # Gamma(HH)
     2.43981007E-07   2        22        22   # BR(HH -> photon photon)
     1.38957455E-07   2        22        23   # BR(HH -> photon Z)
     1.21751372E-05   2        23        23   # BR(HH -> Z Z)
     1.11370228E-04   2       -24        24   # BR(HH -> W W)
     8.55243337E-04   2        21        21   # BR(HH -> gluon gluon)
     1.03125815E-08   2       -11        11   # BR(HH -> Electron electron)
     4.58747984E-04   2       -13        13   # BR(HH -> Muon muon)
     1.28445266E-01   2       -15        15   # BR(HH -> Tau tau)
     1.14568694E-11   2        -2         2   # BR(HH -> Up up)
     1.58739147E-06   2        -4         4   # BR(HH -> Charm charm)
     1.46685993E-06   2        -1         1   # BR(HH -> Down down)
     3.68341042E-04   2        -3         3   # BR(HH -> Strange strange)
     8.69745409E-01   2        -5         5   # BR(HH -> Bottom bottom)
DECAY        36     2.15051022E+00   # Gamma(A0)
    -2.13486951E-07   2        22        22   # BR(A0 -> photon photon)
    -3.59985787E-08   2        22        23   # BR(A0 -> photon Z)
    -8.17459195E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.02871597E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.57617426E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.28200192E-01   2       -15        15   # BR(A0 -> Tau tau)
    -3.94317168E-13   2        -2         2   # BR(A0 -> Up up)
    -5.64017301E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.46487381E-06   2        -1         1   # BR(A0 -> Down down)
    -3.67842598E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.70155035E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -7.29340891E-08   2        23        25   # BR(A0 -> Z h0)
DECAY        37     3.17090688E-01   # Gamma(Hp)
     8.13455114E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47777149E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.83539271E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.04563785E-05   2        -1         2   # BR(Hp -> Down up)
     1.17230559E-04   2        -3         2   # BR(Hp -> Strange up)
     6.60968275E-05   2        -5         2   # BR(Hp -> Bottom up)
     4.87906402E-07   2        -1         4   # BR(Hp -> Down charm)
     2.61676002E-03   2        -3         4   # BR(Hp -> Strange charm)
     9.25490078E-03   2        -5         4   # BR(Hp -> Bottom charm)
     8.55998902E-04   2        -5         6   # BR(Hp -> Bottom top)
     1.57052168E-05   2        24        25   # BR(Hp -> W h0)
     2.08501756E-05   2        24        35   # BR(Hp -> W HH)
     2.43889977E-05   2        24        36   # BR(Hp -> W A0)
