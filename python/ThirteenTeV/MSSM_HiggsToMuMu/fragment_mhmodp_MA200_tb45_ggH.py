...
BLOCK MASS
   ...
   2000005     1.01459737E+03   # MSf(2,4,3)
        25     1.25250704E+02   # Mh0
        35     2.00162610E+02   # MHH
        36     2.00000000E+02   # MA0
        37     2.20381196E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.62717830E-01   # Delta Mh0
        35     9.29446648E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     5.15178943E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -4.98650835E-02   # Alpha
BLOCK DALPHA
               6.59055075E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99871776E-01   # UH(1,1)
     1   2     1.60135098E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.60135098E-02   # UH(2,1)
     2   2     9.99871776E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.19056940E-02   # Gamma(h0)
     7.88434928E-04   2        22        22   # BR(h0 -> photon photon)
     5.05929135E-04   2        22        23   # BR(h0 -> photon Z)
     9.29141163E-03   2        23        23   # BR(h0 -> Z Z)
     7.63748349E-02   2       -24        24   # BR(h0 -> W W)
     2.15876409E-02   2        21        21   # BR(h0 -> gluon gluon)
     8.53031984E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.79443866E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.06563403E-01   2       -15        15   # BR(h0 -> Tau tau)
     6.76974045E-08   2        -2         2   # BR(h0 -> Up up)
     9.37685362E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.27743729E-06   2        -1         1   # BR(h0 -> Down down)
     3.20778020E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.74809916E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     5.73407542E+00   # Gamma(HH)
    -4.79576203E-07   2        22        22   # BR(HH -> photon photon)
    -1.08534491E-07   2        22        23   # BR(HH -> photon Z)
    -4.98151445E-05   2        23        23   # BR(HH -> Z Z)
    -1.41664300E-04   2       -24        24   # BR(HH -> W W)
    -5.35359110E-04   2        21        21   # BR(HH -> gluon gluon)
    -1.18283717E-08   2       -11        11   # BR(HH -> Electron electron)
     5.26222014E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.45288197E-01   2       -15        15   # BR(HH -> Tau tau)
    -4.34086472E-13   2        -2         2   # BR(HH -> Up up)
    -6.00944991E-08   2        -4         4   # BR(HH -> Charm charm)
    -1.51574976E-06   2        -1         1   # BR(HH -> Down down)
    -3.80600479E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.52130491E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -9.45475077E-04   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     5.76615046E+00   # Gamma(A0)
     1.43703751E-07   2        22        22   # BR(A0 -> photon photon)
     8.00154578E-08   2        22        23   # BR(A0 -> photon Z)
     5.46787224E-04   2        21        21   # BR(A0 -> gluon gluon)
     1.17774078E-08   2       -11        11   # BR(A0 -> Electron electron)
     5.23955201E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.44689854E-01   2       -15        15   # BR(A0 -> Tau tau)
     6.82172488E-14   2        -2         2   # BR(A0 -> Up up)
     9.70610651E-09   2        -4         4   # BR(A0 -> Charm charm)
     1.50930867E-06   2        -1         1   # BR(A0 -> Down down)
     3.78983259E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.49198673E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     4.65968476E-03   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     3.07600325E-07   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.66844689E+00   # Gamma(Hp)
     4.42687625E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.89262667E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     5.35291677E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     5.30214763E-06   2        -1         2   # BR(Hp -> Down up)
     5.97567390E-05   2        -3         2   # BR(Hp -> Strange up)
     3.18851327E-05   2        -5         2   # BR(Hp -> Bottom up)
     2.40263352E-07   2        -1         4   # BR(Hp -> Down charm)
     1.32667566E-03   2        -3         4   # BR(Hp -> Strange charm)
     4.46475650E-03   2        -5         4   # BR(Hp -> Bottom charm)
     3.48354991E-08   2        -1         6   # BR(Hp -> Down top)
     1.03556731E-06   2        -3         6   # BR(Hp -> Strange top)
     4.56850764E-01   2        -5         6   # BR(Hp -> Bottom top)
     7.01382900E-05   2        24        25   # BR(Hp -> W h0)
     2.48048017E-06   2        24        35   # BR(Hp -> W HH)
     2.58236146E-06   2        24        36   # BR(Hp -> W A0)
