...
BLOCK MASS
   ...
   2000005     1.01296833E+03   # MSf(2,4,3)
        25     1.25188369E+02   # Mh0
        35     2.75184601E+02   # MHH
        36     2.75000000E+02   # MA0
        37     2.89333848E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.37121086E-01   # Delta Mh0
        35     6.97524298E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     2.68642443E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -3.74038889E-02   # Alpha
BLOCK DALPHA
               2.45455857E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99980481E-01   # UH(1,1)
     1   2     6.24794269E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -6.24794269E-03   # UH(2,1)
     2   2     9.99980481E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     6.40843605E-03   # Gamma(h0)
     1.44940413E-03   2        22        22   # BR(h0 -> photon photon)
     9.34013943E-04   2        22        23   # BR(h0 -> photon Z)
     1.71387104E-02   2        23        23   # BR(h0 -> Z Z)
     1.41052425E-01   2       -24        24   # BR(h0 -> W W)
     4.25738954E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.97116036E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.10089592E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.80290439E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.25865781E-07   2        -2         2   # BR(h0 -> Up up)
     1.74337904E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.08998905E-06   2        -1         1   # BR(h0 -> Down down)
     2.73720400E-04   2        -3         3   # BR(h0 -> Strange strange)
     6.90803684E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     6.16857859E+00   # Gamma(HH)
    -6.75326258E-07   2        22        22   # BR(HH -> photon photon)
    -5.83082365E-07   2        22        23   # BR(HH -> photon Z)
    -4.55152321E-05   2        23        23   # BR(HH -> Z Z)
    -1.04005328E-04   2       -24        24   # BR(HH -> W W)
    -3.67010200E-04   2        21        21   # BR(HH -> gluon gluon)
    -1.18279365E-08   2       -11        11   # BR(HH -> Electron electron)
     5.26252778E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.45948364E-01   2       -15        15   # BR(HH -> Tau tau)
    -2.80185949E-13   2        -2         2   # BR(HH -> Up up)
    -3.87624597E-08   2        -4         4   # BR(HH -> Charm charm)
    -1.46690461E-06   2        -1         1   # BR(HH -> Down down)
    -3.68348631E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.42377366E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -5.52784944E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
    -4.29466691E-03   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
    -4.37845652E-04   2        25        25   # BR(HH -> h0 h0)
DECAY        36     6.27358349E+00   # Gamma(A0)
     2.52589724E-07   2        22        22   # BR(A0 -> photon photon)
     9.99532436E-07   2        22        23   # BR(A0 -> photon Z)
     3.38272503E-04   2        21        21   # BR(A0 -> gluon gluon)
     1.16099251E-08   2       -11        11   # BR(A0 -> Electron electron)
     5.16553142E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.43247396E-01   2       -15        15   # BR(A0 -> Tau tau)
     9.82361660E-14   2        -2         2   # BR(A0 -> Up up)
     1.38022722E-08   2        -4         4   # BR(A0 -> Charm charm)
     1.43965223E-06   2        -1         1   # BR(A0 -> Down down)
     3.61505437E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.27077118E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     9.83101893E-03   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     1.85869396E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
     3.84789204E-05   2        23        25   # BR(A0 -> Z h0)
     2.56907141E-36   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     3.29015683E+00   # Gamma(Hp)
     2.32869618E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     9.95589913E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.81598055E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     2.69467437E-06   2        -1         2   # BR(Hp -> Down up)
     3.05244616E-05   2        -3         2   # BR(Hp -> Strange up)
     1.65909214E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.23377945E-07   2        -1         4   # BR(Hp -> Down charm)
     6.74294609E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.32323155E-03   2        -5         4   # BR(Hp -> Bottom charm)
     7.94500353E-08   2        -1         6   # BR(Hp -> Down top)
     2.13072207E-06   2        -3         6   # BR(Hp -> Strange top)
     6.71033141E-01   2        -5         6   # BR(Hp -> Bottom top)
     4.31980992E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     1.24963036E-04   2        24        25   # BR(Hp -> W h0)
     2.21694526E-07   2        24        35   # BR(Hp -> W HH)
     2.36453952E-07   2        24        36   # BR(Hp -> W A0)
