...
generator = cms.EDFilter("ReggeGribovPartonMCGeneratorFilter",
                    ...
                    model = cms.int32(7),
                    crossSection = cms.untracked.double(73110000000.0),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/GeneratorInterface/ReggeGribovPartonMCInterface/python/ReggeGribovPartonMC_QGSJetII_13TeV_pp_cfi.py,v $'),
