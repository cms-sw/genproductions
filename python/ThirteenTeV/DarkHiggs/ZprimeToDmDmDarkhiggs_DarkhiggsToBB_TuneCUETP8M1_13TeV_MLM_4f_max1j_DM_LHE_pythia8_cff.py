...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/afs/cern.ch/work/s/sabaxter/gridpacks/MZP-1000_MCHI-100_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz'),
...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet( 
        ...
        processParameters = cms.vstring(
            ...
            '52:new  = DM  DM  2 0 0 X_DM_X  0 0 0 99999',
            '52:mayDecay = off'
        ),
