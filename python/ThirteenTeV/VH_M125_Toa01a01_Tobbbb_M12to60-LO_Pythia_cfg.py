...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('15:onMode = off','15:onIfAny = 11 13'), 
...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/afs/cern.ch/user/g/georgia/public/Wh01_M125_Toa01a01_M12_Tobbbb_slc6_amd64_gcc481_CMSSW_7_1_28_tarball.tar.xz','false','slc6_amd64_gcc481','CMSSW_7_1_28'),
