...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('13TeV_gam_2j_Pt-1000-2000_71X'),
  SherpackLocation = cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/sherpa/V2.2.0/exo_GJet_PtBinned/GJets_Pt-1000To2000_13TeV-sherpa_MASTER.tgz'),
  SherpackChecksum = cms.string('d3fef34135e9bfaf4a652dda10a2e22e'),
