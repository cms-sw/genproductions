...
for m in masses:
	...
	if c==0.05:
        ...
        card += "    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/powheg/V2/VBF_H_NNPDF30_13TeV/v1/VBFH_NNPDF30_M-125_13TeV_tarball.tar.gz'), \n"
        ...
        card += " \n"
        card += "# Link to cards: \n"
        card += "# https://github.com/cms-sw/genproductions/blob/6a68fe7bcc051fcc33f55dac960431fb3ffb1da7/bin/Powheg/examples/V2/VBF_H_NNPDF30_13TeV/VBF_H_NNPDF30_13TeV.input \n"
        card += " \n"
        card += "import FWCore.ParameterSet.Config as cms \n"
        ...
        card += "            'POWHEG:nFinal = 3',   ## Number of final state particles \n"
        ...
        outname = DATACARDDIR + "VBFH_HToSSTobbbb_MH-125_MS-"+str(m)+"_ctauS-"+str(ci)+"_13TeV.py"
