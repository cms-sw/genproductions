...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('ADDGravitonToDiPhoton_MS5500_NED2_KK4_M-4000To5500_13TeV-sherpa'),
  SherpackLocation = cms.string('slc6_amd64_gcc481/13TeV/sherpa/2.1.1/ADDGravToGG/v1/'),
  SherpackChecksum = cms.string('fec1eae03c13dd0521e2941918cef6dd'),
