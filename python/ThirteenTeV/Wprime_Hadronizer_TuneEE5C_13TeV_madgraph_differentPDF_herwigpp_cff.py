...
herwigNewPhysicsBlock = cms.PSet(
    herwigNewPhysics = cms.vstring(
        ...
        'setup wprime 900002 wprime 1000 0.0 0.0 0.0 0 0 3 0',
        'cd /'
        ),
    )
	...
	herwigppPDFSettingsBlock,
        herwigppPDFSettingsBlock = cms.PSet(
            ...
            hwpp_pdf_NNPDF30LO = cms.vstring(
                'create ThePEG::LHAPDF /Herwig/Partons/cmsPDFSet ThePEGLHAPDF.so',          # cmsPDFSet Default name fo
            ...
            hwpp_pdf_NNPDF30LO_Hard = cms.vstring(
                'create ThePEG::LHAPDF /Herwig/Partons/cmsHardPDFSet ThePEGLHAPDF.so',          # cmsHardPDFSet Default
