...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('13TeV_gam_2j_Pt-2000-5000_71X'),
  SherpackLocation = cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/sherpa/V2.2.0/exo_GJet_PtBinned/GJets_Pt-2000To5000_13TeV-sherpa_MASTER.tgz'),
