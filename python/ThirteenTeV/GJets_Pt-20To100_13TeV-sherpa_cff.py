...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('13TeV_gam_2j_Pt-20-100_71X'),
  SherpackLocation = cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/sherpa/V2.2.0/exo_GJet_PtBinned/GJets_Pt-20To100_13TeV-sherpa_MASTER.tgz'),
  SherpackChecksum = cms.string('ef20b58014adf23014ffd3728360647a'),
