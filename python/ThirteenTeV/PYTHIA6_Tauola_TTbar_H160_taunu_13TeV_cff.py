...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Tauola_TTbar_H160_taunu_13TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TTbar Hplus160 To TauNu, with Tauola at 13TeV')
    )
