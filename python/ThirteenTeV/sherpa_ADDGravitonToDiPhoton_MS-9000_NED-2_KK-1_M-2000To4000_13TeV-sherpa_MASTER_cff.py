...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('ADDGravitonToDiPhoton_MS-9000_NED-2_KK-1_M-2000To4000_13TeV-sherpa'),
  ...
  SherpackChecksum = cms.string('b7be7f0bf1031debbb2a56669f1d19ab'),
