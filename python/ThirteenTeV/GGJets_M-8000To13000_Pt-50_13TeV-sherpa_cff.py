...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('13TeV_gamgam_0j3incl_loop_8000mgg13000_50ptg13000_Minus2p8Eta2p8'),
  SherpackLocation = cms.string('slc6_amd64_gcc481/13TeV/sherpa/2.1.1/EXO_GGJets/v2/'),
  SherpackChecksum = cms.string('80c17c89538bc6ee00118e0f7b3a142c'),
