...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('13TeV_gamgam_0j3incl_loop_4000mgg6000_50ptg13000_Minus2p8Eta2p8'),
  SherpackLocation = cms.string('slc6_amd64_gcc481/13TeV/sherpa/2.1.1/EXO_GGJets/v2/'),
  SherpackChecksum = cms.string('14f5474302bfa8639866013f5c342b3a'),
