...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('13TeV_gam_2j_Pt-200-500_71X'),
  SherpackLocation = cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/sherpa/V2.2.0/exo_GJet_PtBinned/GJets_Pt-200To500_13TeV-sherpa_MASTER.tgz'),
  SherpackChecksum = cms.string('2f80e2ba39c0717f3cb1815bd2cd2c06'),
