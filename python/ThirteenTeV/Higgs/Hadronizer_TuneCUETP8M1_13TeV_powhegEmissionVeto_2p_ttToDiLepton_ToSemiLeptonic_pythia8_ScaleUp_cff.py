...
##to not overlap with ttZ/gamma* samples
  ...
  #'SigmaProcess:renormMultFac = 4.0', #Only for internal pythia hard processes
  #'SigmaProcess:factorMultFac = 4.0', #Only for internal pythia hard processes
	    'TimeShower:renormMultFac   = 4.0',	#FSR
  	    'TimeShower:factorMultFac   = 4.0',	#FSR
  	    'SpaceShower:renormMultFac  = 4.0',	#ISR
            'SpaceShower:factorMultFac  = 4.0',        #ISR
