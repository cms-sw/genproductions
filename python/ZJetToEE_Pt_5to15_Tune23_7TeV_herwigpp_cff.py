...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	herwigDefaultsBlock,
	crossSection = cms.untracked.double(4.608947e+02),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Summer2011 sample with HERWIGPP: Z + Jet production, Z -> ee, pThat = 5 .. 15 GeV, Tune23')
)
