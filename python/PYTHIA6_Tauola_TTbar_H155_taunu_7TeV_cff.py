...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_TTbar_H155_taunu_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TTbar Hplus155 To TauNu, with Tauola at 7TeV')
    )
