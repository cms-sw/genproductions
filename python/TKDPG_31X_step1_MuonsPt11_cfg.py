...
# with command line options: TKDPG_31X_MuonsPt11_cff.py -s GEN:ProductionFilterSequence,SIM,DIGI,L1,DIGI2RAW,HLT -n 1000 --conditions FrontierConditions_GlobalTag,MC_31X_V3::All --datatier GEN-SIM-DIGI-RAW --eventcontent RAWSIM --no_exec --python_filename TKDPG_31X_step1_MuonsPt11_cfg.py
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('TKDPG MuonsPt11'),
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/Attic/TKDPG_31X_MuonPt11_cff.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TKDPG_31X_MuonsPt11_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
