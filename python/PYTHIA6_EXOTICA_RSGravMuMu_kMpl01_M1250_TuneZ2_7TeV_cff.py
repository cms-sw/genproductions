...
generator = cms.EDFilter("Pythia6GeneratorFilter",   
    ...
    crossSection  = cms.untracked.double(0.01405),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: PYTHIA6_EXOTICA_RSGravMuMu_kMpl01_M1250_TuneZ2_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 RS Graviton to mumu, k/Mpl = 0.1, mass = 1250 at sqrt(s) = 7TeV')
)
