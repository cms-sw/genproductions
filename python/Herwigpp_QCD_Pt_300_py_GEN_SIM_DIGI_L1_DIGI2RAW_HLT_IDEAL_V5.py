...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/Herwigpp_QCD_Pt_300_py'),
...
process.source = cms.Source("ThePEGSource",
    ...
    crossSection = cms.untracked.double(0.00406032),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Herwigpp_QCD_Pt_300_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
