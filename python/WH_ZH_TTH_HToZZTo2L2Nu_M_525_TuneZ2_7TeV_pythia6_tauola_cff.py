...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(25,1)=525.0        !mass of Higgs', 
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_SM_H_2Z_4l_wh_zh_tth_mH525_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 WH/ZH/ttH, H->ZZ->2l2nu mH=525GeV with TAUOLA at 7TeV')
)
