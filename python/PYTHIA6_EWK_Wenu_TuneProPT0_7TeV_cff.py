...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.7875),
    crossSection = cms.untracked.double(7780.),
...
elegenfilter = cms.EDFilter("PythiaFilter",
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EWK_Wenu_TuneProPT0_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-Wenu Tune ProPT0 at 7TeV')
)
