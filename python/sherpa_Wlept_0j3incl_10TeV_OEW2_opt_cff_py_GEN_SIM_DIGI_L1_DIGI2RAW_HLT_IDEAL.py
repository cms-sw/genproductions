...
# with command line options: Configuration/GenProduction/python/sherpa_Wlept_0j3incl_10TeV_OEW2_opt_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec --customise Configuration/GenProduction/sherpa_custom.py
