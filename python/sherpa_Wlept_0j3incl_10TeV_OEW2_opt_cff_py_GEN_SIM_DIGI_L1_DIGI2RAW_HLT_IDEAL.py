...
# with command line options: Configuration/GenProduction/python/sherpa_Wlept_0j3incl_10TeV_OEW2_opt_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V11::All -n 10 --no_exec --customise Configuration/GenProduction/sherpa_custom.py
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/sherpa_Wlept_0j3incl_10TeV_OEW2_opt_cff.py nevts:10'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('sherpa_Wlept_0j3incl_10TeV_OEW2_opt_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
