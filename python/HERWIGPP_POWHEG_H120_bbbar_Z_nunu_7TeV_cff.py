...
pdfCTEQ6M = cms.vstring(
    ...
    crossSection     = cms.untracked.double(0.0457),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /cvs_server/repositories/CMSSW/UserCode/SchieferD/GenProduction/python/HERWIGPP_POWHEG_H120_bbbar_Z_nunu_7TeV_cff.py,v $'),
	annotation = cms.untracked.string('HERWIGPP/POWHEG: (H->bb)(Z->nunu), m(H)=120 GeV, nu=nu_e or nu_mu or nu_tau')
)
