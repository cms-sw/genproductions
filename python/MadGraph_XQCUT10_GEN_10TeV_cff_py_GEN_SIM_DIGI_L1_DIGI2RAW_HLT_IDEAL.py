...
# with command line options: Configuration/GenProduction/python/MadGraph_XQCUT10_GEN_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec --customise Configuration/GenProduction/Herwigpp_custom.py
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MadGraph-PYTHIA6 at 10TeV, qcut 10'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MadGraph_XQCUT10_GEN_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
