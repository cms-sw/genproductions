...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.00052),
    comEnergy = cms.double(7000.0),
    crossSection = cms.untracked.double(2.434e+04),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDEnrichedpt_170_300_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCDEnrichedpt-170-300 at 7TeV')
)
