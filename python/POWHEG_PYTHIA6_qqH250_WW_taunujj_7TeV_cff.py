...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(0.0453),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_PYTHIA6_qqH250_WW_taunujj_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('POWHEG + PYTHIA6 - VBF Higgs -> WW -> taunujj at 7TeV')
    )
