...
configurationMetadata = cms.untracked.PSet(
  ...
  name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/WH_WToLNu_HToBB_M-135_7TeV-mcatnlo-herwig6.py,v $'),
  annotation = cms.untracked.string('Fall 10: MC@NLO 3.4 W->lnu H(bb), mH=135 events with Herwig+Jimmy, 7 TeV')
)
