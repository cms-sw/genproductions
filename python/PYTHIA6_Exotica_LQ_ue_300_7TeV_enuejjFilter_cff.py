...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(0.643),
...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/Configuration/GenProduction/python/PYTHIA6_Exotica_LQ_ue_300_7TeV_enuejjFilter_cff.py,v $'),
