...
generator = cms.EDFilter("Pythia6GeneratorFilter",   
    ...
    crossSection  = cms.untracked.double(0.0280),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EXOTICA_ZPrimeSSMMuMu_M1250_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA ZPRIME SSM mu mu, mass = 1250 at sqrt(s) = 7TeV')
)
