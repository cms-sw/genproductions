...
# with command line options: Configuration/GenProduction/python/MCatNLO_Zee_10TeV_cff.py -s GEN:ProductionFilterSequence --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 1000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('MCatNLO Zee M(ee)> 40 GeV at 10TeV'),
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/MCatNLO_Zee_10TeV_cff.py,v $')
)
...
process.source = cms.Source("MCatNLOSource",
    ...
    processNumber = cms.untracked.int32(-1351)
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('/tmp/malberti/MCatNLO_Zee_10TeV_cff_py_GEN.root'),
