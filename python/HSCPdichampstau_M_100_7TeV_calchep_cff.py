...
PARTICLE_FILE = 'Configuration/Generator/data/particles_Dichamp_%s_%d_GeV.txt' % (FLAVOR, MASS_POINT)
SLHA_FILE = 'file:/uscms_data/d2/jchen/dichamp/modelvariation/Dichamp_7TeV_Dichamp%dGeV.lhe' % MASS_POINT
