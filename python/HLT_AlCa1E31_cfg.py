...
# with command line options: RelVal --step=HLT --conditions=FrontierConditions_GlobalTag,MC_31X_V5::All --filein=input.root --number=10000 --mc --no_exec --datatier RAW-HLT --eventcontent=FEVTDEBUGHLT --python_filename=HLT_AlCa1E31.py --processName=ALCA1E31
import FWCore.ParameterSet.Config as cms

process = cms.Process('ALCA1E31')
...
process.hltAllAlCaRawOutput = cms.OutputModule( "PoolOutputModule",
    ...
    fileName = cms.untracked.string( "AlCaRawStreamTEST.root" ),
    compressionLevel = cms.untracked.int32( 1 ),
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'AlCa_EcalEta_1E31',
  'AlCa_EcalPhiSym',
  'AlCa_EcalPi0_1E31',
  'AlCa_HcalPhiSym' ) ),
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/user/beaucero/3_1_2/AlCaRaw4MCProduction/V4')
)
...
process.HLTSchedule = cms.Schedule( process.AlCaOutput, process.AlCa_EcalPi0_1E31, process.AlCa_EcalEta_1E31, process.AlCa_EcalPhiSym, process.AlCa_HcalPhiSym )
