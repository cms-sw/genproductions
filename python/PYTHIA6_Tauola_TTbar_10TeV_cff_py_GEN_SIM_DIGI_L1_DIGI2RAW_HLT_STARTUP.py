...
# with command line options: Configuration/GenProduction/PYTHIA6_Tauola_TTbar_10TeV_cff -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,STARTUP_V5::All -n 10 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Tauola_TTbar_10TeV_cff_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
