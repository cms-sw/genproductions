...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Upsilon2SWithFSR_7TeV_cff.py,v $'),
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    # I   0 All included subprocesses    I       100000       2072088 I  3.907E-03 I   0.0193 I
    crossSection = cms.untracked.double(75400.0),
    # TrigReport  Trig Bit#    Visited     Passed     Failed      Error Name
    # TrigReport     1    0     100000     100000          0          0 generator
    # TrigReport     1    0     100000      14727      85273          0 oniafilter
    # TrigReport     1    0      14727       7999       6728          0 mumugenfilter
    filterEfficiency = cms.untracked.double(0.080),
