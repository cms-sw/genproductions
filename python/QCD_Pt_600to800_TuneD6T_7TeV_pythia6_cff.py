...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(1.555693e+01),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Fall2010 sample with PYTHIA6: QCD dijet production, pThat = 600 .. 800 GeV, TuneD6T')
)
