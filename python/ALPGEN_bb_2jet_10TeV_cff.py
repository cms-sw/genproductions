...
tionMetadata = cms.untracked.PSet(
    version = cms.untracked.string('$Revision: 1.2 $'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/sergei/final_cfg/ALPGEN_bb_2jet_10TeV_cff.py,v $'),
    annotation = cms.untracked.string('Default ALPGEN_bb_2jet_cff.py')
)
