...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/WH_ZH_HToGG_M_145_TuneZ2_7TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 WH/ZH, H->2gamma mH=145GeV with TAUOLA at 7TeV')
)
