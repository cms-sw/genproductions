...
generator = cms.EDFilter("Pythia6GeneratorFilter", 
    ...
    crossSection = cms.untracked.double(1.559),
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('default documentation string for ZprimeDijet_1200_10TeV_cff.py'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_QCD_ZprimeDijet_1200_10TeV_cff.py,v $')
)
