...
# with command line options: Tkcosmics_cfi.py -s DIGI,L1,DIGI2RAW -n -1 --conditions FrontierConditions_GlobalTag,COSMC3X_V1::All --datatier GEN-SIM-DIGI-RAW --eventcontent FEVTHLTALL --scenario cosmics --magField 38T --no_exec --python_filename TKDPG_Cosmics_MC_35X_STARTUP_38T.py
