...
configurationMetadata = cms.untracked.PSet(
  ...
  name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/DYToLL_7TeV_mcatnlo_photos_cff.py,v $'),
  annotation = cms.untracked.string('Summer09: Showering of MC@NLO WW Herwig+Jimmy, 7 TeV')
)
