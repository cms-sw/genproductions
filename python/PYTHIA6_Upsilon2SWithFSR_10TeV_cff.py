...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Upsilon2SWithFSR_10TeV_cff.py,v $'),
        annotation = cms.untracked.string('Summer09: Pythia6 generation of Upsilon(2S), 10TeV, D6T tune')
)
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(5520000.0),
