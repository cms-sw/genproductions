...
# with command line options: Configuration/GenProduction/python/ALPGEN_Exotica_6jet_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V12::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/ALPGEN_Exotica_6jet_10TeV_cff_py_GEN_IDEAL.py,v $'),
    annotation = cms.untracked.string('default documentation string for ALPGEN_Exotica_6jet_10TeV_cff.py')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ALPGEN_Exotica_6jet_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
...
# fraction of events that fail fragmentation cuts = 0.96390
# 2829.965u 14.716s 49:44.60 95.3% 0+0k 0+50696io 1392pf+0w
# output rootfile size for 10 events is 24M
