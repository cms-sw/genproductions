...
# with command line options: Configuration/GenProduction/python/ALPGEN_Exotica_6jet_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/ALPGEN_Exotica_6jet_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL.py,v $')
)
...
# 2763.397u 9.304s 46:26.58 99.5% 0+0k 0+47688io 13pf+0w
# output rootfile size for 10 generated events: 21.48 MB 
