#--------------------------------------------------------------------------------------------------------
# Reco of simulated cosmics in CMSSW 229
# Last update: KH & AR 29.04.09 
#  * event content changed to RECOSIM
#  * Bfield for RECO is OFF, same as for generation
#--------------------------------------------------------------------------------------------------------
...
# local file
   fileNames=cms.untracked.vstring('file:CosmicMC_BOFF_100GeV_EcalG200_SelReadout_TKOnly.root'
                            )
)
...
process.FEVT = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_CosmicMC_BOFF_100GeV_EcalG200_SelReadout_TKOnly_RECOSIM.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/CosmicMC_BOFFG200_RECO.py,v $'),
    annotation = cms.untracked.string('Reco of simulated cosmics with B=off and ecal g200')
)
...
process.GlobalTag.globaltag = "COSMMC_G2BOV3::All"
