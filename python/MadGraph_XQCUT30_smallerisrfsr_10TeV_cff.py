...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MadGraph_XQCUT30_smallerisrfsr_10TeV_cff.py,v $'),
        annotation = cms.untracked.string('MadGraph-PYTHIA6 at 10TeV, smaller amount of isr and fsr')
)
