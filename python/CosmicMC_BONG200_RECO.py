...
# local file
   fileNames=cms.untracked.vstring('file:CosmicMC_BON_EcalAPD200_FullReadout_TKOnly.root'
                            )
)
...
process.FEVT = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reco_CosmicMC_BON_EcalAPD200_FullReadout_TKOnly_RECOSIM.root')
)
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/CosmicMC_BONG200_RECO.py,v $'),
    annotation = cms.untracked.string('Reco of simulated cosmics with B=on and ecal gain 200')
)
