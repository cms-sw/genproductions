...
# with command line options: Configuration/GenProduction/python/ALPGEN_60GeV_EXC_10TeV_cff.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V12::All -n 1000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/ALPGEN_60GeV_EXC_10TeV_cff.py nevts:1000'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ALPGEN_60GeV_EXC_10TeV_cff_py_GEN.root'),
