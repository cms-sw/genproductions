...
# with command line options: step3 -sALCA:TkAlCosmics0T+DQM -n 1 --no_exec --magField=0T --conditions FrontierConditions_GlobalTag,COSMMC_21X_V1::All --mc --datatier ALCARECO --eventcontent FEVTSIM --filein file:Reco_TKCosmicMC_BOFF_225.root
