...
# using: 
# $Revision: 1.3 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_InclusivebbMu_Pt_20up_10TeV_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_STARTUP_V5.py,v $
...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/PYTHIA6_InclusivebbMu_Pt_20up_10TeV_py'),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_InclusivebbMu_Pt_20up_10TeV_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
