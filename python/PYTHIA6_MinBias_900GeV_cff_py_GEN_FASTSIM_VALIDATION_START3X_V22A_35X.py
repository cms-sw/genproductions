...
# with command line options: Configuration/GenProduction/python/PYTHIA6_MinBias_900GeV_cff.py -s GEN,FASTSIM,VALIDATION --pileup=NoPileUp --conditions=START3X_V22A::All --eventcontent=FEVTDEBUGHLT --beamspot=Early10TeVCollision --datatier GEN-SIM-DIGI-RECO -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_MinBias_900GeV_cff_py_GEN_FASTSIM_VALIDATION_START3X_V22A_35X.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_MinBias_900GeV_cff_py_GEN_FASTSIM_VALIDATION.root'),
...
process.famosSimHits.VertexGenerator.SigmaZ = 3.91833
process.famosPileUp.VertexGenerator = process.Early10TeVCollisionVtxSmearingParameters
process.famosPileUp.VertexGenerator.SigmaZ = 3.91833 
