...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('POMWIG SD minus Di-jets ptmin 80 GeV at 10TeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POMWIG_SingleDiffractiveDijetsMinus_10TeV_Pt_80_cff_py_GEN_STARTUP_V5.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('POMWIG_SingleDiffractiveDijetsMinus_10TeV_Pt_80_cff_py_GEN.root'),
