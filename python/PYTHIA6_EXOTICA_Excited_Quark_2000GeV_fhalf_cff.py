...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(9.603e-04),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Excited_Quark_2500GeV_fhalf_cff.py,v $'),
    annotation = cms.untracked.string('qstar Mass = 2.5 TeV fhalf at 7 TeV')
)
