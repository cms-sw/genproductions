...
# with command line options: Configuration/GenProduction/python/Herwigpp_QCD_Pt_300.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 300000 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('Herwigpp_QCD_Pt_300_py_GEN.root'),
