...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_TTbar_7TeV_cff_largerISRFSR.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TTbar with TAUOLA at 7TeV, larger isr-fsr')
)
