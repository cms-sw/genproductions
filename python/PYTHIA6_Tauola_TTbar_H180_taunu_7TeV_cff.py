...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_TTbar_H180_taunu_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TTbar Hplus180 To TauNu, with Tauola at 7TeV')
    )
