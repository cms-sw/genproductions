...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/WH_ZH_TTH_HToZZTo4L_M_200_TuneZ2_8TeV_pythia6_tauola_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 WH/ZH/ttH, H->ZZ->4l mH=200GeV with TAUOLA at 8TeV')
)
