...
CTAU_X     = '1p5To150' # (c*tau with units of long-lived particle - mm - central c*tau if more than one value being generated)
...
generator.filterEfficiency = cms.untracked.double(0.165)
