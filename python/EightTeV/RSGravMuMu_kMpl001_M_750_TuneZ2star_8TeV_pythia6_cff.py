...
generator = cms.EDFilter("Pythia6GeneratorFilter",   
    ...
    crossSection  = cms.untracked.double(0.005001),
...
#    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/RSGravMuMu_kMpl001_M_750_TuneZ2star_8TeV_pythia6_cff.py,v $'),
#    annotation = cms.untracked.string('PYTHIA6 RS Graviton to mumu, k/Mpl = 0.01, mass = 750 at sqrt(s) = 8TeV')
#)
