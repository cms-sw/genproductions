...
externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string("GJets_HT-40To100_8TeV-madgraph_final.lhe"),
    numberOfParameters = cms.uint32(10),
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.4.8/8TeV_Summer12/GJets_HT-40To100_8TeV-madgraph/v1',
