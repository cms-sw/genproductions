...
generator = cms.EDFilter(
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bd_rhopi.dec'),
...
jpsifilter = cms.EDFilter(
	...
	ParticleID      = cms.untracked.int32(213),  
        DaughterIDs     = cms.untracked.vint32(-211, 111),
	MinPt           = cms.untracked.vdouble(3.5, 0.), 
	MinEta          = cms.untracked.vdouble(-2.5, -99.), 
	MaxEta          = cms.untracked.vdouble( 2.5,  99.)
        )
...
kfilter = cms.EDFilter(
	...
	ParticleID      = cms.untracked.int32(511),  
        DaughterIDs     = cms.untracked.vint32(-213, 211),
	MinPt           = cms.untracked.vdouble(0., 3.5), 
