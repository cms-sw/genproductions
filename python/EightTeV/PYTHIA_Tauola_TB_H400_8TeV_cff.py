...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0         ! User defined processes',
            ...
            'PMAS(37,1) = 400.   ! charged Higgs mass ',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA_Tauola_TB_H400_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TB Hplus400, with Tauola at 8TeV')
    )
