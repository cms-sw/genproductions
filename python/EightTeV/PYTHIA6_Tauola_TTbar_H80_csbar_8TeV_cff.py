...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Tauola_TTbar_H80_csbar_8TeV_cff.py,v $'),
        annotation = cms.untracked.string('PYTHIA6-TTbar Hplus80 To CSbar')
        )
