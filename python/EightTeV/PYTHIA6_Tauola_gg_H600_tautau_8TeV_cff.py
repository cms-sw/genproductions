...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Tauola_gg_H600_tautau_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 - SUSY gg->H(600)->2tau, with Tauola at 8TeV')
    )
