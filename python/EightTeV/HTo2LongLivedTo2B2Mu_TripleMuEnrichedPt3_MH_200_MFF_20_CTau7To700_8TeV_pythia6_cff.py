...
MASS_HIGGS = '200' # GeV (mass of resonance that decays to long-lived particle pair - GeV)
MASS_X     = '20' # (mass of long-lived particle - GeV)
CTAU_X     = '7To700' # (c*tau with units of long-lived particle - mm - central c*tau if more than one value being generated)
...
generator.filterEfficiency = cms.untracked.double(0.088)
