...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string("DYJetsToLL_M-50_scaledown_8TeV-madgraph_final.lhe"),
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/DYJetsToLL_M-50_scaledown_8TeV-madgraph/v1',
    'DYJetsToLL_M-50_scaledown_8TeV-madgraph','false','true','zjets','5','20','true','0','4'),
