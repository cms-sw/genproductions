...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string("DY2JetsToLL_M-50_scaledown_8TeV-madgraph_final.lhe"),
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/DY2JetsToLL_M-50_scaledown_8TeV-madgraph/v1',
    'DY2JetsToLL_M-50_scaledown_8TeV-madgraph','false','true','zjets','5','20','true','2','99'),
