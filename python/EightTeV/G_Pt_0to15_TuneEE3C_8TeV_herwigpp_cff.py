...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	...
	crossSection = cms.untracked.double(1.727622e+07),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Sumer2012 sample with HERWIGPP: Prompt photon production, pThat = 0 .. 15 GeV, TuneEE3C')
)
