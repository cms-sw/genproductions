...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	...
	crossSection = cms.untracked.double(5.848751e-03),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Sumer2012 sample with HERWIGPP: Prompt photon production, pThat = 800 .. 1400 GeV, TuneEE3C')
)
