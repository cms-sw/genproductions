...
MASS_HIGGS = '300' # GeV (mass of resonance that decays to long-lived particle pair - GeV)
MASS_X     = '125' # (mass of long-lived particle - GeV)
CTAU_X     = '5To500' # (c*tau with units of long-lived particle - mm - central c*tau if more than one value being generated)
...
generator.filterEfficiency = cms.untracked.double(0.107)
