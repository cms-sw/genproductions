...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string("ZnunuG130_8TeV-madgraph_unweighted_events_final.lhe"),
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/ZnunuG130_8TeV_madgraph/v3',
    'ZnunuG130_8TeV_madgraph','false','true','zjets','5','20','true','0','3'),
