...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Tauola_SM_H_2tau_tth_mH120_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 ttH, H->tautau mH=120GeV with TAUOLA at 8TeV')
)
