...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Tauola_TTbar_H150_taunu_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TTbar Hplus150 To TauNu, with Tauola at 8TeV')
    )
