...
generator = cms.EDFilter(
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bd_mumuK0.dec'),
...
decayfilter = cms.EDFilter(
	...
	ParticleID      = cms.untracked.int32(511),  
        DaughterIDs     = cms.untracked.vint32(311, -13, 13),
...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Bd2MuMuK0_TuneZ2star_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('Bs -> mu+ mu- K0 at 8TeV')
    )
