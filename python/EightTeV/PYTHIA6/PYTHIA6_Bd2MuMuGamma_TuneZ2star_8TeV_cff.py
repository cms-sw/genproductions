...
generator = cms.EDFilter(
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bd_mumugamma.dec'),
...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Bd2MuMuGamma_TuneZ2star_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('B0 -> mu+ mu- gamma at 8TeV')
    )
