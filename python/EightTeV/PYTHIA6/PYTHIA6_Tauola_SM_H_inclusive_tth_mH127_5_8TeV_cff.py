...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(25,1)=127.5        !mass of Higgs', 
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Tauola_SM_H_inclusive_tth_mH127_5_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 ttH, inclusive decay mH=127.5GeV with TAUOLA at 8TeV')
)
