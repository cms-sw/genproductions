...
generator = cms.EDFilter(
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bu_mumupi.dec'),
...
decayfilter = cms.EDFilter(
	...
	ParticleID      = cms.untracked.int32(521),  
        DaughterIDs     = cms.untracked.vint32(211, -13, 13),
...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Bu2MuMuPi_TuneZ2star_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('B+ -> mu+ mu- pi+ at 8TeV')
    )
