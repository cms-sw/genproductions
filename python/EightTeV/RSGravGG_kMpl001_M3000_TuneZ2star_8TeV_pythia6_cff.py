...
generator = cms.EDFilter("Pythia6GeneratorFilter",
                         ...
                         crossSection  = cms.untracked.double(4.703e-16),
                         PythiaParameters = cms.PSet(pythiaUESettingsBlock,
                                                     processParameters = cms.vstring('PMAS(347,1)= 3000.         !mass of RS Graviton',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/RSGravGG_kMpl001_M3000_TuneZ2star_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 RS Graviton to gammagamma, k/Mpl = 0.01, mass = 3000 at sqrt(s) = 8TeV')
    )
