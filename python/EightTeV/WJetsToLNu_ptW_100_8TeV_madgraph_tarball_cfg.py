...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string("WJetsToLNu_PtW-100_8TeV-madgraph_unweighted_events_final.lhe"),
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/WJetsToLNu_PtW-100_8TeV-madgraph/v3',
    'WJetsToLNu_PtW-100_8TeV-madgraph','false','true','wjets','5','20','true','0','4'),
