...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
                                             ...
                                             outputFile = cms.string("ZbbJetsToLL_M-50_Massive_8TeV-madgraph_unweighted_events_final.lhe"),
                                             args = cms.vstring( '/slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/ZbbJetsToLL_M-50_Massive_8TeV-madgraph/v1/', #gridpack path
                                                                 'ZbbJetsToLL_M-50_Massive_8TeV-madgraph', #gridpack name, without _tarball.tar.gz
                                                                 'false', #DECAY
                                                                 'true', #REPLACE
                                                                 'zjets', #process
                                                                 '4', #maxjetflavour
