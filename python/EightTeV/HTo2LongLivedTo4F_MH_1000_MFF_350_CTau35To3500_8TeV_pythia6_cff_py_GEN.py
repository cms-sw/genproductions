...
# with command line options: Configuration/GenProduction/python/EightTeV/HTo2LongLivedTo4F_MH_1000_MFF_350_CTau35To3500_8TeV_pythia6_cff.py -s GEN --conditions START50_V13::All --beamspot Realistic8TeVCollision --datatier GEN-SIM --eventcontent RAWDEBUG -n 1000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/GenProduction/python/EightTeV/HTo2LongLivedTo4F_MH_1000_MFF_350_CTau35To3500_8TeV_pythia6_cff.py nevts:1000'),
...
process.RAWDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('HTo2LongLivedTo4F_MH_1000_MFF_350_CTau35To3500_8TeV_pythia6_cff_py_GEN.root'),
