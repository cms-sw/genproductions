...
generator = cms.EDFilter(
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bu_JpsiPi.dec'),
...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/PYTHIA6_Bu2JpsiPi_TuneZ2star_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('Bu -> Jpsi pi at 8TeV')
    )
