...
generator = cms.EDFilter(
    ...
    filterEfficiency = cms.untracked.double(3.56e-3),
...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/PYTHIA6_Bd2MuMu_TuneZ2star_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('Bd -> mu mu at 8TeV')
    )
