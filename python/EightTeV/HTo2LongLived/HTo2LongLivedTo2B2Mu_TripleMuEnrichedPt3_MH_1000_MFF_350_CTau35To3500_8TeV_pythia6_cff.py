...
MASS_X     = '350' # (mass of long-lived particle - GeV)
CTAU_X     = '35To3500' # (c*tau with units of long-lived particle - mm - central c*tau if more than one value being generated)
...
generator.filterEfficiency = cms.untracked.double(0.158)
