...
MASS_HIGGS = '125' # GeV (mass of resonance that decays to long-lived particle pair - GeV)
MASS_X     = '20' # (mass of long-lived particle - GeV)
CTAU_X     = '13To1300' # (c*tau with units of long-lived particle - mm - central c*tau if more than one value being generated)
...
#---------------- in-line HTo2LongLivedTo4F_Block_pythia6_cff.py ---------------
#
...
generator.filterEfficiency = cms.untracked.double(0.042)
