...
generator = cms.EDFilter("Pythia8GeneratorFilter",
                        ...
                        PythiaParameters = cms.PSet(
                            pythia8_unparticle = cms.vstring('Main:timesAllowErrors = 10000', 
                                ...
                                'ExtraDimensionsUnpart:dU = 1.300000', 
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: Unpart_ZTo2Mu_SU_0_dU_1p30_LU_15_8TeV_Tune4C_pythia8_cfi.py,v $'),
    annotation = cms.untracked.string('PYTHIA8 Unpart Z/gamma* to 2Mu')
)
