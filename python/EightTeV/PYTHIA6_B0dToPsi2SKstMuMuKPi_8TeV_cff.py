...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /local/reps/CMSSW/UserCode/Dinardo/B0Analysis/B0KstMuMu/python/PYTHIA6_B0dToPsi2SKstMuMuKPi_7TeV_cff.py,v $'),
	annotation = cms.untracked.string('Summer11: Pythia6+EvtGen generation of B0d --> K*0(K pi) Psi(2S)(Mu+Mu-), 7TeV, D6T tune'))
