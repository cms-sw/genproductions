...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.0996),
    crossSection = cms.untracked.double(27.01),                         
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/QCD_Pt_600To800_MuEnrichedPt5_TuneZ2star_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 QCD at 8TeV, 800>pthat>600, with INCLUSIVE muon preselection (pt(mu) > 5)')
)
