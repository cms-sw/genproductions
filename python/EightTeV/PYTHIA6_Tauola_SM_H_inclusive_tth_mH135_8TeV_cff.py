...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Tauola_SM_H_inclusive_tth_mH135_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 ttH, inclusive decay mH=135GeV with TAUOLA at 8TeV')
)
