...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('8TeV_ttbarleptonic_0j4incl'),
  SherpackLocation = cms.string('slc5_amd64_gcc462/sherpa/1.4.0/8TeV'),
  SherpackChecksum = cms.string('32cdb004fc95a02e5b54031c48dbf838'),
  ...
  SherpaParameters = cms.PSet(parameterSets = cms.vstring(
				...
				"}(beam)",
				"(processes){",
				" # ttbar fully leptonic + up to 4 jets",
				...
				" Max_N_Quarks 7 {9}; # the quarks in the decay don't count",
				" Max_N_Quarks 8 {10}; # the quarks in the decay don't count",
				" End process",
				" Process 93 93 ->  6[a] -6[b] 93{4}",
				" Order_EW 4",
				" Decay 6[a] -> 24[c] 5",
