...
name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/TToBENu_tchannel_0010_LVLT_TuneZ2star_8TeV_comphep_cff.py,v $'),
