...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Tauola_SM_H_2W_wh_zh_tth_mH110_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 WH/ZH/ttH, H->WW mH=110GeV with TAUOLA at 8TeV')
)
