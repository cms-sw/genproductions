...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Tauola_TTbar_H140_taunu_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TW Hplus140 To TauNu, with Tauola at 8TeV')
    )
