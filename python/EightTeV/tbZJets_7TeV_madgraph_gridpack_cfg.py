...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string("tbZ01_7TeV-madgraph_final.lhe"),
    args = cms.vstring('/slc5_ia32_gcc434/madgraph/V5_1.4.8/8TeV_Summer12/tbZ01_7TeV-madgraph/v2', 'tbZ01_7TeV-madgraph', 'false','true','zjets','4','9','false','0','1'),
