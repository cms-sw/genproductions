...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.0204),
    crossSection = cms.untracked.double(30980),                         
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('b/c->e filtered QCD pthat 170-250, 8 TeV')
)
