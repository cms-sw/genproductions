## Wprime to WZ, Z2star tune, Summer12 production
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(0.0007166),
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0', 
                                        ...
                                        'MDME(190,1)=    0   !W to d               ubar', 
                                        'MDME(191,1)=    0   !W to d               cbar', 
                                        'MDME(192,1)=    0   !W to d               tbar', 
                                        'MDME(194,1)=    0   !W to s               ubar', 
                                        'MDME(195,1)=    0   !W to s               cbar', 
                                        'MDME(196,1)=    0   !W to s               tbar', 
                                        'MDME(198,1)=    0   !W to b               ubar', 
                                        'MDME(199,1)=    0   !W to b               cbar', 
                                        'MDME(200,1)=    0   !W to b               tbar', 
                                        'MDME(206,1)=    1   !W to e               nu_e', 
                                        'MDME(207,1)=    1   !W to mu              nu_mu', 
                                        'MDME(208,1)=    1   !W to tau             nu_tau', 
                                        'MDME(174,1)=    1   !Z to d               dbar', 
                                        'MDME(175,1)=    1   !Z to u               ubar', 
                                        'MDME(176,1)=    1   !Z to s               sbar', 
                                        'MDME(177,1)=    1   !Z to c               cbar', 
                                        'MDME(178,1)=    1   !Z to b               bbar', 
                                        'MDME(179,1)=    1   !Z to t               tbar', 
                                        'MDME(182,1)=    0   !Z to e-              e+', 
                                        'MDME(183,1)=    0   !Z to nu_e            nu_ebar', 
                                        'MDME(184,1)=    0   !Z to mu-             mu+', 
