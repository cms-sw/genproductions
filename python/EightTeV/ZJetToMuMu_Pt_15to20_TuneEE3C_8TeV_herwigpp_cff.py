...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	...
	crossSection = cms.untracked.double(7.055123e+01),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Sumer2012 sample with HERWIGPP: Z + Jet production, Z -> mumu, pThat = 15 .. 20 GeV, TuneEE3C')
)
