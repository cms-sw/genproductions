...
generator = cms.EDFilter("Pythia6GeneratorFilter", 
    ...
    crossSection = cms.untracked.double(0.0003314),
    PythiaParameters = cms.PSet(
        pythiaUESettingsBlock,
        processParameters = cms.vstring('PMAS(32,1)= 4500.           !mass of Zprime', 
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('default documentation string for ZprimeDijet_4500_8TeV_TuneD6Tcff.py'),
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/ZprimeToJJ_M_4500_TuneD6T_8TeV_pythia6_cff.py,v $')
)
