...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA_Tauola_TB_H300_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TB Hplus300, with Tauola at 8TeV')
    )
