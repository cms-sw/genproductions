...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/HERWIGPP_POWHEG_H115_bbbar_W_lnu_8TeV_cff.py,v $'),
	annotation = cms.untracked.string('HERWIGPP/POWHEG: (H->bb)(W->lnu), m(H)=115 GeV, l=e or mu or tau')
)
