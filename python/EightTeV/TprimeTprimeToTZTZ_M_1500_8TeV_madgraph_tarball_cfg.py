...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string("TprimeTprimeToTZTZ_M-1500_8TeV-madgraph_unweighted_events_final.lhe"),
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/TprimeTprimetoInclusive/v1','TprimeTprimeToTZTZ_M-1500_8TeV-madgraph',
