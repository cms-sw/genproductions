...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(2.065831e+07),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Summer2012-Z2star sample with PYTHIA6: Prompt photon production, pThat = 15 .. 3000 GeV, weighted, TuneD6T')
)
