...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Tauola_TTbar_H170_HBHB_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TTbar Hplus170 To TauNu, with Tauola at 8TeV')
    )
