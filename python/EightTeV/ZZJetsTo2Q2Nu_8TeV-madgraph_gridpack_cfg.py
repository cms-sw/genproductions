...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
                                             ...
                                             outputFile = cms.string("ZZJetsTo2Q2Nu_8TeV-madgraph_unweighted_events_final.lhe"),
                                             args = cms.vstring('/slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/ZZJetsTo2Q2Nu_8TeV-madgraph/v1/', #gridpack path
                                                                'ZZJetsTo2Q2Nu_8TeV-madgraph', #gridpack name, without _gridpack.tar.gz
                                                                'false', #DECAY
                                                                'false', #REPLACE
                                                                'diboson', #process
                                                                '5', #maxjetflavour
