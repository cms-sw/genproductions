...
generator = cms.EDFilter("Pythia6GeneratorFilter",   
    ...
    crossSection  = cms.untracked.double(0.357),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EXOTICA_ZPrimeSSMEE_M750_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA ZPRIME SSM ee, mass = 750 at sqrt(s) = 7TeV')
)
