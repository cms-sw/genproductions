...
# with command line options: PhotonJet_Pt_10_7TeV_cfi.py -s GEN,FASTSIM,HLT:GRun --pileup=InitialPileUp --geometry DB --conditions=auto:mc --eventcontent=RECOSIM --datatier GEN-SIM-DIGI-RECO -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('PhotonJet_Pt_25_7TeV_cfi.py nevts:10'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PhotonJet_7TeV_FASTSIM.root'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.0052),
    pythiaHepMCVerbosity = cms.untracked.bool(False),
    comEnergy = cms.double(7000.0),
    crossSection = cms.untracked.double(37000.0),
