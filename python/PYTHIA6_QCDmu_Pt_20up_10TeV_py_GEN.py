...
# using: 
# $Revision: 1.7 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDmu_Pt_20up_10TeV_py_GEN_STARTUP_V5.py,v $
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_QCDmu_Pt_20up_10TeV_py_GEN.root'),
