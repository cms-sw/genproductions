...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(1.501e-02),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/QstarToGJ_M_2000_fhalf_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('qstar Mass = 2 TeV fhalf at 8 TeV')
)
