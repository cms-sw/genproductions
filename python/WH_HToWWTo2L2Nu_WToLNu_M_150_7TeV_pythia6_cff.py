...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Tauola_SM_H_2W_wh_zh_tth_mH150_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 WH, H->WW->2L2Nu, W->LNu mH=150GeV with TAUOLA at 7TeV, TuneZ2')
)
