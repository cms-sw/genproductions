...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EWK_Wmunu_10TeV_cff_py_GEN_STARTUP_V5.py,v $')
)
...
process.mugenfilter = cms.EDFilter("PythiaFilter",
