...
# using: 
# $Revision: 1.1 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MadGraph_XQCUT15_10TeV_GEN_cff_py__GEN_SIM_DIGI_L1_DIGI2RAW_HLT_STARTUP.py,v $
...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValMadGraph_XQCUT15_10TeV_GEN_cff.pyGEN,SIM,DIGI,L1,DIGI2RAW,HLT'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/MadGraph_XQCUT15_10TeV_GEN_cff_py__GEN_SIM_DIGI_L1_DIGI2RAW_HLT_STARTUP.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('MadGraph_XQCUT15_10TeV_GEN_cff_py__GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
