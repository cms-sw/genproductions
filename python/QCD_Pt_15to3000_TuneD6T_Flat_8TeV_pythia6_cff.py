...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(3.000923e+10),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Spring2011 sample with PYTHIA6: QCD dijet production, pThat = 15 .. 3000 GeV, weighted, TuneD6T')
)
