...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.00116),
    crossSection = cms.untracked.double(296500000.),                         
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_InclusiveMu10_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-MinBias at 7TeV, pthat>20, with INCLUSIVE muon preselection (pt(mu) > 10)')
)
