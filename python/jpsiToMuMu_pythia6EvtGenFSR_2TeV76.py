...
generator = cms.EDFilter("Pythia6GeneratorFilter",
                         ...
                         crossSection = cms.untracked.double(8978000.0),  # to be changed _after_ generation with proper number; no effect at generation time
                         filterEfficiency = cms.untracked.double(0.0513), # to be changed _after_ generation with proper number; no effect at generation time
