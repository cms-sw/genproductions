...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.00054),
    comEnergy = cms.double(7000.0),
    crossSection = cms.untracked.double(1.206e+03),
...
('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDEnrichedpt_300_500_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('QCDEnrichedpt-300-500 at 7TeV')
)
