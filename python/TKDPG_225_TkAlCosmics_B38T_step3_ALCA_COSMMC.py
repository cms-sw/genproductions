...
# with command line options: step3 -sALCA:TkAlCosmics+DQM -n 1 --no_exec --magField=38T --conditions FrontierConditions_GlobalTag,COSMMC_21X_V1::All --mc --datatier ALCARECO --eventcontent FEVTSIM --filein file:Reco_TKCosmicMC_BON_225.root
