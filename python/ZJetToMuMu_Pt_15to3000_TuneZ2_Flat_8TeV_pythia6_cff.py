...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(7.165848e+05),
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Spring2011 sample with PYTHIA6: Z + Jet production, Z -> mumu, pThat = 15 .. 3000 GeV, TuneZ2')
)
