...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.0104),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_QCD_Pt_80_170_7TeV_BCToEFilter_cff.py,v $'),
    annotation = cms.untracked.string('b/c->e filtered QCD pthat 80-170, 7 TeV')
)
