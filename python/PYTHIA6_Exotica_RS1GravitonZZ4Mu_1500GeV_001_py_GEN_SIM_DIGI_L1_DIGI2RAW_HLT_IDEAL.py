...
# with command line options: Configuration/GenProduction/python/PYTHIA6_Exotica_RS1GravitonZZ4Mu_1500GeV_001.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_Exotica_RS1GravitonZZ4Mu_1500GeV_001_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL.py,v $'),
    annotation = cms.untracked.string('RS1GravitonZZ4Mu_1500GeV_001')
)
...
process.source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(1.928e-06),
    ...
    PythiaParameters = cms.PSet(
        pythiaUESettings = cms.vstring('MSTJ(11)=3     ! Choice of the fragmentation function', 
            ...
            'PARP(93)=15.0  ! '),
        processParameters = cms.vstring('PMAS(347,1)=1500.0        !mass of RS Graviton', 
            'MSEL=0                  !(D=1)', 
            'PARP(50) = 0.054  ! Dimensionless coupling constant for RS G*', 
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Exotica_RS1GravitonZZ4Mu_1500GeV_001_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
