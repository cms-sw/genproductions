...
generator = cms.EDFilter("ReggeGribovPartonMCGeneratorFilter",
                    ...
                    model = cms.int32(0),
                    crossSection = cms.untracked.double(72970000000.0),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/GeneratorInterface/ReggeGribovPartonMCInterface/python/ReggeGribovPartonMC_EposLHC_14TeV_pp_cfi.py,v $'),
