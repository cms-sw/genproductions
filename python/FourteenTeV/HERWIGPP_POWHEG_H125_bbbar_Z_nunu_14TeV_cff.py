...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/FourteenTeV/HERWIGPP_POWHEG_H125_bbbar_Z_nunu_14TeV_cff.py,v $'),
