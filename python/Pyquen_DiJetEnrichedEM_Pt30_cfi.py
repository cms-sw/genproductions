...
hiSignal = cms.EDFilter("PyquenGeneratorFilter",
                        ecalTrigPt30,             # ecal gen event selector
                        collisionParameters,
                        qgpParameters,
                        pyquenParameters,
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/UserCode/edwenger/GenProduction/Pyquen_DiJetEnrichedEM_Pt30_cfi.py,v $'),
