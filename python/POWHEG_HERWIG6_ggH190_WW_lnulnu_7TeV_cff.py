...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(0.1405),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_HERWIG6_ggH130_WW_lnulnu_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('POWHEG + HERWIG6 - ggF Higgs -> WW -> lnulnu at 7TeV - MCDB ID 1005 - Xsec in pb')
    )
