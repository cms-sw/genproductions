...
# with command line options: Configuration/GenProduction/python/ALPGEN_Vjets_INC_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('default documentation string for ALPGEN_Vjets_INC_10TeV_cff.py'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/ALPGEN_Vjets_INC_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ALPGEN_Vjets_INC_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
...
# 1491.579u 10.212s 25:27.92 98.2%        0+0k 0+28624io 1251pf+0w
# output rootfile size for 10 generated events: 13.46 MB
