...
# using: 
# $Revision: 1.5 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDmu_Pt_80-120_10TeV_py_GEN_STARTUP_V5.py,v $
...
process.source = cms.Source("PythiaSource",
    ...
    comEnergy = cms.untracked.double(0.033.0),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_QCDmu_Pt_80-120_10TeV_py_GEN.root'),
