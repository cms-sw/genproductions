...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.257),
    crossSection = cms.untracked.double(507900000.),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCD_Pt_20_7TeV_doubleEMEnrichFilter_cff.py,v $'),
    annotation = cms.untracked.string('double em-enriching filtered QCD pthat 20-inf, 10 TeV')
)
