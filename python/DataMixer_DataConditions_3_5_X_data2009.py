...
#
# IOV set based on GlobalTag GR09_R_35X_V3
#
...
# the real run to be overlaid
    ...
    process.ecalConditions1 = cms.ESSource("PoolDBESSource",                                          
        ...
        tag = cms.string('EcalADCToGeVConstant_coll09_v4_offline')                                    
        ),                                                                                            
             cms.PSet(                                                                                
        record = cms.string('EcalChannelStatusRcd'),                                                  
        tag = cms.string('EcalChannelStatus_cosmcoll09_v2_offline')                                   
        ),                                                                                            
             cms.PSet(                                                                                
        ...
        tag = cms.string('EcalIntercalibConstants_coll09_v4_offline')                                 
        ),                                                                                            
             cms.PSet(                                                                                
    ...
    process.hcalConditions = cms.ESSource("PoolDBESSource",                                           
        ...
        tag = cms.string('HcalGains_v2.30_offline')                                                   
        ),                                                                                            
        cms.PSet(                                                                                     
        ...
        tag = cms.string('HcalPedestals_ADC_v9.09_offline')                                        
        ),                                                                                            
        cms.PSet(                                                                                     
