...
# using: 
# $Revision: 1.5 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_QCDmu_Pt_50-80_10TeV_py_GEN_STARTUP_V5.py,v $
...
process.source = cms.Source("PythiaSource",
    ...
    filterEfficiency = cms.untracked.double(0.021),
