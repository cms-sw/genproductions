...
# with command line options: Configuration/GenProduction/python/ALPGEN_Exotica_5jet_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V12::All -n 10 --no_exec
...
# fraction of events that fail fragmentation cuts = 0.95098
# 1422.606u 15.073s 24:31.67 97.6% 0+0k 6384+37824io 1559pf+0w
# output rootfile size for 10 events is 18M
