...
# with command line options: Configuration/GenProduction/python/ALPGEN_Exotica_5jet_10TeV_cff.py -s GEN,SIM,DIGI,L1,DIGI2RAW,HLT --eventcontent RAWSIM --datatier GEN-SIM-RAW --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 10 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/ALPGEN_Exotica_5jet_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT_IDEAL.py,v $')
)
...
process.source = cms.Source("AlpgenSource",
    ...
    fileNames = cms.untracked.vstring('file:5j_0'),
    ...
    crossSection = cms.untracked.double(94010.0),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ALPGEN_Exotica_5jet_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
...
# 1902.997u 8.883s 32:26.05 98.2% 0+0k 8128+43424io 2028pf+0w
# output rootfile size for 10 generated events: 19.49 MB
