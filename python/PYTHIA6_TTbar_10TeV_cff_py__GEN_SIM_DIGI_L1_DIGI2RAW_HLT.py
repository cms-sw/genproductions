...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValPYTHIA6_TTbar_10TeV_cff.pyGEN,SIM,DIGI,L1,DIGI2RAW,HLT'),
...
process.source = cms.Source("PythiaSource",
    ...
    crossSection = cms.untracked.double(218.5),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_TTbar_10TeV_cff_py__GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root'),
