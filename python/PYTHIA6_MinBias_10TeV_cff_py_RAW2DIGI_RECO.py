...
# using: 
# $Revision: 1.1 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_MinBias_10TeV_cff_py_RAW2DIGI_RECO_IDEAL_V6.py,v $
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:PYTHIA6_MinBias_10TeV_cff_py_GEN_SIM_DIGI_L1_DIGI2RAW_HLT.root')
)

# Output definition
process.output = cms.OutputModule("PoolOutputModule",
    outputCommands = process.RECOEventContent.outputCommands,
    fileName = cms.untracked.string('PYTHIA6_MinBias_10TeV_cff_py_RAW2DIGI_RECO.root'),
