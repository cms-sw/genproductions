...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_MinBiasP0_900GeV_Summer09-STARTUP3X_V8P_900GeV.py,v $')
)
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        pythiaUESettings = cms.vstring('MSTU(21)=1     ! Check on possible errors during program execution', 
            ...
            'MSTJ(41)=12    ! explicit pt ordered showers', 
            'PARJ(21)=0.313 ! HAD', 
            'PARJ(41)=0.49  ! HAD', 
            'PARJ(42)=1.2   ! HAD', 
            'PARJ(46)=1.0   ! HAD', 
