...
# with command line options: step3 -s ALCA:TkAlCosmics0T+TkAlCosmicsHLT+MuAlStandAloneCosmics+MuAlGlobalCosmics+MuAlBeamHaloOverlaps+DQM --scenario cosmics --conditions FrontierConditions_GlobalTag,CRAFT_ALL_V12::All --eventcontent FEVT --no_exec
