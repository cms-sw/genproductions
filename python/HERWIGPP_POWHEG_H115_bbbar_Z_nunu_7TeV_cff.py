...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /cvs_server/repositories/CMSSW/UserCode/SchieferD/GenProduction/python/HERWIGPP_POWHEG_H115_bbbar_Z_nunu_7TeV_cff.py,v $'),
