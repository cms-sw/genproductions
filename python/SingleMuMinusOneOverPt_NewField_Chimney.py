...
# with command line options: SingleMuPt100_cfi -s GEN:ProductionFilterSequence,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,RECO --number 1000 --eventcontent FEVTSIM --conditions FrontierConditions_GlobalTag,MC_31X_V5::All --datatier GEN-SIM-DIGI-RAW-RECO --no_exec --magField=MagneticField_38T_ToscaMap090322_cff
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('SingleMuMinusOneOverPt_NewField_Chimney_GEN_SIM_DIGI_L1_DIGI2RAW_RAW2DIGI_RECO_MC.root'),
...
process.generator = cms.EDProducer("FlatRandomOneOverPtGunProducer",
    ...
    MinEta = cms.double(-0.75),
    MaxEta = cms.double(0.75),
    MinPhi = cms.double(-0.25),
    MaxPhi = cms.double(0.8),
