...
# with command line options: Configuration/GenProduction/python/PYTHIA6_MSSM_A_2mu_mA115_10TeV_cff.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9::All -n 1000 --no_exec
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_MSSM_A_2mu_mA115_10TeV_cff_py_GEN.root'),
