...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Z/gamma* to ee sample, M(ee) gt40 GeV -- sqrt(s) = 10TeV'),
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/PYTHIA6_EWK_Zee_10TeV_cff_py_GEN_STARTUP_V5.py,v $')
)
...
process.ProductionFilterSequence = cms.Sequence(process.eegenfilter)
