...
# with command line options: Configuration/GenProduction/python/ALPGEN_Exotica_4jet_10TeV_cff.py -s GEN --eventcontent RAWSIM --datatier GEN --conditions FrontierConditions_GlobalTag,IDEAL_V9:All -n 1000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/ALPGEN_Exotica_4jet_10TeV_cff_py_GEN_IDEAL.py,v $')
)
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ALPGEN_Exotica_4jet_10TeV_cff_py_GEN.root'),
