...
generator = cms.EDFilter(
    ...
    crossSection     = cms.untracked.double(0.1322),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /cvs_server/repositories/CMSSW/UserCode/SchieferD/GenProduction/python/HERWIGPP_POWHEG_H120_bbbar_W_lnu_7TeV_cff.py,v $'),
