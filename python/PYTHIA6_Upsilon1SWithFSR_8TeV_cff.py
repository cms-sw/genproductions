...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(87100.0),
    # TrigReport  Trig Bit#    Visited     Passed     Failed      Error Name
    # TrigReport     1    0      10000      10000          0          0 generator
    # TrigReport     1    0      10000       2772       7228          0 oniafilter
    # TrigReport     1    0       2772       1511       1261          0 mumugenfilter                     
    filterEfficiency = cms.untracked.double(0.151),
