...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/projects/CMSSW/rep/CMSSW/Configuration/GenProduction/python/Attic/POWHEG_HERWIG6_ttbar_lnublnub_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('POWHEG + HERWIG6 - ttbar -> lnublnub at 7TeV')
    )
