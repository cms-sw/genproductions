...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_PYTHIA6_Tauola_qqH_tautau_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('POWHEG+PYTHIA6+Tauola - VBF H->TauTau at 8TeV, Z2 UE tune')
    )
