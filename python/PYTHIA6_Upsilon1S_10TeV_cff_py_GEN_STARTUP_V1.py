...
# using: 
# $Revision: 1.1 $
# $Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Upsilon1S_10TeV_cff_py_GEN_STARTUP_V1.py,v $
...
process.ReleaseValidation = cms.untracked.PSet(
    primaryDatasetName = cms.untracked.string('RelValConfiguration/GenProduction/python/PYTHIA6_Upsilon1S_10TeV_cff_py'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Upsilon1S_10TeV_cff_py_GEN_STARTUP_V1.py,v $')
)
...
process.source = cms.Source("PythiaSource",
    ...
    filterEfficiency = cms.untracked.double(0.1),
    pythiaHepMCVerbosity = cms.untracked.bool(False),
    comEnergy = cms.untracked.double(10000.0),
    crossSection = cms.untracked.double(13922.0),
...
process.output = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PYTHIA6_Upsilon1S_10TeV_cff_py_GEN.root'),
