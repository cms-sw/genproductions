...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(1.049e-01),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/QstarToGJ_M_1500_fhalf_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('qstar Mass = 1.5 TeV fhalf at 8 TeV')
)
