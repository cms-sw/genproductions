...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/QCD_Pt_120to170_CTEQ6L1_8TeV_herwig6_cff.py,v $'),
...
generator = cms.EDFilter("Herwig6GeneratorFilter",
	...
	crossSection = cms.untracked.double(1.2743E+05),
