...
# Use CMSSW_2_2_9. CMS geometry incl. smaller shafts and more detailed simu
# New, new B-field
# Last update: K.Hoepfner 29.04.09
# - p_min = 10 GeV, full angular acceptance
# - Global tag = COSMMC_22X_V6
# - Keep settings from previous production for tracker, DT, HCAL ZS
# - ECAL digitization using SelectiveReadout Gain=50, selective readout suppressed for EE
# - L1 with open DT LUTs, new CSC L1 triggering on singles
#-----------------------------------------------------------------------
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source:/cvs_server/repositories/CMSSW/CMSSW/Configuration/Spring09Production/data/CosmicMC_BON_500GeV_AllCMS_newBfield_cfg.py'),
    annotation = cms.untracked.string('Simulation for CRAFT data, underground, new TOSCA field map, B-field ON and 1 BX, special detector settings') 
    )
...
process.CosMuoGenSource.MinP = 500.
...
##    outputCommands = process.FEVTEventContent.outputCommands,
    fileName = cms.untracked.string('CosmicMC_BON_229_RAW_500GeV_newBfield.root'),
