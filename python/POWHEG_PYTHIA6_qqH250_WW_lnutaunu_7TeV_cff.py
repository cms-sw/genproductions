...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(0.01429),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/POWHEG_PYTHIA6_qqH250_WW_lnutaunu_7TeV_cff.py,v $'),
