      ...
      subroutine qqb_dm_monophot_v_PSamps(p,i1,i2,i3,i4,i5,qgqb) 
      implicit none 
...
!------ subleading colour (swap i2 and i3) 
      call qqb_dm_monophot_PSamps_fill(p,i1,i3,i2,i4,i5,amp_slc)
     ...
     &                 amp_slc(h1,h2,h3,h4))
      ...
      subroutine qqb_dm_monophot_PSamps_fill(p,i1,i2,i3,i4,i5,amp) 
      implicit none
      include 'constants.f' 
      include 'dm_params.f' 
...
!      l23=lnrat(musq,-s(i2,i3))
      ...
      s123=dble(s(i1,i2))+dble(s(i2,i3))+dble(s(i1,i3))
