      ...
      subroutine qqb_dm_monojet_v_Samps(p,i1,i2,i3,i4,i5,qgqb) 
      implicit none 
...
!------ leading colour      
       call qqb_dm_monojet_lc_Samps(p,i1,i2,i3,i4,i5,amp_lc) 
!------ subleading colour (swap i2 and i3) 
      call qqb_dm_monojet_slc_Samps(p,i1,i3,i2,i4,i5,amp_slc)
