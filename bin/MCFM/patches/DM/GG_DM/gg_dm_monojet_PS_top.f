...
!========= Note we remove the *v because of the full theory. 
      ...
      gg=+avegg*ehsvm3_odd_dm(s(1,2),s(1,5),s(2,5),s34)*hdecay
      qq=+aveqq*ehsvm4_odd_dm(s(1,2),s(1,5),s(2,5),s34)*hdecay
      qg=-aveqg*ehsvm4_odd_dm(s(1,5),s(1,2),s(2,5),s34)*hdecay
      gq=-aveqg*ehsvm4_odd_dm(s(2,5),s(1,5),s(1,2),s34)*hdecay
