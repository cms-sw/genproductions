...
!      cor_fac=4d0/(za(i5,i6)*zb(i6,i5))
!      write(6,*) 'my -1 -1', cdabs(amp(2,1,1,1,2)*cor_fac)
!      write(6,*) 'my 1 1', cdabs(amp(2,2,2,1,2)*cor_fac)
!      write(6,*) 'my -1 1', cdabs(amp(2,1,2,1,2)*cor_fac)
!      write(6,*) 'my 1 -1', cdabs(amp(2,2,1,1,2)*cor_fac)
      
!      write(6,*) 'test -1 -1 ',cdabs(z2jet_1LL(-1,-1))
!      write(6,*) 'test 1 1 ',cdabs(z2jet_1LL(1,1))       
!      write(6,*) 'test -1 1 ',cdabs(z2jet_1LL(-1,1))
!      write(6,*) 'test 1 -1 ',cdabs(z2jet_1LL(1,-1)) 
!      pause 
...
!      double precision amp2,amp_tes(2,2) 
      integer h1,h2
!      double complex cor_fac 
      do h1=1,6
         do h2=1,6 
