...
template_filename = 'HWminusJ_HanythingJ_NNPDF31_13p6TeV_V{decay_mode}_template.input'.format(decay_mode=decay_mode)
...
for mass, width in masswidth:
  ...
  with open("HWminusJ_HanythingJ_NNPDF31_13p6TeV_M{mass}_V{decay_mode}.input".format(mass=mass, decay_mode=decay_mode), "w") as f:
