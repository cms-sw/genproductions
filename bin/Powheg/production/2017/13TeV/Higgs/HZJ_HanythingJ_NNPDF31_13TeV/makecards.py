...
template_filename = 'HZJ_HanythingJ_NNPDF31_13TeV_V{decay_mode}_template.input'.format(decay_mode=decay_mode)
...
for mass, width in masswidth:
  ...
  with open("HZJ_HanythingJ_NNPDF31_13TeV_M{mass}_V{decay_mode}.input".format(mass=mass, decay_mode=decay_mode), "w") as f:
