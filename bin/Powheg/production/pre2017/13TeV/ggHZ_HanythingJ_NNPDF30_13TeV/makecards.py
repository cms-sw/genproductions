...
template_filename = 'ggHZ_HanythingJ_NNPDF30_13TeV_Vhadronic_template.input'
...
for mass, width in masswidth:
  ...
  with open("ggHZ_HanythingJ_NNPDF30_13TeV_M{mass}_Vhadronic.input".format(mass=mass), "w") as f:
