...
int main(int argc, char** argv)
{
    ...
    std::ofstream outFile500("test_500_800.lhe" , std::ios::out);
    std::ofstream outFile800("test_800_1200.lhe" , std::ios::out);
    std::ofstream outFile1200("test_1200_1800.lhe" , std::ios::out);
    std::ofstream outFile1800("test_1800.lhe" , std::ios::out);
    ...
    while(!initialFile.eof()) {
        ...
        if(line == "</LesHouchesEvents>") {
            outFile500 << line << std::endl;
            outFile800 << line << std::endl;
            outFile1200 << line << std::endl;
            outFile1800 << line << std::endl;
            break;
        }
        ...
        if( line == "</event>" ) {
            ...
            if(write_LHE_file){
                ...
                if(b_first and b_second and (L_1 + L_2).M() > 500. and (L_1 + L_2).M() < 800.) {
                    n_events_out++;
                ...
                } else if (b_first and b_second and (L_1 + L_2).M() > 800. and (L_1 + L_2).M() < 1200.) {
                    n_events_out++;
                    while(!initialFile_2.eof()) {
                        getline(initialFile_2, line_2);
                ...
                } else if (b_first and b_second and (L_1 + L_2).M() > 1200. and (L_1 + L_2).M() < 1800.) {
                    n_events_out++;
                    while(!initialFile_2.eof()) {
                        getline(initialFile_2, line_2);
                ...
                } else if (b_first and b_second and (L_1 + L_2).M() > 1800.) {
                    n_events_out++;
                    while(!initialFile_2.eof()) {
                        getline(initialFile_2, line_2);
