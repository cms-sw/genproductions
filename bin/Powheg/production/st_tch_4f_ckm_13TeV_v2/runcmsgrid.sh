...
#      fi;      
    ...
    echo -e "\ncomputing weights for 100 NNPDF3.0 4F variations\n"
    iteration=292000
    lastfile=292102
    counter=2000
    while [ $iteration -lt $lastfile ];
    ...
    echo -e "\ncomputing weights for CT14nlo_NF4\n"	
    iteration=13191
    echo -e "\n PDF set ${iteration}"
    sed -e 's/.*lhans1.*/lhans1 '$iteration'/ ; s/.*lhans2.*/lhans2 '$iteration'/' powheg.input.tmp > powheg.input
    counter=$(( counter + 1 ))
    ...
    echo -e "\ncomputing weights for CT10nlo_nf4\n"	
    iteration=11081
    lastfile=11083
    while [ $iteration -lt $lastfile ];
    do
    ...
    echo -e "\ncomputing weights for MSTW2008nlo68cl_nf4variations\n"
    iteration=23299
    lastfile=23340
    while [ $iteration -lt $lastfile ];
    do
