...
if not args1.retar and not args1.resubmit:
    for dm  in args1.dmrange:
        ...
        #Generation offshell does not yet work
            ...
            job_file.write('sed "s@XSECTION@$xs@g"     runcmsgrid_template.sh > runcmsgrid.sh \n')
            job_file.write('mv runcmsgrid.sh runcmsgrid_template.sh                        \n')
            job_file.write('sed "s@XSECUNC@$xsun@g"   runcmsgrid_template.sh > runcmsgrid.sh \n')
            job_file.write('mv runcmsgrid.sh runcmsgrid_template.sh                        \n')
            job_file.write('sed "s@VegasNc2=50000@VegasNc2=\\$\\{nevt\\}@g"   runcmsgrid_template.sh > runcmsgrid.sh \n')
            job_file.write('mv runcmsgrid.sh runcmsgrid_template.sh                        \n')
            job_file.write('sed "s@BASEDIR@JHUGen_%s_%s_%s@g"   runcmsgrid_template.sh > runcmsgrid.sh \n'  % (args1.name,med,dm))
