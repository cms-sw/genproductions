...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpackLocation = cms.string('/afs/cern.ch/cms/generators/www/slc6_amd64_gcc491/sherpa/2.1.1/13TeV/sherpa_ttH_Hinclusive_01j_MCatNLO_OpenLoops_13TeV_MASTER.tgz'),
  SherpackChecksum = cms.string('7a40fc6382b27b4d3e3fa635a3782ec6'),
