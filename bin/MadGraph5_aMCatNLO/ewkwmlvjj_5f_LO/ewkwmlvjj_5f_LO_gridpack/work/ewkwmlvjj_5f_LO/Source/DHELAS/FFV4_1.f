...
C     
     ...
     $ +CI*(V3(5)))+(P1(2)*(-CI*(V3(4))+V3(5))+P1(3)*(V3(3)+V3(6)))))
     $ +M1*(F2(5)*1D0/2D0*(V3(4)-CI*(V3(5)))+1D0/2D0*(F2(6)*(V3(3)
     $ -V3(6))))))
     ...
     $ *2D0*(-V3(3)+V3(6))+2D0*(F2(4)*(V3(4)+CI*(V3(5)))))))
     ...
     $ *(F2(3)*2D0*(-V3(4)+CI*(V3(5)))+2D0*(F2(4)*(V3(3)+V3(6))))))
      END
