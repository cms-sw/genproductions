            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 121 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX121(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_121(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_121/ZEROAMP_121
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,6),W(1,2),GC_105,MDL_MW, ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,6),W(1,4),W(1,10),GC_105,AMP(6))
      CALL FFV1_2(W(1,6),W(1,7),GC_1,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,4),W(1,2),W(1,10),GC_105,AMP(7))
      CALL FFV2_5_1(W(1,2),W(1,9),-GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,6),W(1,4),W(1,10),GC_105,AMP(8))
      CALL FFV2_3_2(W(1,6),W(1,9),GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,4),W(1,2),W(1,10),GC_105,AMP(9))
      CALL FFV2_3(W(1,6),W(1,1),GC_43,MDL_MW, ZERO,W(1,4))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX121 = MATRIX121 + ZTEMP*DCONJG(JAMP(I,N))
     ...
     $   +AMP(11)+AMP(12))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_121(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 121, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_121(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 121, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX121(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS121/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS121
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX121=SOINDEX_FOR_SQUARED_ORDERS121(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS121(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS121/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS121 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS121'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN121(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX121(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX121'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX121(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS121(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS121 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS121'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
