...
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,6),W(1,11),W(1,9),GC_100,AMP(6))
      CALL FFV2_1(W(1,2),W(1,7),-GC_101,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,6),W(1,11),W(1,9),-GC_101,AMP(7))
      CALL FFV2_1(W(1,2),W(1,7),GC_106,MDL_MT, FK_MDL_WT,W(1,11))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,6),W(1,11),W(1,9),GC_47,AMP(8))
...
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,5),W(1,12),W(1,9),GC_100,AMP(14))
      CALL FFV2_1(W(1,2),W(1,11),-GC_101,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,5),W(1,12),W(1,9),-GC_101,AMP(15))
      CALL FFV2_1(W(1,2),W(1,11),GC_106,MDL_MT, FK_MDL_WT,W(1,12))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,5),W(1,12),W(1,9),GC_47,AMP(16))
