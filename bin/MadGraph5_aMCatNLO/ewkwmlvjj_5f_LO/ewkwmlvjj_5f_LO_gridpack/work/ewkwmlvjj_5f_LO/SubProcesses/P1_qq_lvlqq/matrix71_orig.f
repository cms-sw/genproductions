...
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,10),W(1,2),W(1,8),GC_100,AMP(9))
      CALL FFV2_2(W(1,6),W(1,9),GC_101,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,10),W(1,2),W(1,8),GC_101,AMP(10))
      CALL FFV2_2(W(1,6),W(1,9),GC_102,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,10),W(1,2),W(1,8),GC_43,AMP(11))
