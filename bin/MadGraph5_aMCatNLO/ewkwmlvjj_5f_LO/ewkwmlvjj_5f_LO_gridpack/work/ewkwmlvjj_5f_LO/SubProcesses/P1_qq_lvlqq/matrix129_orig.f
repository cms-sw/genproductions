            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 129 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX129(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_129(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_129/ZEROAMP_129
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_2(W(1,6),W(1,7),GC_100,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,9),W(1,5),W(1,8),-GC_101,AMP(1))
...
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,9),W(1,5),W(1,8),GC_105,AMP(3))
...
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,11),W(1,5),W(1,8),GC_105,AMP(9))
      CALL FFV1_1(W(1,5),W(1,9),GC_2,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,2),W(1,11),W(1,8),GC_105,AMP(10))
      CALL FFV2_3_2(W(1,2),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,11),W(1,5),W(1,8),GC_105,AMP(11))
      CALL FFV2_5_1(W(1,5),W(1,10),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,2),W(1,11),W(1,8),GC_105,AMP(12))
      CALL FFV2_1(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,6),W(1,11),W(1,7),GC_100,AMP(13))
      CALL FFV2_1(W(1,1),W(1,8),GC_101,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,6),W(1,11),W(1,7),GC_101,AMP(14))
      CALL FFV2_1(W(1,1),W(1,8),GC_43,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,6),W(1,11),W(1,7),GC_102,AMP(15))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX129 = MATRIX129 + ZTEMP*DCONJG(JAMP(I,N))
     ...
     $   +AMP(3))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_129(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 129, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_129(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 129, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX129(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS129/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS129
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX129=SOINDEX_FOR_SQUARED_ORDERS129(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS129(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS129/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS129 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS129'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN129(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX129(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX129'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX129(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS129(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS129 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS129'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
