...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV2_2(W(1,1),W(1,8),-GC_101,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,4),W(1,5),W(1,10),-GC_101,AMP(10))
      CALL FFV2_2(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,4),W(1,5),W(1,10),GC_100,AMP(11))
      CALL FFV2_2(W(1,1),W(1,8),GC_105,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,4),W(1,5),W(1,10),GC_105,AMP(12))
      CALL FFV2_3(W(1,6),W(1,5),-GC_101,MDL_MW, FK_MDL_WW,W(1,4))
      CALL FFV2_2(W(1,1),W(1,4),-GC_101,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),GC_100,AMP(13))
      CALL FFV2_2(W(1,1),W(1,4),GC_100,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),GC_101,AMP(14))
      CALL FFV2_2(W(1,1),W(1,4),GC_105,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),GC_43,AMP(15))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(13)+AMP(14)+AMP(15)
      JAMP(2,1) = (-1.000000000000000D+00)*AMP(1)+(-1.000000000000000D
     ...
     $ *AMP(11)+(-1.000000000000000D+00)*AMP(12)
