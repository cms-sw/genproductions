            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 115 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX115(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_115(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_115/ZEROAMP_115
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_1(W(1,6),W(1,7),GC_101,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,2),W(1,9),W(1,8),GC_43,AMP(1))
      CALL FFV2_1(W(1,6),W(1,7),GC_100,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,2),W(1,9),W(1,8),GC_105,AMP(2))
      CALL FFV2_1(W(1,6),W(1,7),-GC_105,MDL_MT, ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,2),W(1,9),W(1,8),GC_108,AMP(3))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV2_3_3(W(1,1),W(1,6),GC_50,GC_58,MDL_MZ, ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,11),W(1,6),W(1,7),GC_101,AMP(13))
      CALL FFV2_2(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,11),W(1,6),W(1,7),GC_100,AMP(14))
      CALL FFV2_2(W(1,1),W(1,8),-GC_105,MDL_MT, ZERO,W(1,11))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,11),W(1,6),W(1,7),-GC_105,AMP(15))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.000000000000000D+00)*AMP(14)+(-1.000000000000000D+00)*AMP(15)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX115 = MATRIX115 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_115(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 115, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_115(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 115, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX115(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS115/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS115
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX115=SOINDEX_FOR_SQUARED_ORDERS115(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS115(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS115/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS115 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS115'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN115(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX115(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX115'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX115(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS115(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS115 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS115'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
