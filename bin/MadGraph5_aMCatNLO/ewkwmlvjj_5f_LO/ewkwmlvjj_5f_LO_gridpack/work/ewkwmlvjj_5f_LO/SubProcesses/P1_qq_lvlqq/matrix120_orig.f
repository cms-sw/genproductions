            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 120 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX120(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_120(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_120/ZEROAMP_120
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,6),W(1,2),GC_100,MDL_MW, ZERO,W(1,8))
      CALL FFV1_1(W(1,3),W(1,7),GC_3,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,9),W(1,8),GC_108,AMP(1))
      CALL FFV2_5_3(W(1,5),W(1,1),-GC_50,GC_58,MDL_MZ, ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_1(W(1,2),W(1,7),GC_2,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,6),W(1,4),W(1,10),GC_100,AMP(6))
      CALL FFV1_2(W(1,6),W(1,7),GC_1,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,4),W(1,2),W(1,10),GC_100,AMP(7))
      CALL FFV2_5_1(W(1,2),W(1,9),-GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,6),W(1,4),W(1,10),GC_100,AMP(8))
      CALL FFV2_3_2(W(1,6),W(1,9),GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,4),W(1,2),W(1,10),GC_100,AMP(9))
      CALL FFV2_3(W(1,6),W(1,1),GC_101,MDL_MW, ZERO,W(1,4))
      CALL FFV2_2(W(1,5),W(1,4),GC_100,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),-GC_101,AMP(10))
      CALL FFV2_2(W(1,5),W(1,4),GC_101,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),GC_100,AMP(11))
      CALL FFV2_2(W(1,5),W(1,4),GC_102,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),GC_105,AMP(12))
      CALL FFV2_1(W(1,1),W(1,10),GC_100,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,5),W(1,6),W(1,8),GC_100,AMP(13))
      CALL FFV2_1(W(1,1),W(1,10),GC_101,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,5),W(1,6),W(1,8),GC_101,AMP(14))
      CALL FFV2_1(W(1,1),W(1,10),GC_43,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,5),W(1,6),W(1,8),GC_102,AMP(15))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.000000000000000D+00)*AMP(11)+(-1.000000000000000D+00)*AMP(12)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX120 = MATRIX120 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      IF(SDE_STRAT.EQ.1)THEN
        ...
        AMP2(13)=AMP2(13)+(AMP(13)+AMP(14)+AMP(15))*DCONJG(AMP(13)
     $   +AMP(14)+AMP(15))
        AMP2(10)=AMP2(10)+(AMP(10)+AMP(11)+AMP(12))*DCONJG(AMP(10)
     $   +AMP(11)+AMP(12))
      ENDIF
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_120(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 120, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_120(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 120, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX120(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS120/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS120
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX120=SOINDEX_FOR_SQUARED_ORDERS120(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS120(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS120/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS120 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS120'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN120(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX120(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX120'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX120(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS120(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS120 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS120'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
