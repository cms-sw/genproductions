...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFV2_1(W(1,5),W(1,7),GC_102,ZERO, FK_ZERO,W(1,4))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_1(W(1,5),W(1,7),GC_108,MDL_MT, FK_MDL_WT,W(1,4))
