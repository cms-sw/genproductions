...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,6),W(1,2),GC_2,ZERO, FK_ZERO,W(1,12))
      CALL FFV2_2(W(1,4),W(1,11),GC_108,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,7),W(1,3),W(1,12),GC_3,AMP(9))
      CALL FFV2_5_3(W(1,6),W(1,2),-GC_50,GC_58,MDL_MZ, ZERO,W(1,13))
      CALL FFV2_1(W(1,3),W(1,11),GC_108,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,4),W(1,14),W(1,13),GC_62,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_4_0(W(1,7),W(1,3),W(1,13),GC_50,GC_59,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL VVV1_0(W(1,12),W(1,8),W(1,11),-GC_3,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL VVV1_0(W(1,8),W(1,11),W(1,13),GC_53,AMP(13))
      CALL FFV2_2(W(1,6),W(1,11),-GC_101,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,7),W(1,2),W(1,8),-GC_101,AMP(14))
      CALL FFV2_2(W(1,6),W(1,11),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,7),W(1,2),W(1,8),GC_100,AMP(15))
      CALL FFV2_2(W(1,6),W(1,11),GC_105,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,7),W(1,2),W(1,8),GC_105,AMP(16))
      CALL FFV1_2(W(1,1),W(1,12),GC_1,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,7),W(1,5),W(1,8),-GC_101,AMP(17))
      CALL FFV2_2(W(1,1),W(1,8),-GC_101,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,7),W(1,5),W(1,12),GC_2,AMP(18))
      CALL FFV2_3_2(W(1,1),W(1,13),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,12),W(1,5),W(1,8),-GC_101,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV2_5_0(W(1,7),W(1,5),W(1,13),-GC_50,GC_58,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,7),W(1,2),W(1,9),GC_2,AMP(21))
      CALL FFV1_2(W(1,1),W(1,9),GC_1,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,13),W(1,2),W(1,8),-GC_101,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_5_0(W(1,7),W(1,2),W(1,10),-GC_50,GC_58,AMP(23))
      CALL FFV2_3_2(W(1,1),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,7),W(1,2),W(1,8),-GC_101,AMP(24))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.000000000000000D+00)*AMP(19)+(-1.000000000000000D+00)*AMP(20)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        ...
        AMP2(14)=AMP2(14)+(AMP(14)+AMP(15)+AMP(16))*DCONJG(AMP(14)
     $   +AMP(15)+AMP(16))
