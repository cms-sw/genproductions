...
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,6),W(1,7),W(1,8),GC_100,AMP(15))
      CALL FFV2_1(W(1,2),W(1,11),-GC_101,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,6),W(1,7),W(1,8),-GC_101,AMP(16))
      CALL FFV2_1(W(1,2),W(1,11),GC_106,MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,6),W(1,7),W(1,8),GC_47,AMP(17))
...
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,12),W(1,2),W(1,10),GC_100,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,7),W(1,2),W(1,10),-GC_101,AMP(23))
      CALL FFV2_2(W(1,1),W(1,8),GC_47,MDL_MT, ZERO,W(1,7))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,7),W(1,2),W(1,10),GC_106,AMP(24))
