            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 237 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX237(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_237(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_237/ZEROAMP_237
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,2),W(1,8),-GC_101,AMP(1))
      CALL FFV2_2(W(1,5),W(1,7),GC_101,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,2),W(1,8),GC_100,AMP(2))
      CALL FFV2_2(W(1,5),W(1,7),GC_102,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,4),W(1,2),W(1,8),GC_105,AMP(3))
      CALL FFV2_3(W(1,6),W(1,2),GC_100,MDL_MW, ZERO,W(1,4))
      CALL FFV2_1(W(1,1),W(1,8),-GC_101,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,6),W(1,4),GC_100,AMP(4))
      CALL FFV2_1(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,5),W(1,6),W(1,4),GC_101,AMP(5))
      CALL FFV2_1(W(1,1),W(1,8),GC_105,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,5),W(1,6),W(1,4),GC_102,AMP(6))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX237 = MATRIX237 + ZTEMP*DCONJG(JAMP(I,N))
     ...
     $   +AMP(3))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_237(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 237, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_237(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 237, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX237(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS237/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS237
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX237=SOINDEX_FOR_SQUARED_ORDERS237(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS237(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS237/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS237 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS237'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN237(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX237(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX237'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX237(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS237(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS237 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS237'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
