...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV2_5_3(W(1,6),W(1,5),-GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1
     $ ,10))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_3(W(1,2),W(1,5),GC_43,MDL_MW, ZERO,W(1,11))
      CALL FFV2_1(W(1,1),W(1,8),-GC_101,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,6),W(1,5),W(1,11),GC_100,AMP(9))
      CALL FFV2_1(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,6),W(1,5),W(1,11),GC_101,AMP(10))
      CALL FFV2_1(W(1,1),W(1,8),GC_105,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,6),W(1,5),W(1,11),GC_102,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,2),W(1,5),W(1,9),GC_1,AMP(12))
      CALL FFV1_1(W(1,1),W(1,9),GC_2,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,2),W(1,11),W(1,8),GC_105,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_3_0(W(1,2),W(1,5),W(1,10),GC_50,GC_58,AMP(14))
      CALL FFV2_5_1(W(1,1),W(1,10),-GC_50,GC_58,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,2),W(1,5),W(1,8),GC_105,AMP(15))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +00)*AMP(14)+(-1.000000000000000D+00)*AMP(15)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        AMP2(9)=AMP2(9)+(AMP(9)+AMP(10)+AMP(11))*DCONJG(AMP(9)+AMP(10)
     $   +AMP(11))
