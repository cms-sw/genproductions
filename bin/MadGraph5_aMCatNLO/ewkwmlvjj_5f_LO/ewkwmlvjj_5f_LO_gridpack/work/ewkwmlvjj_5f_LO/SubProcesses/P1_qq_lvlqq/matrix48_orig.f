...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV2_3(W(1,1),W(1,5),GC_105,MDL_MW, ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,7),W(1,5),W(1,8),GC_105,AMP(18))
...
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,9),W(1,5),W(1,8),GC_105,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,7),W(1,5),W(1,12),-GC_50,GC_58,AMP(21))
      CALL FFV2_2(W(1,1),W(1,8),GC_43,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,12),W(1,2),W(1,10),GC_102,AMP(22))
