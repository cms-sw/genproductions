...
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,12),W(1,5),W(1,8),GC_100,AMP(19))
      CALL FFV2_2(W(1,1),W(1,9),GC_101,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,12),W(1,5),W(1,8),GC_101,AMP(20))
      CALL FFV2_2(W(1,1),W(1,9),GC_102,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,12),W(1,5),W(1,8),GC_43,AMP(21))
      CALL FFV2_2(W(1,1),W(1,10),GC_100,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,12),W(1,2),W(1,8),GC_100,AMP(22))
      CALL FFV2_2(W(1,1),W(1,10),GC_101,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,12),W(1,2),W(1,8),GC_101,AMP(23))
      CALL FFV2_2(W(1,1),W(1,10),GC_102,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,12),W(1,2),W(1,8),GC_43,AMP(24))
