...
C     Amplitude(s) for diagram number 14
      ...
      CALL FFV2_1(W(1,2),W(1,11),GC_101,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,6),W(1,7),W(1,8),GC_101,AMP(15))
      CALL FFV2_1(W(1,2),W(1,11),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,6),W(1,7),W(1,8),GC_100,AMP(16))
      CALL FFV2_1(W(1,2),W(1,11),-GC_105,MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,6),W(1,7),W(1,8),-GC_105,AMP(17))
      CALL FFV1_2(W(1,1),W(1,9),GC_1,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,7),W(1,5),W(1,8),GC_100,AMP(18))
      CALL FFV2_2(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,7),W(1,5),W(1,9),GC_2,AMP(19))
      CALL FFV2_3_2(W(1,1),W(1,12),GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,9),W(1,5),W(1,8),GC_100,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,7),W(1,5),W(1,12),-GC_50,GC_58,AMP(21))
      CALL FFV2_2(W(1,1),W(1,8),GC_101,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,12),W(1,2),W(1,10),GC_101,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,7),W(1,2),W(1,10),GC_100,AMP(23))
      CALL FFV2_2(W(1,1),W(1,8),-GC_105,MDL_MT, ZERO,W(1,7))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,7),W(1,2),W(1,10),-GC_105,AMP(24))
