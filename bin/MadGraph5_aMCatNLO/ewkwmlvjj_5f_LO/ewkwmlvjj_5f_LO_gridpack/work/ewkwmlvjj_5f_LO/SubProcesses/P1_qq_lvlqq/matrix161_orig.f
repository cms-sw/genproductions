...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WW)
      ...
      CALL FFV2_2(W(1,1),W(1,7),GC_100,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,5),W(1,8),-GC_101,AMP(1))
      CALL FFV2_2(W(1,1),W(1,7),GC_101,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,5),W(1,8),GC_100,AMP(2))
      CALL FFV2_2(W(1,1),W(1,7),GC_102,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,4),W(1,5),W(1,8),GC_105,AMP(3))
      CALL FFV2_3(W(1,6),W(1,5),GC_105,MDL_MW, FK_MDL_WW,W(1,4))
      CALL FFV2_2(W(1,1),W(1,4),GC_100,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,6),W(1,2),W(1,8),-GC_101,AMP(4))
      CALL FFV2_2(W(1,1),W(1,4),GC_101,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,6),W(1,2),W(1,8),GC_100,AMP(5))
      CALL FFV2_2(W(1,1),W(1,4),GC_102,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,6),W(1,2),W(1,8),GC_105,AMP(6))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(4)+AMP(5)+AMP(6)
