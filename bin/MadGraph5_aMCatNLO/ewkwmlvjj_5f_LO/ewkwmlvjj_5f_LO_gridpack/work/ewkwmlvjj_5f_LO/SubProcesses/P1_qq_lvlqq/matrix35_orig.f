...
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,6),W(1,7),W(1,8),GC_43,AMP(17))
      CALL FFV2_1(W(1,1),W(1,8),GC_43,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,6),W(1,7),W(1,12),GC_1,AMP(18))
      CALL FFV2_5_1(W(1,1),W(1,13),-GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,6),W(1,12),W(1,8),GC_43,AMP(19))
...
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,2),W(1,13),W(1,8),GC_43,AMP(22))
...
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,2),W(1,7),W(1,8),GC_43,AMP(24))
