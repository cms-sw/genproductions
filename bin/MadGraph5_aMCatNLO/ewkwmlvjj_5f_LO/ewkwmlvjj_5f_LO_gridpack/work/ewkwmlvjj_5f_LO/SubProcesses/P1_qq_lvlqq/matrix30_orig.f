...
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,7),W(1,2),W(1,10),GC_100,AMP(15))
      CALL FFV2_2(W(1,5),W(1,11),GC_101,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,7),W(1,2),W(1,10),GC_101,AMP(16))
      CALL FFV2_2(W(1,5),W(1,11),GC_102,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,7),W(1,2),W(1,10),GC_43,AMP(17))
      CALL FFV1_1(W(1,1),W(1,9),GC_2,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,6),W(1,7),W(1,10),GC_101,AMP(18))
      CALL FFV2_1(W(1,1),W(1,10),GC_101,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,6),W(1,7),W(1,9),GC_1,AMP(19))
      CALL FFV2_5_1(W(1,1),W(1,12),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,6),W(1,9),W(1,10),GC_101,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_3_0(W(1,6),W(1,7),W(1,12),GC_50,GC_58,AMP(21))
      CALL FFV2_1(W(1,1),W(1,10),GC_100,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,5),W(1,12),W(1,8),GC_100,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,5),W(1,7),W(1,8),GC_101,AMP(23))
      CALL FFV2_1(W(1,1),W(1,10),GC_43,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,5),W(1,7),W(1,8),GC_102,AMP(24))
