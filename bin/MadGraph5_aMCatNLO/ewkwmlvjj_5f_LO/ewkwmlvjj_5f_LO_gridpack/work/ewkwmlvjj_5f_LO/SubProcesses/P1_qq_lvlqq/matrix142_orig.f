            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 142 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX142(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_142(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_142/ZEROAMP_142
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,9),W(1,5),W(1,8),GC_100,AMP(1))
...
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,9),W(1,5),W(1,8),GC_43,AMP(3))
...
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,11),W(1,5),W(1,8),GC_43,AMP(9))
      CALL FFV1_1(W(1,5),W(1,9),GC_2,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,2),W(1,11),W(1,8),GC_43,AMP(10))
      CALL FFV2_3_2(W(1,2),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,11),W(1,5),W(1,8),GC_43,AMP(11))
      CALL FFV2_5_1(W(1,5),W(1,10),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,2),W(1,11),W(1,8),GC_43,AMP(12))
      CALL FFV2_1(W(1,1),W(1,8),-GC_101,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,6),W(1,11),W(1,7),-GC_101,AMP(13))
      CALL FFV2_1(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,6),W(1,11),W(1,7),GC_100,AMP(14))
      CALL FFV2_1(W(1,1),W(1,8),GC_105,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,6),W(1,11),W(1,7),GC_105,AMP(15))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX142 = MATRIX142 + ZTEMP*DCONJG(JAMP(I,N))
     ...
     $   +AMP(3))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_142(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 142, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_142(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 142, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX142(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS142/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS142
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX142=SOINDEX_FOR_SQUARED_ORDERS142(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS142(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS142/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS142 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS142'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN142(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX142(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX142'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX142(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS142(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS142 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS142'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
