            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 46 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX46(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_46(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_46/ZEROAMP_46
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,1),W(1,5),GC_105,MDL_MW, ZERO,W(1,7))
      CALL FFV1P0_3(W(1,2),W(1,6),GC_1,ZERO, FK_ZERO,W(1,8))
      CALL FFV2_2(W(1,4),W(1,7),GC_108,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,9),W(1,3),W(1,8),GC_3,AMP(1))
      CALL FFV2_3_3(W(1,2),W(1,6),GC_50,GC_58,MDL_MZ, ZERO,W(1,10))
      CALL FFV2_1(W(1,3),W(1,7),GC_108,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,4),W(1,11),W(1,10),GC_62,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV2_4_0(W(1,9),W(1,3),W(1,10),GC_50,GC_59,AMP(3))
      CALL FFV2_3(W(1,4),W(1,3),GC_108,MDL_MW, FK_MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,8),W(1,9),W(1,7),-GC_3,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVV1_0(W(1,9),W(1,7),W(1,10),GC_53,AMP(5))
      CALL FFV2_1(W(1,6),W(1,7),GC_102,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,2),W(1,11),W(1,9),GC_43,AMP(6))
      CALL FFV2_1(W(1,6),W(1,7),GC_105,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,2),W(1,11),W(1,9),GC_105,AMP(7))
      CALL FFV2_1(W(1,6),W(1,7),GC_108,MDL_MT, ZERO,W(1,11))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,2),W(1,11),W(1,9),GC_108,AMP(8))
      CALL FFV1P0_3(W(1,1),W(1,6),GC_1,ZERO, FK_ZERO,W(1,11))
      CALL FFV2_3(W(1,2),W(1,5),GC_105,MDL_MW, ZERO,W(1,7))
      CALL FFV1_1(W(1,3),W(1,11),GC_3,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,4),W(1,12),W(1,7),GC_108,AMP(9))
      CALL FFV2_3_3(W(1,1),W(1,6),GC_50,GC_58,MDL_MZ, ZERO,W(1,12))
      CALL FFV2_4_1(W(1,3),W(1,12),GC_50,GC_59,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,4),W(1,13),W(1,7),GC_108,AMP(10))
      CALL FFV2_2(W(1,4),W(1,12),GC_62,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,13),W(1,3),W(1,7),GC_108,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL VVV1_0(W(1,11),W(1,9),W(1,7),-GC_3,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL VVV1_0(W(1,9),W(1,7),W(1,12),GC_53,AMP(13))
      CALL FFV1_2(W(1,2),W(1,11),GC_1,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,13),W(1,5),W(1,9),GC_105,AMP(14))
      CALL FFV1_1(W(1,5),W(1,11),GC_2,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,2),W(1,13),W(1,9),GC_105,AMP(15))
      CALL FFV2_3_2(W(1,2),W(1,12),GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,13),W(1,5),W(1,9),GC_105,AMP(16))
      CALL FFV2_5_1(W(1,5),W(1,12),-GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,2),W(1,13),W(1,9),GC_105,AMP(17))
      CALL FFV2_2(W(1,1),W(1,9),GC_43,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,13),W(1,6),W(1,7),GC_102,AMP(18))
      CALL FFV2_2(W(1,1),W(1,9),GC_105,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,13),W(1,6),W(1,7),GC_105,AMP(19))
      CALL FFV2_2(W(1,1),W(1,9),GC_108,MDL_MT, ZERO,W(1,2))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,2),W(1,6),W(1,7),GC_108,AMP(20))
      CALL FFV1_2(W(1,1),W(1,8),GC_1,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,2),W(1,5),W(1,9),GC_105,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,13),W(1,5),W(1,8),GC_2,AMP(22))
      CALL FFV2_3_2(W(1,1),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,8),W(1,5),W(1,9),GC_105,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_5_0(W(1,13),W(1,5),W(1,10),-GC_50,GC_58,AMP(24))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(1)+AMP(2)+AMP(3)+AMP(4)+AMP(5)+AMP(6)+AMP(7)
     $ +AMP(8)+AMP(21)+AMP(22)+AMP(23)+AMP(24)
     ...
     $ -1.000000000000000D+00)*AMP(19)+(-1.000000000000000D+00)*AMP(20)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX46 = MATRIX46 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      IF(SDE_STRAT.EQ.1)THEN
        ...
        AMP2(12)=AMP2(12)+(AMP(12)+AMP(13))*DCONJG(AMP(12)+AMP(13))
        AMP2(14)=AMP2(14)+(AMP(14)+AMP(16))*DCONJG(AMP(14)+AMP(16))
        AMP2(15)=AMP2(15)+(AMP(15)+AMP(17))*DCONJG(AMP(15)+AMP(17))
        AMP2(1)=AMP2(1)+(AMP(1)+AMP(3))*DCONJG(AMP(1)+AMP(3))
        ...
        AMP2(18)=AMP2(18)+(AMP(18)+AMP(19))*DCONJG(AMP(18)+AMP(19))
        AMP2(20)=AMP2(20)+AMP(20)*DCONJG(AMP(20))
        AMP2(21)=AMP2(21)+(AMP(21)+AMP(23))*DCONJG(AMP(21)+AMP(23))
        AMP2(22)=AMP2(22)+(AMP(22)+AMP(24))*DCONJG(AMP(22)+AMP(24))
      ENDIF
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_46(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 46, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_46(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 46, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX46(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS46/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS46
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX46=SOINDEX_FOR_SQUARED_ORDERS46(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS46(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS46/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS46 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS46'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN46(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX46(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX46'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX46(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS46(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS46 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS46'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
