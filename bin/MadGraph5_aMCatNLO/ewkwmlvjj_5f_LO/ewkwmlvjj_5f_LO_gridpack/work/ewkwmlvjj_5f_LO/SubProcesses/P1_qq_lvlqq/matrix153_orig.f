            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 153 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX153(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_153(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_153/ZEROAMP_153
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -1.000000000000000D+00)*AMP(11)+(-1.000000000000000D+00)*AMP(12)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX153 = MATRIX153 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_153(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 153, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_153(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 153, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX153(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS153/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS153
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX153=SOINDEX_FOR_SQUARED_ORDERS153(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS153(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS153/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS153 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS153'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN153(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX153(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX153'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX153(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS153(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS153 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS153'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
