...
for b in bins:
    ...
    if not os.path.exists(fDir):
        mkdir = "mkdir "+fDir
        os.system(mkdir)
    fName1 = "DYJetsToLL_M-1to10_"+bstring+"13TeV-madgraphMLM-pythia8_proc_card.dat"
    fName2 = "DYJetsToLL_M-1to10_"+bstring+"13TeV-madgraphMLM-pythia8_run_card.dat"
...
output DYJetsToLL_M-1to10_"""+bstring+"""13TeV-madgraphMLM-pythia8 -nojpeg
    """)
    f2.writelines("""
#*********************************************************************
#                       MadGraph5_aMC@NLO                            *
...
#*********************************************************************
  """+minptll+"""	= ptllmin ! Minimum pt for 4-momenta sum of leptons(l and vl)
  """+maxptll+"""	= ptllmax ! Maximum pt for 4-momenta sum of leptons(l and vl)
#*********************************************************************
# Inclusive cuts                                                     *
#*********************************************************************
