...
for H_decay in H_decays :
    for mass in mass_points :
        ...
        directoryName = str('./Radion_hh_narrow/Radion_hh'+H_decay+'_narrow_M'+mass)
        print directoryName
        if generate==1 :
            os.makedirs( directoryName )
            os.chdir( directoryName )

            run_card = open( 'Radion_hh'+H_decay+'_narrow_M'+mass+'_run_card.dat', 'w' )
            ...
            for line in fileinput.input('Radion_hh'+H_decay+'_narrow_M'+mass+'_proc_card.dat', inplace=True): 
                print line.rstrip().replace('Radion_hh_hdecay_narrow_Mmass', 'Radion_hh'+H_decay+'_narrow_M'+mass),'\n'
