...
os.system('cp '+old_cardsPath+'/'+'setcuts.f'+' '+ old_cardsPath+'/'+prefix+'/bbDM_2HDMa_MH3_AA_MH4_XX_Mchi_YY_setcuts.f' )
...
def submitgrid(MH3, MH4, Mchi):
    ...
    setcutcards    = d_setcutcards.replace("AA",str(MH3)).replace("XX",str(MH4)).replace("YY",str(Mchi))
    ...
    change_cards(d_setcutcards, setcutcards, MH3,MH4, Mchi)
    ...
    os.system('nohup PYTHONPATH=$PYTHONPATH:/usr/lib64/python2.6/site-packages; ./submit_condor_gridpack_generation.sh '+outdir+' '+cardspath+' > mysubmit_'+outdir+'.debug 2>&1 &')


Mchi = [1]
MH3 = [600,1200]
MH4 = [100,50,100,150,200,250,300,350,400,450,500,700,750,1000]
    ...
    for i in Mchi:
        for j in MH4:
            ...
            if j < k:
                ...
                mh4 = j
                mchi = i
                print("MH3=", mh3, "MH4= ", mh4,"Mchi= ", mchi)
