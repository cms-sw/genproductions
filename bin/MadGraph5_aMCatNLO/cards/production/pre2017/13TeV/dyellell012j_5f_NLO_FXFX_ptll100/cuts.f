...
C     file, others are in ./Source/kin_functions.f
      REAL*8 R2_04,invm2_04,dilep_pt_04,pt_04,eta_04,pt,eta
      external R2_04,invm2_04,dilep_pt_04,pt_04,eta_04,pt,eta
c local integers
      integer i,j
            ...
            if (is_a_lp(i)) then
               do j=nincoming+1,nexternal
                  if (is_a_lm(j)) then
                     ...
                     if (dilep_pt_04(p(0,i),p(0,j),1d0).lt.100d0) then
                        passcuts_user=.false.
                        return
                     endif
...
c-----
      ...
      END
       ...
       DOUBLE PRECISION FUNCTION dilep_pt_04(P1,P2,dsign)
c************************************************************************
c     Invarient mass of 2 particles
c************************************************************************
      IMPLICIT NONE
...
c-----
      ...
      do i=0,3
         ptot(i)=p1(i)+dsign*p2(i)
      enddo
      dilep_pt_04 = dsqrt(ptot(1)**2+ptot(2)**2)
      RETURN
      END
