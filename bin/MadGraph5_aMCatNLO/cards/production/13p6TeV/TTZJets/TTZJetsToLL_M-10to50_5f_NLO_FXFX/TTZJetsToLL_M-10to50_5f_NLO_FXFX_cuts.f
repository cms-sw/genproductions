c *****************************************************************
c This file has been edited to include an  mll_sf < 50 cut. 
c Source code: MG5_aMC_v2_9_13/Template/NLO/SubProcesses/cuts.f 
c Changes: L146 to L150: set passcuts_user to false if mll_sf > 50 
c *****************************************************************
                  ...
                  if (is_a_lm(j)) then
                     ...
                     if (ipdg(i).eq.-ipdg(j)) then
                        ...
                        if (mll_sf.gt.0d0) then
                           if (invm2_04(p(0,i),p(0,j),1d0).gt.50**2) then
                              passcuts_user=.false.
                              return
                           endif
                        endif
