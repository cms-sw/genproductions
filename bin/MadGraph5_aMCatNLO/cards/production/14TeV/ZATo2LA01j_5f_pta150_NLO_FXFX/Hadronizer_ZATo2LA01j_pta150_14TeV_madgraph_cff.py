...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/14TeV/madgraph/V5_2.4.2/ZATo2LA01j_5f_pta150_NLO_FXFX/v1/ZATo2LA01j_5f_pta150_NLO_FXFX_slc6_amd64_gcc481_CMSSW_7_1_30_tarball.tar.xz'),
    nEvents = cms.untracked.uint32(100000),
    numberOfParameters = cms.uint32(1),
    outputFile = cms.string('cmsgrid_final_ZATo2LA01j_5f_pta150_NLO.lhe'),
