...
print "This script will create the DS_IS, DS_IS_runningBW and DS_runningBW variations for the dilep tW sample. This should be executed from this very folder."

prename = "ST_tW_5f_NLO_dilep_DS"
