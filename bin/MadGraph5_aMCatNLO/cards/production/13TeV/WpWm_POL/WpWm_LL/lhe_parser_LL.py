...
if '__main__' == __name__:    
    ...
    output = open('output_events_LL.lhe', 'w')
    ...
    for event in lhe:
        ...
        for particle in event:
            ...
            if particle.pid == 24 and particle.helicity == 0 and particle.status == 1:
                countwp += 1
                #print "if ",countwp
            if particle.pid == -24 and particle.helicity == 0 and particle.status == 1:
                countwm += 1
            #print "countwp = ",countwp, "\t countwm = ",countwm
                #print "ifm ",countwm
            #if math.fabs(particle.pid) == 24 and particle.helicity != 0:
            #    countVeto += 1
        #write this modify event
        #print "======================================"
        #if countwp == 1 and countwm == 1 and countVeto == 0:
        if countwp == 1 and countwm == 1:
            #print "countwp = ",countwp, "\t countwm = ",countwm
            #print event
            countEvent +=1
