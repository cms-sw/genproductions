...
for m in MassList:
    ...
    with open (f"TpTp_M{m}_ttgg_channel/TpTp_M{m}_ttgg_channel_extramodels.dat",'w') as _file:
        _file.write(modelCardData)

    with open (f"TpTp_M{m}_ttgg_channel/TpTp_M{m}_ttgg_channel_run_card.dat",'w') as _file:
        _file.write(runCardData)

    with open (f"TpTp_M{m}_ttgg_channel/TpTp_M{m}_ttgg_channel_proc_card.dat",'w') as _file:
