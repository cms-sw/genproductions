...
generate p p > tp tp~, ( tp > a t, ( t > b w+, w+ > wdecay wdecay ) ), ( tp~ > a t~, ( t~ > b~ w-, w- > wdecay wdecay ) )
...
for m in MassList:
    if not os.path.exists(f"TpTp_M{m}_ttaa_channel"):
        os.mkdir(f"TpTp_M{m}_ttaa_channel")

    with open (f"TpTp_M{m}_ttaa_channel/TpTp_M{m}_ttaa_channel_customizecards.dat",'w') as _file:
        _file.write(customCardData%m)

    with open (f"TpTp_M{m}_ttaa_channel/TpTp_M{m}_ttaa_channel_extramodels.dat",'w') as _file:
        _file.write(modelCardData)

    with open (f"TpTp_M{m}_ttaa_channel/TpTp_M{m}_ttaa_channel_run_card.dat",'w') as _file:
        _file.write(runCardData)

    with open (f"TpTp_M{m}_ttaa_channel/TpTp_M{m}_ttaa_channel_proc_card.dat",'w') as _file:
