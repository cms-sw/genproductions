...
sample = 'VBFToRadionToHH_htatahbb_MMASS' 
...
for mass in masses:
    ...
    file_run_card = 'M%i/VBFToRadionToHH_htatahbb_M%i_run_card.dat' % (mass,mass)
    file_proc_card = 'M%i/VBFToRadionToHH_htatahbb_M%i_proc_card.dat' % (mass,mass)
    file_customizecards = 'M%i/VBFToRadionToHH_htatahbb_M%i_customizecards.dat' % (mass,mass)
    file_extramodels = 'M%i/VBFToRadionToHH_htatahbb_M%i_extramodels.dat' % (mass,mass)
