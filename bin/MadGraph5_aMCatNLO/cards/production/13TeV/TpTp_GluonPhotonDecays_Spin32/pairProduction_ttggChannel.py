...
for m in MassList:
    if not os.path.exists("TpTp_M%s_ttgg_channel"%m):
        os.mkdir("TpTp_M%s_ttgg_channel"%m)

    with open ("TpTp_M%s_ttgg_channel/TpTp_M%s_ttgg_channel_customizecards.dat"%(m, m),'w') as _file:
        _file.write(customCardData%m)

    with open ("TpTp_M%s_ttgg_channel/TpTp_M%s_ttgg_channel_extramodels.dat"%(m, m),'w') as _file:
        _file.write(modelCardData)

    with open ("TpTp_M%s_ttgg_channel/TpTp_M%s_ttgg_channel_run_card.dat"%(m, m),'w') as _file:
        _file.write(runCardData)

    with open ("TpTp_M%s_ttgg_channel/TpTp_M%s_ttgg_channel_proc_card.dat"%(m, m),'w') as _file:
