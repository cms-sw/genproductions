...
def submitgrid(MH3,MH4,tb,st):
    ...
    #os.system('nohup ./submit_cmsconnect_gridpack_generation.sh  '+ outdir +' '+ cardspath +'  4 "4 Gb" > mysubmit_'+outdir+'.debug 2>&1 &')          # Debu off
    os.system('./gridpack_generation.sh ' + outdir + ' ' + cardspath)                                                                            # Debu
...
f=open('par_scans_2HDMa_gammagamma.txt','r')
