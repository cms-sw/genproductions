...
def main():
    ...
    # First Set
    # unit of MZp is GeV 
    # MZpList = [100, 250, 500, 550, 600, 650, 700, 750, 1000, 1250, 1500, 1750, 2000]    #original file values
    MZpList = [650, 700, 750, 1000, 1250, 1500, 1750, 2000]

    #unit of MChi is GeV
    #mdm = MChi
    mdmList = [1, 10, 50, 100]   #original file values
    ...
    for MZp in MZpList:
        for mdm in mdmList:
            ...
            shutil.copyfile('monoHiggs_ZpBaryonic_UL/ZpBaryonic_template/ZpBaryonic_run_card.dat','cards/'+dirName+'/'+dirName+'_run_card.dat')
            shutil.copyfile('monoHiggs_ZpBaryonic_UL/ZpBaryonic_template/ZpBaryonic_extramodels.dat','cards/'+dirName+'/'+dirName+'_extramodels.dat')
            
            f_proc0 = open('monoHiggs_ZpBaryonic_UL/ZpBaryonic_template/ZpBaryonic_proc_card.dat','r')
            ...
            f_cust0 = open('monoHiggs_ZpBaryonic_UL/ZpBaryonic_template/ZpBaryonic_customizecards.dat','r')
    ...
    # Second Set
    # unit of MZp is GeV
    MZpList2 = [1000, 1500, 1750, 2000]

    #unit of MChi is GeV
    #mdm = MChi
    mdmList2 = [200, 400, 600, 800, 1000]
