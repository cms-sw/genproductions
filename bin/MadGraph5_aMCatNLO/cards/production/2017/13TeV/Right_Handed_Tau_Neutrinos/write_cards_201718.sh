...
do
    cd $code_dir
    echo $mass;
    dir1=$code_dir"/RHTauNeutrino_M-"$mass"_13TeV-2017-2018_madgraph"
    mkdir $dir1
    cd $dir1
	...
	#done
	customize_card=RHTauNeutrino_M-$mass"_13TeV-2017-2018_madgraph_customizecards.dat"
	extramodels=RHTauNeutrino_M-$mass"_13TeV-2017-2018_madgraph_extramodels.dat"
	proc_card=RHTauNeutrino_M-$mass"_13TeV-2017-2018_madgraph_proc_card.dat"
	run_card=RHTauNeutrino_M-$mass"_13TeV-2017-2018_madgraph_run_card.dat"	
	...
	echo "output RHTauNeutrino_M-"$mass"_13TeV-2017-2018_madgraph -nojpeg" >> $proc_card
	echo "" >> $proc_card
