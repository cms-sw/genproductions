...
sample = 'BulkGraviton_hh_htatahbb_incl_narrow_MMASS' 
...
for mass in masses:
    ...
    file_run_card = 'M%i/BulkGraviton_hh_htatahbb_incl_narrow_M%i_run_card.dat' % (mass,mass)
    file_proc_card = 'M%i/BulkGraviton_hh_htatahbb_incl_narrow_M%i_proc_card.dat' % (mass,mass)
    file_customizecards = 'M%i/BulkGraviton_hh_htatahbb_incl_narrow_M%i_customizecards.dat' % (mass,mass)
    file_extramodels = 'M%i/BulkGraviton_hh_htatahbb_incl_narrow_M%i_extramodels.dat' % (mass,mass)
