...
base_dir="2017/13TeV/BprimeBToTW_LH_narrowLO/"
template_dir="2017/13TeV/BprimeBToTW_LH_narrowLO/BprimeBToTW_LH_narrowLO_M1000"
...
do
    ...
    sed -i "s/M1000/_M${mp}/g" "${dir}BprimeBToTW_LH_narrowLO_M${mp}_proc_card.dat"
