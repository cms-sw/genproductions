...
C     
C     Generated by MadGraph5_aMC@NLO v. 2.5.1, 2016-11-04
...
C     
      ...
      PARAMETER (NWAVEFUNCS=7, NCOLOR=3)
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
      ...
      CALL FFV2_3(W(1,4),W(1,5),GC_58,MDL_MW,MDL_WW,W(1,6))
      CALL FFV2_1(W(1,3),W(1,6),GC_149,MDL_MT,MDL_WT,W(1,5))
      CALL IXXXXX(P(0,6),MDL_MB,NHEL(6),-1*IC(6),W(1,6))
      CALL OXXXXX(P(0,7),MDL_ME,NHEL(7),+1*IC(7),W(1,3))
      CALL IXXXXX(P(0,8),ZERO,NHEL(8),-1*IC(8),W(1,4))
      CALL FFV2_3(W(1,4),W(1,3),GC_58,MDL_MW,MDL_WW,W(1,7))
      CALL FFV2_2(W(1,6),W(1,7),GC_67,MDL_MT,MDL_WT,W(1,4))
      CALL VVS1_3(W(1,1),W(1,2),GC_87,MDL_MA0,MDL_A0WIDTH,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,4),W(1,5),W(1,7),GC_85,AMP(1))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,5),W(1,7),GC_11,AMP(2))
      CALL FFV1_1(W(1,5),W(1,1),GC_11,MDL_MT,MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,4),W(1,7),W(1,2),GC_11,AMP(3))
      CALL FFV1_2(W(1,4),W(1,1),GC_11,MDL_MT,MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,7),W(1,5),W(1,2),GC_11,AMP(4))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1)=-IMAG1*AMP(2)+AMP(3)
      JAMP(2,1)=+IMAG1*AMP(2)+AMP(4)
      JAMP(3,1)=+2D0*(+AMP(1))
