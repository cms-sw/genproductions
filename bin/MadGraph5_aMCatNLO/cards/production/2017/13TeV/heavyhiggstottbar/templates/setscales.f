...
c      
      ...
      REAL*8 rscale
      REAL*8 Escale,PXscale,PYscale,PZscale
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
          ...
          do i=3,nexternal
           Escale=Escale+P(0,i)
           PXscale=PXscale+P(1,i)
           PYscale=PYscale+P(2,i)
           PZscale=PZscale+P(3,i)
          enddo
          rscale=5D-1*dsqrt(max(0d0,Escale*Escale-PXscale*PXscale
     1    -PYscale*PYscale-PZscale*PZscale))
