...
base_dir="2017/13TeV/"
template_dir="ZDfDsD_ZDscan_fDdecay-pythia8/"
...
do
    ...
    cp "${template_dir}ZDfDsD_ZDscan_fDdecay-pythia8_proc_card.dat" "${dir}ZDfDsD_ZDscan_fDdecay_M${mp}-pythia8_proc_card.dat"
    ...
    cd ${dir}
        ...
        #proc_card.dat
        sed -i '' "s/MASS/M${mp}/g" "ZDfDsD_ZDscan_fDdecay_M${mp}-pythia8_proc_card.dat"
