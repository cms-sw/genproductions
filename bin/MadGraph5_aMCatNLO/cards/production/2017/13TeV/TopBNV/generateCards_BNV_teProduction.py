...
MG = [
['define p =  u d u~ d~', 'generate p p > t~ e+', 'add process p p > t e-'],
['define p =  c d c~ d~', 'generate p p > t~ e+', 'add process p p > t e-'],
['define p =  u s u~ s~', 'generate p p > t~ e+', 'add process p p > t e-'], 
['define p =  c s c~ s~', 'generate p p > t~ e+', 'add process p p > t e-'], 
['define p =  u b u~ b~', 'generate p p > t~ e+', 'add process p p > t e-'], 
['define p =  c b c~ b~', 'generate p p > t~ e+', 'add process p p > t e-'], 
]
