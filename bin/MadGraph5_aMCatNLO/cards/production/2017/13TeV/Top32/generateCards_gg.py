...
REFERENCE_DIR = "Top32_1000_ggChannel"
...
def formatName(mass):
    return "Top32_%d_ggChannel" % (mass)
...
for mass in MASSES:
    ...
    with open("{0}/{0}_proc_card.dat".format(sampleName), "w") as f:
        ...
        f.write("generate p p > tstar tstar~ , ( tstar > t g , ( t > b w+ , w+ > wdec wdec ) ) , ( tstar~ > t~ g , ( t~ > b~ w- , w- > wdec wdec ) )\n")
        f.write("output Top32_%d_ggChannel -nojpeg\n" % mass)
