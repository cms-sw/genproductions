...
C     ----------
      ...
      SUBROUTINE LOOP_2_2( LID, W1, W2, M1,MP_M1, M2,MP_M2, C1,MP_C1
     $ , C2,MP_C2,  RANK, LSYMFACT, AMPLN, RES, STABLE)
...
C     ----------
      ...
      SUBROUTINE LOOP_3_4_3( LID, P1, P2, P3, W1, W2, W3, W4, M1,MP_M1
     $ , M2,MP_M2, M3,MP_M3, C1,MP_C1, C2,MP_C2, C3,MP_C3,  RANK
...
C     ----------
      ...
      SUBROUTINE LOOP_2_3_2( LID, P1, P2, W1, W2, W3, M1,MP_M1, M2
     $ ,MP_M2, C1,MP_C1, C2,MP_C2,  RANK, LSYMFACT, AMPLN, RES, STABLE)
...
C     ----------
      ...
      SUBROUTINE LOOP_4_5_4( LID, P1, P2, P3, P4, W1, W2, W3, W4, W5
     $ , M1,MP_M1, M2,MP_M2, M3,MP_M3, M4,MP_M4, C1,MP_C1, C2,MP_C2
     $ , C3,MP_C3, C4,MP_C4,  RANK, LSYMFACT, AMPLN, RES, STABLE)
...
C     ----------
      ...
      SUBROUTINE LOOP_5_5( LID, W1, W2, W3, W4, W5, M1,MP_M1, M2,MP_M2
     $ , M3,MP_M3, M4,MP_M4, M5,MP_M5, C1,MP_C1, C2,MP_C2, C3,MP_C3
     $ , C4,MP_C4, C5,MP_C5,  RANK, LSYMFACT, AMPLN, RES, STABLE)
