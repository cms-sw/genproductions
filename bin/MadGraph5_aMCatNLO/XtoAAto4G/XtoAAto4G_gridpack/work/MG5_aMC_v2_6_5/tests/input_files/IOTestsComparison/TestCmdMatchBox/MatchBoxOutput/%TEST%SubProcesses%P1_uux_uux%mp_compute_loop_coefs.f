...
C     
     ...
     $ -1:NLOOPWAVEFUNCS)
      ...
      COMMON/MG5_1_LCOEFS/DP_LOOPCOEFS
...
C         Handle the possible requirement of specific polarizations
     ...
     $      THEN
          ...
          IF (COMPUTE_INTEGRAND_IN_QP) THEN
            CALL MG5_1_MP_HELAS_CALLS_AMPB_1(MP_P,NHEL,H,IC)
            CONTINUE
          ELSE
...
C            containers (but only those needed)
 ...
 3000     CONTINUE
     ...
     $           ,0.0E0_16,KIND=16)
                ...
                ITEMP = MG5_1_ML5SQSOINDEX(MG5_1_ML5SOINDEX_FOR_LOOP_AM
     $P(I),MG5_1_ML5SOINDEX_FOR_BORN_AMP(J))
     ...
     $               ,KIND=8)
          ...
          IF (COMPUTE_INTEGRAND_IN_QP) THEN
            ...
            CALL MG5_1_MP_COEF_CONSTRUCTION_1(MP_P,NHEL,H,IC)
