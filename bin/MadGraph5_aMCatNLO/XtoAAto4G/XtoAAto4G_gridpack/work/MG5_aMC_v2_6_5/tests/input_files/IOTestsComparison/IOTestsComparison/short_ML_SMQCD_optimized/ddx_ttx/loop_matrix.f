...
C         Coefficient construction for loop diagram with ID 2
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,2),2,4,LOOPCOEFS(0,1),1,30,H)
C         Coefficient construction for loop diagram with ID 3
     ...
     $     ,COEFS)
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,6),2,4,LOOPCOEFS(0,2),1,31,H)
C         Coefficient construction for loop diagram with ID 4
     ...
     $     ,COEFS)
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,8),2,4,LOOPCOEFS(0,3),1,32,H)
C         Coefficient construction for loop diagram with ID 5
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,9),2,4,LOOPCOEFS(0,4),1,33,H)
C         Coefficient construction for loop diagram with ID 6
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,12),2,4,LOOPCOEFS(0,5),1,34
     $     ,H)
C         Coefficient construction for loop diagram with ID 7
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,14),2,4,LOOPCOEFS(0,6),1,35
     $     ,H)
C         Coefficient construction for loop diagram with ID 8
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,16),2,4,LOOPCOEFS(0,7),1,36
     $     ,H)
C         Coefficient construction for loop diagram with ID 9
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,18),2,4,LOOPCOEFS(0,8),1,37
     $     ,H)
C         Coefficient construction for loop diagram with ID 10
     ...
     $     ,COEFS)
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,20),2,4,LOOPCOEFS(0,9),1,38
     $     ,H)
C         Coefficient construction for loop diagram with ID 11
     ...
     $     ,COEFS)
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,22),2,4,LOOPCOEFS(0,10),1,39
     $     ,H)
C         Coefficient construction for loop diagram with ID 12
     ...
     $     ,COEFS)
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,25),2,4,LOOPCOEFS(0,11),1,40
     $     ,H)
C         Coefficient construction for loop diagram with ID 13
     ...
     $     ,COEFS)
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,28),2,4,LOOPCOEFS(0,12),1,41
     $     ,H)
C         Coefficient construction for loop diagram with ID 14
     ...
     $     ,COEFS)
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,30),2,4,LOOPCOEFS(0,13),2,42
     $     ,H)
C         Coefficient construction for loop diagram with ID 15
          CALL GHGHGL2_1(PL(0,0),W(1,5),GC_4,ZERO,ZERO,PL(0,31),COEFS)
          CALL UPDATE_WL_0_1(WL(1,0,1,0),1,COEFS,1,1,WL(1,0,1,31))
          CALL GHGHGL2_1(PL(0,31),W(1,6),GC_4,ZERO,ZERO,PL(0,32),COEFS)
          CALL UPDATE_WL_1_1(WL(1,0,1,31),1,COEFS,1,1,WL(1,0,1,32))
          CALL CREATE_LOOP_COEFS(WL(1,0,1,32),2,1,LOOPCOEFS(0,14),1,43
     $     ,H)
        ENDIF
      ENDDO

      CALL ADD_COEFS(LOOPCOEFS(0,1),2,LOOPCOEFS(0,6),2)
      ...
      CALL ADD_COEFS(LOOPCOEFS(0,4),2,LOOPCOEFS(0,5),2)
...
C     CutTools call for loop numbers 1,6,7,8,13,14
      CALL LOOP_2(1,5,6,DCMPLX(ZERO),DCMPLX(ZERO),2,LOOPRES(1,1),S(1)
     $ ,1)
C     CutTools call for loop numbers 2
      CALL LOOP_4(2,1,2,4,3,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(MDL_MT)
     $ ,DCMPLX(ZERO),2,LOOPRES(1,2),S(2),2)
C     CutTools call for loop numbers 3
      CALL LOOP_4(3,1,2,3,4,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(MDL_MT)
     $ ,DCMPLX(ZERO),2,LOOPRES(1,3),S(3),3)
C     CutTools call for loop numbers 4,5
      CALL LOOP_3(4,1,2,6,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,LOOPRES(1,4),S(4),4)
C     CutTools call for loop numbers 9
      CALL LOOP_2(9,5,6,DCMPLX(MDL_MB),DCMPLX(MDL_MB),2,LOOPRES(1,5)
     $ ,S(5),5)
C     CutTools call for loop numbers 10
      CALL LOOP_2(10,5,6,DCMPLX(MDL_MT),DCMPLX(MDL_MT),2,LOOPRES(1,6)
     $ ,S(6),6)
C     CutTools call for loop numbers 11
      CALL LOOP_3(11,3,4,5,DCMPLX(ZERO),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,2,LOOPRES(1,7),S(7),7)
C     CutTools call for loop numbers 12
      CALL LOOP_3(12,3,4,5,DCMPLX(MDL_MT),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,LOOPRES(1,8),S(8),8)
