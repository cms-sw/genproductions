...
!  ********************************************************************
      use avh_olo
      implicit none
      complex(kind(1q0)) :: p1,p2,p3,p4,p12,p23,m1,m2,m3,m4
      complex(kind(1q0)) :: zolo(0:2),zLT,D0C
!
      read(5,*) p1
      read(5,*) p2
      read(5,*) p3
  ...
  101 format(a6,e39.32,a1,e39.32,a1)
!
...
!
      write(6,'(a10)') ' eps^( 0):'
      if (zLT.ne.0)
     &write(6,'(a8,2e32.24)') '     LT:',zLT
      write(6,'(a8,2e32.24)') '    olo:',zolo(0)
      write(6,'(a10)') ' eps^(-1):'
      write(6,'(a8,2e32.24)') '    olo:',zolo(1)
      write(6,'(a10)') ' eps^(-2):'
      write(6,'(a8,2e32.24)') '    olo:',zolo(2)
      write(6,*)
!
      end
...
!  ********************************************************************
      use avh_olo
      implicit none
      complex(kind(1q0)) :: p1,p2,p3,m1,m2,m3 ,zolo(0:2),zLT,C0C
!
      read(5,*) p1
      read(5,*) p2
      read(5,*) p3
...
!  ********************************************************************
      use avh_olo
      implicit none
      complex(kind(1q0)) :: p1,m1,m2 ,b0(0:2),b1(0:2),b00(0:2),b11(0:2)
      complex(kind(1q0)) :: rslt(0:2)
      complex(kind(1q0)) :: b0LT,b1LT,b00LT,b11LT,b0C,b1C,b00C,b11C
!
      read(5,*) p1
      read(5,*) m1
      read(5,*) m2
...
!
      write(6,'(a10)') ' eps^( 0):'
      write(6,'(a8,2e32.24)') 'b0   LT:',b0LT !|LT=yes
      write(6,'(a8,2e32.24)') '    olo:',rslt(0)
      write(6,'(a8,2e32.24)') '    olo:',b0(0)
      write(6,'(a8,2e32.24)') 'b1   LT:',b1LT !|LT=yes
      write(6,'(a8,2e32.24)') '    olo:',b1(0)
      write(6,'(a8,2e32.24)') 'b00  LT:',b00LT !|LT=yes
      write(6,'(a8,2e32.24)') '    olo:',b00(0)
      write(6,'(a8,2e32.24)') 'b11  LT:',b11LT !|LT=yes
      write(6,'(a8,2e32.24)') '    olo:',b11(0)
      write(6,'(a10)') ' eps^(-1):'
      write(6,'(a8,2e32.24)') '    olo:',b0(1)
      write(6,'(a10)') ' eps^(-2):'
      write(6,'(a8,2e32.24)') '    olo:',b0(2)
      write(6,*)
!
      end
