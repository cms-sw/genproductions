...
C     CutTools call for loop numbers 1,2,9,10,35,39,56,58
...
C     CutTools call for loop numbers 13
     ...
     $ ,7)
C     CutTools call for loop numbers 14,70
...
C     CutTools call for loop numbers 32,37,66,72
      CALL LOOP_3(1,5,20,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,24)
C     CutTools call for loop numbers 33,63
...
C     CutTools call for loop numbers 38,69
...
C     CutTools call for loop numbers 49,51,73,79
