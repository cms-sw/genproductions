...
C     
C     Process: d u > z a d u WEIGHTED<=6 [ all = QCD ] @1
C     Process: d c > z a d c WEIGHTED<=6 [ all = QCD ] @1
C     Process: s u > z a s u WEIGHTED<=6 [ all = QCD ] @1
C     Process: s c > z a s c WEIGHTED<=6 [ all = QCD ] @1
C     Process: b u > z a b u WEIGHTED<=6 [ all = QCD ] @1
C     Process: b c > z a b c WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,12),W(1,6),W(1,13),GC_5,AMP(5))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV2_5_1(W(1,6),W(1,3),-GC_21,GC_23,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,2),W(1,9),W(1,13),GC_5,AMP(8))
      CALL FFV1P0_3(W(1,1),W(1,5),GC_5,ZERO,ZERO,W(1,13))
      CALL FFV1_1(W(1,6),W(1,13),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,12),W(1,5),W(1,4),GC_2,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,7),W(1,13),GC_5,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,8),W(1,5),W(1,3),-GC_21,GC_23,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,8),W(1,9),W(1,13),GC_5,AMP(12))
      CALL FFV1_2(W(1,2),W(1,13),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,5),W(1,9),W(1,4),GC_2,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,5),W(1,7),W(1,3),-GC_21,GC_23,AMP(14))
      CALL FFV1P0_3(W(1,1),W(1,11),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,12),W(1,6),W(1,5),GC_5,AMP(15))
      CALL FFV1P0_3(W(1,1),W(1,14),GC_5,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,8),W(1,6),W(1,12),GC_5,AMP(16))
...
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,2),W(1,7),W(1,12),GC_5,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,2),W(1,9),W(1,5),GC_5,AMP(20))
      ...
      JAMP(1) = (1.666666666666667D-01)*TMP_JAMP(19)
      JAMP(2) = (-5.000000000000000D-01)*TMP_JAMP(19)
      MATRIX_6 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
