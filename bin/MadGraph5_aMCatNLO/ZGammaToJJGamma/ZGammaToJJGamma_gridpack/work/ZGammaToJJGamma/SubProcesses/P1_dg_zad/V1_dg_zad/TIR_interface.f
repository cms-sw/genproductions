...
C     
C     Process: d g > z a d QCD<=1 QED<=2 WEIGHTED<=5 [ all = QCD ] @1
C     Process: s g > z a s QCD<=1 QED<=2 WEIGHTED<=5 [ all = QCD ] @1
C     Process: b g > z a b QCD<=1 QED<=2 WEIGHTED<=5 [ all = QCD ] @1
C     
C     
C     CONSTANTS 
C     
