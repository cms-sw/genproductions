...
C     ----------
     ...
     $   //' only with calculatedborn = true'
      ...
      JAMP2(1) = (1.666666666666667D-01)*AMP(1)+(1.666666666666667D-01)
     $ *AMP(2)+(1.666666666666667D-01)*AMP(3)+(1.666666666666667D-01)
     $ *AMP(4)+(1.666666666666667D-01)*AMP(5)+(1.666666666666667D-01)
     $ *AMP(6)
      B_SF_002 = 0.D0
      DO I = 1, NCOLOR1
        ZTEMP = (0.D0,0.D0)
