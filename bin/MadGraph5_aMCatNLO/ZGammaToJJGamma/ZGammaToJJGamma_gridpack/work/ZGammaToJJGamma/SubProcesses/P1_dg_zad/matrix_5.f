...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV2_5_2(W(1,6),W(1,3),-GC_21,GC_23,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,5),W(1,12),W(1,4),GC_2,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,7),W(1,12),W(1,13),GC_5,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,5),W(1,8),W(1,3),-GC_21,GC_23,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,9),W(1,8),W(1,13),GC_5,AMP(12))
      CALL FFV1_1(W(1,2),W(1,13),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,9),W(1,5),W(1,4),GC_2,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,7),W(1,5),W(1,3),-GC_21,GC_23,AMP(14))
