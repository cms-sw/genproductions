...
C     CutTools call for loop numbers 6,36
...
C     CutTools call for loop numbers 13
     ...
     $ ,12)
C     CutTools call for loop numbers 14,20
...
C     CutTools call for loop numbers 16,23,31,38
...
C     CutTools call for loop numbers 26
     ...
     $ ,I_SO,19)
C     CutTools call for loop numbers 27,30,69,70,71,72,79,80
      CALL LOOP_3(2,3,22,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),3,I_SO
     $ ,20)
C     CutTools call for loop numbers 28,35
