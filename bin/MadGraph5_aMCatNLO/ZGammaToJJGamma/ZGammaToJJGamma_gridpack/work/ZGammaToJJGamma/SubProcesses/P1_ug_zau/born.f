...
C     
C     Process: u g > z a u WEIGHTED<=5 [ all = QCD ] @1
C     Process: c g > z a c WEIGHTED<=5 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C           Amplitude(s) for diagram number 2
            ...
            CALL FFV1_1(W(1,5),W(1,2),GC_5,ZERO,ZERO,W(1,9))
C           Amplitude(s) for diagram number 3
            CALL FFV1_0(W(1,6),W(1,9),W(1,4),GC_2,AMP(3))
C           Amplitude(s) for diagram number 4
            CALL FFV1_0(W(1,6),W(1,8),W(1,2),GC_5,AMP(4))
            CALL FFV1_2(W(1,1),W(1,4),GC_2,ZERO,ZERO,W(1,6))
C           Amplitude(s) for diagram number 5
            CALL FFV2_5_0(W(1,6),W(1,9),W(1,3),-GC_21,GC_23,AMP(5))
