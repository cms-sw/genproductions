...
C     CutTools call for loop numbers 1,2,9,10,37,40,79,80
      CALL LOOP_3(2,3,12,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),3,I_SO
     $ ,1)
C     CutTools call for loop numbers 3,5,49,51
      CALL LOOP_4(2,3,4,13,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),4,I_SO,2)
C     CutTools call for loop numbers 4,7,50,53
      CALL LOOP_4(2,4,3,13,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),4,I_SO,3)
C     CutTools call for loop numbers 6,8,52,54
      CALL LOOP_4(2,3,13,4,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),4,I_SO,4)
C     CutTools call for loop numbers 11,43
...
C     CutTools call for loop numbers 16,46
...
C     CutTools call for loop numbers 18,28
      CALL LOOP_2(8,17,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,12)
C     CutTools call for loop numbers 20,31
...
C     CutTools call for loop numbers 22,29
...
C     CutTools call for loop numbers 23
     ...
     $ ,16)
C     CutTools call for loop numbers 24,30
...
C     CutTools call for loop numbers 26,33,41,48
      CALL LOOP_3(2,5,19,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,19)
...
C     CutTools call for loop numbers 35,44
      CALL LOOP_2(11,24,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,22)
C     CutTools call for loop numbers 36
      CALL LOOP_3(3,11,10,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,I_SO,23)
C     CutTools call for loop numbers 38,45
...
C     CutTools call for loop numbers 56,73
...
C     CutTools call for loop numbers 58,68
      CALL LOOP_3(1,4,24,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,31)
...
C     CutTools call for loop numbers 61,63,65,75
...
C     CutTools call for loop numbers 81,82,89,90
      CALL LOOP_3(2,3,12,DCMPLX(MDL_MT),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,3,I_SO,47)
C     CutTools call for loop numbers 83,85
      CALL LOOP_4(2,3,4,13,DCMPLX(MDL_MT),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),4,I_SO,48)
C     CutTools call for loop numbers 84,87
      CALL LOOP_4(2,4,3,13,DCMPLX(MDL_MT),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),4,I_SO,49)
C     CutTools call for loop numbers 86,88
      CALL LOOP_4(2,3,13,4,DCMPLX(MDL_MT),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
