...
C     CutTools call for loop numbers 3
     ...
     $ ,3)
C     CutTools call for loop numbers 4,36
...
C     CutTools call for loop numbers 8,18
      CALL LOOP_2(8,14,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,8)
C     CutTools call for loop numbers 10,21
      CALL LOOP_3(4,5,14,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,9)
C     CutTools call for loop numbers 11,24
...
C     CutTools call for loop numbers 13
      CALL LOOP_3(4,9,10,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,12)
C     CutTools call for loop numbers 14,23,27,38
      CALL LOOP_3(2,5,16,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,13)
C     CutTools call for loop numbers 15
      CALL LOOP_4(2,4,5,9,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,14)
C     CutTools call for loop numbers 16,20
      CALL LOOP_3(2,9,8,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,15)
C     CutTools call for loop numbers 17
      CALL LOOP_4(2,4,9,5,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,16)
C     CutTools call for loop numbers 22
      CALL LOOP_4(2,5,4,9,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,17)
C     CutTools call for loop numbers 25,34
      CALL LOOP_2(11,21,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,18)
C     CutTools call for loop numbers 26
      CALL LOOP_3(3,11,10,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,I_SO,19)
C     CutTools call for loop numbers 28,32,69,70,71,72,79,80
      CALL LOOP_3(2,3,22,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),3,I_SO
     $ ,20)
C     CutTools call for loop numbers 29
      CALL LOOP_4(2,3,5,11,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,21)
C     CutTools call for loop numbers 30,35
      CALL LOOP_3(2,11,7,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,22)
C     CutTools call for loop numbers 31
      CALL LOOP_4(2,3,11,5,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,23)
C     CutTools call for loop numbers 37
      CALL LOOP_4(2,5,3,11,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,24)
C     CutTools call for loop numbers 39,41,73,75
      CALL LOOP_4(2,3,4,25,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),4,I_SO,25)
C     CutTools call for loop numbers 40,43,74,77
      CALL LOOP_4(2,4,3,25,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),4,I_SO,26)
C     CutTools call for loop numbers 42,44,76,78
      CALL LOOP_4(2,3,25,4,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),4,I_SO,27)
C     CutTools call for loop numbers 45
      CALL LOOP_4(1,3,4,10,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,28)
C     CutTools call for loop numbers 46,63
      CALL LOOP_3(1,3,17,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,29)
C     CutTools call for loop numbers 47
      CALL LOOP_4(1,4,3,10,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,30)
C     CutTools call for loop numbers 48,58
      CALL LOOP_3(1,4,21,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,31)
...
C     CutTools call for loop numbers 51,53,55,65
...
C     CutTools call for loop numbers 81,82,89,90
      CALL LOOP_3(2,3,22,DCMPLX(MDL_MT),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,3,I_SO,47)
C     CutTools call for loop numbers 83,85
      CALL LOOP_4(2,3,4,25,DCMPLX(MDL_MT),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),4,I_SO,48)
C     CutTools call for loop numbers 84,87
      CALL LOOP_4(2,4,3,25,DCMPLX(MDL_MT),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,DCMPLX(MDL_MT),4,I_SO,49)
C     CutTools call for loop numbers 86,88
      CALL LOOP_4(2,3,25,4,DCMPLX(MDL_MT),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
