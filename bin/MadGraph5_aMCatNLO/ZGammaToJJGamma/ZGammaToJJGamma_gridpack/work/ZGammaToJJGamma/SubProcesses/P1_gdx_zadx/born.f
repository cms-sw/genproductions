...
C     
C     Process: g d~ > z a d~ WEIGHTED<=5 [ all = QCD ] @1
C     Process: g s~ > z a s~ WEIGHTED<=5 [ all = QCD ] @1
C     Process: g b~ > z a b~ WEIGHTED<=5 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      ...
      DATA IDEN_VALUES /96, 96, 96, 96, 96, 96, 96, 96, 96, 96/
      INTEGER IJ_VALUES(10)
      DATA IJ_VALUES /1, 2, 5, 1, 1, 1, 1, 1, 1, 2/
C     
C     GLOBAL VARIABLES
C     
      DOUBLE PRECISION AMP2(6), JAMP2(0:1)
...
C           Amplitude(s) for diagram number 2
            ...
            CALL FFV2_3_1(W(1,2),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,5))
C           Amplitude(s) for diagram number 3
            CALL FFV1_0(W(1,6),W(1,5),W(1,4),GC_1,AMP(3))
            CALL FFV1_1(W(1,2),W(1,4),GC_1,ZERO,ZERO,W(1,9))
C           Amplitude(s) for diagram number 4
            CALL FFV2_3_0(W(1,6),W(1,9),W(1,3),GC_21,GC_23,AMP(4))
C           Amplitude(s) for diagram number 5
            CALL FFV1_0(W(1,8),W(1,5),W(1,1),GC_5,AMP(5))
C           Amplitude(s) for diagram number 6
            CALL FFV1_0(W(1,7),W(1,9),W(1,1),GC_5,AMP(6))
            DO I=1,NGRAPHS
