...
C     
C     Process: u d~ > z a u d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c d~ > z a c d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: u s~ > z a u s~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c s~ > z a c s~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: u b~ > z a u b~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c b~ > z a c b~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_5_2(W(1,9),W(1,3),-GC_21,GC_23,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,14),W(1,5),W(1,10),GC_5,AMP(6))
      CALL FFV2_5_1(W(1,5),W(1,3),-GC_21,GC_23,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,8),W(1,14),W(1,4),GC_2,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_5_0(W(1,8),W(1,11),W(1,3),-GC_21,GC_23,AMP(18))
