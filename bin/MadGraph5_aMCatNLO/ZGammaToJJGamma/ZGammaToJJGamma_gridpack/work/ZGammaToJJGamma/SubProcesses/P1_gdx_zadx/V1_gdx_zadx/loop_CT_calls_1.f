...
C     CutTools call for loop numbers 3
     ...
     $ ,3)
C     CutTools call for loop numbers 4,60
...
C     CutTools call for loop numbers 22,27,56,62
      CALL LOOP_3(1,5,17,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,20)
C     CutTools call for loop numbers 23,53
...
C     CutTools call for loop numbers 25,29,46,48,71,72,79,80
...
C     CutTools call for loop numbers 28,59
...
C     CutTools call for loop numbers 39,41,63,69
