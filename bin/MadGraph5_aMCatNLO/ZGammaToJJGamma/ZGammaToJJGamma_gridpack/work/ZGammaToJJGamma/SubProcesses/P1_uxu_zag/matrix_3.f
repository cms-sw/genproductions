...
C     
C     Process: u~ g > z a u~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: c~ g > z a c~ g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 22
      ...
      CALL FFV2_5_1(W(1,15),W(1,3),-GC_21,GC_23,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,12),W(1,6),W(1,4),GC_2,AMP(23))
      CALL FFV1_1(W(1,15),W(1,4),GC_2,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 24
      CALL FFV2_5_0(W(1,12),W(1,10),W(1,3),-GC_21,GC_23,AMP(24))
      CALL FFV1_1(W(1,15),W(1,2),GC_5,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,8),W(1,12),W(1,4),GC_2,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,8),W(1,10),W(1,2),GC_5,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_5_0(W(1,11),W(1,12),W(1,3),-GC_21,GC_23,AMP(27))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,8),W(1,6),W(1,4),GC_2,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_5_0(W(1,11),W(1,6),W(1,3),-GC_21,GC_23,AMP(30))
