...
C      if true.
      ...
      CALL MP_FFV2_3_1(W(1,1),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,5))
C     Amplitude(s) for born diagram with ID 1
      CALL MP_FFV1_0(W(1,2),W(1,5),W(1,4),GC_1,AMP(1))
      CALL MP_FFV1_1(W(1,1),W(1,4),GC_1,ZERO,ZERO,W(1,6))
C     Amplitude(s) for born diagram with ID 2
      CALL MP_FFV2_3_0(W(1,2),W(1,6),W(1,3),GC_21,GC_23,AMP(2))
      CALL MP_FFV1_2(W(1,2),W(1,4),GC_1,ZERO,ZERO,W(1,7))
C     Counter-term amplitude(s) for loop diagram number 3
      CALL MP_R2_QQ_1_0(W(1,7),W(1,5),R2_QQQ,AMPL(1,1))
C     Counter-term amplitude(s) for loop diagram number 4
      CALL MP_FFV1_0(W(1,2),W(1,5),W(1,4),R2_DDA,AMPL(1,2))
      CALL MP_FFV2_3_2(W(1,2),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,8))
C     Counter-term amplitude(s) for loop diagram number 5
      CALL MP_R2_QQ_1_0(W(1,8),W(1,6),R2_QQQ,AMPL(1,3))
C     Counter-term amplitude(s) for loop diagram number 6
      CALL MP_FFV2_3_0(W(1,2),W(1,6),W(1,3),R2_DDZ_V2,R2_DDZ_V3,AMPL(1
     $ ,4))
C     Counter-term amplitude(s) for loop diagram number 7
      CALL MP_FFV1_0(W(1,8),W(1,1),W(1,4),R2_DDA,AMPL(1,5))
C     Counter-term amplitude(s) for loop diagram number 8
      CALL MP_FFV2_3_0(W(1,7),W(1,1),W(1,3),R2_DDZ_V2,R2_DDZ_V3,AMPL(1
     $ ,6))
