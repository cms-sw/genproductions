...
C     
C     Process: d~ d > z a QED<=2 WEIGHTED<=4 [ all = QCD ]
C     Process: s~ s > z a QED<=2 WEIGHTED<=4 [ all = QCD ]
C     Process: b~ b > z a QED<=2 WEIGHTED<=4 [ all = QCD ]
C     
C     Modules
C     
...
C     
      ...
      DATA (LOOPAMPORDERS(I),I= 11, 14) /    2,    2,    2,    2/
C     -----------
C     BEGIN CODE
C     -----------
