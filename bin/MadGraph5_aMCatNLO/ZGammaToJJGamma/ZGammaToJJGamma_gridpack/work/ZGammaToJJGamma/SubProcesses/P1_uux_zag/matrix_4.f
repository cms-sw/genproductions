...
C     
C     Process: u u~ > z a d d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: u u~ > z a s s~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: u u~ > z a b b~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c c~ > z a d d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c c~ > z a s s~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c c~ > z a b b~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV1_2(W(1,12),W(1,4),GC_2,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,14),W(1,2),W(1,7),GC_5,AMP(10))
      CALL FFV1_2(W(1,1),W(1,4),GC_2,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 13
      ...
      CALL FFV2_5_2(W(1,14),W(1,3),-GC_21,GC_23,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,15),W(1,12),W(1,4),GC_2,AMP(17))
...
C     Amplitude(s) for diagram number 20
      CALL FFV2_5_0(W(1,15),W(1,9),W(1,3),-GC_21,GC_23,AMP(20))
