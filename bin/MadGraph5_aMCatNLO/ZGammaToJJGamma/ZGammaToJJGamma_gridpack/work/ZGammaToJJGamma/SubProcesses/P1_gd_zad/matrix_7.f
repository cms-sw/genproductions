...
C     
C     Process: s d > z a d s WEIGHTED<=6 [ all = QCD ] @1
C     Process: b d > z a d b WEIGHTED<=6 [ all = QCD ] @1
C     Process: d s > z a s d WEIGHTED<=6 [ all = QCD ] @1
C     Process: b s > z a s b WEIGHTED<=6 [ all = QCD ] @1
C     Process: d b > z a b d WEIGHTED<=6 [ all = QCD ] @1
C     Process: s b > z a b s WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,7),W(1,6),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,8),W(1,5),W(1,9),GC_5,AMP(1))
      CALL FFV1P0_3(W(1,2),W(1,5),GC_5,ZERO,ZERO,W(1,10))
      CALL FFV1_2(W(1,7),W(1,4),GC_1,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,11),W(1,6),W(1,10),GC_5,AMP(2))
      CALL FFV1_1(W(1,6),W(1,4),GC_1,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,11),W(1,10),GC_5,AMP(3))
      CALL FFV1_1(W(1,5),W(1,4),GC_1,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,14),W(1,6),W(1,10),GC_5,AMP(6))
      CALL FFV2_3_1(W(1,6),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,9),W(1,14),W(1,10),GC_5,AMP(7))
      CALL FFV2_3_1(W(1,5),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,2),W(1,9),W(1,13),GC_5,AMP(8))
      CALL FFV1P0_3(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,13))
      CALL FFV1_1(W(1,5),W(1,13),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,12),W(1,6),W(1,4),GC_1,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,7),W(1,13),GC_5,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_3_0(W(1,8),W(1,6),W(1,3),GC_21,GC_23,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,8),W(1,9),W(1,13),GC_5,AMP(12))
      CALL FFV1_2(W(1,2),W(1,13),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,6),W(1,9),W(1,4),GC_1,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_3_0(W(1,6),W(1,7),W(1,3),GC_21,GC_23,AMP(14))
      CALL FFV1P0_3(W(1,1),W(1,11),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,12),W(1,5),W(1,6),GC_5,AMP(15))
      CALL FFV1P0_3(W(1,1),W(1,14),GC_5,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,8),W(1,5),W(1,12),GC_5,AMP(16))
...
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,2),W(1,9),W(1,6),GC_5,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,2),W(1,7),W(1,12),GC_5,AMP(20))
