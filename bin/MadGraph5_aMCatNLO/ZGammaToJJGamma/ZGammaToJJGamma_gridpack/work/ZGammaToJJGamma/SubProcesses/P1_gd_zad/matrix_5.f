...
C     
C     Process: u d > z a d u WEIGHTED<=6 [ all = QCD ] @1
C     Process: c d > z a d c WEIGHTED<=6 [ all = QCD ] @1
C     Process: u s > z a s u WEIGHTED<=6 [ all = QCD ] @1
C     Process: c s > z a s c WEIGHTED<=6 [ all = QCD ] @1
C     Process: u b > z a b u WEIGHTED<=6 [ all = QCD ] @1
C     Process: c b > z a b c WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,6),W(1,4),GC_2,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_5_1(W(1,6),W(1,3),-GC_21,GC_23,ZERO,ZERO,W(1,14))
