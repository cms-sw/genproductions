...
C     
C     Process: g d~ > z a d~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: g s~ > z a s~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: g b~ > z a b~ g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV2_3_2(W(1,5),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,10),W(1,4),GC_1,AMP(2))
      CALL FFV1_2(W(1,5),W(1,4),GC_1,ZERO,ZERO,W(1,11))
      CALL FFV2_3_1(W(1,7),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,11),W(1,12),W(1,6),GC_5,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,11),W(1,10),W(1,3),GC_21,GC_23,AMP(4))
      CALL FFV1_2(W(1,5),W(1,6),GC_5,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,10),W(1,12),W(1,4),GC_1,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,10),W(1,9),W(1,3),GC_21,GC_23,AMP(6))
      CALL FFV1_2(W(1,5),W(1,1),GC_5,ZERO,ZERO,W(1,9))
      CALL FFV2_3_1(W(1,2),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,12))
      CALL FFV1_2(W(1,9),W(1,4),GC_1,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,7),W(1,12),W(1,6),GC_5,AMP(7))
      CALL FFV1_2(W(1,9),W(1,6),GC_5,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,13),W(1,12),W(1,4),GC_1,AMP(8))
      CALL FFV1_1(W(1,2),W(1,4),GC_1,ZERO,ZERO,W(1,14))
      CALL FFV2_3_2(W(1,9),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,15),W(1,14),W(1,6),GC_5,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,13),W(1,14),W(1,3),GC_21,GC_23,AMP(10))
      CALL FFV1_1(W(1,2),W(1,6),GC_5,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,15),W(1,13),W(1,4),GC_1,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,7),W(1,13),W(1,3),GC_21,GC_23,AMP(12))
      CALL VVV1P0_1(W(1,1),W(1,6),GC_4,ZERO,ZERO,W(1,7))
      CALL FFV1_2(W(1,5),W(1,7),GC_5,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,15),W(1,12),W(1,4),GC_1,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,11),W(1,12),W(1,7),GC_5,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_3_0(W(1,15),W(1,14),W(1,3),GC_21,GC_23,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,8),W(1,14),W(1,7),GC_5,AMP(16))
      CALL FFV1_1(W(1,2),W(1,7),GC_5,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,8),W(1,15),W(1,4),GC_1,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_3_0(W(1,11),W(1,15),W(1,3),GC_21,GC_23,AMP(18))
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,10),W(1,15),W(1,4),GC_1,AMP(21))
      CALL FFV1_2(W(1,10),W(1,1),GC_5,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,15),W(1,12),W(1,4),GC_1,AMP(22))
...
C     Amplitude(s) for diagram number 25
      CALL FFV2_3_0(W(1,10),W(1,12),W(1,3),GC_21,GC_23,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,15),W(1,14),W(1,3),GC_21,GC_23,AMP(26))
      CALL FFV1_1(W(1,13),W(1,1),GC_5,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,8),W(1,15),W(1,4),GC_1,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,2),W(1,13),W(1,4),GC_1,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV2_3_0(W(1,11),W(1,15),W(1,3),GC_21,GC_23,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_3_0(W(1,7),W(1,13),W(1,3),GC_21,GC_23,AMP(30))
