...
C         FeynRules, there are none of these type of counterterms.
          CALL HELAS_CALLS_UVCT_1(P,NHEL,H,IC)
 3000     CONTINUE
...
C     
      ...
      DATA (LOOPAMPORDERS(I),I=196,198) /    2,    2,    2/
C     -----------
C     BEGIN CODE
C     -----------
...
C     
      ...
      DATA (AMPSPLITORDERS(  2,I),I=  1,  1) /    3/
