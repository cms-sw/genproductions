...
C     CutTools call for loop numbers 1,3,71,73
      CALL LOOP_4(3,4,5,12,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),4,I_SO,1)
C     CutTools call for loop numbers 2,5,72,75
      CALL LOOP_4(3,5,4,12,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),4,I_SO,2)
C     CutTools call for loop numbers 4,6,74,76
      CALL LOOP_4(3,4,12,5,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),4,I_SO,3)
C     CutTools call for loop numbers 7,38
      CALL LOOP_2(7,13,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,4)
C     CutTools call for loop numbers 8,12
      CALL LOOP_2(6,14,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,5)
...
C     CutTools call for loop numbers 17,44
      CALL LOOP_3(2,4,13,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,12)
C     CutTools call for loop numbers 18
      CALL LOOP_4(2,5,4,6,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,13)
C     CutTools call for loop numbers 20,35
      CALL LOOP_2(10,17,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,14)
C     CutTools call for loop numbers 21,25
      CALL LOOP_2(9,18,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,15)
C     CutTools call for loop numbers 22,23
...
C     CutTools call for loop numbers 30,42
      CALL LOOP_3(2,3,17,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,20)
C     CutTools call for loop numbers 31
      CALL LOOP_4(2,5,3,9,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,21)
C     CutTools call for loop numbers 33,34,69,70,77,78,79,80
      CALL LOOP_3(3,5,21,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),3,I_SO
     $ ,22)
C     CutTools call for loop numbers 36,39
      CALL LOOP_2(11,23,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,23)
...
C     CutTools call for loop numbers 45,50,51,56
...
C     CutTools call for loop numbers 47,60
      CALL LOOP_3(1,4,18,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,30)
...
C     CutTools call for loop numbers 53,58
      CALL LOOP_3(1,3,14,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,34)
...
C     CutTools call for loop numbers 87,88,89,90
      CALL LOOP_3(3,5,21,DCMPLX(MDL_MT),DCMPLX(MDL_MT),DCMPLX(MDL_MT)
     $ ,3,I_SO,50)
