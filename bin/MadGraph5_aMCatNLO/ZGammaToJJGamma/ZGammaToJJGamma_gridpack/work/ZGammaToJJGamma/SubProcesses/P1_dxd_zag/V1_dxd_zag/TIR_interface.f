...
C     
C     Process: d~ d > z a g QCD<=1 QED<=2 WEIGHTED<=5 [ all = QCD ] @1
C     Process: s~ s > z a g QCD<=1 QED<=2 WEIGHTED<=5 [ all = QCD ] @1
C     Process: b~ b > z a g QCD<=1 QED<=2 WEIGHTED<=5 [ all = QCD ] @1
C     
C     
C     CONSTANTS 
C     
