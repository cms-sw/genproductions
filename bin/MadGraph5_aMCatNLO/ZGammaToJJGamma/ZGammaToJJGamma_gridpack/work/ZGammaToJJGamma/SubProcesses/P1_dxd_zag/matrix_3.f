...
C     
C     Process: d~ g > z a d~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ g > z a s~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: b~ g > z a b~ g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_2(W(1,5),W(1,2),GC_5,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL VVV1P0_1(W(1,2),W(1,6),GC_4,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,5),W(1,7),W(1,14),GC_5,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,11),W(1,9),W(1,14),GC_5,AMP(10))
      CALL FFV1_1(W(1,9),W(1,2),GC_5,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,11),W(1,15),W(1,6),GC_5,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,11),W(1,13),W(1,2),GC_5,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,10),W(1,15),W(1,4),GC_1,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,10),W(1,7),W(1,2),GC_5,AMP(14))
      CALL FFV1_1(W(1,1),W(1,4),GC_1,ZERO,ZERO,W(1,7))
      CALL FFV2_3_1(W(1,7),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,12),W(1,15),W(1,6),GC_5,AMP(15))
      CALL FFV1_1(W(1,7),W(1,6),GC_5,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,12),W(1,13),W(1,3),GC_21,GC_23,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,5),W(1,15),W(1,14),GC_5,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,8),W(1,7),W(1,14),GC_5,AMP(18))
      CALL FFV1_1(W(1,7),W(1,2),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,8),W(1,5),W(1,6),GC_5,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,8),W(1,13),W(1,2),GC_5,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_3_0(W(1,10),W(1,5),W(1,3),GC_21,GC_23,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,10),W(1,15),W(1,2),GC_5,AMP(22))
      CALL FFV1_1(W(1,1),W(1,6),GC_5,ZERO,ZERO,W(1,15))
      CALL FFV2_3_1(W(1,15),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,12),W(1,6),W(1,4),GC_1,AMP(23))
      CALL FFV1_1(W(1,15),W(1,4),GC_1,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 24
      CALL FFV2_3_0(W(1,12),W(1,10),W(1,3),GC_21,GC_23,AMP(24))
      CALL FFV1_1(W(1,15),W(1,2),GC_5,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,8),W(1,12),W(1,4),GC_1,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,8),W(1,10),W(1,2),GC_5,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_3_0(W(1,11),W(1,12),W(1,3),GC_21,GC_23,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,11),W(1,6),W(1,2),GC_5,AMP(28))
      CALL FFV1_1(W(1,1),W(1,14),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,8),W(1,6),W(1,4),GC_1,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_3_0(W(1,11),W(1,6),W(1,3),GC_21,GC_23,AMP(30))
      TMP_JAMP(3) = AMP(29) +  AMP(30)  ! used 2 times
      TMP_JAMP(2) = AMP(17) +  AMP(18)  ! used 2 times
      TMP_JAMP(1) = AMP(9) +  AMP(10)  ! used 2 times
     ...
     $ *AMP(11)+(-1.000000000000000D+00)*AMP(13)+(-1.000000000000000D
     $ +00)*AMP(14)+(-1.000000000000000D+00)*AMP(19)+(
     ...
     $ +00)*AMP(8)+(-1.000000000000000D+00)*AMP(12)+(
