...
C     
C     Process: d~ d > z a g WEIGHTED<=5 [ all = QCD ] @1
C     Process: s~ s > z a g WEIGHTED<=5 [ all = QCD ] @1
C     Process: b~ b > z a g WEIGHTED<=5 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      ...
      DATA IDEN_VALUES /36, 36, 36, 36, 36, 36, 36, 36/
      INTEGER IJ_VALUES(8)
      DATA IJ_VALUES /1, 2, 5, 1, 2, 5, 5, 5/
C     
C     GLOBAL VARIABLES
C     
...
C           Amplitude(s) for diagram number 4
            CALL FFV2_3_0(W(1,8),W(1,6),W(1,3),GC_21,GC_23,AMP(4))
            CALL FFV1_1(W(1,1),W(1,5),GC_5,ZERO,ZERO,W(1,6))
C           Amplitude(s) for diagram number 5
            CALL FFV1_0(W(1,9),W(1,6),W(1,4),GC_1,AMP(5))
C           Amplitude(s) for diagram number 6
            CALL FFV2_3_0(W(1,7),W(1,6),W(1,3),GC_21,GC_23,AMP(6))
            DO I=1,NGRAPHS
