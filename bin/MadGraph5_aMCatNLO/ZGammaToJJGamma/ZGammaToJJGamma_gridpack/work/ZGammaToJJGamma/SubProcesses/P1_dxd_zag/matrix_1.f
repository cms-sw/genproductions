...
C     
C     Process: d~ d > z a g g WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ s > z a g g WEIGHTED<=6 [ all = QCD ] @1
C     Process: b~ b > z a g g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_3_2(W(1,2),W(1,3),GC_21,GC_23,ZERO,ZERO,W(1,9))
