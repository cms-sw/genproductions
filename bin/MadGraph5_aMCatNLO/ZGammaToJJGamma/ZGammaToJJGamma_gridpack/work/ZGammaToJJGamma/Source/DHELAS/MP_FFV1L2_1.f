...
C     Gamma(3,2,1)
C     
      SUBROUTINE MP_FFV1L2_1(P2, V3, COUP, M1, W1, P1, COEFF)
      IMPLICIT NONE
      COMPLEX*32 CI
      ...
      P1(2) = +P2(2)+V3(3)
      P1(3) = +P2(3)+V3(4)
      COEFF(1,0,1)= COUP*(-1Q0)*(P1(0)*(-CI*(V3(5))+CI*(V3(8)))+(P1(1)
     $ *(+CI*(V3(6))+V3(7))+(P1(2)*(-V3(6)+CI*(V3(7)))+P1(3)*(-CI
     $ *(V3(5))+CI*(V3(8))))))
      COEFF(2,0,1)= COUP*(P1(0)*(-1Q0)*(+CI*(V3(6))+V3(7))+(P1(1)*(+CI
     ...
     $ +V3(7)))))
      ...
      COEFF(3,1,1)= 0Q0
      COEFF(4,1,1)= 0Q0
      COEFF(1,2,1)= COUP*(-1Q0)*(+CI*(V3(6))+V3(7))
      COEFF(2,2,1)= COUP*(+CI*(V3(5))-CI*(V3(8)))
      COEFF(3,2,1)= 0Q0
      COEFF(4,2,1)= 0Q0
      COEFF(1,3,1)= COUP*(-1Q0)*(-V3(6)+CI*(V3(7)))
     ...
     $ +V3(8)))+(P1(2)*(-1Q0)*(V3(5)+V3(8))+P1(3)*(-CI*(V3(6))+V3(7))))
     $ )
      COEFF(2,0,2)= COUP*(-1Q0)*(P1(0)*(-1Q0)*(+CI*(V3(5)+V3(8)))
     ...
     $ +CI*(V3(5)+V3(8))))))
      ...
      COEFF(2,2,2)= COUP*(-1Q0)*(+CI*(V3(6))-V3(7))
      COEFF(3,2,2)= 0Q0
      COEFF(4,2,2)= 0Q0
      COEFF(1,3,2)= COUP*(-V3(5)-V3(8))
      COEFF(2,3,2)= COUP*(-1Q0)*(V3(6)+CI*(V3(7)))
      COEFF(3,3,2)= 0Q0
      COEFF(4,3,2)= 0Q0
      COEFF(1,4,2)= COUP*(-1Q0)*(+CI*(V3(6))-V3(7))
      COEFF(2,4,2)= COUP*(-1Q0)*(+CI*(V3(5)+V3(8)))
      COEFF(3,4,2)= 0Q0
      COEFF(4,4,2)= 0Q0
