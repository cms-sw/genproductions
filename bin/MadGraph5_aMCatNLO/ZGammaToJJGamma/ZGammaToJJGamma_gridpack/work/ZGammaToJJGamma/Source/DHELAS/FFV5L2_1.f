...
C     
     ...
     $ *(V3(5))+CI*(V3(8))))))
      COEFF(2,0,1)= COUP*4D0*(P1(0)*(-1D0)*(+CI*(V3(6))+V3(7))+(P1(1)
     $ *(+CI*(V3(5))-CI*(V3(8)))+(P1(2)*(V3(5)-V3(8))+P1(3)*(+CI*(V3(6)
     $ )+V3(7)))))
      COEFF(3,0,1)= COUP*4D0 * M1*(+CI*(V3(5))-CI*(V3(8)))
      COEFF(4,0,1)= COUP*-4D0 * M1*(+CI*(V3(6))+V3(7))
      COEFF(1,1,1)= COUP*4D0*(+CI*(V3(5))-CI*(V3(8)))
      COEFF(2,1,1)= COUP*(-4D0)*(+CI*(V3(6))+V3(7))
      COEFF(3,1,1)= 0D0
      COEFF(4,1,1)= 0D0
      COEFF(1,2,1)= COUP*(-4D0)*(+CI*(V3(6))+V3(7))
      COEFF(2,2,1)= COUP*4D0*(+CI*(V3(5))-CI*(V3(8)))
      COEFF(3,2,1)= 0D0
      COEFF(4,2,1)= 0D0
      ...
      COEFF(3,3,1)= 0D0
      COEFF(4,3,1)= 0D0
      COEFF(1,4,1)= COUP*4D0*(+CI*(V3(5))-CI*(V3(8)))
      COEFF(2,4,1)= COUP*4D0*(+CI*(V3(6))+V3(7))
      COEFF(3,4,1)= 0D0
      COEFF(4,4,1)= 0D0
      COEFF(1,0,2)= COUP*4D0*(P1(0)*(-CI*(V3(6))+V3(7))+(P1(1)*(+CI
     ...
     $ +CI*(V3(5)+V3(8))))))
      COEFF(3,0,2)= COUP*4D0 * M1*(-CI*(V3(6))+V3(7))
      COEFF(4,0,2)= COUP*4D0 * M1*(+CI*(V3(5)+V3(8)))
      COEFF(1,1,2)= COUP*4D0*(-CI*(V3(6))+V3(7))
      COEFF(2,1,2)= COUP*4D0*(+CI*(V3(5)+V3(8)))
      COEFF(3,1,2)= 0D0
      COEFF(4,1,2)= 0D0
      COEFF(1,2,2)= COUP*4D0*(+CI*(V3(5)+V3(8)))
      COEFF(2,2,2)= COUP*4D0*(-CI*(V3(6))+V3(7))
      COEFF(3,2,2)= 0D0
      COEFF(4,2,2)= 0D0
      ...
      COEFF(3,3,2)= 0D0
      COEFF(4,3,2)= 0D0
      COEFF(1,4,2)= COUP*4D0*(-CI*(V3(6))+V3(7))
