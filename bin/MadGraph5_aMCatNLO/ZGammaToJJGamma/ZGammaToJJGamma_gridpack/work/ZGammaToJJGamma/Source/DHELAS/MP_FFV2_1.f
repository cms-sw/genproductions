...
C     
      SUBROUTINE MP_FFV2_1(F2, V3, COUP, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*32 CI
     ...
     $ * W1))
      F1(5)= DENOM*CI * M1*(F2(7)*(V3(5)+V3(8))+F2(8)*(V3(6)+CI*(V3(7))
     $ ))
      F1(6)= DENOM*(-CI )* M1*(F2(7)*(-V3(6)+CI*(V3(7)))+F2(8)*(-V3(5)
     $ +V3(8)))
     ...
     $ *(-CI*(V3(5))+CI*(V3(8)))-P1(3)*(V3(6)+CI*(V3(7)))))))
