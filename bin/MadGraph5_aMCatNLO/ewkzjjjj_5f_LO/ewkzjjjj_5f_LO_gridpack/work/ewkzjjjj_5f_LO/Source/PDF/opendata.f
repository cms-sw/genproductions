...
C     First try system wide (for cluster if define)
      ...
      TEMPNAME='/cvmfs/cms.cern.ch/slc7_amd64_gcc10/external/lhapdf'
     $ //'/6.4.0-68defff11ffd434c73727d03802bfb85/share/LHAPDF'/
     $ /TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=1)
      RETURN
 1    TEMPNAME='/cvmfs/cms.cern.ch/slc7_amd64_gcc10/external/lhapdf'
     $ //'/6.4.0-68defff11ffd434c73727d03802bfb85/share/LHAPDF/Pdfdata'
     $ //'/'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=2)
      RETURN
 2    TEMPNAME='/cvmfs/cms.cern.ch/slc7_amd64_gcc10/external/lhapdf'
     $ //'/6.4.0-68defff11ffd434c73727d03802bfb85/share/LHAPDF/lhapdf'
     $ //TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=3)
      RETURN
 3    TEMPNAME='/cvmfs/cms.cern.ch/slc7_amd64_gcc10/external/lhapdf'
     $ //'/6.4.0-68defff11ffd434c73727d03802bfb85/share/LHAPDF/..'
     $ //'/lhapdf/pdfsets/'//TABLEFILE
      OPEN(IU,FILE=TEMPNAME,STATUS='old',ERR=4)
      RETURN
 4    TEMPNAME='/cvmfs/cms.cern.ch/slc7_amd64_gcc10/external/lhapdf'
     $ //'/6.4.0-68defff11ffd434c73727d03802bfb85/share/LHAPDF/..'
     $ //'/lhapdf/pdfsets/6.1/'//TABLEFILE
