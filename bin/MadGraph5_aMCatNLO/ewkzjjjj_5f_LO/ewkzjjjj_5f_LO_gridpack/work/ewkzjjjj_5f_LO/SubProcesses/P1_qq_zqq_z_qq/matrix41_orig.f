...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV2_5_3(W(1,1),W(1,4),-GC_50,GC_58,MDL_MZ, ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 7
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_100,MDL_MW, FK_MDL_WW,W(1,11))
...
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,1),W(1,12),W(1,7),GC_100,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,1),W(1,10),W(1,8),GC_2,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,1),W(1,10),W(1,9),-GC_50,GC_58,AMP(13))
