...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,10),W(1,3),W(1,6),GC_1,AMP(4))
      CALL FFV2_5_3(W(1,1),W(1,4),-GC_50,GC_58,MDL_MZ, ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,10),W(1,3),W(1,11),GC_50,GC_58,AMP(5))
      CALL FFV2_3_1(W(1,3),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,12),W(1,6),GC_1,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_3_0(W(1,2),W(1,12),W(1,11),GC_50,GC_58,AMP(7))
      CALL FFV2_3(W(1,1),W(1,3),GC_100,MDL_MW, ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,2),W(1,10),W(1,11),GC_100,AMP(10))
