...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,3),W(1,4),GC_1,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,2),W(1,7),GC_1,AMP(1))
      CALL FFV2_3_3(W(1,3),W(1,4),GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,8))
...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,9),W(1,4),W(1,6),GC_1,AMP(3))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,10)
     $ )
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,9),W(1,4),W(1,10),GC_50,GC_58,AMP(4))
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,1),W(1,9),W(1,7),GC_1,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,1),W(1,9),W(1,8),GC_50,GC_58,AMP(8))
