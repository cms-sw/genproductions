            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 97 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX97(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.13, 2022-12-15
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_97(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_97/ZEROAMP_97
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,3),W(1,1),GC_100,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,6),W(1,2),W(1,7),GC_100,AMP(1))
      CALL FFV1P0_3(W(1,3),W(1,2),GC_1,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,1),W(1,8),GC_2,AMP(2))
      CALL FFV2_3_3(W(1,3),W(1,2),GC_50,GC_58,MDL_MZ, ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,6),W(1,1),W(1,9),-GC_50,GC_58,AMP(3))
      CALL FFV1P0_3(W(1,4),W(1,1),GC_2,ZERO, FK_ZERO,W(1,6))
      CALL FFV2_3_2(W(1,3),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,10),W(1,2),W(1,6),GC_1,AMP(4))
      CALL FFV2_5_3(W(1,4),W(1,1),-GC_50,GC_58,MDL_MZ, ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,11),GC_50,GC_58,AMP(5))
      CALL FFV2_3_1(W(1,2),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,3),W(1,12),W(1,6),GC_1,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_3_0(W(1,3),W(1,12),W(1,11),GC_50,GC_58,AMP(7))
      CALL FFV2_3(W(1,4),W(1,2),GC_100,MDL_MW, ZERO,W(1,11))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,10),W(1,1),W(1,11),GC_100,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VVV1_0(W(1,11),W(1,7),W(1,5),GC_53,AMP(9))
      CALL FFV2_5_1(W(1,1),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,3),W(1,10),W(1,11),GC_100,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,4),W(1,12),W(1,7),GC_100,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,4),W(1,10),W(1,8),GC_2,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,4),W(1,10),W(1,9),-GC_50,GC_58,AMP(13))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(2)+AMP(3)+AMP(4)+AMP(5)+AMP(6)+AMP(7)+AMP(12)
     $ +AMP(13)
     ...
     $ -1.000000000000000D+00)*AMP(10)+(-1.000000000000000D+00)*AMP(11)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX97 = MATRIX97 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_97(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 97, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_97(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 97, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX97(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS97/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS97
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX97=SOINDEX_FOR_SQUARED_ORDERS97(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS97(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS97/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS97 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS97'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN97(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX97(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX97'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX97(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS97(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS97 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS97'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
