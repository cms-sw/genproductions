...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3_2(W(1,1),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,8),W(1,2),W(1,6),GC_100,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,6),W(1,7),W(1,5),GC_53,AMP(3))
      CALL FFV2_5_1(W(1,2),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,1),W(1,8),W(1,6),GC_100,AMP(4))
      CALL FFV2_3_1(W(1,4),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,3),W(1,8),W(1,7),GC_100,AMP(5))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(1)+AMP(2)+AMP(3)+AMP(4)+AMP(5)
