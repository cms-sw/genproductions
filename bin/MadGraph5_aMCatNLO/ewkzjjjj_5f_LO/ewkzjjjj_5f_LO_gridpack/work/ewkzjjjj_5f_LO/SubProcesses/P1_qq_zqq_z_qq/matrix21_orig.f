...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,3),W(1,4),GC_2,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,2),W(1,9),GC_2,AMP(3))
      CALL FFV2_5_3(W(1,3),W(1,4),-GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1
     $ ,10))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,6),W(1,2),W(1,10),-GC_50,GC_58,AMP(4))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_2,ZERO, FK_ZERO,W(1,6))
      CALL FFV2_5_2(W(1,3),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,11),W(1,4),W(1,6),GC_2,AMP(5))
      CALL FFV2_5_3(W(1,1),W(1,2),-GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1
     $ ,12))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,11),W(1,4),W(1,12),-GC_50,GC_58,AMP(6))
      CALL FFV2_5_1(W(1,4),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,3),W(1,13),W(1,6),GC_2,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,3),W(1,13),W(1,12),-GC_50,GC_58,AMP(8))
      CALL FFV1P0_3(W(1,1),W(1,4),GC_2,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,11),W(1,2),W(1,12),GC_2,AMP(9))
      CALL FFV2_5_3(W(1,1),W(1,4),-GC_50,GC_58,MDL_MZ, ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV2_5_0(W(1,11),W(1,2),W(1,6),-GC_50,GC_58,AMP(10))
      CALL FFV2_5_1(W(1,2),W(1,5),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
