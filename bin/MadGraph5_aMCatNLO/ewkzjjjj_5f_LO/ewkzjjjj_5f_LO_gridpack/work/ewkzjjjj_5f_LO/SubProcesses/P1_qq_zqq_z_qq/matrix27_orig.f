...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,3),W(1,2),GC_100,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,6),W(1,4),W(1,7),GC_100,AMP(1))
      CALL FFV1P0_3(W(1,3),W(1,4),GC_1,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_2,AMP(2))
      CALL FFV2_3_3(W(1,3),W(1,4),GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,9))
