            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 112 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX112(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.13, 2022-12-15
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_112(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_112/ZEROAMP_112
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3_3(W(1,4),W(1,3),GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,5))
      CALL IXXXXX(P(0,5),ZERO,NHEL(5),-1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),ZERO,NHEL(6),-1*IC(6),W(1,3))
      CALL FFV2_3_2(W(1,4),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,6))
      CALL FFV1P0_3(W(1,3),W(1,1),GC_1,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,2),W(1,7),GC_1,AMP(1))
      CALL FFV2_3_3(W(1,3),W(1,1),GC_50,GC_58,MDL_MZ, ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,6),W(1,2),W(1,8),GC_50,GC_58,AMP(2))
      CALL FFV1P0_3(W(1,3),W(1,2),GC_1,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,1),W(1,9),GC_1,AMP(3))
      CALL FFV2_3_3(W(1,3),W(1,2),GC_50,GC_58,MDL_MZ, ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,6),W(1,1),W(1,10),GC_50,GC_58,AMP(4))
      CALL FFV1P0_3(W(1,4),W(1,1),GC_1,ZERO, FK_ZERO,W(1,6))
      CALL FFV2_3_2(W(1,3),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,11),W(1,2),W(1,6),GC_1,AMP(5))
      CALL FFV2_3_3(W(1,4),W(1,1),GC_50,GC_58,MDL_MZ, ZERO,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,11),W(1,2),W(1,12),GC_50,GC_58,AMP(6))
      CALL FFV2_3_1(W(1,2),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,3),W(1,13),W(1,6),GC_1,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,3),W(1,13),W(1,12),GC_50,GC_58,AMP(8))
      CALL FFV1P0_3(W(1,4),W(1,2),GC_1,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,11),W(1,1),W(1,12),GC_1,AMP(9))
      CALL FFV2_3_3(W(1,4),W(1,2),GC_50,GC_58,MDL_MZ, ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,11),W(1,1),W(1,6),GC_50,GC_58,AMP(10))
      CALL FFV2_3_1(W(1,1),W(1,5),GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,3),W(1,11),W(1,12),GC_1,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,3),W(1,11),W(1,6),GC_50,GC_58,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,4),W(1,13),W(1,7),GC_1,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_3_0(W(1,4),W(1,13),W(1,8),GC_50,GC_58,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,4),W(1,11),W(1,9),GC_1,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,4),W(1,11),W(1,10),GC_50,GC_58,AMP(16))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(3)+AMP(4)+AMP(5)+AMP(6)+AMP(7)+AMP(8)+AMP(15)
     $ +AMP(16)
      JAMP(2,1) = (-1.000000000000000D+00)*AMP(1)+(-1.000000000000000D
     $ +00)*AMP(2)+(-1.000000000000000D+00)*AMP(9)+(
     $ -1.000000000000000D+00)*AMP(10)+(-1.000000000000000D+00)*AMP(11)
     $ +(-1.000000000000000D+00)*AMP(12)+(-1.000000000000000D+00)
     $ *AMP(13)+(-1.000000000000000D+00)*AMP(14)

      IF(INIT_MODE)THEN
        DO I=1, NGRAPHS
          IF (AMP(I).NE.0) THEN
            ZEROAMP_112(IHEL,I) = .FALSE.
          ENDIF
        ENDDO
      ENDIF
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX112 = MATRIX112 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      IF(SDE_STRAT.EQ.1)THEN
        ...
        AMP2(5)=AMP2(5)+(AMP(5)+AMP(6))*DCONJG(AMP(5)+AMP(6))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_112(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 112, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_112(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 112, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX112(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS112/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS112
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX112=SOINDEX_FOR_SQUARED_ORDERS112(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS112(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS112/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS112 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS112'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN112(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX112(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX112'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX112(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS112(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS112 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS112'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
