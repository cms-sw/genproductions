...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV2_3(W(1,6),W(1,2),-GC_101,MDL_MW, ZERO,W(1,13))
      CALL FFV2_1(W(1,4),W(1,9),GC_108,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,3),W(1,10),W(1,13),GC_108,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL VVV1_0(W(1,8),W(1,13),W(1,9),-GC_3,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVV1_0(W(1,13),W(1,9),W(1,11),GC_53,AMP(19))
      CALL FFV2_1(W(1,2),W(1,9),-GC_101,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,6),W(1,10),W(1,8),GC_2,AMP(20))
      CALL FFV2_2(W(1,6),W(1,9),-GC_101,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_1,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_5_0(W(1,6),W(1,10),W(1,11),-GC_50,GC_58,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,11),GC_50,GC_58,AMP(23))
      CALL FFV2_2(W(1,1),W(1,13),-GC_101,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,3),W(1,5),W(1,8),GC_2,AMP(24))
      CALL FFV1_2(W(1,1),W(1,8),GC_1,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 25
      CALL FFV2_0(W(1,10),W(1,5),W(1,13),-GC_101,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV2_5_0(W(1,3),W(1,5),W(1,11),-GC_50,GC_58,AMP(26))
      CALL FFV2_3_2(W(1,1),W(1,11),GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 27
      CALL FFV2_0(W(1,3),W(1,5),W(1,13),-GC_101,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,10),W(1,2),W(1,12),GC_1,AMP(28))
      CALL FFV1_2(W(1,1),W(1,12),GC_1,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,13),W(1,2),W(1,8),GC_1,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,7),GC_50,GC_58,AMP(30))
      CALL FFV2_3_2(W(1,1),W(1,7),GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,10),W(1,2),W(1,8),GC_1,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,3),W(1,2),W(1,12),GC_1,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV2_3_0(W(1,13),W(1,2),W(1,11),GC_50,GC_58,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,7),GC_50,GC_58,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,11),GC_50,GC_58,AMP(35))
