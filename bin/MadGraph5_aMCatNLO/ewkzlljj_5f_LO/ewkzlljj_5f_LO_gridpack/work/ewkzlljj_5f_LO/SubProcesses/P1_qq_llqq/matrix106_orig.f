...
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,6),W(1,4),W(1,10),GC_108,AMP(7))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),GC_105,AMP(8))
      CALL FFV2_2(W(1,1),W(1,10),GC_105,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_1,AMP(9))
      CALL FFV2_5_2(W(1,1),W(1,11),-GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,8),W(1,2),W(1,10),GC_105,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_3_0(W(1,6),W(1,2),W(1,11),GC_50,GC_58,AMP(11))
