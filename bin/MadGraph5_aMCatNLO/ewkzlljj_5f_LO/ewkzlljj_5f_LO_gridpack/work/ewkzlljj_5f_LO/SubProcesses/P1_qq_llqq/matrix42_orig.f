...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,9),W(1,5),W(1,12),GC_1,AMP(17))
      CALL FFV1_2(W(1,1),W(1,12),GC_1,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,2),W(1,5),W(1,8),GC_1,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_3_0(W(1,9),W(1,5),W(1,7),GC_50,GC_58,AMP(19))
      CALL FFV2_3_2(W(1,1),W(1,7),GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,9),W(1,5),W(1,8),GC_1,AMP(20))
      CALL FFV2_3_2(W(1,1),W(1,11),GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,8),W(1,5),W(1,12),GC_1,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_3_0(W(1,2),W(1,5),W(1,11),GC_50,GC_58,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_3_0(W(1,8),W(1,5),W(1,7),GC_50,GC_58,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_3_0(W(1,9),W(1,5),W(1,11),GC_50,GC_58,AMP(24))
