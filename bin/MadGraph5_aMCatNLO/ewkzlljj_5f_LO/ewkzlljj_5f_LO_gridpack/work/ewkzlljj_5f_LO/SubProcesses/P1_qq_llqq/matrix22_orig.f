...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1_1(W(1,2),W(1,9),GC_2,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,6),W(1,15),W(1,8),GC_2,AMP(16))
      CALL FFV1_2(W(1,6),W(1,9),GC_2,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_2,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_5_0(W(1,6),W(1,15),W(1,11),-GC_50,GC_58,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_5_0(W(1,3),W(1,2),W(1,11),-GC_50,GC_58,AMP(19))
      CALL FFV2_5_1(W(1,2),W(1,13),-GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,6),W(1,3),W(1,8),GC_2,AMP(20))
      CALL FFV2_5_2(W(1,6),W(1,13),-GC_50,GC_58,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,15),W(1,2),W(1,8),GC_2,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_5_0(W(1,6),W(1,3),W(1,11),-GC_50,GC_58,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_5_0(W(1,15),W(1,2),W(1,11),-GC_50,GC_58,AMP(23))
      CALL FFV1_2(W(1,1),W(1,7),GC_1,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,15),W(1,5),W(1,8),GC_1,AMP(24))
      CALL FFV1_2(W(1,1),W(1,8),GC_1,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,3),W(1,5),W(1,7),GC_1,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,15),W(1,5),W(1,11),GC_50,GC_58,AMP(26))
      CALL FFV2_3_2(W(1,1),W(1,11),GC_50,GC_58,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,15),W(1,5),W(1,7),GC_1,AMP(27))
      CALL FFV2_3_2(W(1,1),W(1,14),GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,7),W(1,5),W(1,8),GC_1,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV2_3_0(W(1,3),W(1,5),W(1,14),GC_50,GC_58,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_3_0(W(1,7),W(1,5),W(1,11),GC_50,GC_58,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_3_0(W(1,15),W(1,5),W(1,14),GC_50,GC_58,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_0(W(1,3),W(1,2),W(1,10),GC_100,AMP(32))
      CALL FFV2_2(W(1,1),W(1,10),GC_100,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,3),W(1,2),W(1,8),GC_2,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV2_0(W(1,15),W(1,2),W(1,10),GC_100,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV2_5_0(W(1,3),W(1,2),W(1,11),-GC_50,GC_58,AMP(35))
