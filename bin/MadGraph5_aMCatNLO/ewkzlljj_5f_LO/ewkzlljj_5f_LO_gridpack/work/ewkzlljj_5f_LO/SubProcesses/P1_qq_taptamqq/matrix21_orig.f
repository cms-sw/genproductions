...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_105,MDL_MW, FK_MDL_WW,W(1,7))
...
C     Amplitude(s) for diagram number 34
      CALL FFV2_0(W(1,16),W(1,2),W(1,10),GC_105,AMP(34))
      CALL FFV2_2(W(1,1),W(1,10),GC_105,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,16),W(1,2),W(1,8),GC_1,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_0(W(1,9),W(1,2),W(1,10),GC_105,AMP(36))
