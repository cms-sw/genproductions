            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 164 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX164(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_164(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_164/ZEROAMP_164
...
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,9),W(1,7),W(1,8),-GC_3,AMP(2))
      CALL FFS4_3(W(1,3),W(1,4),GC_99,MDL_MH, FK_MDL_WH,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,7),W(1,8),W(1,10),GC_72,AMP(3))
      CALL FFV2_4_3(W(1,3),W(1,4),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,10)
     $ )
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,7),W(1,8),W(1,10),GC_53,AMP(4))
      CALL FFV2_2(W(1,2),W(1,7),GC_43,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,4),W(1,5),W(1,9),GC_2,AMP(5))
      CALL FFV2_1(W(1,5),W(1,7),GC_43,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,3),W(1,9),GC_1,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_5_0(W(1,4),W(1,5),W(1,10),-GC_50,GC_58,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,2),W(1,3),W(1,10),GC_50,GC_58,AMP(8))
      CALL FFV2_1(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,6),W(1,3),W(1,9),GC_2,AMP(9))
      CALL FFV1_1(W(1,1),W(1,9),GC_1,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,6),W(1,2),W(1,8),GC_100,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,6),W(1,3),W(1,10),-GC_50,GC_58,AMP(11))
      CALL FFV2_3_1(W(1,1),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,6),W(1,3),W(1,8),GC_100,AMP(12))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ *AMP(11)+(-1.000000000000000D+00)*AMP(12)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX164 = MATRIX164 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_164(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 164, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_164(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 164, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX164(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS164/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS164
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX164=SOINDEX_FOR_SQUARED_ORDERS164(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS164(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS164/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS164 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS164'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN164(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX164(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX164'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX164(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS164(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS164 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS164'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
