...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,3),W(1,9),W(1,8),GC_108,AMP(1))
      CALL FFV1P0_3(W(1,3),W(1,4),GC_3,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,9),W(1,8),W(1,7),-GC_3,AMP(2))
      CALL FFS4_3(W(1,3),W(1,4),GC_99,MDL_MH, FK_MDL_WH,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL VVS1_0(W(1,8),W(1,7),W(1,10),GC_72,AMP(3))
      CALL FFV2_4_3(W(1,3),W(1,4),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,10)
     $ )
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,8),W(1,7),W(1,10),GC_53,AMP(4))
      CALL FFV2_1(W(1,2),W(1,7),GC_102,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,5),W(1,4),W(1,9),GC_2,AMP(5))
      CALL FFV2_2(W(1,5),W(1,7),GC_102,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,3),W(1,2),W(1,9),GC_1,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_5_0(W(1,5),W(1,4),W(1,10),-GC_50,GC_58,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,10),GC_50,GC_58,AMP(8))
      CALL FFV2_1(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,6),W(1,3),W(1,9),GC_1,AMP(9))
      CALL FFV1_1(W(1,1),W(1,9),GC_2,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,6),W(1,2),W(1,8),GC_100,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_3_0(W(1,6),W(1,3),W(1,10),GC_50,GC_58,AMP(11))
      CALL FFV2_5_1(W(1,1),W(1,10),-GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
