...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1P0_3(W(1,1),W(1,5),GC_1,ZERO, FK_ZERO,W(1,12))
      CALL FFV1P0_3(W(1,6),W(1,2),GC_2,ZERO, FK_ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV1_1(W(1,2),W(1,12),GC_2,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,6),W(1,9),W(1,8),GC_2,AMP(18))
      CALL FFV1_2(W(1,6),W(1,12),GC_2,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,16),W(1,2),W(1,8),GC_2,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV2_5_0(W(1,6),W(1,9),W(1,11),-GC_50,GC_58,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_5_0(W(1,16),W(1,2),W(1,11),-GC_50,GC_58,AMP(21))
      CALL FFV2_5_1(W(1,2),W(1,14),-GC_50,GC_58,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,16),W(1,8),GC_2,AMP(22))
      CALL FFV2_5_2(W(1,6),W(1,14),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_2,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_5_0(W(1,6),W(1,16),W(1,11),-GC_50,GC_58,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV2_5_0(W(1,9),W(1,2),W(1,11),-GC_50,GC_58,AMP(25))
      CALL FFV1_2(W(1,1),W(1,7),GC_1,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,9),W(1,5),W(1,8),GC_1,AMP(26))
      CALL FFV1_2(W(1,1),W(1,8),GC_1,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,16),W(1,5),W(1,7),GC_1,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV2_3_0(W(1,9),W(1,5),W(1,11),GC_50,GC_58,AMP(28))
      CALL FFV2_3_2(W(1,1),W(1,11),GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,9),W(1,5),W(1,7),GC_1,AMP(29))
      CALL FFV2_3_2(W(1,1),W(1,15),GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,7),W(1,5),W(1,8),GC_1,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_3_0(W(1,16),W(1,5),W(1,15),GC_50,GC_58,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_3_0(W(1,7),W(1,5),W(1,11),GC_50,GC_58,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV2_3_0(W(1,9),W(1,5),W(1,15),GC_50,GC_58,AMP(33))
