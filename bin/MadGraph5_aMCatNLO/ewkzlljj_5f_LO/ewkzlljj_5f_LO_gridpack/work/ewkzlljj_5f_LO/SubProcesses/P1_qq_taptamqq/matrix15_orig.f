...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_102,MDL_MW, FK_MDL_WW,W(1,7))
      CALL FFV1P0_3(W(1,3),W(1,4),GC_3,ZERO, FK_ZERO,W(1,8))
      CALL FFV2_1(W(1,5),W(1,7),GC_43,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,9),W(1,8),GC_1,AMP(1))
      CALL FFV2_2(W(1,6),W(1,7),GC_43,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 34
      CALL FFV2_0(W(1,16),W(1,2),W(1,10),GC_102,AMP(34))
      CALL FFV2_2(W(1,1),W(1,10),GC_102,ZERO, FK_ZERO,W(1,16))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,16),W(1,2),W(1,8),GC_1,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_0(W(1,9),W(1,2),W(1,10),GC_102,AMP(36))
