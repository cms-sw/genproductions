...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFS4_3(W(1,3),W(1,4),GC_99,MDL_MH, FK_MDL_WH,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL VVS1_0(W(1,10),W(1,7),W(1,6),GC_72,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL VVV1_0(W(1,10),W(1,7),W(1,11),GC_53,AMP(7))
      CALL FFV2_1(W(1,4),W(1,7),GC_108,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,3),W(1,6),W(1,10),GC_108,AMP(8))
      CALL FFV1_2(W(1,1),W(1,8),GC_1,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),GC_100,AMP(9))
      CALL FFV2_2(W(1,1),W(1,10),GC_100,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_2,AMP(10))
      CALL FFV2_3_2(W(1,1),W(1,11),GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,8),W(1,2),W(1,10),GC_100,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,6),W(1,2),W(1,11),-GC_50,GC_58,AMP(12))
