...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV2_3(W(1,1),W(1,5),-GC_101,MDL_MW, ZERO,W(1,14))
      CALL FFV2_3(W(1,6),W(1,2),-GC_101,MDL_MW, ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 21
      ...
      CALL FFV2_1(W(1,2),W(1,14),-GC_101,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,12),W(1,8),GC_2,AMP(22))
      CALL FFV2_2(W(1,6),W(1,14),-GC_101,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 25
      ...
      CALL FFV2_2(W(1,1),W(1,15),-GC_101,ZERO, FK_ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 27
      CALL FFV2_0(W(1,12),W(1,5),W(1,15),-GC_101,AMP(27))
...
C     Amplitude(s) for diagram number 29
      CALL FFV2_0(W(1,10),W(1,5),W(1,15),-GC_101,AMP(29))
