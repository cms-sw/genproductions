...
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,9),W(1,12),GC_1,AMP(10))
      CALL FFV1_2(W(1,6),W(1,7),GC_1,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,13),W(1,2),W(1,12),GC_1,AMP(11))
      CALL FFV2_4_3(W(1,3),W(1,4),GC_50,GC_59,MDL_MZ, FK_MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,6),W(1,9),W(1,7),GC_50,GC_58,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV2_3_0(W(1,13),W(1,2),W(1,7),GC_50,GC_58,AMP(13))
      CALL FFV2_3_1(W(1,2),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,6),W(1,13),W(1,12),GC_1,AMP(14))
      CALL FFV2_3_2(W(1,6),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,9),W(1,2),W(1,12),GC_1,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,6),W(1,13),W(1,7),GC_50,GC_58,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_3_0(W(1,9),W(1,2),W(1,7),GC_50,GC_58,AMP(17))
      CALL FFV1_2(W(1,1),W(1,8),GC_1,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,9),W(1,5),W(1,12),GC_1,AMP(18))
      CALL FFV1_2(W(1,1),W(1,12),GC_1,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,2),W(1,5),W(1,8),GC_1,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV2_3_0(W(1,9),W(1,5),W(1,7),GC_50,GC_58,AMP(20))
      CALL FFV2_3_2(W(1,1),W(1,7),GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,9),W(1,5),W(1,8),GC_1,AMP(21))
      CALL FFV2_3_2(W(1,1),W(1,11),GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,8),W(1,5),W(1,12),GC_1,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_3_0(W(1,2),W(1,5),W(1,11),GC_50,GC_58,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_3_0(W(1,8),W(1,5),W(1,7),GC_50,GC_58,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV2_3_0(W(1,9),W(1,5),W(1,11),GC_50,GC_58,AMP(25))
