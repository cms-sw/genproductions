...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV2_2(W(1,3),W(1,14),GC_108,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,10),W(1,4),W(1,15),GC_108,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL VVV1_0(W(1,8),W(1,14),W(1,15),-GC_3,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL VVS1_0(W(1,14),W(1,15),W(1,12),GC_72,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL VVV1_0(W(1,14),W(1,15),W(1,11),GC_53,AMP(21))
      CALL FFV2_1(W(1,2),W(1,14),GC_100,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,12),W(1,8),GC_1,AMP(22))
      CALL FFV2_2(W(1,6),W(1,14),GC_100,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,10),W(1,2),W(1,8),GC_2,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_3_0(W(1,6),W(1,12),W(1,11),GC_50,GC_58,AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV2_5_0(W(1,10),W(1,2),W(1,11),-GC_50,GC_58,AMP(25))
      CALL FFV2_2(W(1,1),W(1,15),GC_100,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,10),W(1,5),W(1,8),GC_1,AMP(26))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 27
      CALL FFV2_0(W(1,12),W(1,5),W(1,15),GC_100,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV2_3_0(W(1,10),W(1,5),W(1,11),GC_50,GC_58,AMP(28))
      CALL FFV2_5_2(W(1,1),W(1,11),-GC_50,GC_58,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 29
      CALL FFV2_0(W(1,10),W(1,5),W(1,15),GC_100,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,12),W(1,2),W(1,13),GC_2,AMP(30))
      CALL FFV1_2(W(1,1),W(1,13),GC_2,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,15),W(1,2),W(1,8),GC_2,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_5_0(W(1,12),W(1,2),W(1,9),-GC_50,GC_58,AMP(32))
      CALL FFV2_5_2(W(1,1),W(1,9),-GC_50,GC_58,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,12),W(1,2),W(1,8),GC_2,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,10),W(1,2),W(1,13),GC_2,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV2_5_0(W(1,15),W(1,2),W(1,11),-GC_50,GC_58,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_5_0(W(1,10),W(1,2),W(1,9),-GC_50,GC_58,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV2_5_0(W(1,12),W(1,2),W(1,11),-GC_50,GC_58,AMP(37))
