...
#ifndef QUADNINJA_NINJA_IN_HH
#define QUADNINJA_NINJA_IN_HH

#ifndef QUADNINJA_NINJA_HH_INSIDE
...
namespace quadninja {
  ...
  void setDefaultIntegralLibrary(quadninja::IntegralLibrary & lib);
  quadninja::IntegralLibrary * getIntegralLibrary();
  ...
  private:
    ...
    friend quadninja::IntegralLibrary * getIntegralLibrary();
