...
C         add to the sum of helicities
      ...
      REAL*8 FUNCTION MATRIX_9(P,NHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,6),W(1,8),W(1,9),GC_5,AMP(7))
...
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,7),W(1,2),W(1,9),GC_5,AMP(12))
      ...
      JAMP(1) = (5.000000000000000D-01)*TMP_JAMP(11)
      JAMP(2) = (-1.666666666666667D-01)*TMP_JAMP(11)
      MATRIX_9 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
        ...
        ENDDO
        MATRIX_9 = MATRIX_9+ZTEMP*DCONJG(JAMP(I))
      ENDDO
      END
