...
C           Amplitude(s) for diagram number 4
            CALL FFV1_0(W(1,6),W(1,10),W(1,4),GC_2,AMP(4))
C           Amplitude(s) for diagram number 5
            CALL FFV1_0(W(1,6),W(1,9),W(1,2),GC_5,AMP(5))
            CALL FFV1_2(W(1,1),W(1,4),GC_1,ZERO,ZERO,W(1,6))
C           Amplitude(s) for diagram number 6
            CALL FFV2_0(W(1,6),W(1,10),W(1,3),GC_11,AMP(6))
C           Amplitude(s) for diagram number 7
            CALL FFV1_0(W(1,6),W(1,8),W(1,2),GC_5,AMP(7))
C           Amplitude(s) for diagram number 8
            CALL FFV2_0(W(1,1),W(1,10),W(1,7),GC_11,AMP(8))
            DO I=1,NGRAPHS
