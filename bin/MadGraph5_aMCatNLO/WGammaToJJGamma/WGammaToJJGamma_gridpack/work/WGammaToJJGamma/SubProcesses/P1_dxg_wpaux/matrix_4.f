...
C     
C     Process: d~ d > w+ a d u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ s > w+ a s c~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV1_1(W(1,9),W(1,4),GC_2,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,13),W(1,10),W(1,4),GC_1,AMP(22))
