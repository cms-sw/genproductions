...
C     
C     Process: u~ d > w- a WEIGHTED<=4 [ all = QCD ]
C     Process: c~ s > w- a WEIGHTED<=4 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     GLOBAL VARIABLES
C     
      DOUBLE PRECISION AMP2(3), JAMP2(0:1)
...
C           Amplitude(s) for diagram number 2
            CALL FFV1_0(W(1,2),W(1,5),W(1,4),GC_1,AMP(2))
            CALL FFV1_1(W(1,1),W(1,4),GC_2,ZERO,ZERO,W(1,5))
C           Amplitude(s) for diagram number 3
            CALL FFV2_0(W(1,2),W(1,5),W(1,3),GC_11,AMP(3))
            DO I=1,NGRAPHS
