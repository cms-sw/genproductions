...
C     
C     Process: g g > w- a u d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: g g > w- a c s~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C         add to the sum of helicities
      ...
      REAL*8 FUNCTION MATRIX_10(P,NHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV1_1(W(1,5),W(1,7),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,6),W(1,9),W(1,8),GC_11,AMP(1))
      CALL FFV1_2(W(1,6),W(1,7),GC_5,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,10),W(1,5),W(1,8),GC_11,AMP(2))
      CALL FFV2_1(W(1,5),W(1,3),GC_11,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 33
      CALL FFV2_0(W(1,16),W(1,14),W(1,3),GC_11,AMP(33))
      CALL FFV1_1(W(1,14),W(1,1),GC_5,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 34
      CALL FFV2_0(W(1,10),W(1,16),W(1,3),GC_11,AMP(34))
...
C     Amplitude(s) for diagram number 38
      ...
      JAMP(1) = (-1.000000000000000D+00)*AMP(9)+(-1.000000000000000D
     ...
     $ +00,1.000000000000000D+00))*TMP_JAMP(7)
      JAMP(2) = (-1.000000000000000D+00)*AMP(17)+(-1.000000000000000D
     $ +00)*AMP(18)+(-1.000000000000000D+00)*AMP(19)+(
     $ -1.000000000000000D+00)*AMP(20)+(-1.000000000000000D+00)*AMP(21)
     ...
     $ -1.000000000000000D+00)*AMP(27)+(-1.000000000000000D+00)*AMP(28)
     ...
     $ +00,-1.000000000000000D+00))*TMP_JAMP(7)
      ...
      DO I = 1, NCOLOR
        ...
        ENDDO
        MATRIX_10 = MATRIX_10+ZTEMP*DCONJG(JAMP(I))
      ENDDO
      END
