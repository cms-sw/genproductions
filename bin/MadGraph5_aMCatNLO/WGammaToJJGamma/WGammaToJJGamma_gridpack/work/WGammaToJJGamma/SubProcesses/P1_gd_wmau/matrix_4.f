...
C     
C     Process: u~ d > w- a u u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c~ s > w- a c c~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV1_1(W(1,5),W(1,4),GC_2,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1_1(W(1,7),W(1,4),GC_1,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,7),W(1,11),W(1,4),GC_2,AMP(9))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL VVV1_3(W(1,4),W(1,3),GC_25,MDL_MW,MDL_WW,W(1,15))
...
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,16),W(1,14),W(1,4),GC_1,AMP(15))
