...
C     ----------
     ...
     $ +AMP(8)
      JAMP2(1) = (-1.500000000000000D+00)*AMP(1)+(-1.500000000000000D
     $ +00)*AMP(2)+(-1.500000000000000D+00)*AMP(3)+(
     $ -1.500000000000000D+00)*AMP(4)+(-1.500000000000000D+00)*AMP(5)
     $ +(-1.500000000000000D+00)*AMP(6)+(-1.500000000000000D+00)*AMP(7)
     $ +(-1.500000000000000D+00)*AMP(8)
      B_SF_002 = 0.D0
      DO I = 1, NCOLOR1
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR2
        ...
        ENDDO
        B_SF_002 =B_SF_002+ZTEMP*DCONJG(JAMP1(I))
      ENDDO
      END
