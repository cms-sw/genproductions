...
C     CutTools call for loop numbers 1,22
      CALL LOOP_2(7,13,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,1)
C     CutTools call for loop numbers 2,6
      CALL LOOP_2(6,14,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,2)
C     CutTools call for loop numbers 3,4
      CALL LOOP_3(5,6,7,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,3)
C     CutTools call for loop numbers 5,14,33
      CALL LOOP_2(8,15,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,4)
C     CutTools call for loop numbers 7
      CALL LOOP_3(4,6,8,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,5)
C     CutTools call for loop numbers 8,13,16,21,39,42
...
C     CutTools call for loop numbers 11,28
...
C     CutTools call for loop numbers 19,26
...
C     CutTools call for loop numbers 24
      CALL LOOP_3(2,12,11,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,I_SO,17)
...
C     CutTools call for loop numbers 29,35
...
C     CutTools call for loop numbers 38
      CALL LOOP_4(1,2,12,5,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,27)
C     CutTools call for loop numbers 40
      CALL LOOP_4(1,5,2,12,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,I_SO,28)
C     CutTools call for loop numbers 41
      CALL LOOP_4(1,2,5,12,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
...
C     CutTools call for loop numbers 51,56
      CALL LOOP_2(10,18,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,38)
C     CutTools call for loop numbers 52,55
      CALL LOOP_2(9,22,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,39)
C     CutTools call for loop numbers 53,54
      CALL LOOP_3(5,10,9,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,40)
C     CutTools call for loop numbers 57,59,60
      CALL LOOP_2(11,24,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,41)
C     CutTools call for loop numbers 58
      CALL LOOP_3(4,10,11,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,I_SO,42)
C     CutTools call for loop numbers 61,66,67,68,70,71
...
C     CutTools call for loop numbers 63,69
      CALL LOOP_3(1,4,22,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,45)
