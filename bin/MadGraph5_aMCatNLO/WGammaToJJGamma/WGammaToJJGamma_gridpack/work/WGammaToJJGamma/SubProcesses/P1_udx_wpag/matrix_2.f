...
C     
C     Process: g d~ > w+ a u~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: g s~ > w+ a c~ g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,11),W(1,9),W(1,4),GC_1,AMP(4))
      CALL FFV1_2(W(1,5),W(1,4),GC_2,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,10),W(1,14),W(1,4),GC_2,AMP(7))
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_2(W(1,12),W(1,4),GC_2,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,9),W(1,14),W(1,6),GC_5,AMP(9))
      CALL FFV1_2(W(1,12),W(1,6),GC_5,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,7),W(1,14),W(1,4),GC_2,AMP(10))
      CALL FFV1_1(W(1,2),W(1,4),GC_1,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,16),W(1,17),W(1,4),GC_1,AMP(13))
...
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,12),W(1,14),W(1,4),GC_2,AMP(17))
...
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,11),W(1,9),W(1,4),GC_1,AMP(23))
...
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,10),W(1,9),W(1,4),GC_2,AMP(27))
      CALL FFV1_2(W(1,10),W(1,1),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,9),W(1,14),W(1,4),GC_2,AMP(28))
...
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,11),W(1,15),W(1,4),GC_1,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,7),W(1,17),W(1,4),GC_1,AMP(35))
