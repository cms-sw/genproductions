...
C     
      ...
      CALL EVAL_POLY(LOOPCOEFS(0,SQSOINDEX,ID),RANK,-Q,RES)
      END
...
C     ----------
      ...
      CALL MP_EVAL_POLY(LOOPCOEFS(0,SQSOINDEX,ID),RANK,-QQ,QRES)
      RES=QRES
