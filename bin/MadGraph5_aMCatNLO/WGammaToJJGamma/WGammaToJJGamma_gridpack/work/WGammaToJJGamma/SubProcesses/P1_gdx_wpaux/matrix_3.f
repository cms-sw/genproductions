...
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,13),W(1,5),W(1,15),GC_5,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,13),W(1,2),W(1,7),GC_5,AMP(12))
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,12),W(1,10),W(1,7),GC_5,AMP(14))
      CALL FFV1_1(W(1,2),W(1,4),GC_1,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,15),W(1,9),W(1,3),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,13),W(1,9),W(1,7),GC_5,AMP(16))
      CALL FFV1_1(W(1,2),W(1,7),GC_5,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,6),W(1,16),W(1,8),GC_11,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,15),W(1,2),W(1,8),GC_11,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,13),W(1,16),W(1,4),GC_1,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,12),W(1,16),W(1,3),GC_11,AMP(20))
      CALL FFV1P0_3(W(1,1),W(1,14),GC_5,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,6),W(1,10),W(1,16),GC_5,AMP(21))
...
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,13),W(1,2),W(1,16),GC_5,AMP(24))
