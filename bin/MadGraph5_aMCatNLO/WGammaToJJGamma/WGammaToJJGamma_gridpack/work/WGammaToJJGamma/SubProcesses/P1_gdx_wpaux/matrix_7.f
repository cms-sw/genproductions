...
C     
C     Process: s d~ > w+ a s u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: b d~ > w+ a b u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: d s~ > w+ a d c~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: b s~ > w+ a b c~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,10),W(1,8),W(1,4),GC_2,AMP(3))
