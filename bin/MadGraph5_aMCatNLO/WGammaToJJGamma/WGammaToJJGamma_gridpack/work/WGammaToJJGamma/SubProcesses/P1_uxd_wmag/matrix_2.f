...
C     ----------
      ...
      CALL FFV1_2(W(1,7),W(1,6),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,9),W(1,5),W(1,8),GC_11,AMP(1))
      CALL FFV1_1(W(1,5),W(1,6),GC_5,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,7),W(1,10),W(1,8),GC_11,AMP(2))
      CALL FFV2_1(W(1,5),W(1,3),GC_11,ZERO,ZERO,W(1,11))
      CALL FFV1_2(W(1,7),W(1,4),GC_1,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,12),W(1,11),W(1,6),GC_5,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,9),W(1,11),W(1,4),GC_1,AMP(4))
      CALL FFV1_1(W(1,5),W(1,4),GC_2,ZERO,ZERO,W(1,13))
      CALL FFV2_2(W(1,7),W(1,3),GC_11,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,14),W(1,13),W(1,6),GC_5,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,9),W(1,13),W(1,3),GC_11,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,14),W(1,10),W(1,4),GC_2,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,12),W(1,10),W(1,3),GC_11,AMP(8))
      CALL FFV1_1(W(1,5),W(1,1),GC_5,ZERO,ZERO,W(1,12))
      CALL FFV2_2(W(1,2),W(1,3),GC_11,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_2(W(1,2),W(1,4),GC_1,ZERO,ZERO,W(1,15))
      CALL FFV2_1(W(1,12),W(1,3),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,15),W(1,16),W(1,6),GC_5,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,15),W(1,7),W(1,3),GC_11,AMP(12))
      CALL FFV1_2(W(1,2),W(1,6),GC_5,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,17),W(1,16),W(1,4),GC_1,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,17),W(1,9),W(1,3),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,17),W(1,12),W(1,8),GC_11,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,2),W(1,7),W(1,8),GC_11,AMP(16))
      CALL VVV1P0_1(W(1,1),W(1,6),GC_4,ZERO,ZERO,W(1,7))
      CALL FFV1_1(W(1,5),W(1,7),GC_5,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,14),W(1,12),W(1,4),GC_2,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,14),W(1,13),W(1,7),GC_5,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_0(W(1,15),W(1,12),W(1,3),GC_11,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,15),W(1,11),W(1,7),GC_5,AMP(20))
      CALL FFV1_2(W(1,2),W(1,7),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,9),W(1,5),W(1,8),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,2),W(1,12),W(1,8),GC_11,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,9),W(1,11),W(1,4),GC_1,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV2_0(W(1,9),W(1,13),W(1,3),GC_11,AMP(24))
      CALL FFV1_2(W(1,14),W(1,1),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,9),W(1,13),W(1,6),GC_5,AMP(25))
      CALL FFV1_1(W(1,13),W(1,1),GC_5,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,14),W(1,12),W(1,6),GC_5,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,9),W(1,10),W(1,4),GC_2,AMP(27))
      CALL FFV1_1(W(1,10),W(1,1),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,14),W(1,9),W(1,4),GC_2,AMP(28))
      CALL FFV1_2(W(1,15),W(1,1),GC_5,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,14),W(1,11),W(1,6),GC_5,AMP(29))
      CALL FFV1_1(W(1,11),W(1,1),GC_5,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,15),W(1,7),W(1,6),GC_5,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_0(W(1,14),W(1,10),W(1,3),GC_11,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_0(W(1,15),W(1,9),W(1,3),GC_11,AMP(32))
      CALL FFV1_2(W(1,17),W(1,1),GC_5,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 33
      CALL FFV2_0(W(1,15),W(1,5),W(1,8),GC_11,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,15),W(1,11),W(1,4),GC_1,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,17),W(1,7),W(1,4),GC_1,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_0(W(1,15),W(1,13),W(1,3),GC_11,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV2_0(W(1,17),W(1,12),W(1,3),GC_11,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_0(W(1,2),W(1,9),W(1,8),GC_11,AMP(38))
      ...
      JAMP(1) = AMP(9)+AMP(10)+AMP(11)+AMP(12)+AMP(13)+AMP(14)+AMP(15)
     $ +AMP(16)+AMP(26)+AMP(30)+AMP(33)+AMP(34)+AMP(35)+AMP(36)+AMP(37)
     $ +((0.000000000000000D+00,-1.000000000000000D+00))*TMP_JAMP(7)
      JAMP(2) = AMP(1)+AMP(2)+AMP(3)+AMP(4)+AMP(5)+AMP(6)+AMP(7)+AMP(8)
     $ +AMP(25)+AMP(27)+AMP(28)+AMP(29)+AMP(31)+AMP(32)+AMP(38)
     $ +((0.000000000000000D+00,1.000000000000000D+00))*TMP_JAMP(7)
      MATRIX_2 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
