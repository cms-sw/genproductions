...
C     
C     Process: u~ d > w- a d d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c~ s > w- a s s~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,8),W(1,5),W(1,9),GC_5,AMP(1))
      CALL FFV1P0_3(W(1,6),W(1,5),GC_5,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,8),W(1,7),W(1,10),GC_5,AMP(2))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1P0_3(W(1,2),W(1,7),GC_5,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,6),W(1,14),W(1,15),GC_5,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,2),W(1,14),W(1,9),GC_5,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,13),W(1,5),W(1,15),GC_5,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,2),W(1,12),W(1,10),GC_5,AMP(8))
      CALL FFV1_1(W(1,1),W(1,4),GC_2,ZERO,ZERO,W(1,12))
      CALL FFV2_2(W(1,2),W(1,3),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,15),W(1,12),W(1,10),GC_5,AMP(9))
      CALL FFV2_1(W(1,12),W(1,3),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,9),W(1,11),GC_5,AMP(10))
      CALL FFV2_2(W(1,6),W(1,3),GC_11,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,7),W(1,12),W(1,11),GC_5,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,2),W(1,9),W(1,10),GC_5,AMP(12))
      CALL FFV1P0_3(W(1,15),W(1,1),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,6),W(1,14),W(1,9),GC_5,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,13),W(1,5),W(1,9),GC_5,AMP(14))
      CALL FFV1_1(W(1,1),W(1,10),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,15),W(1,9),W(1,4),GC_2,AMP(15))
      CALL FFV1P0_3(W(1,7),W(1,1),GC_5,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,8),W(1,5),W(1,15),GC_5,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,8),W(1,9),W(1,3),GC_11,AMP(17))
      CALL VVV1_3(W(1,4),W(1,3),GC_25,MDL_MW,MDL_WW,W(1,8))
      CALL FFV1_1(W(1,1),W(1,11),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,6),W(1,5),W(1,8),GC_11,AMP(18))
      CALL FFV2_1(W(1,1),W(1,8),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,6),W(1,12),W(1,11),GC_5,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,7),W(1,5),W(1,4),GC_2,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,13),W(1,5),W(1,3),GC_11,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,2),W(1,12),W(1,10),GC_5,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,2),W(1,9),W(1,8),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,2),W(1,14),W(1,15),GC_5,AMP(24))
      ...
      TMP_JAMP(3) = AMP(4) +  AMP(6)  ! used 2 times
