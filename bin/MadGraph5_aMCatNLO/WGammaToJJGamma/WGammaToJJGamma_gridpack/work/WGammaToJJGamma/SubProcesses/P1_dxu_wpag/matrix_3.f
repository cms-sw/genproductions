...
C     
C     Process: d~ g > w+ a u~ g WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ g > w+ a c~ g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,10),W(1,16),W(1,4),GC_2,AMP(15))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,14),W(1,12),W(1,4),GC_2,AMP(25))
      CALL FFV1_1(W(1,16),W(1,4),GC_1,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,11),W(1,9),W(1,4),GC_1,AMP(29))
...
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,11),W(1,14),W(1,4),GC_1,AMP(36))
