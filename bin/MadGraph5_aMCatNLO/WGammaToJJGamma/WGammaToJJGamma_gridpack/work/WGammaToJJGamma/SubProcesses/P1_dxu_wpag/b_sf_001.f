...
C     ----------
     ...
     $ +(-1.000000000000000D+00)*AMP(8)
      JAMP2(1) = (-1.666666666666667D-01)*AMP(1)+(-1.666666666666667D
     $ -01)*AMP(2)+(-1.666666666666667D-01)*AMP(3)+(
     $ -1.666666666666667D-01)*AMP(4)+(-1.666666666666667D-01)*AMP(5)
     $ +(-1.666666666666667D-01)*AMP(6)+(-1.666666666666667D-01)*AMP(7)
     $ +(-1.666666666666667D-01)*AMP(8)
      B_SF_001 = 0.D0
      DO I = 1, NCOLOR1
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR2
