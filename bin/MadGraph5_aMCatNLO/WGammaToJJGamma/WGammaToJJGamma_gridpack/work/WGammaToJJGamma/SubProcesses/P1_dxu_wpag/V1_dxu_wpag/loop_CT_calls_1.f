...
C     CutTools call for loop numbers 1,11
      CALL LOOP_2(10,13,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,1)
C     CutTools call for loop numbers 2,5
      CALL LOOP_2(9,14,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,2)
...
C     CutTools call for loop numbers 7,18
      CALL LOOP_3(2,3,13,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,5)
...
C     CutTools call for loop numbers 12,14,16
      CALL LOOP_2(11,17,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,9)
...
C     CutTools call for loop numbers 21,26,27,32,39,42
...
C     CutTools call for loop numbers 23,37
      CALL LOOP_3(1,4,14,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,17)
...
C     CutTools call for loop numbers 51,67
      CALL LOOP_2(7,22,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,38)
C     CutTools call for loop numbers 52,56
      CALL LOOP_2(6,20,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,39)
C     CutTools call for loop numbers 53,54
      CALL LOOP_3(5,6,7,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,40)
C     CutTools call for loop numbers 55,64,69
      CALL LOOP_2(8,23,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,41)
C     CutTools call for loop numbers 57
      CALL LOOP_3(4,6,8,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,42)
C     CutTools call for loop numbers 58,63,65,66,70,71
...
C     CutTools call for loop numbers 61,68
      CALL LOOP_3(2,4,22,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,46)
