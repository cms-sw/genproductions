...
C     
C     Process: d~ u > w+ a g g WEIGHTED<=6 [ all = QCD ] @1
C     Process: s~ c > w+ a g g WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,10),W(1,13),W(1,4),GC_2,AMP(21))
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1_1(W(1,14),W(1,4),GC_1,ZERO,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,9),W(1,13),W(1,4),GC_1,AMP(26))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,12),W(1,16),W(1,4),GC_2,AMP(29))
...
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,9),W(1,13),W(1,4),GC_1,AMP(33))
