...
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,16),W(1,10),W(1,4),GC_1,AMP(15))
...
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,12),W(1,14),W(1,4),GC_1,AMP(25))
      CALL FFV1_2(W(1,16),W(1,4),GC_2,ZERO,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,9),W(1,11),W(1,4),GC_2,AMP(29))
...
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,14),W(1,11),W(1,4),GC_2,AMP(36))
