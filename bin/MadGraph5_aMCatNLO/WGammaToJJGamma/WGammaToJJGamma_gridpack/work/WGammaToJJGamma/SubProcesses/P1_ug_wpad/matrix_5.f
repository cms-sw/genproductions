...
C     
C     Process: u u~ > w+ a d u~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c c~ > w+ a s c~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_2(W(1,1),W(1,3),GC_11,ZERO,ZERO,W(1,9))
      CALL FFV1_1(W(1,2),W(1,4),GC_2,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV2_2(W(1,7),W(1,3),GC_11,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,9),W(1,5),W(1,8),GC_11,AMP(20))
      CALL FFV2_2(W(1,1),W(1,8),GC_11,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,13),W(1,5),W(1,15),GC_5,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,9),W(1,11),W(1,4),GC_2,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,9),W(1,14),W(1,3),GC_11,AMP(23))
