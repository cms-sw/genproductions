...
C     CutTools call for loop numbers 1
      CALL LOOP_2(6,8,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,1)
...
C     CutTools call for loop numbers 4
      CALL LOOP_3(1,3,8,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,4)
...
C     CutTools call for loop numbers 8
      CALL LOOP_2(10,7,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,8)
C     CutTools call for loop numbers 9
      CALL LOOP_3(1,4,10,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,9)
