...
C     
C     Process: g u~ > w- a d~ WEIGHTED<=5 [ all = QCD ] @1
C     Process: g c~ > w- a s~ WEIGHTED<=5 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      ...
      DATA IDEN_VALUES /96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96, 96/
      INTEGER IJ_VALUES(12)
      DATA IJ_VALUES /1, 2, 5, 1, 1, 1, 1, 1, 1, 1, 1, 2/
C     
C     GLOBAL VARIABLES
C     
      DOUBLE PRECISION AMP2(8), JAMP2(0:1)
...
C           Amplitude(s) for diagram number 3
            ...
            CALL FFV1_2(W(1,5),W(1,1),GC_5,ZERO,ZERO,W(1,6))
            CALL FFV2_1(W(1,2),W(1,3),GC_11,ZERO,ZERO,W(1,5))
C           Amplitude(s) for diagram number 4
            CALL FFV1_0(W(1,6),W(1,5),W(1,4),GC_1,AMP(4))
            CALL FFV1_1(W(1,2),W(1,4),GC_2,ZERO,ZERO,W(1,10))
C           Amplitude(s) for diagram number 5
            CALL FFV2_0(W(1,6),W(1,10),W(1,3),GC_11,AMP(5))
C           Amplitude(s) for diagram number 6
            CALL FFV2_0(W(1,6),W(1,2),W(1,7),GC_11,AMP(6))
C           Amplitude(s) for diagram number 7
            CALL FFV1_0(W(1,9),W(1,5),W(1,1),GC_5,AMP(7))
C           Amplitude(s) for diagram number 8
            CALL FFV1_0(W(1,8),W(1,10),W(1,1),GC_5,AMP(8))
            DO I=1,NGRAPHS
