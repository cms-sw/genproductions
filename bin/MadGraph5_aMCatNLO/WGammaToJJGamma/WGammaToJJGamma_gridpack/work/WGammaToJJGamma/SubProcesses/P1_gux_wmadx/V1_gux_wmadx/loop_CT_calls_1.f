...
C     CutTools call for loop numbers 14
     ...
     $ ,12)
C     CutTools call for loop numbers 15,44
      CALL LOOP_3(2,3,15,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,13)
...
C     CutTools call for loop numbers 19,22,24,35,39,40
      CALL LOOP_3(1,5,16,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,17)
C     CutTools call for loop numbers 20,32
...
C     CutTools call for loop numbers 52,64
...
C     CutTools call for loop numbers 54
     ...
     $ ,40)
C     CutTools call for loop numbers 56,65
      CALL LOOP_2(12,25,DCMPLX(ZERO),DCMPLX(ZERO),1,I_SO,41)
C     CutTools call for loop numbers 57,70
      CALL LOOP_3(2,4,25,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,42)
C     CutTools call for loop numbers 58,66
      CALL LOOP_3(1,12,8,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2,I_SO
     $ ,43)
C     CutTools call for loop numbers 59,60,62,67,68,71
