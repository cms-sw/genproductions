...
C     
C     Process: s u > w+ a d s WEIGHTED<=6 [ all = QCD ] @1
C     Process: b u > w+ a d b WEIGHTED<=6 [ all = QCD ] @1
C     Process: d c > w+ a s d WEIGHTED<=6 [ all = QCD ] @1
C     Process: b c > w+ a s b WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,8),W(1,10),W(1,4),GC_1,AMP(3))
