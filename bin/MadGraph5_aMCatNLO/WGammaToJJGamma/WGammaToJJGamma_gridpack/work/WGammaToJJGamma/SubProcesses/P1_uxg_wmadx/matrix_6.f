...
C     
C     Process: u~ u > w- a u d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c~ c > w- a c s~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_1(W(1,1),W(1,3),GC_11,ZERO,ZERO,W(1,9))
      CALL FFV1_2(W(1,2),W(1,4),GC_2,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,16),W(1,15),GC_5,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,12),W(1,9),W(1,15),GC_5,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,2),W(1,14),W(1,7),GC_5,AMP(12))
      CALL FFV1_1(W(1,1),W(1,4),GC_2,ZERO,ZERO,W(1,7))
      CALL FFV2_1(W(1,7),W(1,3),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,6),W(1,9),W(1,15),GC_5,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,13),W(1,7),W(1,15),GC_5,AMP(14))
...
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,13),W(1,5),W(1,9),GC_5,AMP(18))
      CALL FFV1P0_3(W(1,13),W(1,1),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,10),W(1,5),W(1,9),GC_5,AMP(19))
      CALL FFV1_1(W(1,1),W(1,15),GC_5,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,6),W(1,10),W(1,8),GC_11,AMP(20))
      CALL FFV2_1(W(1,1),W(1,8),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,6),W(1,5),W(1,15),GC_5,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,13),W(1,10),W(1,4),GC_2,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,12),W(1,10),W(1,3),GC_11,AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,2),W(1,14),W(1,9),GC_5,AMP(24))
      ...
      TMP_JAMP(17) = TMP_JAMP(4) +  TMP_JAMP(3)  ! used 2 times
      TMP_JAMP(16) = TMP_JAMP(6) +  TMP_JAMP(5)  ! used 2 times
      TMP_JAMP(15) = TMP_JAMP(9) +  TMP_JAMP(8)  ! used 2 times
      TMP_JAMP(14) = TMP_JAMP(10) +  TMP_JAMP(7)  ! used 2 times
      TMP_JAMP(13) = TMP_JAMP(12) +  TMP_JAMP(11)  ! used 2 times
      TMP_JAMP(20) = TMP_JAMP(16) +  TMP_JAMP(14)  ! used 2 times
      TMP_JAMP(19) = TMP_JAMP(18) +  TMP_JAMP(17)  ! used 2 times
      TMP_JAMP(22) = TMP_JAMP(19) +  TMP_JAMP(15)  ! used 2 times
