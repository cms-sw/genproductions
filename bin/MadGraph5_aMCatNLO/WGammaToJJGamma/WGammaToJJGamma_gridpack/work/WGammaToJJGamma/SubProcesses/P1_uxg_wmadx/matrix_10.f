...
C     
C     Process: u~ c > w- a c d~ WEIGHTED<=6 [ all = QCD ] @1
C     Process: c~ u > w- a u s~ WEIGHTED<=6 [ all = QCD ] @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,6),W(1,12),W(1,10),GC_5,AMP(5))
      CALL FFV2_2(W(1,6),W(1,3),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,12),W(1,9),W(1,10),GC_5,AMP(6))
      CALL FFV1P0_3(W(1,12),W(1,1),GC_5,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,8),W(1,5),W(1,9),GC_5,AMP(7))
      CALL VVV1_3(W(1,4),W(1,3),GC_25,MDL_MW,MDL_WW,W(1,8))
      CALL FFV1_1(W(1,1),W(1,10),GC_5,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,6),W(1,5),W(1,8),GC_11,AMP(8))
      CALL FFV2_1(W(1,1),W(1,8),GC_11,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,6),W(1,13),W(1,10),GC_5,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,12),W(1,5),W(1,4),GC_2,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,11),W(1,5),W(1,3),GC_11,AMP(11))
