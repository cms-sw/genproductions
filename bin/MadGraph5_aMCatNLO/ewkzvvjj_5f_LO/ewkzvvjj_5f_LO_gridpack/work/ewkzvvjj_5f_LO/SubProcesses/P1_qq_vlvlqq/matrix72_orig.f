            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 72 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX72(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_72(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_72/ZEROAMP_72
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,2),W(1,9),GC_1,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,6),W(1,4),W(1,10),GC_50,GC_58,AMP(3))
      CALL FFV1_2(W(1,6),W(1,9),GC_1,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,4),W(1,2),W(1,10),GC_50,GC_58,AMP(4))
      CALL FFV2_3_1(W(1,2),W(1,7),GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,6),W(1,4),W(1,10),GC_50,GC_58,AMP(5))
      CALL FFV2_3_2(W(1,6),W(1,7),GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,4),W(1,2),W(1,10),GC_50,GC_58,AMP(6))
      CALL FFV1P0_3(W(1,6),W(1,2),GC_1,ZERO, FK_ZERO,W(1,4))
      CALL FFV1_2(W(1,1),W(1,4),GC_1,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_3_0(W(1,6),W(1,5),W(1,10),GC_50,GC_58,AMP(7))
      CALL FFV2_3_2(W(1,1),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,6),W(1,5),W(1,4),GC_1,AMP(8))
      CALL FFV2_3_2(W(1,1),W(1,8),GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFV2_3_0(W(1,4),W(1,5),W(1,10),GC_50,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,6),W(1,5),W(1,8),GC_50,GC_58,AMP(10))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +(-1.000000000000000D+00)*AMP(10)

      IF(INIT_MODE)THEN
        DO I=1, NGRAPHS
          IF (AMP(I).NE.0) THEN
            ZEROAMP_72(IHEL,I) = .FALSE.
          ENDIF
        ENDDO
      ENDIF
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX72 = MATRIX72 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_72(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 72, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_72(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 72, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX72(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS72/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS72
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX72=SOINDEX_FOR_SQUARED_ORDERS72(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS72(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS72/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS72 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS72'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN72(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX72(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX72'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX72(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS72(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS72 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS72'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
