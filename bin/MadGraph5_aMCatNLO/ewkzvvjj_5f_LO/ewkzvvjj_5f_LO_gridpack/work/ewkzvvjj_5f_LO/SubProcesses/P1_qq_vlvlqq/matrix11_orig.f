...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_1(W(1,3),W(1,10),GC_108,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,4),W(1,11),W(1,9),GC_108,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VVV1_0(W(1,10),W(1,9),W(1,8),GC_53,AMP(8))
      CALL FFV2_1(W(1,2),W(1,10),GC_100,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 9
      CALL FFV2_3_0(W(1,6),W(1,11),W(1,8),GC_50,GC_58,AMP(9))
      CALL FFV2_2(W(1,6),W(1,10),GC_100,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL FFV2_5_0(W(1,11),W(1,2),W(1,8),-GC_50,GC_58,AMP(10))
      CALL FFV2_2(W(1,1),W(1,9),GC_100,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 11
      CALL FFV2_3_0(W(1,11),W(1,5),W(1,8),GC_50,GC_58,AMP(11))
      CALL FFV2_5_2(W(1,1),W(1,8),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,11),W(1,5),W(1,9),GC_100,AMP(12))
      CALL FFV1P0_3(W(1,6),W(1,5),GC_1,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,11),W(1,2),W(1,9),GC_2,AMP(13))
      CALL FFV1_2(W(1,1),W(1,9),GC_2,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,6),W(1,2),W(1,8),-GC_50,GC_58,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_5_0(W(1,11),W(1,2),W(1,7),-GC_50,GC_58,AMP(15))
      CALL FFV2_5_2(W(1,1),W(1,7),-GC_50,GC_58,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,11),W(1,2),W(1,8),-GC_50,GC_58,AMP(16))
