            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 71 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX71(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_71(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_71/ZEROAMP_71
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,6),W(1,9),W(1,8),GC_50,GC_58,AMP(1))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3_1(W(1,5),W(1,9),GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,6),W(1,7),W(1,8),GC_50,GC_58,AMP(3))
      CALL FFV2_3_2(W(1,6),W(1,9),GC_50,GC_58,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,7),W(1,5),W(1,8),GC_50,GC_58,AMP(4))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1P0_3(W(1,6),W(1,5),GC_1,ZERO, FK_ZERO,W(1,10))
      CALL FFV2_3_2(W(1,1),W(1,8),GC_50,GC_58,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,6),W(1,2),W(1,10),GC_1,AMP(7))
      CALL FFV1_2(W(1,1),W(1,10),GC_1,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,8),GC_50,GC_58,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV2_3_0(W(1,6),W(1,2),W(1,7),GC_50,GC_58,AMP(9))
      CALL FFV2_3_2(W(1,1),W(1,7),GC_50,GC_58,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,6),W(1,2),W(1,8),GC_50,GC_58,AMP(10))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +AMP(8)+AMP(9)+AMP(10)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX71 = MATRIX71 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_71(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 71, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_71(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 71, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX71(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS71/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS71
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX71=SOINDEX_FOR_SQUARED_ORDERS71(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS71(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS71/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS71 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS71'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN71(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX71(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX71'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX71(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS71(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS71 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS71'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
