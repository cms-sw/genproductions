...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_1(W(1,3),W(1,7),GC_108,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,4),W(1,9),W(1,8),GC_108,AMP(1))
      CALL FFV2_3(W(1,4),W(1,3),GC_62,MDL_MZ, FK_MDL_WZ,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,7),W(1,8),W(1,9),GC_53,AMP(2))
      CALL FFV2_2(W(1,2),W(1,7),GC_100,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,4),W(1,5),W(1,9),-GC_50,GC_58,AMP(3))
      CALL FFV2_1(W(1,5),W(1,7),GC_100,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,2),W(1,4),W(1,9),GC_50,GC_58,AMP(4))
      CALL FFV2_2(W(1,1),W(1,8),GC_105,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV2_3_0(W(1,4),W(1,6),W(1,9),GC_50,GC_58,AMP(5))
      CALL FFV2_5_2(W(1,1),W(1,9),-GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,4),W(1,6),W(1,8),GC_105,AMP(6))
