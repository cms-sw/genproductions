            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 59 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX59(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_59(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_59/ZEROAMP_59
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,4),W(1,3),GC_62,MDL_MZ, FK_MDL_WZ,W(1,8))
      CALL FFV2_1(W(1,5),W(1,7),GC_105,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_5_0(W(1,6),W(1,9),W(1,8),-GC_50,GC_58,AMP(1))
      CALL FFV2_2(W(1,6),W(1,7),GC_105,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,9),W(1,5),W(1,8),GC_50,GC_58,AMP(2))
      CALL FFV2_3(W(1,6),W(1,5),GC_105,MDL_MW, FK_MDL_WW,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,9),W(1,7),W(1,8),GC_53,AMP(3))
      CALL FFV2_2(W(1,4),W(1,7),GC_108,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,10),W(1,3),W(1,9),GC_108,AMP(4))
      CALL FFV2_5_3(W(1,6),W(1,1),-GC_50,GC_58,MDL_MZ, ZERO,W(1,10))
      CALL FFV2_3_3(W(1,2),W(1,5),GC_50,GC_58,MDL_MZ, ZERO,W(1,7))
      CALL FFV2_1(W(1,3),W(1,10),GC_62,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,4),W(1,11),W(1,7),GC_62,AMP(5))
      CALL FFV2_2(W(1,4),W(1,10),GC_62,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,11),W(1,3),W(1,7),GC_62,AMP(6))
      CALL FFV1P0_3(W(1,6),W(1,1),GC_2,ZERO, FK_ZERO,W(1,11))
      CALL FFV1_2(W(1,2),W(1,11),GC_1,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 7
      CALL FFV2_3_0(W(1,3),W(1,5),W(1,8),GC_50,GC_58,AMP(7))
      CALL FFV1_1(W(1,5),W(1,11),GC_1,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,2),W(1,3),W(1,8),GC_50,GC_58,AMP(8))
      CALL FFV2_3_2(W(1,2),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 9
      CALL FFV2_3_0(W(1,3),W(1,5),W(1,8),GC_50,GC_58,AMP(9))
      CALL FFV2_3_1(W(1,5),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,2),W(1,3),W(1,8),GC_50,GC_58,AMP(10))
      CALL FFV1P0_3(W(1,2),W(1,5),GC_1,ZERO, FK_ZERO,W(1,3))
      CALL FFV1_1(W(1,1),W(1,3),GC_2,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,6),W(1,5),W(1,8),-GC_50,GC_58,AMP(11))
      CALL FFV2_5_1(W(1,1),W(1,8),-GC_50,GC_58,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,6),W(1,5),W(1,3),GC_2,AMP(12))
      CALL FFV2_5_1(W(1,1),W(1,7),-GC_50,GC_58,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,6),W(1,3),W(1,8),-GC_50,GC_58,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,6),W(1,5),W(1,7),-GC_50,GC_58,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,2),W(1,5),W(1,9),GC_105,AMP(15))
      CALL FFV2_1(W(1,1),W(1,9),GC_105,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,2),W(1,5),W(1,8),GC_50,GC_58,AMP(16))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = (-1.000000000000000D+00)*AMP(1)+(-1.000000000000000D
     $ +00)*AMP(2)+(-1.000000000000000D+00)*AMP(3)+(
     $ -1.000000000000000D+00)*AMP(4)+(-1.000000000000000D+00)*AMP(15)
     $ +(-1.000000000000000D+00)*AMP(16)
      JAMP(2,1) = AMP(5)+AMP(6)+AMP(7)+AMP(8)+AMP(9)+AMP(10)+AMP(11)
     $ +AMP(12)+AMP(13)+AMP(14)

      IF(INIT_MODE)THEN
        DO I=1, NGRAPHS
          IF (AMP(I).NE.0) THEN
            ZEROAMP_59(IHEL,I) = .FALSE.
          ENDIF
        ENDDO
      ENDIF
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX59 = MATRIX59 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      IF(SDE_STRAT.EQ.1)THEN
        ...
        AMP2(7)=AMP2(7)+(AMP(7)+AMP(9))*DCONJG(AMP(7)+AMP(9))
        AMP2(8)=AMP2(8)+(AMP(8)+AMP(10))*DCONJG(AMP(8)+AMP(10))
        AMP2(11)=AMP2(11)+(AMP(11)+AMP(13))*DCONJG(AMP(11)+AMP(13))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_59(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 59, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_59(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 59, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX59(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS59/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS59
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX59=SOINDEX_FOR_SQUARED_ORDERS59(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS59(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS59/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS59 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS59'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN59(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX59(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX59'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX59(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS59(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS59 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS59'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
