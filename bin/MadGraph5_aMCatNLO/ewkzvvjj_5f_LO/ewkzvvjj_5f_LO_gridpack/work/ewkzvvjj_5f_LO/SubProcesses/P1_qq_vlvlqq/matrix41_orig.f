...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3(W(1,1),W(1,5),GC_100,MDL_MW, ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_1(W(1,2),W(1,10),GC_100,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,6),W(1,11),W(1,8),-GC_50,GC_58,AMP(9))
      CALL FFV2_2(W(1,6),W(1,10),GC_100,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,11),W(1,2),W(1,8),GC_50,GC_58,AMP(10))
      CALL FFV2_2(W(1,1),W(1,9),GC_100,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,11),W(1,5),W(1,9),GC_100,AMP(12))
