            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 64 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX64(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_64(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_64/ZEROAMP_64
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_3(W(1,1),W(1,5),GC_105,MDL_MW, ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_1(W(1,2),W(1,10),GC_105,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,6),W(1,11),W(1,8),-GC_50,GC_58,AMP(9))
      CALL FFV2_2(W(1,6),W(1,10),GC_105,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,11),W(1,2),W(1,8),GC_50,GC_58,AMP(10))
      CALL FFV2_2(W(1,1),W(1,9),GC_105,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,11),W(1,5),W(1,9),GC_105,AMP(12))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +(-1.000000000000000D+00)*AMP(12)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX64 = MATRIX64 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_64(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 64, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_64(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 64, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX64(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS64/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS64
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX64=SOINDEX_FOR_SQUARED_ORDERS64(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS64(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS64/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS64 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS64'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN64(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX64(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX64'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX64(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS64(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS64 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS64'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
