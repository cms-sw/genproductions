...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,1),W(1,4),GC_2,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_5_0(W(1,5),W(1,6),W(1,10),-GC_50,GC_58,AMP(7))
      CALL FFV2_5_1(W(1,1),W(1,10),-GC_50,GC_58,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,5),W(1,6),W(1,4),GC_2,AMP(8))
      CALL FFV2_5_1(W(1,1),W(1,8),-GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFV2_5_0(W(1,5),W(1,4),W(1,10),-GC_50,GC_58,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV2_5_0(W(1,5),W(1,6),W(1,8),-GC_50,GC_58,AMP(10))
