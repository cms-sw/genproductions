#ifndef QUADNINJA_CUTS_UTILS_HH
#define QUADNINJA_CUTS_UTILS_HH
...
namespace quadninja {
  namespace cuts_utils {
    ...
    void complementaryPartition (const quadninja::PartitionInt p [],
    ...
    bool isSubPartition4of5(const quadninja::PartitionInt a[],
                            const quadninja::PartitionInt b[]);
    ...
    bool isSubPartition2of3(const quadninja::PartitionInt a[],
                            const quadninja::PartitionInt b[],
                            quadninja::PartitionInt c[]);

    // This function checks whether a Partition 'a' of dimension 1 is a
    // subset of another Partition 'b' of dimension 3 and in that case
    // returns b-a in c
    bool isSubPartition1of3(const quadninja::PartitionInt a[],
                            const quadninja::PartitionInt b[],
                            quadninja::PartitionInt c[]);
    ...
    // returns b-a in (the first entry of) c
    bool isSubPartition1of2(const quadninja::PartitionInt a[],
                            const quadninja::PartitionInt b[],
                            quadninja::PartitionInt c[]);
    ...
    class CutTadpole {
    public:
      CutTadpole(const quadninja::Basis & ein,
                 const MassType & mqin)
        : e(ein), mq(mqin) {}
...
#include <quadsources/cuts_utils-inl.hh>

#endif //  QUADNINJA_CUTS_UTILS_HH
