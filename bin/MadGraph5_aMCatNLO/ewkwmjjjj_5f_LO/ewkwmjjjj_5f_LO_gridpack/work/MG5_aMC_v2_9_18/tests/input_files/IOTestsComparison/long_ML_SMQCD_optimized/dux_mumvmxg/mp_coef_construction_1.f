...
C     Coefficient construction for loop diagram with ID 4
      ...
      CALL MP_FFV2L2_1(PL(0,3),W(1,7),GC_11,ZERO,ZERO,PL(0,4),COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      ...
      CALL MP_FFV2L1_2(PL(0,6),W(1,7),GC_11,ZERO,ZERO,PL(0,7),COEFS)
...
C     Coefficient construction for loop diagram with ID 6
     ...
     $ )
      CALL MP_FFV2L2_1(PL(0,11),W(1,7),GC_11,ZERO,ZERO,PL(0,12),COEFS)
...
C     Coefficient construction for loop diagram with ID 8
     ...
     $ )
      CALL MP_FFV2L2_1(PL(0,15),W(1,7),GC_11,ZERO,ZERO,PL(0,16),COEFS)
...
C     Coefficient construction for loop diagram with ID 9
      CALL MP_FFV2L2_1(PL(0,10),W(1,7),GC_11,ZERO,ZERO,PL(0,17),COEFS)
