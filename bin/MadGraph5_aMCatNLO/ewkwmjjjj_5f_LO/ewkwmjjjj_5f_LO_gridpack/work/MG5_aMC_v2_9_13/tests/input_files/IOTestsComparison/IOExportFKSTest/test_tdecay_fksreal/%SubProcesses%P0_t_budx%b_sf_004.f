...
C     
C     Process: t > b u d~ [ real = QCD ]
C     Process: t > b c s~ [ real = QCD ]
C     spectators: 1 4 
...
C     ----------
     ...
     $   //' called only with calculatedborn = true'
      ...
      REAL*8 FUNCTION B_SF_004(P,HELL)
C     
C     Generated by MadGraph5_aMC@NLO v. %(version)s, %(date)s
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
     ...
     $   //' only with calculatedborn = true'
      ...
      ELSEIF (CALCULATEDBORN) THEN
        ...
        ENDDO
      ENDIF
      JAMP1(1) = (-1.000000000000000D+00)*AMP(1)
      JAMP2(1) = (1.666666666666667D-01)*AMP(1)
      JAMP2(2) = (-5.000000000000000D-01)*AMP(1)
      B_SF_004 = 0.D0
      DO I = 1, NCOLOR1
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR2
        ...
        ENDDO
        B_SF_004 =B_SF_004+ZTEMP*DCONJG(JAMP1(I))
      ENDDO
      END
