...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_2(W(1,4),W(1,5),GC_11,MDL_MT,MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,8),W(1,3),W(1,6),GC_11,AMP(3))
      CALL FFV1_2(W(1,1),W(1,5),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,8),W(1,2),W(1,7),GC_11,AMP(4))
      CALL FFV1_1(W(1,2),W(1,5),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,1),W(1,8),W(1,7),GC_11,AMP(5))
      JAMP(1) = (1.666666666666667D-01)*AMP(2)+(1.666666666666667D-01)
     $ *AMP(3)
      JAMP(2) = ((0.000000000000000D+00,5.000000000000000D-01))*AMP(1)
     $ +(-5.000000000000000D-01)*AMP(2)+(-5.000000000000000D-01)*AMP(4)
      JAMP(3) = ((0.000000000000000D+00,-5.000000000000000D-01))*AMP(1)
     $ +(-5.000000000000000D-01)*AMP(3)+(-5.000000000000000D-01)*AMP(5)
      JAMP(4) = (1.666666666666667D-01)*AMP(4)+(1.666666666666667D-01)
     $ *AMP(5)
      MATRIX_1 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
