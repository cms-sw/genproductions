...
C     Amplitude(s) for diagram number 5
      ...
      JAMP(1) = (5.000000000000000D-01)*AMP(1)+(5.000000000000000D-01)
     $ *AMP(3)+((0.000000000000000D+00,5.000000000000000D-01))*AMP(5)
      JAMP(2) = (-1.666666666666667D-01)*AMP(1)+(-1.666666666666667D
     $ -01)*AMP(4)
      JAMP(3) = (-1.666666666666667D-01)*AMP(2)+(-1.666666666666667D
     $ -01)*AMP(3)
      JAMP(4) = (5.000000000000000D-01)*AMP(2)+(5.000000000000000D-01)
     $ *AMP(4)+((0.000000000000000D+00,-5.000000000000000D-01))*AMP(5)
      MATRIX_2 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
        DO J = 1, NCOLOR
