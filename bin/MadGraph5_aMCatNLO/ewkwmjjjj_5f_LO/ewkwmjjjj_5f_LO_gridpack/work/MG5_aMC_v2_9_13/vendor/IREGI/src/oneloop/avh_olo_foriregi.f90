...
module avh_olo_forIREGI_dp_kinds
  integer ,parameter :: kindr2=selected_real_kind(15) 
end module


module avh_olo_forIREGI_dp_arrays
  use avh_olo_forIREGI_units
  use avh_olo_forIREGI_dp_kinds 
  implicit none
  private
...
module avh_olo_forIREGI_dp_prec
  use avh_olo_forIREGI_dp_kinds
...
module avh_olo_forIREGI_dp_print
  use avh_olo_forIREGI_dp_prec
  implicit none
  private
  public :: myprint
...
module avh_olo_forIREGI_dp_auxfun
  use avh_olo_forIREGI_units
  use avh_olo_forIREGI_dp_prec
...
module avh_olo_forIREGI_dp_olog
!***********************************************************************
...
!***********************************************************************
  use avh_olo_forIREGI_units
  use avh_olo_forIREGI_dp_prec
  use avh_olo_forIREGI_dp_print
  use avh_olo_forIREGI_dp_auxfun
  implicit none
  private
...
!***********************************************************************
!***********************************************************************
  use avh_olo_forIREGI_dp_arrays
  real(kindr2) &  
    :: tt
  integer :: nn,mm,ii,jj
...
module avh_olo_forIREGI_dp_dilog
!***********************************************************************
!                     /1    ln(1-zz*t)
!   dilog(xx,iph) = - |  dt ---------- 
!                     /0        t
...
module avh_olo_forIREGI_dp_bnlog
!***********************************************************************
!                      /1    
...
module avh_olo_forIREGI_dp_qmplx
  use avh_olo_forIREGI_units
  use avh_olo_forIREGI_dp_prec
  use avh_olo_forIREGI_dp_auxfun
  use avh_olo_forIREGI_dp_olog
  use avh_olo_forIREGI_dp_dilog
...
module avh_olo_forIREGI_dp_bub
  use avh_olo_forIREGI_units
  use avh_olo_forIREGI_dp_prec
  use avh_olo_forIREGI_dp_auxfun
  use avh_olo_forIREGI_dp_bnlog
  use avh_olo_forIREGI_dp_qmplx
  implicit none
  private
...
module avh_olo_forIREGI_dp_tri
  use avh_olo_forIREGI_units
  use avh_olo_forIREGI_dp_prec
  use avh_olo_forIREGI_dp_auxfun
  use avh_olo_forIREGI_dp_qmplx
...
module avh_olo_forIREGI_dp_box
  use avh_olo_forIREGI_units
  use avh_olo_forIREGI_dp_prec
  use avh_olo_forIREGI_dp_auxfun
  use avh_olo_forIREGI_dp_qmplx
...
module avh_olo_forIREGI_dp_boxc
   use avh_olo_forIREGI_units
   use avh_olo_forIREGI_dp_prec
   use avh_olo_forIREGI_dp_auxfun
   use avh_olo_forIREGI_dp_qmplx
...
!*******************************************************************
   use avh_olo_forIREGI_dp_box ,only: base,casetable,ll=>permtable
  complex(kindr2) &   
     ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
!*******************************************************************
!*******************************************************************
  use avh_olo_forIREGI_dp_olog  ,only: update_olog
  use avh_olo_forIREGI_dp_dilog ,only: update_dilog
  use avh_olo_forIREGI_dp_bnlog ,only: update_bnlog
...
!*******************************************************************
!*******************************************************************
  use avh_olo_forIREGI_dp_prec ,only: ndecim,prcpar
  integer :: rslt
  if (initz) call init
  rslt = ndecim(prcpar)
  end function
...
!
  use avh_olo_forIREGI_dp_bub ,only: tadp
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
!
  use avh_olo_forIREGI_dp_bub ,only: tadpn
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:,0:)   
  complex(kindr2) &   
...
!
  use avh_olo_forIREGI_dp_bub ,only: bub0
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
!
  use avh_olo_forIREGI_dp_bub ,only: bub11
!
  complex(kindr2) &   
    ,intent(out) :: b11(0:2),b00(0:2),b1(0:2),b0(0:2)
  complex(kindr2) &   
...
!
  use avh_olo_forIREGI_dp_bub ,only: bub0,bub1,bub11,bub111,bub1111
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:,0:)   
  complex(kindr2) &   
...
!*******************************************************************
  ...
  use avh_olo_forIREGI_dp_tri
  use avh_olo_forIREGI_dp_auxfun ,only: kallen
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
!*******************************************************************
  ...
  use avh_olo_forIREGI_dp_box
  use avh_olo_forIREGI_dp_boxc
!
  complex(kindr2) &   
    ,intent(out) :: rslt(0:2)
  complex(kindr2) &   
...
contains
  ...
  use avh_olo_forIREGI_dp ,only: dp_sub=>olo_precision 
  integer ,intent(in) :: ndec
  call dp_sub( ndec ) 
  end subroutine

  subroutine olo_scale( val )
  use avh_olo_forIREGI_dp ,only: dp_sub=>olo_scale 
  real(kind(1d0)) ,intent(in) :: val
  call dp_sub( val ) 
  end subroutine

  subroutine olo_onshell( val )
  use avh_olo_forIREGI_dp ,only: dp_sub=>olo_onshell 
  real(kind(1d0)) ,intent(in) :: val
  call dp_sub( val ) 
  end subroutine
