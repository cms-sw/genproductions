...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,4),W(1,2),GC_2,ZERO, FK_ZERO,W(1,6))
      CALL FFV2_2(W(1,3),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,1),W(1,6),GC_2,AMP(1))
      CALL FFV2_5_3(W(1,4),W(1,2),-GC_50,GC_58,MDL_MZ, ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,7),W(1,1),W(1,8),-GC_50,GC_58,AMP(2))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,4),W(1,9),W(1,7),GC_100,AMP(7))
