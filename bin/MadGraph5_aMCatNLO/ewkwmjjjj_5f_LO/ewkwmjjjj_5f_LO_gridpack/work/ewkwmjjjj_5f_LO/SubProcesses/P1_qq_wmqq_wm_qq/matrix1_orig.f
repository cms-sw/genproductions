...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_2(W(1,2),W(1,5),GC_100,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,3),W(1,6),GC_2,AMP(1))
      CALL FFV2_5_3(W(1,1),W(1,4),-GC_50,GC_58,MDL_MZ, ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,7),W(1,3),W(1,8),-GC_50,GC_58,AMP(2))
      CALL FFV2_3(W(1,2),W(1,3),GC_100,MDL_MW, ZERO,W(1,9))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,6),W(1,5),W(1,9),-GC_3,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,5),W(1,9),W(1,8),GC_53,AMP(4))
      CALL FFV2_1(W(1,3),W(1,5),GC_100,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,10),W(1,6),GC_1,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,2),W(1,10),W(1,8),GC_50,GC_58,AMP(6))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_2,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,7),W(1,4),W(1,8),GC_2,AMP(7))
      CALL FFV2_5_3(W(1,1),W(1,3),-GC_50,GC_58,MDL_MZ, ZERO,W(1,6))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,7),W(1,4),W(1,6),-GC_50,GC_58,AMP(8))
      CALL FFV2_3(W(1,2),W(1,4),GC_100,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 9
      CALL VVV1_0(W(1,8),W(1,5),W(1,7),-GC_3,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL VVV1_0(W(1,5),W(1,7),W(1,6),GC_53,AMP(10))
      CALL FFV2_1(W(1,4),W(1,5),GC_100,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,2),W(1,3),W(1,8),GC_1,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,2),W(1,3),W(1,6),GC_50,GC_58,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,1),W(1,10),W(1,7),GC_100,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,1),W(1,3),W(1,9),GC_100,AMP(14))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(1)+AMP(2)+AMP(3)+AMP(4)+AMP(5)+AMP(6)+AMP(14)
