...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,3),W(1,1),GC_100,MDL_MW, ZERO,W(1,6))
      CALL FFV1P0_3(W(1,2),W(1,4),GC_1,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,7),W(1,5),W(1,6),-GC_3,AMP(1))
      CALL FFV2_3_3(W(1,2),W(1,4),GC_50,GC_58,MDL_MZ, ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,5),W(1,6),W(1,8),GC_53,AMP(2))
      CALL FFV2_2(W(1,3),W(1,5),GC_100,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,1),W(1,7),GC_2,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,6),W(1,1),W(1,8),-GC_50,GC_58,AMP(4))
      CALL FFV2_1(W(1,1),W(1,5),GC_100,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,3),W(1,6),W(1,7),GC_1,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,3),W(1,6),W(1,8),GC_50,GC_58,AMP(6))
