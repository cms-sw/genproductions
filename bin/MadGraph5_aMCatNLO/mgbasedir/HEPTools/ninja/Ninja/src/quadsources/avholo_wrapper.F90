...
# define AVH_ONSHELL_KIND(x) x
      ...
      subroutine quadninjavholo_onshell(thrs)  bind (c)
      ...
      subroutine quadninjavholo_d0_cm(rslt,p1,p2,p3,p4,p12,p23,m1,m2,m3,m4,rmu) &
           & bind (c)
      use, intrinsic :: iso_c_binding
      use avh_olo
      implicit none
      ...
      subroutine quadninjavholo_d0_rm(rslt,p1,p2,p3,p4,p12,p23,m1,m2,m3,m4,rmu) &
           & bind (c)
      use, intrinsic :: iso_c_binding
      use avh_olo
      implicit none
      ...
      subroutine quadninjavholo_c0_cm(rslt,p1,p2,p3,m1,m2,m3,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use avh_olo
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
      ...
      subroutine quadninjavholo_c0_rm(rslt,p1,p2,p3,m1,m2,m3,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use avh_olo
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
      ...
      subroutine quadninjavholo_b0_cm(rslt,pp,m1,m2,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use avh_olo
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
      ...
      subroutine quadninjavholo_b0_rm(rslt,pp,m1,m2,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use avh_olo
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
      ...
      subroutine quadninjavholo_b11_cm(b11,b00,b1,b0,pp,m1,m2,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use avh_olo
      implicit none
      ...
      subroutine quadninjavholo_b11_rm(b11,b00,b1,b0,pp,m1,m2,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use avh_olo
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: b11,b00,b1,b0
      ...
      subroutine quadninjavholo_a0_cm(rslt,mm,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use avh_olo
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
      ...
      subroutine quadninjavholo_a0_rm(rslt,mm,rmu) bind (c)
      use, intrinsic :: iso_c_binding
      use avh_olo
      implicit none
      complex(KI_NIN), dimension(0:2), intent(out) :: rslt
