...
// preprocessor macro QUADNINJA_IMPLEMENTING_X1RANK is defined only in the
...
const int max_hr = 0
#ifdef QUADNINJA_IMPLEMENTING_X1RANK
    +1
#endif
    ;
                                      ...
                                      Box & d)
{
  ...
  // Invariants
  Real invariants[] = {quadninja::real(m2[cut1]),
                       quadninja::real(m2[cut2]),
                       quadninja::real(m2[cut3]),
                       quadninja::real(m2[cut4]),
                       abs(s_mat(cut2,cut1)),
                       abs(s_mat(cut3,cut2)),
                       abs(s_mat(cut4,cut3)),
                       abs(s_mat(cut1,cut4)),
...
#ifndef QUADNINJA_IMPLEMENTING_X1RANK
...
#endif // QUADNINJA_IMPLEMENTING_X1RANK
...
#else // ! QUADNINJA_IMPLEMENTING_X1RANK
