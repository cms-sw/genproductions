...
set key font ",9"
set key samplen "2"
set output "CKKWL_djrs_output.ps"
...
set xrange [0.0000e+00:2.5800e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
0.0 ls 999 title '',\
'CKKWL_djrs_output.HwU' index 0 using (($1+$2)/2):(0.0):(safe($4,$3,0.0)) w yerrorbar ls 1 title ''
...
set xrange [0.0000e+00:2.4900e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
0.0 ls 999 title '',\
'CKKWL_djrs_output.HwU' index 4 using (($1+$2)/2):(0.0):(safe($4,$3,0.0)) w yerrorbar ls 1 title ''
...
set xrange [0.0000e+00:2.0700e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
0.0 ls 999 title '',\
'CKKWL_djrs_output.HwU' index 8 using (($1+$2)/2):(0.0):(safe($4,$3,0.0)) w yerrorbar ls 1 title ''
...
set xrange [0.0000e+00:1.8900e+00]
set bmargin 0 
set tmargin 0
set xtics nomirror
set ytics nomirror
...
0.0 ls 999 title '',\
'CKKWL_djrs_output.HwU' index 12 using (($1+$2)/2):(0.0):(safe($4,$3,0.0)) w yerrorbar ls 1 title ''

unset label

################################################################################
unset multiplot
!ps2pdf "CKKWL_djrs_output.ps" &> /dev/null