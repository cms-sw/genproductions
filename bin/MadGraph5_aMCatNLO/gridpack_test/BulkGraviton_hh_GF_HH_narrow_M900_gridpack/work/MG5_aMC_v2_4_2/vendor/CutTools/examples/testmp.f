!---------------------------------------------------------------------
! PROGRAM FOR TESTING THE IMPLEMENTATION OF THE MP ROUTINES
!---------------------------------------------------------------------
      program testmp
      implicit none
!                     !----------------------------------!
...
!                       !
      if (number_propagators.gt.maxden) then
         stop 'increase maxden in testmp.f'
      endif
!
