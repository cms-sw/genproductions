...
module collier_global
  ...
  character(len=5) :: version_cll="1.2.7"
!  character(len=5) :: version_cll=" 1.2 "
  ...
  integer :: ErrFlag_cll,ErrCnt_cll,InfCnt_cll,MaxInfOut_cll,AccFlag_cll,CritPointsCntCOLI_cll
  integer :: ErrCntCOLI_cll,ErrCntDD_cll,MaxErrOut_cll,MaxErrOutCOLI_cll,MaxErrOutDD_cll
  integer :: rmaxB_cll,rmaxC_cll,rmaxD_cll,ritmax_cll
  integer :: EventCnt_cll,infoutlev_cll,erroutlev_cll
...
!  integer :: PointsCntTN_cll(10),CritPointsCntTN_cll(10),AccPointsCntTN_cll(10)
  ...
  integer :: PointsCntAten_coli,PointsCntBten_coli,PointsCntDBten_coli,PointsCntCten_coli,  &
      PointsCntDten_coli,PointsCntEten_coli,PointsCntFten_coli,PointsCntGten_coli
  integer, allocatable :: PointsCntTNten_coli(:)
  integer :: PointsCntA_dd,PointsCntB_dd,PointsCntDB_dd,PointsCntC_dd,  &
      PointsCntD_dd,PointsCntE_dd,PointsCntF_dd,PointsCntG_dd
  integer, allocatable :: PointsCntTN_dd(:)
  integer :: PointsCntAten_dd,PointsCntBten_dd,PointsCntDBten_dd,PointsCntCten_dd,  &
      PointsCntDten_dd,PointsCntEten_dd,PointsCntFten_dd,PointsCntGten_dd
  integer, allocatable :: PointsCntTNten_dd(:)

  integer, allocatable :: MaxCheck_cll(:),CheckCnt_cll(:),DiffCnt_cll(:)
  integer, allocatable :: CheckCntten_cll(:),DiffCntten_cll(:)
  integer :: MaxCheckDB_cll,CheckCntDB_cll,DiffCntDB_cll
  integer :: MaxCheckEc_cll,DiffCntEc_cll

  integer :: AccCnt(-2:1), ErrCnt(-10:1), ErrCntcoli(-10:0), ErrCntdd(-10:0)
  integer :: AccEventCnt(-2:1), ErrEventCnt(-10:1)
