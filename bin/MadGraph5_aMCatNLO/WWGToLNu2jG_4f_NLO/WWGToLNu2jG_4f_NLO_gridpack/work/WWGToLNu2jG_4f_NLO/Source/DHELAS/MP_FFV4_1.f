...
C     
      SUBROUTINE MP_FFV4_1(F2, V3, COUP, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*32 CI
     ...
     $ *2Q0*(-V3(5)+V3(8))+2Q0*(F2(6)*(V3(6)+CI*(V3(7)))))))
