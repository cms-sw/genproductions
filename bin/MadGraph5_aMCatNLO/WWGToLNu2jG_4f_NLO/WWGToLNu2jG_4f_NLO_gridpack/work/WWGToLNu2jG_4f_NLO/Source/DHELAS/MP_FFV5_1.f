...
C     
      SUBROUTINE MP_FFV5_1(F2, V3, COUP, M1, W1,F1)
      IMPLICIT NONE
      COMPLEX*32 CI
     ...
     $ * W1))
      F1(5)= DENOM*4Q0 * CI*(F2(5)*(P1(0)*(-V3(5)+V3(8))+(P1(1)*(V3(6)
     $ -CI*(V3(7)))+(P1(2)*(+CI*(V3(6))+V3(7))+P1(3)*(-V3(5)+V3(8)))))
     $ +(F2(6)*(P1(0)*(V3(6)+CI*(V3(7)))+(P1(1)*(-1Q0)*(V3(5)+V3(8))
     $ +(P1(2)*(-1Q0)*(+CI*(V3(5)+V3(8)))+P1(3)*(V3(6)+CI*(V3(7))))))
     $ +M1*(F2(7)*1Q0/4Q0*(V3(5)+V3(8))+1Q0/4Q0*(F2(8)*(V3(6)+CI*(V3(7)
     $ ))))))
      F1(6)= DENOM*4Q0 * CI*(F2(5)*(P1(0)*(V3(6)-CI*(V3(7)))+(P1(1)*(
     $ -V3(5)+V3(8))+(P1(2)*(+CI*(V3(5))-CI*(V3(8)))+P1(3)*(-V3(6)+CI
     $ *(V3(7))))))+(F2(6)*(P1(0)*(-1Q0)*(V3(5)+V3(8))+(P1(1)*(V3(6)
     $ +CI*(V3(7)))+(P1(2)*(-CI*(V3(6))+V3(7))+P1(3)*(V3(5)+V3(8)))))
     $ +M1*(F2(7)*1Q0/4Q0*(V3(6)-CI*(V3(7)))+1Q0/4Q0*(F2(8)*(V3(5)
     $ -V3(8))))))
     ...
     $ *4Q0*(-V3(5)+V3(8))+4Q0*(F2(6)*(V3(6)+CI*(V3(7)))))))
