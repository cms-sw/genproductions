...
C     
C     Process: u~ g > e+ ve w- a u~ WEIGHTED<=9 [ all = QCD ]
C     Process: u~ g > mu+ vm w- a u~ WEIGHTED<=9 [ all = QCD ]
C     Process: c~ g > e+ ve w- a c~ WEIGHTED<=9 [ all = QCD ]
C     Process: c~ g > mu+ vm w- a c~ WEIGHTED<=9 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 32
      ...
      CALL FFV2_1(W(1,1),W(1,5),GC_11,ZERO,ZERO,W(1,17))
      CALL FFV1_2(W(1,7),W(1,2),GC_5,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 36
      ...
      CALL FFV1_1(W(1,17),W(1,2),GC_5,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 37
      CALL FFV2_0(W(1,7),W(1,28),W(1,11),GC_11,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,12),W(1,28),W(1,6),GC_1,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,12),W(1,30),W(1,2),GC_5,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV2_0(W(1,19),W(1,28),W(1,9),GC_11,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,19),W(1,29),W(1,2),GC_5,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV2_0(W(1,7),W(1,28),W(1,24),GC_11,AMP(42))
      CALL FFV1_1(W(1,1),W(1,6),GC_2,ZERO,ZERO,W(1,28))
      CALL FFV1P0_3(W(1,16),W(1,28),GC_2,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 43
      CALL VVV1_0(W(1,29),W(1,5),W(1,9),GC_25,AMP(43))
      CALL FFV2_5_3(W(1,16),W(1,28),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,30))
C     Amplitude(s) for diagram number 44
      CALL VVV1_0(W(1,5),W(1,9),W(1,30),GC_7,AMP(44))
      CALL FFV2_1(W(1,28),W(1,5),GC_11,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 45
      CALL FFV2_0(W(1,16),W(1,17),W(1,9),GC_11,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV2_0(W(1,8),W(1,4),W(1,30),GC_28,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,3),W(1,25),W(1,29),-GC_25,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV2_4_0(W(1,3),W(1,25),W(1,30),GC_21,GC_24,AMP(48))
      CALL FFV1_1(W(1,28),W(1,2),GC_5,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,7),W(1,30),W(1,14),GC_2,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV2_5_0(W(1,7),W(1,30),W(1,15),-GC_21,GC_23,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV2_0(W(1,12),W(1,30),W(1,5),GC_11,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV1_0(W(1,12),W(1,17),W(1,2),GC_5,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV2_5_0(W(1,7),W(1,30),W(1,22),-GC_21,GC_23,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,7),W(1,30),W(1,26),GC_2,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_5_0(W(1,7),W(1,30),W(1,27),-GC_21,GC_23,AMP(55))
      CALL FFV1P0_3(W(1,16),W(1,1),GC_2,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 56
      CALL VVV1_0(W(1,30),W(1,5),W(1,11),GC_25,AMP(56))
      CALL FFV2_5_3(W(1,16),W(1,1),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,7))
C     Amplitude(s) for diagram number 57
      CALL VVV1_0(W(1,5),W(1,11),W(1,7),GC_7,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL VVVV2_0(W(1,6),W(1,30),W(1,5),W(1,9),GC_27,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL VVVV5_0(W(1,6),W(1,5),W(1,9),W(1,7),GC_26,AMP(59))
      CALL FFV1_2(W(1,16),W(1,6),GC_2,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,11),W(1,1),W(1,14),GC_2,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV2_5_0(W(1,11),W(1,1),W(1,15),-GC_21,GC_23,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL VVV1_0(W(1,30),W(1,18),W(1,9),GC_25,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL VVV1_0(W(1,18),W(1,9),W(1,7),GC_7,AMP(63))
      CALL FFV2_1(W(1,1),W(1,18),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 64
      CALL FFV2_0(W(1,16),W(1,6),W(1,9),GC_11,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL FFV2_5_0(W(1,11),W(1,1),W(1,22),-GC_21,GC_23,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL VVV1_0(W(1,30),W(1,5),W(1,24),GC_25,AMP(66))
C     Amplitude(s) for diagram number 67
      CALL VVV1_0(W(1,5),W(1,24),W(1,7),GC_7,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFV2_0(W(1,10),W(1,4),W(1,7),GC_28,AMP(68))
C     Amplitude(s) for diagram number 69
      CALL FFV1_0(W(1,23),W(1,25),W(1,30),-GC_25,AMP(69))
C     Amplitude(s) for diagram number 70
      CALL FFV2_4_0(W(1,23),W(1,25),W(1,7),GC_21,GC_24,AMP(70))
C     Amplitude(s) for diagram number 71
      CALL FFV1_0(W(1,3),W(1,13),W(1,30),-GC_25,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFV2_4_0(W(1,3),W(1,13),W(1,7),GC_21,GC_24,AMP(72))
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,11),W(1,1),W(1,26),GC_2,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV2_5_0(W(1,11),W(1,1),W(1,27),-GC_21,GC_23,AMP(74))
C     Amplitude(s) for diagram number 75
      CALL FFV2_0(W(1,21),W(1,4),W(1,7),GC_28,AMP(75))
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,3),W(1,20),W(1,30),-GC_25,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV2_4_0(W(1,3),W(1,20),W(1,7),GC_21,GC_24,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFV1_0(W(1,12),W(1,6),W(1,2),GC_5,AMP(78))
      CALL FFV1_2(W(1,19),W(1,2),GC_5,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 79
      CALL FFV1_0(W(1,6),W(1,1),W(1,14),GC_2,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV2_5_0(W(1,6),W(1,1),W(1,15),-GC_21,GC_23,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV2_5_0(W(1,6),W(1,1),W(1,22),-GC_21,GC_23,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,6),W(1,1),W(1,26),GC_2,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV2_5_0(W(1,6),W(1,1),W(1,27),-GC_21,GC_23,AMP(83))
