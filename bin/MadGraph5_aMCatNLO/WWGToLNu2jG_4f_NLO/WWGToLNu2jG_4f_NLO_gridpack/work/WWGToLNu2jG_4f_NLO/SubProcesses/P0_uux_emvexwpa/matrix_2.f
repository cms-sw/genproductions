...
C     ----------
      ...
      CALL FFV1_1(W(1,8),W(1,6),GC_2,ZERO,ZERO,W(1,10))
      CALL VVV1P0_1(W(1,9),W(1,5),GC_25,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,10),W(1,11),GC_2,AMP(1))
      CALL VVV1_3(W(1,9),W(1,5),GC_7,MDL_MZ,MDL_WZ,W(1,12))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,7),W(1,10),W(1,12),-GC_21,GC_23,AMP(2))
      CALL FFV1P0_3(W(1,7),W(1,8),GC_2,ZERO,ZERO,W(1,13))
      CALL VVV1_3(W(1,6),W(1,9),GC_25,MDL_MW,MDL_WW,W(1,14))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,13),W(1,14),W(1,5),GC_25,AMP(3))
      CALL FFV2_5_3(W(1,7),W(1,8),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,15))
...
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,18),W(1,17),W(1,6),GC_1,AMP(10))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_2(W(1,7),W(1,6),GC_2,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,20),W(1,17),W(1,5),GC_11,AMP(13))
      CALL FFV1P0_3(W(1,20),W(1,8),GC_2,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 14
      CALL VVV1_0(W(1,17),W(1,9),W(1,5),GC_25,AMP(14))
      CALL FFV2_5_3(W(1,20),W(1,8),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,21))
...
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,7),W(1,10),W(1,22),-GC_21,GC_23,AMP(16))
...
C     Amplitude(s) for diagram number 20
      ...
      CALL FFV2_2(W(1,4),W(1,5),GC_11,ZERO,ZERO,W(1,26))
...
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,7),W(1,10),W(1,19),GC_2,AMP(24))
      CALL FFV2_4_3(W(1,26),W(1,3),GC_21,GC_24,MDL_MZ,MDL_WZ,W(1,27))
C     Amplitude(s) for diagram number 25
      CALL FFV2_5_0(W(1,7),W(1,10),W(1,27),-GC_21,GC_23,AMP(25))
      CALL FFV1_2(W(1,26),W(1,6),-GC_25,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 30
      ...
      CALL FFV2_2(W(1,4),W(1,16),GC_11,ZERO,ZERO,W(1,17))
...
C     Amplitude(s) for diagram number 32
      ...
      CALL FFV1_1(W(1,2),W(1,6),GC_2,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 38
      ...
      CALL FFV1P0_3(W(1,15),W(1,2),GC_2,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 39
      CALL VVV1_0(W(1,29),W(1,14),W(1,5),GC_25,AMP(39))
      CALL FFV2_5_3(W(1,15),W(1,2),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,28))
C     Amplitude(s) for diagram number 40
      CALL VVV1_0(W(1,14),W(1,5),W(1,28),GC_7,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL VVVV2_0(W(1,6),W(1,29),W(1,9),W(1,5),GC_27,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL VVVV5_0(W(1,6),W(1,9),W(1,5),W(1,28),GC_26,AMP(42))
      CALL FFV2_1(W(1,2),W(1,9),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 43
      CALL FFV1_0(W(1,30),W(1,8),W(1,6),GC_1,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV2_0(W(1,30),W(1,2),W(1,14),GC_11,AMP(44))
      CALL FFV1_2(W(1,15),W(1,6),GC_2,ZERO,ZERO,W(1,31))
C     Amplitude(s) for diagram number 45
      CALL FFV2_0(W(1,31),W(1,8),W(1,5),GC_11,AMP(45))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,31),W(1,2),W(1,11),GC_2,AMP(46))
C     Amplitude(s) for diagram number 47
      CALL FFV2_5_0(W(1,31),W(1,2),W(1,12),-GC_21,GC_23,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL VVV1_0(W(1,29),W(1,9),W(1,16),GC_25,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL VVV1_0(W(1,9),W(1,16),W(1,28),GC_7,AMP(49))
...
C     Amplitude(s) for diagram number 51
      CALL FFV2_5_0(W(1,31),W(1,2),W(1,22),-GC_21,GC_23,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL VVV1_0(W(1,29),W(1,24),W(1,5),GC_25,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL VVV1_0(W(1,24),W(1,5),W(1,28),GC_7,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV2_0(W(1,4),W(1,25),W(1,28),GC_28,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_0(W(1,30),W(1,2),W(1,24),GC_11,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV1_0(W(1,26),W(1,23),W(1,29),-GC_25,AMP(56))
C     Amplitude(s) for diagram number 57
      CALL FFV2_4_0(W(1,26),W(1,23),W(1,28),GC_21,GC_24,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,10),W(1,3),W(1,29),-GC_25,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV2_4_0(W(1,10),W(1,3),W(1,28),GC_21,GC_24,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,31),W(1,2),W(1,19),GC_2,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV2_5_0(W(1,31),W(1,2),W(1,27),-GC_21,GC_23,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV2_0(W(1,4),W(1,21),W(1,28),GC_28,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFV1_0(W(1,17),W(1,3),W(1,29),-GC_25,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV2_4_0(W(1,17),W(1,3),W(1,28),GC_21,GC_24,AMP(64))
      CALL FFV1_1(W(1,13),W(1,1),GC_5,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,7),W(1,28),W(1,11),GC_2,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL FFV2_5_0(W(1,7),W(1,28),W(1,12),-GC_21,GC_23,AMP(66))
...
C     Amplitude(s) for diagram number 69
      CALL FFV2_5_0(W(1,7),W(1,28),W(1,22),-GC_21,GC_23,AMP(69))
C     Amplitude(s) for diagram number 70
      CALL FFV1_0(W(1,7),W(1,28),W(1,19),GC_2,AMP(70))
C     Amplitude(s) for diagram number 71
      CALL FFV2_5_0(W(1,7),W(1,28),W(1,27),-GC_21,GC_23,AMP(71))
...
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,17),W(1,8),W(1,6),GC_1,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV2_0(W(1,17),W(1,2),W(1,14),GC_11,AMP(74))
      CALL FFV1_2(W(1,18),W(1,6),GC_1,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,14),W(1,2),W(1,11),GC_2,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFV2_5_0(W(1,14),W(1,2),W(1,12),-GC_21,GC_23,AMP(78))
