...
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,28),W(1,12),W(1,6),GC_1,AMP(38))
...
C     Amplitude(s) for diagram number 42
      ...
      CALL FFV1_2(W(1,1),W(1,6),GC_2,ZERO,ZERO,W(1,28))
      CALL FFV1P0_3(W(1,28),W(1,16),GC_2,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 43
      CALL VVV1_0(W(1,29),W(1,9),W(1,5),GC_25,AMP(43))
      CALL FFV2_5_3(W(1,28),W(1,16),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,30))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,30),W(1,7),W(1,14),GC_2,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV2_5_0(W(1,30),W(1,7),W(1,15),-GC_21,GC_23,AMP(50))
...
C     Amplitude(s) for diagram number 53
      CALL FFV2_5_0(W(1,30),W(1,7),W(1,22),-GC_21,GC_23,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,30),W(1,7),W(1,26),GC_2,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_5_0(W(1,30),W(1,7),W(1,27),-GC_21,GC_23,AMP(55))
      CALL FFV1P0_3(W(1,1),W(1,16),GC_2,ZERO,ZERO,W(1,30))
C     Amplitude(s) for diagram number 56
      CALL VVV1_0(W(1,30),W(1,11),W(1,5),GC_25,AMP(56))
      CALL FFV2_5_3(W(1,1),W(1,16),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,7))
...
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,1),W(1,11),W(1,14),GC_2,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV2_5_0(W(1,1),W(1,11),W(1,15),-GC_21,GC_23,AMP(61))
...
C     Amplitude(s) for diagram number 65
      CALL FFV2_5_0(W(1,1),W(1,11),W(1,22),-GC_21,GC_23,AMP(65))
...
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,1),W(1,11),W(1,26),GC_2,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV2_5_0(W(1,1),W(1,11),W(1,27),-GC_21,GC_23,AMP(74))
...
C     Amplitude(s) for diagram number 79
      CALL FFV1_0(W(1,1),W(1,6),W(1,14),GC_2,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV2_5_0(W(1,1),W(1,6),W(1,15),-GC_21,GC_23,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV2_5_0(W(1,1),W(1,6),W(1,22),-GC_21,GC_23,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,1),W(1,6),W(1,26),GC_2,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV2_5_0(W(1,1),W(1,6),W(1,27),-GC_21,GC_23,AMP(83))
