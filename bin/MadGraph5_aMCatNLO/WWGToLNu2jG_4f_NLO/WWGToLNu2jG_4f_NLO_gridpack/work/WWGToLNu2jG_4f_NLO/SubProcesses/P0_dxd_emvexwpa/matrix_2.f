...
C     Amplitude(s) for diagram number 32
      ...
      CALL FFV1_2(W(1,2),W(1,6),GC_1,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 38
      ...
      CALL FFV1P0_3(W(1,2),W(1,15),GC_1,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 39
      CALL VVV1_0(W(1,29),W(1,14),W(1,5),GC_25,AMP(39))
      CALL FFV2_3_3(W(1,2),W(1,15),GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,28))
...
C     Amplitude(s) for diagram number 51
      CALL FFV2_3_0(W(1,2),W(1,31),W(1,22),GC_21,GC_23,AMP(51))
...
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,2),W(1,31),W(1,19),GC_1,AMP(60))
C     Amplitude(s) for diagram number 61
      CALL FFV2_3_0(W(1,2),W(1,31),W(1,27),GC_21,GC_23,AMP(61))
...
C     Amplitude(s) for diagram number 65
      CALL FFV1_0(W(1,28),W(1,7),W(1,11),GC_1,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL FFV2_3_0(W(1,28),W(1,7),W(1,12),GC_21,GC_23,AMP(66))
...
C     Amplitude(s) for diagram number 69
      CALL FFV2_3_0(W(1,28),W(1,7),W(1,22),GC_21,GC_23,AMP(69))
C     Amplitude(s) for diagram number 70
      CALL FFV1_0(W(1,28),W(1,7),W(1,19),GC_1,AMP(70))
C     Amplitude(s) for diagram number 71
      CALL FFV2_3_0(W(1,28),W(1,7),W(1,27),GC_21,GC_23,AMP(71))
...
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,8),W(1,17),W(1,6),GC_2,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV2_0(W(1,2),W(1,17),W(1,14),GC_11,AMP(74))
      CALL FFV1_1(W(1,18),W(1,6),GC_2,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 77
      CALL FFV1_0(W(1,2),W(1,14),W(1,11),GC_1,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFV2_3_0(W(1,2),W(1,14),W(1,12),GC_21,GC_23,AMP(78))
