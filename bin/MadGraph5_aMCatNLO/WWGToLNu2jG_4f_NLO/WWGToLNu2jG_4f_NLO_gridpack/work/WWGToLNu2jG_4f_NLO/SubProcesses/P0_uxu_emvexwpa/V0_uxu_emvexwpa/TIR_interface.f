...
C     
C     Process: u~ u > e- ve~ w+ a QED<=4 WEIGHTED<=8 [ all = QCD ]
C     Process: u~ u > mu- vm~ w+ a QED<=4 WEIGHTED<=8 [ all = QCD ]
C     Process: c~ c > e- ve~ w+ a QED<=4 WEIGHTED<=8 [ all = QCD ]
C     Process: c~ c > mu- vm~ w+ a QED<=4 WEIGHTED<=8 [ all = QCD ]
C     
C     
C     CONSTANTS 
C     
...
C      so that CutTools limitations can be correctly implemented
     ...
     $ ,.FALSE.,.FALSE.,.FALSE.,.FALSE.,.FALSE.,.FALSE.,.FALSE./
      DATA (HAS_AN_HEFT_VERTEX(I),I=    28,    29) /.FALSE.,.FALSE./
C     
C     GLOBAL VARIABLES
C     
      INCLUDE 'MadLoopParams.inc'
