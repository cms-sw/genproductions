...
C     
C     Process: u u~ > ta+ vt w- a g WEIGHTED<=9 [ all = QCD ]
C     Process: c c~ > ta+ vt w- a g WEIGHTED<=9 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV2_1(W(1,4),W(1,5),GC_11,MDL_MTA,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 16
      ...
      CALL FFV1_2(W(1,3),W(1,6),-GC_25,MDL_MTA,ZERO,W(1,22))
...
C     Amplitude(s) for diagram number 38
      ...
      CALL FFV1_1(W(1,8),W(1,6),-GC_25,MDL_MTA,ZERO,W(1,26))
...
C     Amplitude(s) for diagram number 43
      ...
      CALL FFV2_1(W(1,4),W(1,12),GC_11,MDL_MTA,ZERO,W(1,27))
