...
C           Amplitude(s) for diagram number 16
            ...
            CALL FFV1_2(W(1,2),W(1,6),GC_2,ZERO,ZERO,W(1,7))
...
C           Amplitude(s) for diagram number 18
            ...
            CALL FFV1_1(W(1,9),W(1,6),GC_1,ZERO,ZERO,W(1,10))
C           Amplitude(s) for diagram number 19
            CALL FFV2_0(W(1,2),W(1,10),W(1,8),GC_11,AMP(19))
C           Amplitude(s) for diagram number 20
            CALL FFV2_0(W(1,13),W(1,4),W(1,14),GC_11,AMP(20))
            CALL FFV1_1(W(1,1),W(1,6),GC_2,ZERO,ZERO,W(1,14))
            CALL FFV1P0_3(W(1,2),W(1,14),GC_2,ZERO,ZERO,W(1,6))
C           Amplitude(s) for diagram number 21
            CALL VVV1_0(W(1,6),W(1,5),W(1,8),GC_25,AMP(21))
            CALL FFV2_5_3(W(1,2),W(1,14),-GC_21,GC_23,MDL_MZ,MDL_WZ
     $       ,W(1,13))
...
C           Amplitude(s) for diagram number 26
            ...
            CALL FFV1P0_3(W(1,7),W(1,1),GC_2,ZERO,ZERO,W(1,13))
C           Amplitude(s) for diagram number 27
            CALL VVV1_0(W(1,13),W(1,5),W(1,8),GC_25,AMP(27))
            CALL FFV2_5_3(W(1,7),W(1,1),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1
     $       ,6))
