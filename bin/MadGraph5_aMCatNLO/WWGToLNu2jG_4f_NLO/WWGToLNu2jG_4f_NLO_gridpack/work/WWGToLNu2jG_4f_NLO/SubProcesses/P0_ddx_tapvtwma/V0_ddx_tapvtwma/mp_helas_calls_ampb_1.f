...
C     Amplitude(s) for born diagram with ID 16
      ...
      CALL MP_FFV1_1(W(1,2),W(1,6),GC_1,ZERO,ZERO,W(1,19))
...
C     Amplitude(s) for born diagram with ID 18
      ...
      CALL MP_FFV1_2(W(1,18),W(1,6),GC_2,ZERO,ZERO,W(1,21))
...
C     Amplitude(s) for born diagram with ID 20
      ...
      CALL MP_FFV1_2(W(1,1),W(1,6),GC_1,ZERO,ZERO,W(1,22))
      CALL MP_FFV1P0_3(W(1,22),W(1,2),GC_1,ZERO,ZERO,W(1,23))
C     Amplitude(s) for born diagram with ID 21
      CALL MP_VVV1_0(W(1,23),W(1,5),W(1,8),GC_25,AMP(21))
      CALL MP_FFV2_3_3(W(1,22),W(1,2),GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,24)
     $ )
...
C     Amplitude(s) for born diagram with ID 26
      ...
      CALL MP_FFV1P0_3(W(1,1),W(1,19),GC_1,ZERO,ZERO,W(1,27))
C     Amplitude(s) for born diagram with ID 27
      CALL MP_VVV1_0(W(1,27),W(1,5),W(1,8),GC_25,AMP(27))
      CALL MP_FFV2_3_3(W(1,1),W(1,19),GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,28)
     $ )
...
C     Amplitude(s) for born diagram with ID 32
      ...
      CALL MP_FFV2_2(W(1,18),W(1,8),GC_11,ZERO,ZERO,W(1,30))
C     Counter-term amplitude(s) for loop diagram number 33
      CALL MP_R2_QQ_1_0(W(1,30),W(1,19),R2_QQQ,AMPL(1,1))
...
C     Counter-term amplitude(s) for loop diagram number 35
      CALL MP_FFV2_0(W(1,18),W(1,2),W(1,31),R2_BXTW,AMPL(1,3))
...
C     Counter-term amplitude(s) for loop diagram number 39
      CALL MP_FFV1_0(W(1,30),W(1,2),W(1,6),R2_DDA,AMPL(1,5))
      CALL MP_FFV2_3(W(1,13),W(1,4),GC_11,MDL_MW,MDL_WW,W(1,32))
C     Counter-term amplitude(s) for loop diagram number 40
      CALL MP_FFV2_0(W(1,18),W(1,2),W(1,32),R2_BXTW,AMPL(1,6))
      CALL MP_VVV1P0_1(W(1,5),W(1,8),GC_25,ZERO,ZERO,W(1,33))
C     Counter-term amplitude(s) for loop diagram number 41
      CALL MP_FFV1_0(W(1,22),W(1,2),W(1,33),R2_DDA,AMPL(1,7))
      CALL MP_VVV1_3(W(1,5),W(1,8),GC_7,MDL_MZ,MDL_WZ,W(1,34))
C     Counter-term amplitude(s) for loop diagram number 42
      CALL MP_FFV2_3_0(W(1,22),W(1,2),W(1,34),R2_DDZ_V2,R2_DDZ_V3
     $ ,AMPL(1,8))
C     Counter-term amplitude(s) for loop diagram number 44
      CALL MP_FFV2_0(W(1,25),W(1,2),W(1,8),R2_BXTW,AMPL(1,9))
      CALL MP_FFV2_3(W(1,26),W(1,4),GC_28,MDL_MZ,MDL_WZ,W(1,35))
C     Counter-term amplitude(s) for loop diagram number 45
      CALL MP_FFV2_3_0(W(1,22),W(1,2),W(1,35),R2_DDZ_V2,R2_DDZ_V3
     $ ,AMPL(1,10))
      CALL MP_FFV1P0_3(W(1,3),W(1,15),-GC_25,ZERO,ZERO,W(1,36))
C     Counter-term amplitude(s) for loop diagram number 46
      CALL MP_FFV1_0(W(1,22),W(1,2),W(1,36),R2_DDA,AMPL(1,11))
      CALL MP_FFV2_4_3(W(1,3),W(1,15),GC_21,GC_24,MDL_MZ,MDL_WZ,W(1,37)
     $ )
C     Counter-term amplitude(s) for loop diagram number 47
      CALL MP_FFV2_3_0(W(1,22),W(1,2),W(1,37),R2_DDZ_V2,R2_DDZ_V3
     $ ,AMPL(1,12))
      CALL MP_FFV2_1(W(1,2),W(1,8),GC_11,ZERO,ZERO,W(1,38))
      CALL MP_FFV2_1(W(1,38),W(1,5),GC_11,ZERO,ZERO,W(1,39))
C     Counter-term amplitude(s) for loop diagram number 48
      CALL MP_R2_QQ_1_0(W(1,22),W(1,39),R2_QQQ,AMPL(1,13))
      CALL MP_FFV1_1(W(1,2),W(1,33),GC_1,ZERO,ZERO,W(1,40))
C     Counter-term amplitude(s) for loop diagram number 49
      CALL MP_R2_QQ_1_0(W(1,22),W(1,40),R2_QQQ,AMPL(1,14))
      CALL MP_FFV2_3_1(W(1,2),W(1,34),GC_21,GC_23,ZERO,ZERO,W(1,41))
C     Counter-term amplitude(s) for loop diagram number 50
      CALL MP_R2_QQ_1_0(W(1,22),W(1,41),R2_QQQ,AMPL(1,15))
C     Counter-term amplitude(s) for loop diagram number 51
      CALL MP_FFV2_0(W(1,22),W(1,38),W(1,5),R2_BXTW,AMPL(1,16))
      CALL MP_FFV2_3_1(W(1,2),W(1,35),GC_21,GC_23,ZERO,ZERO,W(1,42))
C     Counter-term amplitude(s) for loop diagram number 52
      CALL MP_R2_QQ_1_0(W(1,22),W(1,42),R2_QQQ,AMPL(1,17))
      CALL MP_FFV1_1(W(1,2),W(1,36),GC_1,ZERO,ZERO,W(1,43))
C     Counter-term amplitude(s) for loop diagram number 53
      CALL MP_R2_QQ_1_0(W(1,22),W(1,43),R2_QQQ,AMPL(1,18))
      CALL MP_FFV2_3_1(W(1,2),W(1,37),GC_21,GC_23,ZERO,ZERO,W(1,44))
C     Counter-term amplitude(s) for loop diagram number 54
      CALL MP_R2_QQ_1_0(W(1,22),W(1,44),R2_QQQ,AMPL(1,19))
C     Counter-term amplitude(s) for loop diagram number 55
      CALL MP_FFV1_0(W(1,1),W(1,19),W(1,33),R2_DDA,AMPL(1,20))
C     Counter-term amplitude(s) for loop diagram number 56
      CALL MP_FFV2_3_0(W(1,1),W(1,19),W(1,34),R2_DDZ_V2,R2_DDZ_V3
     $ ,AMPL(1,21))
      CALL MP_FFV2_1(W(1,19),W(1,8),GC_11,ZERO,ZERO,W(1,45))
C     Counter-term amplitude(s) for loop diagram number 58
      CALL MP_FFV2_0(W(1,1),W(1,45),W(1,5),R2_BXTW,AMPL(1,22))
C     Counter-term amplitude(s) for loop diagram number 59
      CALL MP_FFV2_3_0(W(1,1),W(1,19),W(1,35),R2_DDZ_V2,R2_DDZ_V3
     $ ,AMPL(1,23))
C     Counter-term amplitude(s) for loop diagram number 60
      CALL MP_FFV1_0(W(1,1),W(1,19),W(1,36),R2_DDA,AMPL(1,24))
C     Counter-term amplitude(s) for loop diagram number 61
      CALL MP_FFV2_3_0(W(1,1),W(1,19),W(1,37),R2_DDZ_V2,R2_DDZ_V3
     $ ,AMPL(1,25))
      CALL MP_VVV1P0_1(W(1,5),W(1,31),GC_25,ZERO,ZERO,W(1,46))
C     Counter-term amplitude(s) for loop diagram number 64
      CALL MP_FFV1_0(W(1,1),W(1,2),W(1,46),R2_DDA,AMPL(1,26))
      CALL MP_VVV1_3(W(1,5),W(1,31),GC_7,MDL_MZ,MDL_WZ,W(1,47))
C     Counter-term amplitude(s) for loop diagram number 65
      CALL MP_FFV2_3_0(W(1,1),W(1,2),W(1,47),R2_DDZ_V2,R2_DDZ_V3
     $ ,AMPL(1,27))
      CALL MP_VVVV2P0_1(W(1,6),W(1,5),W(1,8),GC_27,ZERO,ZERO,W(1,48))
C     Counter-term amplitude(s) for loop diagram number 66
      CALL MP_FFV1_0(W(1,1),W(1,2),W(1,48),R2_DDA,AMPL(1,28))
      CALL MP_VVVV5_4(W(1,6),W(1,5),W(1,8),GC_26,MDL_MZ,MDL_WZ,W(1,49))
C     Counter-term amplitude(s) for loop diagram number 67
      CALL MP_FFV2_3_0(W(1,1),W(1,2),W(1,49),R2_DDZ_V2,R2_DDZ_V3
     $ ,AMPL(1,29))
      CALL MP_VVV1P0_1(W(1,12),W(1,8),GC_25,ZERO,ZERO,W(1,50))
C     Counter-term amplitude(s) for loop diagram number 68
      CALL MP_FFV1_0(W(1,1),W(1,2),W(1,50),R2_DDA,AMPL(1,30))
      CALL MP_VVV1_3(W(1,12),W(1,8),GC_7,MDL_MZ,MDL_WZ,W(1,51))
C     Counter-term amplitude(s) for loop diagram number 69
      CALL MP_FFV2_3_0(W(1,1),W(1,2),W(1,51),R2_DDZ_V2,R2_DDZ_V3
     $ ,AMPL(1,31))
C     Counter-term amplitude(s) for loop diagram number 71
      CALL MP_FFV2_0(W(1,1),W(1,38),W(1,12),R2_BXTW,AMPL(1,32))
      CALL MP_FFV1_1(W(1,38),W(1,6),GC_2,ZERO,ZERO,W(1,52))
C     Counter-term amplitude(s) for loop diagram number 75
      CALL MP_FFV2_0(W(1,1),W(1,52),W(1,5),R2_BXTW,AMPL(1,33))
      CALL MP_FFV2_1(W(1,2),W(1,31),GC_11,ZERO,ZERO,W(1,53))
C     Counter-term amplitude(s) for loop diagram number 76
      CALL MP_FFV2_0(W(1,1),W(1,53),W(1,5),R2_BXTW,AMPL(1,34))
C     Counter-term amplitude(s) for loop diagram number 81
      CALL MP_FFV1_0(W(1,1),W(1,39),W(1,6),R2_DDA,AMPL(1,35))
C     Counter-term amplitude(s) for loop diagram number 82
      CALL MP_FFV1_0(W(1,1),W(1,40),W(1,6),R2_DDA,AMPL(1,36))
C     Counter-term amplitude(s) for loop diagram number 83
      CALL MP_FFV1_0(W(1,1),W(1,41),W(1,6),R2_DDA,AMPL(1,37))
C     Counter-term amplitude(s) for loop diagram number 87
      CALL MP_FFV1_0(W(1,1),W(1,42),W(1,6),R2_DDA,AMPL(1,38))
      CALL MP_VVV1P0_1(W(1,5),W(1,32),GC_25,ZERO,ZERO,W(1,54))
C     Counter-term amplitude(s) for loop diagram number 88
      CALL MP_FFV1_0(W(1,1),W(1,2),W(1,54),R2_DDA,AMPL(1,39))
      CALL MP_VVV1_3(W(1,5),W(1,32),GC_7,MDL_MZ,MDL_WZ,W(1,55))
C     Counter-term amplitude(s) for loop diagram number 89
      CALL MP_FFV2_3_0(W(1,1),W(1,2),W(1,55),R2_DDZ_V2,R2_DDZ_V3
     $ ,AMPL(1,40))
