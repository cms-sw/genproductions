...
C     Amplitude(s) for diagram number 32
      ...
      CALL FFV1_2(W(1,1),W(1,6),GC_2,ZERO,ZERO,W(1,15))
      CALL FFV1_1(W(1,7),W(1,2),GC_5,ZERO,ZERO,W(1,13))
      CALL FFV1P0_3(W(1,15),W(1,13),GC_2,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 33
      CALL VVV1_0(W(1,28),W(1,5),W(1,9),GC_25,AMP(33))
      CALL FFV2_5_3(W(1,15),W(1,13),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,29))
...
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,29),W(1,7),W(1,11),GC_2,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV2_5_0(W(1,29),W(1,7),W(1,12),-GC_21,GC_23,AMP(40))
...
C     Amplitude(s) for diagram number 43
      CALL FFV2_5_0(W(1,29),W(1,7),W(1,22),-GC_21,GC_23,AMP(43))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,29),W(1,7),W(1,19),GC_2,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV2_5_0(W(1,29),W(1,7),W(1,27),-GC_21,GC_23,AMP(45))
      CALL FFV1P0_3(W(1,1),W(1,13),GC_2,ZERO,ZERO,W(1,29))
C     Amplitude(s) for diagram number 46
      CALL VVV1_0(W(1,29),W(1,5),W(1,14),GC_25,AMP(46))
      CALL FFV2_5_3(W(1,1),W(1,13),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,30))
...
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,15),W(1,28),W(1,6),GC_1,AMP(50))
      CALL FFV1_1(W(1,13),W(1,6),GC_2,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,1),W(1,8),W(1,11),GC_2,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV2_5_0(W(1,1),W(1,8),W(1,12),-GC_21,GC_23,AMP(54))
...
C     Amplitude(s) for diagram number 58
      CALL FFV2_5_0(W(1,1),W(1,8),W(1,22),-GC_21,GC_23,AMP(58))
...
C     Amplitude(s) for diagram number 67
      CALL FFV1_0(W(1,1),W(1,8),W(1,19),GC_2,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFV2_5_0(W(1,1),W(1,8),W(1,27),-GC_21,GC_23,AMP(68))
...
C     Amplitude(s) for diagram number 73
      CALL FFV1_0(W(1,15),W(1,30),W(1,6),GC_1,AMP(73))
      CALL FFV1_1(W(1,18),W(1,6),GC_1,ZERO,ZERO,W(1,16))
...
C     Amplitude(s) for diagram number 78
      CALL FFV1_0(W(1,1),W(1,14),W(1,11),GC_2,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV2_5_0(W(1,1),W(1,14),W(1,12),-GC_21,GC_23,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV2_5_0(W(1,1),W(1,14),W(1,22),-GC_21,GC_23,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV2_0(W(1,1),W(1,30),W(1,24),GC_11,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV1_0(W(1,1),W(1,14),W(1,19),GC_2,AMP(82))
C     Amplitude(s) for diagram number 83
      CALL FFV2_5_0(W(1,1),W(1,14),W(1,27),-GC_21,GC_23,AMP(83))
