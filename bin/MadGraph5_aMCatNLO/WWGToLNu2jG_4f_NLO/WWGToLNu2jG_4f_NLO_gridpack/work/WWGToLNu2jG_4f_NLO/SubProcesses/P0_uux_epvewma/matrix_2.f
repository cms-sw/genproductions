...
C     
C     Process: g u~ > e+ ve w- a u~ WEIGHTED<=9 [ all = QCD ]
C     Process: g u~ > mu+ vm w- a u~ WEIGHTED<=9 [ all = QCD ]
C     Process: g c~ > e+ ve w- a c~ WEIGHTED<=9 [ all = QCD ]
C     Process: g c~ > mu+ vm w- a c~ WEIGHTED<=9 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 17
      ...
      CALL FFV1_2(W(1,3),W(1,6),-GC_25,ZERO,ZERO,W(1,23))
...
C     Amplitude(s) for diagram number 21
      ...
      CALL FFV2_1(W(1,4),W(1,5),GC_11,ZERO,ZERO,W(1,25))
...
C     Amplitude(s) for diagram number 25
      ...
      CALL FFV1_1(W(1,25),W(1,6),-GC_25,ZERO,ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 30
      ...
      CALL FFV2_1(W(1,4),W(1,18),GC_11,ZERO,ZERO,W(1,20))
