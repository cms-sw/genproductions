...
C     Coefficient construction for loop diagram with ID 35
      ...
      CALL FFV2L2_1(PL(0,6),W(1,5),GC_11,ZERO,ZERO,PL(0,7),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,6),4,COEFS,4,4,WL(1,0,1,7))
      CALL FFV1L2P0_3(PL(0,7),W(1,28),GC_5,ZERO,ZERO,PL(0,8),COEFS)
...
C     Coefficient construction for loop diagram with ID 36
      CALL FFV2L2_1(PL(0,7),W(1,8),GC_11,ZERO,ZERO,PL(0,9),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,7),4,COEFS,4,4,WL(1,0,1,9))
      CALL FFV1L2P0_3(PL(0,9),W(1,18),GC_5,ZERO,ZERO,PL(0,10),COEFS)
...
C     Coefficient construction for loop diagram with ID 37
      CALL FFV1L2P0_3(PL(0,0),W(1,24),GC_5,ZERO,ZERO,PL(0,11),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,11))
      CALL FFV1L3_1(PL(0,11),W(1,29),GC_5,ZERO,ZERO,PL(0,12),COEFS)
...
C     Coefficient construction for loop diagram with ID 38
      CALL FFV1L3_2(PL(0,1),W(1,30),GC_5,ZERO,ZERO,PL(0,13),COEFS)
...
C     Coefficient construction for loop diagram with ID 39
      CALL FFV1L3_2(PL(0,0),W(1,1),GC_5,ZERO,ZERO,PL(0,14),COEFS)
      ...
      CALL FFV1L1P0_3(PL(0,15),W(1,29),GC_5,ZERO,ZERO,PL(0,16),COEFS)
...
C     Coefficient construction for loop diagram with ID 40
      ...
      CALL FFV1L3_1(PL(0,17),W(1,19),GC_5,ZERO,ZERO,PL(0,18),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1,18))
      CALL FFV2L2_1(PL(0,18),W(1,31),GC_11,ZERO,ZERO,PL(0,19),COEFS)
...
C     Coefficient construction for loop diagram with ID 41
      CALL FFV1L3_2(PL(0,1),W(1,32),GC_5,ZERO,ZERO,PL(0,20),COEFS)
...
C     Coefficient construction for loop diagram with ID 42
      CALL FFV1L1_2(PL(0,14),W(1,6),GC_2,ZERO,ZERO,PL(0,21),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,14),4,COEFS,4,4,WL(1,0,1,21))
      CALL FFV2L1_2(PL(0,21),W(1,8),GC_11,ZERO,ZERO,PL(0,22),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,22))
      CALL FFV1L1P0_3(PL(0,22),W(1,19),GC_5,ZERO,ZERO,PL(0,23),COEFS)
...
C     Coefficient construction for loop diagram with ID 43
      CALL FFV1L1_2(PL(0,0),W(1,6),GC_1,ZERO,ZERO,PL(0,24),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,24))
      CALL FFV1L1P0_3(PL(0,24),W(1,19),GC_5,ZERO,ZERO,PL(0,25),COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,24),4,COEFS,4,4,WL(1,0,1,25))
      CALL FFV1L3_2(PL(0,25),W(1,24),GC_5,ZERO,ZERO,PL(0,26),COEFS)
...
C     Coefficient construction for loop diagram with ID 44
      CALL FFV1L1_2(PL(0,15),W(1,6),GC_1,ZERO,ZERO,PL(0,27),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,15),4,COEFS,4,4,WL(1,0,1,27))
      CALL FFV1L1P0_3(PL(0,27),W(1,19),GC_5,ZERO,ZERO,PL(0,28),COEFS)
...
C     Coefficient construction for loop diagram with ID 45
      CALL FFV2L2_1(PL(0,18),W(1,33),GC_11,ZERO,ZERO,PL(0,29),COEFS)
...
C     Coefficient construction for loop diagram with ID 46
      CALL FFV1L3_2(PL(0,1),W(1,34),GC_5,ZERO,ZERO,PL(0,30),COEFS)
...
C     Coefficient construction for loop diagram with ID 47
      CALL FFV1L3_1(PL(0,11),W(1,35),GC_5,ZERO,ZERO,PL(0,31),COEFS)
...
C     Coefficient construction for loop diagram with ID 48
      CALL FFV1L1P0_3(PL(0,15),W(1,35),GC_5,ZERO,ZERO,PL(0,32),COEFS)
...
C     Coefficient construction for loop diagram with ID 49
      CALL FFV2L1_2(PL(0,0),W(1,5),GC_11,ZERO,ZERO,PL(0,33),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,33))
      CALL FFV1L1P0_3(PL(0,33),W(1,25),GC_5,ZERO,ZERO,PL(0,34),COEFS)
      CALL UPDATE_WL_1_0(WL(1,0,1,33),4,COEFS,4,4,WL(1,0,1,34))
      CALL FFV1L3_2(PL(0,34),W(1,24),GC_5,ZERO,ZERO,PL(0,35),COEFS)
...
C     Coefficient construction for loop diagram with ID 50
      CALL FFV2L1_2(PL(0,15),W(1,5),GC_11,ZERO,ZERO,PL(0,36),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,15),4,COEFS,4,4,WL(1,0,1,36))
      CALL FFV1L1P0_3(PL(0,36),W(1,25),GC_5,ZERO,ZERO,PL(0,37),COEFS)
...
C     Coefficient construction for loop diagram with ID 51
      CALL FFV1L3_1(PL(0,11),W(1,36),GC_5,ZERO,ZERO,PL(0,38),COEFS)
...
C     Coefficient construction for loop diagram with ID 52
      CALL FFV2L2_1(PL(0,6),W(1,12),GC_11,ZERO,ZERO,PL(0,39),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,6),4,COEFS,4,4,WL(1,0,1,39))
      CALL FFV1L2P0_3(PL(0,39),W(1,24),GC_5,ZERO,ZERO,PL(0,40),COEFS)
...
C     Coefficient construction for loop diagram with ID 53
      CALL FFV1L1P0_3(PL(0,15),W(1,36),GC_5,ZERO,ZERO,PL(0,41),COEFS)
...
C     Coefficient construction for loop diagram with ID 54
      CALL FFV1L3_1(PL(0,17),W(1,2),GC_5,ZERO,ZERO,PL(0,42),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1,42))
      CALL FFV2L2_1(PL(0,42),W(1,12),GC_11,ZERO,ZERO,PL(0,43),COEFS)
...
C     Coefficient construction for loop diagram with ID 55
      CALL FFV1L2P0_3(PL(0,7),W(1,30),GC_5,ZERO,ZERO,PL(0,45),COEFS)
...
C     Coefficient construction for loop diagram with ID 56
      CALL FFV1L2_1(PL(0,6),W(1,6),GC_2,ZERO,ZERO,PL(0,46),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,6),4,COEFS,4,4,WL(1,0,1,46))
      CALL FFV2L2_1(PL(0,46),W(1,5),GC_11,ZERO,ZERO,PL(0,47),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,46),4,COEFS,4,4,WL(1,0,1,47))
      CALL FFV1L2P0_3(PL(0,47),W(1,24),GC_5,ZERO,ZERO,PL(0,48),COEFS)
...
C     Coefficient construction for loop diagram with ID 57
      CALL FFV2L2_1(PL(0,42),W(1,5),GC_11,ZERO,ZERO,PL(0,49),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,42),4,COEFS,4,4,WL(1,0,1,49))
      CALL FFV2L2_1(PL(0,49),W(1,31),GC_11,ZERO,ZERO,PL(0,50),COEFS)
...
C     Coefficient construction for loop diagram with ID 58
      CALL FFV1L2P0_3(PL(0,7),W(1,32),GC_5,ZERO,ZERO,PL(0,51),COEFS)
...
C     Coefficient construction for loop diagram with ID 59
      CALL FFV2L2_1(PL(0,49),W(1,8),GC_11,ZERO,ZERO,PL(0,52),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,49),4,COEFS,4,4,WL(1,0,1,52))
      CALL FFV1L2_1(PL(0,52),W(1,6),GC_2,ZERO,ZERO,PL(0,53),COEFS)
...
C     Coefficient construction for loop diagram with ID 60
      CALL FFV1L2_1(PL(0,42),W(1,6),GC_2,ZERO,ZERO,PL(0,54),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,42),4,COEFS,4,4,WL(1,0,1,54))
      CALL FFV2L2_1(PL(0,54),W(1,5),GC_11,ZERO,ZERO,PL(0,55),COEFS)
...
C     Coefficient construction for loop diagram with ID 61
      CALL FFV1L2_1(PL(0,7),W(1,6),GC_1,ZERO,ZERO,PL(0,57),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,7),4,COEFS,4,4,WL(1,0,1,57))
      CALL FFV1L2P0_3(PL(0,57),W(1,24),GC_5,ZERO,ZERO,PL(0,58),COEFS)
...
C     Coefficient construction for loop diagram with ID 62
      CALL FFV1L2_1(PL(0,49),W(1,6),GC_1,ZERO,ZERO,PL(0,59),COEFS)
      CALL UPDATE_WL_2_1(WL(1,0,1,49),4,COEFS,4,4,WL(1,0,1,59))
      CALL FFV2L2_1(PL(0,59),W(1,8),GC_11,ZERO,ZERO,PL(0,60),COEFS)
...
C     Coefficient construction for loop diagram with ID 63
      CALL FFV2L2_1(PL(0,49),W(1,33),GC_11,ZERO,ZERO,PL(0,61),COEFS)
...
C     Coefficient construction for loop diagram with ID 64
      CALL FFV1L2P0_3(PL(0,7),W(1,34),GC_5,ZERO,ZERO,PL(0,62),COEFS)
...
C     Coefficient construction for loop diagram with ID 65
      CALL FFV1L2P0_3(PL(0,0),W(1,18),GC_5,ZERO,ZERO,PL(0,63),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,63))
      CALL FFV1L3_1(PL(0,63),W(1,37),GC_5,ZERO,ZERO,PL(0,64),COEFS)
...
C     Coefficient construction for loop diagram with ID 66
      CALL FFV1L1P0_3(PL(0,0),W(1,2),GC_5,ZERO,ZERO,PL(0,65),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,65))
      CALL FFV1L3_2(PL(0,65),W(1,18),GC_5,ZERO,ZERO,PL(0,66),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,65),4,COEFS,4,4,WL(1,0,1,66))
      CALL FFV1L1_2(PL(0,66),W(1,38),GC_2,ZERO,ZERO,PL(0,67),COEFS)
...
C     Coefficient construction for loop diagram with ID 67
      CALL FFV2_5L1_2(PL(0,66),W(1,39),-GC_21,GC_23,ZERO,ZERO,PL(0,68)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 68
      CALL FFV2_5L1_2(PL(0,66),W(1,40),-GC_21,GC_23,ZERO,ZERO,PL(0,69)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 69
      CALL FFV1L1_2(PL(0,66),W(1,41),GC_2,ZERO,ZERO,PL(0,70),COEFS)
...
C     Coefficient construction for loop diagram with ID 70
      CALL FFV2_5L1_2(PL(0,66),W(1,42),-GC_21,GC_23,ZERO,ZERO,PL(0,71)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 71
      CALL FFV1L3_1(PL(0,63),W(1,43),GC_5,ZERO,ZERO,PL(0,72),COEFS)
...
C     Coefficient construction for loop diagram with ID 72
      CALL FFV1L3_1(PL(0,63),W(1,44),GC_5,ZERO,ZERO,PL(0,73),COEFS)
...
C     Coefficient construction for loop diagram with ID 73
      CALL FFV1L3_1(PL(0,63),W(1,45),GC_5,ZERO,ZERO,PL(0,74),COEFS)
...
C     Coefficient construction for loop diagram with ID 74
      CALL FFV1L3_1(PL(0,63),W(1,46),GC_5,ZERO,ZERO,PL(0,75),COEFS)
...
C     Coefficient construction for loop diagram with ID 75
      CALL FFV1L3_1(PL(0,63),W(1,47),GC_5,ZERO,ZERO,PL(0,76),COEFS)
...
C     Coefficient construction for loop diagram with ID 76
      CALL FFV1L1P0_3(PL(0,21),W(1,37),GC_5,ZERO,ZERO,PL(0,77),COEFS)
...
C     Coefficient construction for loop diagram with ID 77
      CALL FFV1L3_1(PL(0,17),W(1,25),GC_5,ZERO,ZERO,PL(0,78),COEFS)
      CALL UPDATE_WL_0_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1,78))
      CALL FFV1L2_1(PL(0,78),W(1,38),GC_2,ZERO,ZERO,PL(0,79),COEFS)
...
C     Coefficient construction for loop diagram with ID 78
      CALL FFV2_5L2_1(PL(0,78),W(1,39),-GC_21,GC_23,ZERO,ZERO,PL(0,80)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 79
      CALL FFV2_5L2_1(PL(0,78),W(1,40),-GC_21,GC_23,ZERO,ZERO,PL(0,81)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 80
      CALL FFV1L2_1(PL(0,78),W(1,41),GC_2,ZERO,ZERO,PL(0,82),COEFS)
...
C     Coefficient construction for loop diagram with ID 81
      CALL FFV2_5L2_1(PL(0,78),W(1,42),-GC_21,GC_23,ZERO,ZERO,PL(0,83)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 82
      CALL FFV1L2_1(PL(0,54),W(1,38),GC_2,ZERO,ZERO,PL(0,84),COEFS)
...
C     Coefficient construction for loop diagram with ID 83
      CALL FFV2_5L2_1(PL(0,54),W(1,39),-GC_21,GC_23,ZERO,ZERO,PL(0,85)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 84
      CALL FFV1L2_1(PL(0,42),W(1,48),GC_2,ZERO,ZERO,PL(0,86),COEFS)
...
C     Coefficient construction for loop diagram with ID 85
      CALL FFV2_5L2_1(PL(0,42),W(1,49),-GC_21,GC_23,ZERO,ZERO,PL(0,87)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 86
      CALL FFV1L2_1(PL(0,42),W(1,50),GC_2,ZERO,ZERO,PL(0,88),COEFS)
...
C     Coefficient construction for loop diagram with ID 87
      CALL FFV2_5L2_1(PL(0,42),W(1,51),-GC_21,GC_23,ZERO,ZERO,PL(0,89)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 88
      CALL FFV1L2_1(PL(0,42),W(1,52),GC_2,ZERO,ZERO,PL(0,90),COEFS)
...
C     Coefficient construction for loop diagram with ID 89
      CALL FFV2_5L2_1(PL(0,42),W(1,53),-GC_21,GC_23,ZERO,ZERO,PL(0,91)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 90
      CALL FFV1L2_1(PL(0,42),W(1,38),GC_2,ZERO,ZERO,PL(0,92),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,42),4,COEFS,4,4,WL(1,0,1,92))
      CALL FFV1L2_1(PL(0,92),W(1,6),GC_2,ZERO,ZERO,PL(0,93),COEFS)
...
C     Coefficient construction for loop diagram with ID 91
      CALL FFV2_5L2_1(PL(0,42),W(1,39),-GC_21,GC_23,ZERO,ZERO,PL(0,94)
     $ ,COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,42),4,COEFS,4,4,WL(1,0,1,94))
      CALL FFV1L2_1(PL(0,94),W(1,6),GC_2,ZERO,ZERO,PL(0,95),COEFS)
...
C     Coefficient construction for loop diagram with ID 92
      CALL FFV1L1P0_3(PL(0,21),W(1,43),GC_5,ZERO,ZERO,PL(0,96),COEFS)
...
C     Coefficient construction for loop diagram with ID 93
      CALL FFV1L1P0_3(PL(0,21),W(1,44),GC_5,ZERO,ZERO,PL(0,97),COEFS)
...
C     Coefficient construction for loop diagram with ID 94
      CALL FFV2_5L2_1(PL(0,54),W(1,40),-GC_21,GC_23,ZERO,ZERO,PL(0,98)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 95
      CALL FFV2_5L2_1(PL(0,42),W(1,40),-GC_21,GC_23,ZERO,ZERO,PL(0,99)
     $ ,COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,42),4,COEFS,4,4,WL(1,0,1,99))
      CALL FFV1L2_1(PL(0,99),W(1,6),GC_2,ZERO,ZERO,PL(0,100),COEFS)
...
C     Coefficient construction for loop diagram with ID 96
      CALL FFV1L1P0_3(PL(0,21),W(1,45),GC_5,ZERO,ZERO,PL(0,101),COEFS)
...
C     Coefficient construction for loop diagram with ID 97
      CALL FFV1L2_1(PL(0,42),W(1,54),GC_2,ZERO,ZERO,PL(0,102),COEFS)
...
C     Coefficient construction for loop diagram with ID 98
      CALL FFV2_5L2_1(PL(0,42),W(1,55),-GC_21,GC_23,ZERO,ZERO,PL(0,103)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 99
      CALL FFV2_5L2_1(PL(0,42),W(1,57),-GC_21,GC_23,ZERO,ZERO,PL(0,104)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 100
      CALL FFV1L2_1(PL(0,42),W(1,58),GC_2,ZERO,ZERO,PL(0,105),COEFS)
...
C     Coefficient construction for loop diagram with ID 101
      CALL FFV2_5L2_1(PL(0,42),W(1,59),-GC_21,GC_23,ZERO,ZERO,PL(0,106)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 102
      CALL FFV1L2_1(PL(0,54),W(1,41),GC_2,ZERO,ZERO,PL(0,107),COEFS)
...
C     Coefficient construction for loop diagram with ID 103
      CALL FFV2_5L2_1(PL(0,54),W(1,42),-GC_21,GC_23,ZERO,ZERO,PL(0,108)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 104
      CALL FFV1L2_1(PL(0,42),W(1,61),GC_2,ZERO,ZERO,PL(0,109),COEFS)
...
C     Coefficient construction for loop diagram with ID 105
      CALL FFV2_5L2_1(PL(0,42),W(1,62),-GC_21,GC_23,ZERO,ZERO,PL(0,110)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 106
      CALL FFV1L2_1(PL(0,42),W(1,41),GC_2,ZERO,ZERO,PL(0,111),COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,42),4,COEFS,4,4,WL(1,0,1,111))
      CALL FFV1L2_1(PL(0,111),W(1,6),GC_2,ZERO,ZERO,PL(0,112),COEFS)
...
C     Coefficient construction for loop diagram with ID 107
      CALL FFV2_5L2_1(PL(0,42),W(1,42),-GC_21,GC_23,ZERO,ZERO,PL(0,113)
     $ ,COEFS)
      CALL UPDATE_WL_1_1(WL(1,0,1,42),4,COEFS,4,4,WL(1,0,1,113))
      CALL FFV1L2_1(PL(0,113),W(1,6),GC_2,ZERO,ZERO,PL(0,114),COEFS)
...
C     Coefficient construction for loop diagram with ID 108
      CALL FFV1L1P0_3(PL(0,21),W(1,46),GC_5,ZERO,ZERO,PL(0,115),COEFS)
...
C     Coefficient construction for loop diagram with ID 109
      CALL FFV1L1P0_3(PL(0,21),W(1,47),GC_5,ZERO,ZERO,PL(0,116),COEFS)
...
C     Coefficient construction for loop diagram with ID 110
      CALL FFV2_5L2_1(PL(0,42),W(1,64),-GC_21,GC_23,ZERO,ZERO,PL(0,117)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 111
      CALL FFV1L2_1(PL(0,42),W(1,66),GC_2,ZERO,ZERO,PL(0,118),COEFS)
...
C     Coefficient construction for loop diagram with ID 112
      CALL FFV2_5L2_1(PL(0,42),W(1,67),-GC_21,GC_23,ZERO,ZERO,PL(0,119)
     $ ,COEFS)
...
C     Coefficient construction for loop diagram with ID 113
      CALL FFV1L1P0_3(PL(0,0),W(1,25),GC_5,ZERO,ZERO,PL(0,120),COEFS)
      CALL UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,120))
      CALL FFV1L3_2(PL(0,120),W(1,68),GC_5,ZERO,ZERO,PL(0,121),COEFS)
...
C     Coefficient construction for loop diagram with ID 114
      CALL FFV1L3_2(PL(0,120),W(1,69),GC_5,ZERO,ZERO,PL(0,122),COEFS)
...
C     Coefficient construction for loop diagram with ID 115
      CALL FFV1L3_2(PL(0,120),W(1,70),GC_5,ZERO,ZERO,PL(0,123),COEFS)
...
C     Coefficient construction for loop diagram with ID 116
      CALL FFV1L3_2(PL(0,120),W(1,71),GC_5,ZERO,ZERO,PL(0,124),COEFS)
...
C     Coefficient construction for loop diagram with ID 117
      CALL FFV1L3_2(PL(0,120),W(1,72),GC_5,ZERO,ZERO,PL(0,125),COEFS)
...
C     Coefficient construction for loop diagram with ID 118
      CALL FFV1L3_2(PL(0,120),W(1,73),GC_5,ZERO,ZERO,PL(0,126),COEFS)
...
C     Coefficient construction for loop diagram with ID 119
      CALL FFV1L2P0_3(PL(0,46),W(1,68),GC_5,ZERO,ZERO,PL(0,127),COEFS)
...
C     Coefficient construction for loop diagram with ID 120
      CALL FFV1L2P0_3(PL(0,46),W(1,69),GC_5,ZERO,ZERO,PL(0,128),COEFS)
...
C     Coefficient construction for loop diagram with ID 121
      CALL FFV1L2P0_3(PL(0,46),W(1,70),GC_5,ZERO,ZERO,PL(0,129),COEFS)
...
C     Coefficient construction for loop diagram with ID 122
      CALL FFV1L2P0_3(PL(0,46),W(1,71),GC_5,ZERO,ZERO,PL(0,130),COEFS)
...
C     Coefficient construction for loop diagram with ID 123
      CALL FFV1L2P0_3(PL(0,46),W(1,72),GC_5,ZERO,ZERO,PL(0,131),COEFS)
...
C     Coefficient construction for loop diagram with ID 124
      CALL FFV1L2P0_3(PL(0,46),W(1,73),GC_5,ZERO,ZERO,PL(0,132),COEFS)
