...
C     
C     Process: u u~ > e+ ve w- a g WEIGHTED<=9 [ all = QCD ]
C     Process: u u~ > mu+ vm w- a g WEIGHTED<=9 [ all = QCD ]
C     Process: c c~ > e+ ve w- a g WEIGHTED<=9 [ all = QCD ]
C     Process: c c~ > mu+ vm w- a g WEIGHTED<=9 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     
      ...
      PARAMETER (NWAVEFUNCS=28, NCOLOR=1)
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
      ...
      CALL FFV1_2(W(1,1),W(1,6),GC_2,ZERO,ZERO,W(1,8))
      CALL FFV2_1(W(1,2),W(1,5),GC_11,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1P0_3(W(1,8),W(1,13),GC_2,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,14),W(1,5),W(1,10),GC_25,AMP(3))
      CALL FFV2_5_3(W(1,8),W(1,13),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,15))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,5),W(1,10),W(1,15),GC_7,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL FFV2_0(W(1,11),W(1,13),W(1,5),GC_11,AMP(5))
      CALL FFV2_2(W(1,3),W(1,5),GC_11,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,11),W(1,4),W(1,15),GC_28,AMP(6))
      CALL FFV2_1(W(1,4),W(1,5),GC_11,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,3),W(1,8),W(1,14),-GC_25,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_4_0(W(1,3),W(1,8),W(1,15),GC_21,GC_24,AMP(8))
      CALL VVV1P0_1(W(1,5),W(1,10),GC_25,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,12),W(1,2),W(1,15),GC_2,AMP(9))
      CALL VVV1_3(W(1,5),W(1,10),GC_7,MDL_MZ,MDL_WZ,W(1,14))
C     Amplitude(s) for diagram number 10
      CALL FFV2_5_0(W(1,12),W(1,2),W(1,14),-GC_21,GC_23,AMP(10))
      CALL FFV2_3(W(1,11),W(1,4),GC_28,MDL_MZ,MDL_WZ,W(1,16))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,12),W(1,2),W(1,16),-GC_21,GC_23,AMP(11))
      CALL FFV1P0_3(W(1,3),W(1,8),-GC_25,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,12),W(1,2),W(1,17),GC_2,AMP(12))
      CALL FFV2_4_3(W(1,3),W(1,8),GC_21,GC_24,MDL_MZ,MDL_WZ,W(1,18))
C     Amplitude(s) for diagram number 13
      CALL FFV2_5_0(W(1,12),W(1,2),W(1,18),-GC_21,GC_23,AMP(13))
      CALL FFV1_2(W(1,1),W(1,7),GC_5,ZERO,ZERO,W(1,12))
      CALL FFV2_3(W(1,12),W(1,9),GC_11,MDL_MW,MDL_WW,W(1,19))
C     Amplitude(s) for diagram number 14
      CALL VVV1_0(W(1,6),W(1,19),W(1,10),GC_25,AMP(14))
      CALL FFV2_2(W(1,12),W(1,10),GC_11,ZERO,ZERO,W(1,20))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,20),W(1,9),W(1,6),GC_1,AMP(15))
      CALL FFV1_2(W(1,12),W(1,6),GC_2,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 16
      CALL FFV2_0(W(1,21),W(1,9),W(1,10),GC_11,AMP(16))
      CALL FFV1_2(W(1,3),W(1,6),-GC_25,ZERO,ZERO,W(1,22))
C     Amplitude(s) for diagram number 17
      CALL FFV2_0(W(1,22),W(1,4),W(1,19),GC_11,AMP(17))
      CALL FFV1_1(W(1,2),W(1,6),GC_2,ZERO,ZERO,W(1,19))
      CALL FFV1P0_3(W(1,12),W(1,19),GC_2,ZERO,ZERO,W(1,23))
C     Amplitude(s) for diagram number 18
      CALL VVV1_0(W(1,23),W(1,5),W(1,10),GC_25,AMP(18))
      CALL FFV2_5_3(W(1,12),W(1,19),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,24))
C     Amplitude(s) for diagram number 19
      CALL VVV1_0(W(1,5),W(1,10),W(1,24),GC_7,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,20),W(1,19),W(1,5),GC_11,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,11),W(1,4),W(1,24),GC_28,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,3),W(1,8),W(1,23),-GC_25,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_4_0(W(1,3),W(1,8),W(1,24),GC_21,GC_24,AMP(23))
      CALL FFV1P0_3(W(1,12),W(1,2),GC_2,ZERO,ZERO,W(1,24))
      CALL VVV1_2(W(1,6),W(1,10),GC_25,MDL_MW,MDL_WW,W(1,23))
C     Amplitude(s) for diagram number 24
      CALL VVV1_0(W(1,24),W(1,5),W(1,23),GC_25,AMP(24))
      CALL FFV2_5_3(W(1,12),W(1,2),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,11))
C     Amplitude(s) for diagram number 25
      CALL VVV1_0(W(1,5),W(1,23),W(1,11),GC_7,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL VVVV2_0(W(1,6),W(1,24),W(1,5),W(1,10),GC_27,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL VVVV5_0(W(1,6),W(1,5),W(1,10),W(1,11),GC_26,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,21),W(1,2),W(1,15),GC_2,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV2_5_0(W(1,21),W(1,2),W(1,14),-GC_21,GC_23,AMP(29))
      CALL VVV1_3(W(1,6),W(1,5),GC_25,MDL_MW,MDL_WW,W(1,12))
C     Amplitude(s) for diagram number 30
      CALL VVV1_0(W(1,24),W(1,12),W(1,10),GC_25,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL VVV1_0(W(1,12),W(1,10),W(1,11),GC_7,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_0(W(1,20),W(1,2),W(1,12),GC_11,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV2_5_0(W(1,21),W(1,2),W(1,16),-GC_21,GC_23,AMP(33))
      CALL FFV2_3(W(1,22),W(1,4),GC_11,MDL_MW,MDL_WW,W(1,20))
C     Amplitude(s) for diagram number 34
      CALL VVV1_0(W(1,24),W(1,5),W(1,20),GC_25,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL VVV1_0(W(1,5),W(1,20),W(1,11),GC_7,AMP(35))
      CALL FFV2_2(W(1,22),W(1,5),GC_11,ZERO,ZERO,W(1,25))
C     Amplitude(s) for diagram number 36
      CALL FFV2_0(W(1,25),W(1,4),W(1,11),GC_28,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,22),W(1,8),W(1,24),-GC_25,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_4_0(W(1,22),W(1,8),W(1,11),GC_21,GC_24,AMP(38))
      CALL FFV1_1(W(1,8),W(1,6),-GC_25,ZERO,ZERO,W(1,26))
C     Amplitude(s) for diagram number 39
      CALL FFV1_0(W(1,3),W(1,26),W(1,24),-GC_25,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV2_4_0(W(1,3),W(1,26),W(1,11),GC_21,GC_24,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,21),W(1,2),W(1,17),GC_2,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV2_5_0(W(1,21),W(1,2),W(1,18),-GC_21,GC_23,AMP(42))
      CALL FFV2_2(W(1,3),W(1,12),GC_11,ZERO,ZERO,W(1,21))
C     Amplitude(s) for diagram number 43
      CALL FFV2_0(W(1,21),W(1,4),W(1,11),GC_28,AMP(43))
      CALL FFV2_1(W(1,4),W(1,12),GC_11,ZERO,ZERO,W(1,27))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,3),W(1,27),W(1,24),-GC_25,AMP(44))
C     Amplitude(s) for diagram number 45
      CALL FFV2_4_0(W(1,3),W(1,27),W(1,11),GC_21,GC_24,AMP(45))
      CALL FFV2_2(W(1,1),W(1,10),GC_11,ZERO,ZERO,W(1,11))
      CALL FFV1_1(W(1,9),W(1,6),GC_1,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 46
      CALL FFV1_0(W(1,11),W(1,24),W(1,7),GC_5,AMP(46))
      CALL FFV1_1(W(1,9),W(1,7),GC_5,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 47
      CALL FFV1_0(W(1,11),W(1,24),W(1,6),GC_1,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFV2_0(W(1,1),W(1,24),W(1,23),GC_11,AMP(48))
C     Amplitude(s) for diagram number 49
      CALL FFV2_0(W(1,1),W(1,24),W(1,20),GC_11,AMP(49))
      CALL FFV2_1(W(1,19),W(1,5),GC_11,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 50
      CALL FFV1_0(W(1,11),W(1,24),W(1,7),GC_5,AMP(50))
      CALL FFV1_1(W(1,19),W(1,7),GC_5,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 51
      CALL FFV2_0(W(1,11),W(1,24),W(1,5),GC_11,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV1_0(W(1,1),W(1,24),W(1,15),GC_2,AMP(52))
C     Amplitude(s) for diagram number 53
      CALL FFV2_5_0(W(1,1),W(1,24),W(1,14),-GC_21,GC_23,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV2_5_0(W(1,1),W(1,24),W(1,16),-GC_21,GC_23,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV1_0(W(1,1),W(1,24),W(1,17),GC_2,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV2_5_0(W(1,1),W(1,24),W(1,18),-GC_21,GC_23,AMP(56))
      CALL FFV1P0_3(W(1,1),W(1,13),GC_2,ZERO,ZERO,W(1,24))
C     Amplitude(s) for diagram number 57
      CALL VVV1_0(W(1,24),W(1,5),W(1,23),GC_25,AMP(57))
      CALL FFV2_5_3(W(1,1),W(1,13),-GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,19))
C     Amplitude(s) for diagram number 58
      CALL VVV1_0(W(1,5),W(1,23),W(1,19),GC_7,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL VVVV2_0(W(1,6),W(1,24),W(1,5),W(1,10),GC_27,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL VVVV5_0(W(1,6),W(1,5),W(1,10),W(1,19),GC_26,AMP(60))
      CALL FFV2_1(W(1,13),W(1,5),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,11),W(1,9),W(1,6),GC_1,AMP(61))
      CALL FFV1_1(W(1,13),W(1,6),GC_2,ZERO,ZERO,W(1,28))
C     Amplitude(s) for diagram number 62
      CALL FFV2_0(W(1,11),W(1,28),W(1,5),GC_11,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFV2_0(W(1,1),W(1,9),W(1,23),GC_11,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV1_0(W(1,1),W(1,28),W(1,15),GC_2,AMP(64))
C     Amplitude(s) for diagram number 65
      CALL FFV2_5_0(W(1,1),W(1,28),W(1,14),-GC_21,GC_23,AMP(65))
C     Amplitude(s) for diagram number 66
      CALL VVV1_0(W(1,24),W(1,12),W(1,10),GC_25,AMP(66))
C     Amplitude(s) for diagram number 67
      CALL VVV1_0(W(1,12),W(1,10),W(1,19),GC_7,AMP(67))
C     Amplitude(s) for diagram number 68
      CALL FFV2_0(W(1,11),W(1,13),W(1,12),GC_11,AMP(68))
C     Amplitude(s) for diagram number 69
      CALL FFV2_5_0(W(1,1),W(1,28),W(1,16),-GC_21,GC_23,AMP(69))
C     Amplitude(s) for diagram number 70
      CALL VVV1_0(W(1,24),W(1,5),W(1,20),GC_25,AMP(70))
C     Amplitude(s) for diagram number 71
      CALL VVV1_0(W(1,5),W(1,20),W(1,19),GC_7,AMP(71))
C     Amplitude(s) for diagram number 72
      CALL FFV2_0(W(1,25),W(1,4),W(1,19),GC_28,AMP(72))
C     Amplitude(s) for diagram number 73
      CALL FFV2_0(W(1,1),W(1,9),W(1,20),GC_11,AMP(73))
C     Amplitude(s) for diagram number 74
      CALL FFV1_0(W(1,22),W(1,8),W(1,24),-GC_25,AMP(74))
C     Amplitude(s) for diagram number 75
      CALL FFV2_4_0(W(1,22),W(1,8),W(1,19),GC_21,GC_24,AMP(75))
C     Amplitude(s) for diagram number 76
      CALL FFV1_0(W(1,3),W(1,26),W(1,24),-GC_25,AMP(76))
C     Amplitude(s) for diagram number 77
      CALL FFV2_4_0(W(1,3),W(1,26),W(1,19),GC_21,GC_24,AMP(77))
C     Amplitude(s) for diagram number 78
      CALL FFV1_0(W(1,1),W(1,28),W(1,17),GC_2,AMP(78))
C     Amplitude(s) for diagram number 79
      CALL FFV2_5_0(W(1,1),W(1,28),W(1,18),-GC_21,GC_23,AMP(79))
C     Amplitude(s) for diagram number 80
      CALL FFV2_0(W(1,21),W(1,4),W(1,19),GC_28,AMP(80))
C     Amplitude(s) for diagram number 81
      CALL FFV1_0(W(1,3),W(1,27),W(1,24),-GC_25,AMP(81))
C     Amplitude(s) for diagram number 82
      CALL FFV2_4_0(W(1,3),W(1,27),W(1,19),GC_21,GC_24,AMP(82))
      CALL FFV2_1(W(1,2),W(1,12),GC_11,ZERO,ZERO,W(1,19))
C     Amplitude(s) for diagram number 83
      CALL FFV1_0(W(1,11),W(1,19),W(1,7),GC_5,AMP(83))
