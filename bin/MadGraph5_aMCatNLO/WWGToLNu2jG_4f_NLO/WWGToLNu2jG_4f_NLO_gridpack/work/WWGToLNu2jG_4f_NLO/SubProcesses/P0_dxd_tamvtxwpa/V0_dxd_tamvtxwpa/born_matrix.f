...
C     
C     Process: d~ d > ta- vt~ w+ a QED<=4 WEIGHTED<=8 [ all = QCD ]
C     Process: s~ s > ta- vt~ w+ a QED<=4 WEIGHTED<=8 [ all = QCD ]
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV2_4_1(W(1,3),W(1,10),GC_21,GC_24,MDL_MTA,ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 21
      ...
      CALL FFV2_3_3(W(1,2),W(1,14),GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,13))
...
C     Amplitude(s) for diagram number 27
      ...
      CALL FFV2_3_3(W(1,7),W(1,1),GC_21,GC_23,MDL_MZ,MDL_WZ,W(1,6))
