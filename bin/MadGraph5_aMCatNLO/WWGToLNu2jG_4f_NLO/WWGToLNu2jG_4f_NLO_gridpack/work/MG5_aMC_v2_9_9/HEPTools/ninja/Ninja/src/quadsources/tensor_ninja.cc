...
namespace quadninja {
  ...
  Complex TensorNumerator::evaluate(const quadninja::ComplexMomentum & q,
  ...
  void TensorNumerator::muExpansion(const quadninja::ComplexMomentum v[],
  ...
  void TensorNumerator::t3Expansion(const quadninja::ComplexMomentum & a,
  ...
  void TensorNumerator::t2Expansion(const quadninja::ComplexMomentum & a0,
