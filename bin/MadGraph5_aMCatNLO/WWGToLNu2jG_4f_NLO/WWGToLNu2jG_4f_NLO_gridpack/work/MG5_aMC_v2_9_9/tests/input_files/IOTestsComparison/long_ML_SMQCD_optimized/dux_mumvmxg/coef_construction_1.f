...
C     Coefficient construction for loop diagram with ID 4
      ...
      CALL FFV2L2_1(PL(0,3),W(1,7),GC_11,ZERO,ZERO,PL(0,4),COEFS)
...
C     Coefficient construction for loop diagram with ID 5
      ...
      CALL FFV2L1_2(PL(0,6),W(1,7),GC_11,ZERO,ZERO,PL(0,7),COEFS)
...
C     Coefficient construction for loop diagram with ID 6
      ...
      CALL ML5_0_UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0,1,11))
      CALL FFV2L2_1(PL(0,11),W(1,7),GC_11,ZERO,ZERO,PL(0,12),COEFS)
      CALL ML5_0_UPDATE_WL_2_1(WL(1,0,1,11),4,COEFS,4,4,WL(1,0,1,12))
...
C     Coefficient construction for loop diagram with ID 7
      ...
      CALL ML5_0_UPDATE_WL_0_1(WL(1,0,1,9),4,COEFS,4,4,WL(1,0,1,13))
...
C     Coefficient construction for loop diagram with ID 8
      ...
      CALL ML5_0_UPDATE_WL_1_1(WL(1,0,1,13),4,COEFS,4,4,WL(1,0,1,15))
      CALL FFV2L2_1(PL(0,15),W(1,7),GC_11,ZERO,ZERO,PL(0,16),COEFS)
...
C     Coefficient construction for loop diagram with ID 9
      CALL FFV2L2_1(PL(0,10),W(1,7),GC_11,ZERO,ZERO,PL(0,17),COEFS)
      CALL ML5_0_UPDATE_WL_1_1(WL(1,0,1,10),4,COEFS,4,4,WL(1,0,1,17))
      CALL FFV1L2_1(PL(0,17),W(1,5),GC_5,ZERO,ZERO,PL(0,18),COEFS)
      CALL ML5_0_UPDATE_WL_2_1(WL(1,0,1,17),4,COEFS,4,4,WL(1,0,1,18))
...
C     Coefficient construction for loop diagram with ID 10
      ...
      CALL ML5_0_UPDATE_WL_1_1(WL(1,0,1,6),4,COEFS,4,4,WL(1,0,1,19))
...
C     Coefficient construction for loop diagram with ID 11
      ...
      CALL ML5_0_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,21))
      CALL FFV1L3_2(PL(0,21),W(1,10),GC_5,ZERO,ZERO,PL(0,22),COEFS)
      CALL ML5_0_UPDATE_WL_0_1(WL(1,0,1,21),4,COEFS,4,4,WL(1,0,1,22))
...
C     Coefficient construction for loop diagram with ID 12
      ...
      CALL ML5_0_UPDATE_WL_0_0(WL(1,0,1,0),4,COEFS,4,4,WL(1,0,1,23))
      CALL VVV1L2P0_1(PL(0,23),W(1,5),GC_4,ZERO,ZERO,PL(0,24),COEFS)
      CALL ML5_0_UPDATE_WL_0_1(WL(1,0,1,23),4,COEFS,4,4,WL(1,0,1,24))
...
C     Coefficient construction for loop diagram with ID 13
      ...
      CALL ML5_0_UPDATE_WL_1_1(WL(1,0,1,3),4,COEFS,4,4,WL(1,0,1,26))
      CALL FFV1L2P0_3(PL(0,26),W(1,10),GC_5,ZERO,ZERO,PL(0,27),COEFS)
      CALL ML5_0_UPDATE_WL_2_0(WL(1,0,1,26),4,COEFS,4,4,WL(1,0,1,27))
