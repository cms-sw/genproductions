...
C      if true.
      ...
      CALL MP_FFV2_3(W(1,4),W(1,3),GC_11,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for born diagram with ID 1
      CALL MP_FFV2_0(W(1,6),W(1,2),W(1,7),GC_11,AMP(1))
      CALL MP_FFV1_1(W(1,2),W(1,5),GC_5,ZERO,ZERO,W(1,8))
C     Amplitude(s) for born diagram with ID 2
      CALL MP_FFV2_0(W(1,1),W(1,8),W(1,7),GC_11,AMP(2))
      CALL MP_FFV2_1(W(1,2),W(1,7),GC_11,ZERO,ZERO,W(1,9))
...
C     Counter-term amplitude(s) for loop diagram number 4
      CALL MP_FFV2_0(W(1,6),W(1,2),W(1,7),R2_BXTW,AMPL(1,2))
C     Counter-term amplitude(s) for loop diagram number 5
      CALL MP_FFV2_0(W(1,1),W(1,8),W(1,7),R2_BXTW,AMPL(1,3))
C     Counter-term amplitude(s) for loop diagram number 7
      CALL MP_FFV1_0(W(1,1),W(1,9),W(1,5),UV_GQQB_1EPS,AMPL(2,4))
      CALL MP_FFV1_0(W(1,1),W(1,9),W(1,5),UV_GQQB_1EPS,AMPL(2,5))
      CALL MP_FFV1_0(W(1,1),W(1,9),W(1,5),UV_GQQB_1EPS,AMPL(2,6))
      CALL MP_FFV1_0(W(1,1),W(1,9),W(1,5),UV_GQQB_1EPS,AMPL(2,7))
      CALL MP_FFV1_0(W(1,1),W(1,9),W(1,5),UV_GQQB,AMPL(1,8))
      CALL MP_FFV1_0(W(1,1),W(1,9),W(1,5),UV_GQQB_1EPS,AMPL(2,9))
      CALL MP_FFV1_0(W(1,1),W(1,9),W(1,5),UV_GQQT,AMPL(1,10))
      CALL MP_FFV1_0(W(1,1),W(1,9),W(1,5),UV_GQQB_1EPS,AMPL(2,11))
      CALL MP_FFV1_0(W(1,1),W(1,9),W(1,5),UV_GQQG_1EPS,AMPL(2,12))
      CALL MP_FFV1_0(W(1,1),W(1,9),W(1,5),R2_GQQ,AMPL(1,13))
      CALL MP_FFV2_2(W(1,1),W(1,7),GC_11,ZERO,ZERO,W(1,10))
C     Counter-term amplitude(s) for loop diagram number 11
      CALL MP_R2_QQ_1_0(W(1,10),W(1,8),R2_QQQ,AMPL(1,14))
C     Counter-term amplitude(s) for loop diagram number 12
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,5),UV_GQQB_1EPS,AMPL(2,15))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,5),UV_GQQB_1EPS,AMPL(2,16))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,5),UV_GQQB_1EPS,AMPL(2,17))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,5),UV_GQQB_1EPS,AMPL(2,18))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,5),UV_GQQB,AMPL(1,19))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,5),UV_GQQB_1EPS,AMPL(2,20))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,5),UV_GQQT,AMPL(1,21))
      CALL MP_FFV1_0(W(1,10),W(1,2),W(1,5),UV_GQQB_1EPS,AMPL(2,22))
