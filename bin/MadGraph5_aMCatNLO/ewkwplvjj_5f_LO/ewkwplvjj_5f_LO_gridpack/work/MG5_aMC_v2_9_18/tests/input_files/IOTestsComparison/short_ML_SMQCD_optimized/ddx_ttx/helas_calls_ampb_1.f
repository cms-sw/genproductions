...
C     Counter-term amplitude(s) for loop diagram number 5
      CALL FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQB_1EPS,AMPL(2,5))
      CALL FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQB_1EPS,AMPL(2,6))
      CALL FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQB_1EPS,AMPL(2,7))
      CALL FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQB_1EPS,AMPL(2,8))
      CALL FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQB,AMPL(1,9))
      CALL FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQB_1EPS,AMPL(2,10))
      CALL FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQT,AMPL(1,11))
      CALL FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQB_1EPS,AMPL(2,12))
      CALL FFV1_0(W(1,1),W(1,2),W(1,6),UV_GQQG_1EPS,AMPL(2,13))
      CALL FFV1_0(W(1,1),W(1,2),W(1,6),R2_GQQ,AMPL(1,14))
C     Counter-term amplitude(s) for loop diagram number 7
      CALL R2_GG_1_R2_GG_3_0(W(1,5),W(1,6),R2_GGQ,R2_GGB,AMPL(1,15))
C     Counter-term amplitude(s) for loop diagram number 8
      CALL R2_GG_1_R2_GG_3_0(W(1,5),W(1,6),R2_GGQ,R2_GGT,AMPL(1,16))
C     Counter-term amplitude(s) for loop diagram number 9
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),UV_GQQB_1EPS,AMPL(2,17))
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),UV_GQQB_1EPS,AMPL(2,18))
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),UV_GQQB_1EPS,AMPL(2,19))
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),UV_GQQB_1EPS,AMPL(2,20))
...
C     Counter-term amplitude(s) for loop diagram number 11
      CALL R2_GG_1_R2_GG_2_0(W(1,5),W(1,6),R2_GGG_1,R2_GGG_2,AMPL(1,27)
     $ )
