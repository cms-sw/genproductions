            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 141 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX141(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_141(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_141/ZEROAMP_141
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFV2_3_3(W(1,2),W(1,5),GC_50,GC_58,MDL_MZ, ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV2_2(W(1,2),W(1,7),GC_43,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,4),W(1,5),W(1,9),GC_102,AMP(6))
      CALL FFV2_2(W(1,2),W(1,7),GC_105,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,4),W(1,5),W(1,9),GC_105,AMP(7))
      CALL FFV2_2(W(1,2),W(1,7),GC_108,MDL_MT, FK_MDL_WT,W(1,4))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,4),W(1,5),W(1,9),GC_108,AMP(8))
      CALL FFV1_1(W(1,1),W(1,8),GC_1,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,6),W(1,4),W(1,9),GC_100,AMP(9))
      CALL FFV2_1(W(1,1),W(1,9),GC_100,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,4),W(1,8),GC_2,AMP(10))
      CALL FFV2_3_1(W(1,1),W(1,10),GC_50,GC_58,ZERO, FK_ZERO,W(1,8))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,6),W(1,8),W(1,9),GC_100,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,6),W(1,4),W(1,10),-GC_50,GC_58,AMP(12))
      CALL FFV2_3(W(1,6),W(1,5),GC_102,MDL_MW, FK_MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,2),W(1,4),W(1,10),GC_43,AMP(13))
      CALL FFV2_1(W(1,1),W(1,9),-GC_101,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,2),W(1,4),W(1,10),GC_105,AMP(14))
      CALL FFV2_1(W(1,1),W(1,9),GC_106,MDL_MT, ZERO,W(1,4))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,2),W(1,4),W(1,10),GC_108,AMP(15))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ *AMP(11)+(-1.000000000000000D+00)*AMP(12)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX141 = MATRIX141 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_141(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 141, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_141(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 141, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX141(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS141/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS141
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX141=SOINDEX_FOR_SQUARED_ORDERS141(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS141(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS141/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS141 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS141'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN141(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX141(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX141'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX141(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS141(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS141 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS141'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
