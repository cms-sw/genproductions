            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 100 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX100(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_100(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_100/ZEROAMP_100
...
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,5),W(1,2),W(1,8),GC_100,AMP(9))
      CALL FFV2_2(W(1,6),W(1,11),GC_105,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,5),W(1,2),W(1,8),-GC_101,AMP(10))
      CALL FFV2_2(W(1,6),W(1,11),GC_108,MDL_MT, ZERO,W(1,5))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,5),W(1,2),W(1,8),GC_106,AMP(11))
...
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,11),W(1,2),W(1,8),-GC_101,AMP(13))
...
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,5),W(1,2),W(1,8),-GC_101,AMP(15))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +00)*AMP(14)+(-1.000000000000000D+00)*AMP(15)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX100 = MATRIX100 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_100(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 100, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_100(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 100, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX100(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS100/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS100
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX100=SOINDEX_FOR_SQUARED_ORDERS100(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS100(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS100/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS100 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS100'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN100(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX100(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX100'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX100(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS100(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS100 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS100'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
