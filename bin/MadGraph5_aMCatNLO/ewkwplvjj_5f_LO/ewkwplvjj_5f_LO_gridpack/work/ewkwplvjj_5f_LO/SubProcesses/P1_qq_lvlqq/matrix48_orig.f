            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 48 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX48(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_48(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_48/ZEROAMP_48
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,5),W(1,1),GC_105,MDL_MW, ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV2_3(W(1,5),W(1,2),GC_105,MDL_MW, ZERO,W(1,7))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +AMP(15)+AMP(16)+AMP(17)+AMP(18)+AMP(19)+AMP(20)
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX48 = MATRIX48 + ZTEMP*DCONJG(JAMP(I,N))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_48(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 48, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_48(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 48, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX48'
