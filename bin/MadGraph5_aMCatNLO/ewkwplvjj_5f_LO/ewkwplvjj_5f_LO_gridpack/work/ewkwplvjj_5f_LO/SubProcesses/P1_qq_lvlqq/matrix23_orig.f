...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV1P0_3(W(1,6),W(1,2),GC_2,ZERO, FK_ZERO,W(1,9))
      CALL FFV2_1(W(1,4),W(1,11),GC_108,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,3),W(1,7),W(1,9),GC_3,AMP(10))
      CALL FFV2_5_3(W(1,6),W(1,2),-GC_50,GC_58,MDL_MZ, ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 13
      CALL VVV1_0(W(1,9),W(1,11),W(1,8),-GC_3,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL VVV1_0(W(1,11),W(1,8),W(1,12),GC_53,AMP(14))
...
C     Amplitude(s) for diagram number 23
      CALL FFV2_0(W(1,12),W(1,2),W(1,10),GC_100,AMP(23))
