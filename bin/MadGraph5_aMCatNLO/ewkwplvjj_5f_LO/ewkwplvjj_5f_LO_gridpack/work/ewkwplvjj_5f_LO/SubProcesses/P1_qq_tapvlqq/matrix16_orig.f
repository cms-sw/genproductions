...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV2_3(W(1,1),W(1,6),-GC_101,MDL_MW, ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 18
      CALL FFV2_0(W(1,7),W(1,6),W(1,10),-GC_101,AMP(18))
      CALL FFV2_2(W(1,1),W(1,10),-GC_101,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,7),W(1,6),W(1,9),GC_1,AMP(19))
      CALL FFV2_5_2(W(1,1),W(1,12),-GC_50,GC_58,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 20
      CALL FFV2_0(W(1,9),W(1,6),W(1,10),-GC_101,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFV2_3_0(W(1,7),W(1,6),W(1,12),GC_50,GC_58,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_0(W(1,7),W(1,5),W(1,8),-GC_101,AMP(22))
