            ...
            DO I=1,NCOMB
              IF(INIT_MODE) THEN
                IF (DABS(TS(I)).GT.ANS*LIMHEL/NCOMB) THEN
                  PRINT *, 'Matrix Element/Good Helicity: 132 ', I,
     $              'IMIRROR', IMIRROR
                ENDIF
...
C           Set right sign for ANS, based on sign of chosen helicity
 ...
 10     CONTINUE
     ...
     $       //' zero but not the total matrix-element'
      ...
      REAL*8 FUNCTION MATRIX132(P,NHEL,IC, IHEL)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.9.18, 2023-12-08
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     
      ...
      LOGICAL ZEROAMP_132(NCOMB,NGRAPHS)
      COMMON/TO_ZEROAMP_132/ZEROAMP_132
...
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,9),W(1,4),W(1,8),GC_108,AMP(1))
      CALL FFV2_5_3(W(1,5),W(1,1),-GC_50,GC_58,MDL_MZ, ZERO,W(1,9))
      CALL FFV2_4_2(W(1,3),W(1,9),GC_50,GC_59,MDL_MTA, ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV2_0(W(1,10),W(1,4),W(1,8),GC_108,AMP(2))
      CALL FFV2_1(W(1,4),W(1,9),GC_62,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,3),W(1,10),W(1,8),GC_108,AMP(3))
      CALL FFV2_3(W(1,3),W(1,4),GC_108,MDL_MW, FK_MDL_WW,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL VVV1_0(W(1,7),W(1,8),W(1,10),-GC_3,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVV1_0(W(1,8),W(1,10),W(1,9),GC_53,AMP(5))
      CALL FFV1_1(W(1,2),W(1,7),GC_1,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 6
      CALL FFV2_0(W(1,6),W(1,4),W(1,10),GC_100,AMP(6))
      CALL FFV1_2(W(1,6),W(1,7),GC_2,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 7
      CALL FFV2_0(W(1,4),W(1,2),W(1,10),GC_100,AMP(7))
      CALL FFV2_3_1(W(1,2),W(1,9),GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 8
      CALL FFV2_0(W(1,6),W(1,4),W(1,10),GC_100,AMP(8))
      CALL FFV2_5_2(W(1,6),W(1,9),-GC_50,GC_58,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 9
      CALL FFV2_0(W(1,4),W(1,2),W(1,10),GC_100,AMP(9))
      CALL FFV2_3(W(1,5),W(1,2),GC_101,MDL_MW, ZERO,W(1,4))
      CALL FFV2_1(W(1,1),W(1,4),GC_100,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),-GC_101,AMP(10))
      CALL FFV2_1(W(1,1),W(1,4),GC_101,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 11
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),GC_100,AMP(11))
      CALL FFV2_1(W(1,1),W(1,4),GC_43,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 12
      CALL FFV2_0(W(1,6),W(1,2),W(1,10),GC_105,AMP(12))
      CALL FFV2_1(W(1,1),W(1,8),GC_100,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 13
      CALL FFV2_0(W(1,5),W(1,2),W(1,10),GC_100,AMP(13))
      CALL FFV2_1(W(1,1),W(1,8),GC_101,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 14
      CALL FFV2_0(W(1,5),W(1,2),W(1,10),GC_101,AMP(14))
      CALL FFV2_1(W(1,1),W(1,8),GC_43,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 15
      CALL FFV2_0(W(1,5),W(1,2),W(1,10),GC_102,AMP(15))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ *AMP(14)+(-1.000000000000000D+00)*AMP(15)
      JAMP(2,1) = AMP(10)+AMP(11)+AMP(12)

      IF(INIT_MODE)THEN
        DO I=1, NGRAPHS
          IF (AMP(I).NE.0) THEN
            ZEROAMP_132(IHEL,I) = .FALSE.
          ENDIF
        ENDDO
      ENDIF
      ...
      DO M = 1, NAMPSO
        DO I = 1, NCOLOR
          ...
          DO N = 1, NAMPSO
            ...
            MATRIX132 = MATRIX132 + ZTEMP*DCONJG(JAMP(I,N))
     ...
     $   +AMP(11)+AMP(12))
      ...
      DO I=1, NGRAPHS
        ALL_FALSE = .TRUE.
        DO J=1,NCOMB
          IF (.NOT.ZEROAMP_132(J, I)) THEN
            ALL_FALSE = .FALSE.
            EXIT
          ENDIF
        ENDDO
        IF (ALL_FALSE) THEN
          WRITE(*,*) 'Amplitude/ZEROAMP:', 132, I
        ELSE
          DO J=1,NCOMB
            IF (ZEROAMP_132(J, I)) THEN
              WRITE(*,*) 'HEL/ZEROAMP:', 132, J  , I
            ENDIF
          ENDDO
        ENDIF
      ENDDO
...
C     Set of functions to handle the array indices of the split orders
      ...
      INTEGER FUNCTION SQSOINDEX132(ORDERINDEXA, ORDERINDEXB)
C     
...
C     
      ...
      COMMON/AMPSPLITORDERS132/AMPSPLITORDERS
C     
C     FUNCTION
C     
      INTEGER SOINDEX_FOR_SQUARED_ORDERS132
C     
C     BEGIN CODE
C     
      DO I=1,NSO
     ...
     $   +AMPSPLITORDERS(ORDERINDEXB,I)
      ENDDO
      SQSOINDEX132=SOINDEX_FOR_SQUARED_ORDERS132(SQORDERS)
      END

      INTEGER FUNCTION SOINDEX_FOR_SQUARED_ORDERS132(ORDERS)
C     
...
C     
      ...
      COMMON/SQPLITORDERS132/SQPLITORDERS
C     
C     BEGIN CODE
C     
      DO I=1,NSQSO
        ...
        ENDDO
        SOINDEX_FOR_SQUARED_ORDERS132 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping in function'
      WRITE(*,*) 'SOINDEX_FOR_SQUARED_ORDERS132'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP

      END

      SUBROUTINE GET_NSQSO_BORN132(NSQSO)
C     
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_SQUARED_ORDERS_FOR_SOINDEX132(SOINDEX,ORDERS)
C     
...
C     
     ...
     $ //' GET_SQUARED_ORDERS_FOR_SOINDEX132'
...
C      Not directly useful, but provided nonetheless.
      SUBROUTINE GET_ORDERS_FOR_AMPSOINDEX132(SOINDEX,ORDERS)
C     
...
C      completeness
      INTEGER FUNCTION SOINDEX_FOR_AMPORDERS132(ORDERS)
C     
...
C     
      DO I=1,NAMPSO
        ...
        ENDDO
        SOINDEX_FOR_AMPORDERS132 = I
        RETURN
 1009   CONTINUE
      ENDDO

      WRITE(*,*) 'ERROR:: Stopping function SOINDEX_FOR_AMPORDERS132'
      WRITE(*,*) 'Could not find squared orders ',(ORDERS(I),I=1,NSO)
      STOP
