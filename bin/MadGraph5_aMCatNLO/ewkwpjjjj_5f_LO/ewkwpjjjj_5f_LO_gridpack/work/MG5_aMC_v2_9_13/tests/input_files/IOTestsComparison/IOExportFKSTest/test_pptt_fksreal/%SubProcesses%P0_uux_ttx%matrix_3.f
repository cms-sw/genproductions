...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV1_1(W(1,5),W(1,2),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,1),W(1,6),W(1,7),GC_11,AMP(5))
      JAMP(1) = (-5.000000000000000D-01)*AMP(1)+(-5.000000000000000D
     $ -01)*AMP(2)+((0.000000000000000D+00,-5.000000000000000D-01))
     $ *AMP(4)
      JAMP(2) = (1.666666666666667D-01)*AMP(2)+(1.666666666666667D-01)
     $ *AMP(3)
      JAMP(3) = (1.666666666666667D-01)*AMP(1)+(1.666666666666667D-01)
     $ *AMP(5)
      JAMP(4) = (-5.000000000000000D-01)*AMP(3)+((0.000000000000000D
