...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      UV_3GB = -(COND(DCMPLX(MDL_MB),DCMPLX(0.000000D+00),DCMPLX(
     $ -((MDL_G__EXP__2)/(2.000000D+00*4.800000D+01*PI**2))*4.000000D
     $ +00*MDL_TF*REGLOG(DCMPLX(MDL_MB__EXP__2/MDL_MU_R__EXP__2)))))*G
      UV_3GT = -(COND(DCMPLX(MDL_MT),DCMPLX(0.000000D+00),DCMPLX(
     $ -((MDL_G__EXP__2)/(2.000000D+00*4.800000D+01*PI**2))*4.000000D
     $ +00*MDL_TF*REGLOG(DCMPLX(MDL_MT__EXP__2/MDL_MU_R__EXP__2)))))*G
     ...
     $ EXP__2)))))*G
      UV_BMASS = (COND(DCMPLX(MDL_MB),DCMPLX(0.000000D+00),DCMPLX(MDL_C
     $ OMPLEXI*((MDL_G__EXP__2)/(1.600000D+01*PI**2))*MDL_CF*(4.000000D
     $ +00-3.000000D+00*REGLOG(DCMPLX(MDL_MB__EXP__2/MDL_MU_R__EXP__2)
     $ ))*MDL_MB)))
      UV_TMASS = (COND(DCMPLX(MDL_MT),DCMPLX(0.000000D+00),DCMPLX(MDL_C
     $ OMPLEXI*((MDL_G__EXP__2)/(1.600000D+01*PI**2))*MDL_CF*(4.000000D
     $ +00-3.000000D+00*REGLOG(DCMPLX(MDL_MT__EXP__2/MDL_MU_R__EXP__2)
     $ ))*MDL_MT)))
     ...
     $ +MDL_LHV)
      R2_GGQ = (2.000000D+00)*MDL_COMPLEXI*MDL_G__EXP__2/(4.800000D
     $ +01*PI**2)
     ...
     $ )/(3.200000D+01*PI**2*MDL_NCOL)
      R2_QQB = MDL_LHV*MDL_COMPLEXI*MDL_G__EXP__2*(MDL_NCOL__EXP__2_M_1
     $ )*(2.000000D+00*MDL_MB)/(3.200000D+01*PI**2*MDL_NCOL)
      R2_QQT = MDL_LHV*MDL_COMPLEXI*MDL_G__EXP__2*(MDL_NCOL__EXP__2_M_1
     $ )*(2.000000D+00*MDL_MT)/(3.200000D+01*PI**2*MDL_NCOL)
      END
