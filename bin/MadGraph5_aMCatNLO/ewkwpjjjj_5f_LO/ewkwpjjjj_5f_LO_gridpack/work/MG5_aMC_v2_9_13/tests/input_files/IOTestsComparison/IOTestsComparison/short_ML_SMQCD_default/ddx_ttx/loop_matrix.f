...
C            optimized output)
          ...
          CALL FFV1P0_3(W(1,1,H),W(1,2,H),GC_5,ZERO,ZERO,W(1,5,H))
...
C         Counter-term amplitude(s) for loop diagram number 12
     ...
     $     ,19))
          CALL FFV1_0(W(1,4,H),W(1,3,H),W(1,5,H),UV_GQQQ_1EPS,AMPL(2
     $     ,20))
          CALL FFV1_0(W(1,4,H),W(1,3,H),W(1,5,H),UV_GQQB,AMPL(1,21))
          CALL FFV1_0(W(1,4,H),W(1,3,H),W(1,5,H),UV_GQQQ_1EPS,AMPL(2
     $     ,22))
          CALL FFV1_0(W(1,4,H),W(1,3,H),W(1,5,H),UV_GQQT,AMPL(1,23))
          CALL FFV1_0(W(1,4,H),W(1,3,H),W(1,5,H),UV_GQQQ_1EPS,AMPL(2
     $     ,24))
...
C     Loop amplitude for loop diagram with ID 2
      CALL LOOP_2_2(1,5,6,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16)
...
C     Loop amplitude for loop diagram with ID 3
      CALL LOOP_4_4(2,1,2,4,3,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16)
     $ ,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16),DCMPLX(MDL_MT),CMPLX(MP__M
     $ DL_MT,KIND=16),DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16),GC_5
     $ ,MP__GC_5,GC_5,MP__GC_5,GC_5,MP__GC_5,GC_5,MP__GC_5,2,1,31
     $ ,AMPL(1,31),S(31))
C     Loop amplitude for loop diagram with ID 4
      CALL LOOP_4_4(3,1,2,3,4,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16)
     $ ,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16),DCMPLX(MDL_MT),CMPLX(MP__M
     $ DL_MT,KIND=16),DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16),GC_5
     $ ,MP__GC_5,GC_5,MP__GC_5,GC_5,MP__GC_5,GC_5,MP__GC_5,2,1,32
     $ ,AMPL(1,32),S(32))
C     Loop amplitude for loop diagram with ID 5
      CALL LOOP_3_3(4,1,2,6,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16)
...
C     Loop amplitude for loop diagram with ID 6
      CALL LOOP_3_3(5,1,2,6,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16)
     $ ,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16),DCMPLX(ZERO),CMPLX(MP__ZER
...
C     Loop amplitude for loop diagram with ID 10
      CALL LOOP_2_2(1,5,6,DCMPLX(MDL_MB),CMPLX(MP__MDL_MB,KIND=16)
...
C     Loop amplitude for loop diagram with ID 11
      CALL LOOP_2_2(1,5,6,DCMPLX(MDL_MT),CMPLX(MP__MDL_MT,KIND=16)
...
C     Loop amplitude for loop diagram with ID 12
      CALL LOOP_3_3(6,3,4,5,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16)
...
C     Loop amplitude for loop diagram with ID 13
      CALL LOOP_3_3(7,3,4,5,DCMPLX(MDL_MT),CMPLX(MP__MDL_MT,KIND=16)
     $ ,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16),DCMPLX(ZERO),CMPLX(MP__ZER
     $ O,KIND=16),GC_5,MP__GC_5,GC_5,MP__GC_5,GC_4,MP__GC_4,2,1,41
     $ ,AMPL(1,41),S(41))
C     Loop amplitude for loop diagram with ID 14
      CALL LOOP_2_2(8,5,6,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16)
...
C     Loop amplitude for loop diagram with ID 15
      CALL LOOP_2_2(9,5,6,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16)
     $ ,DCMPLX(ZERO),CMPLX(MP__ZERO,KIND=16),GC_4,MP__GC_4,GC_4
