...
c      
      ...
      do i=1,2
        l=(kk-1)*108+(i-1)*54
         call rbook(l+  1,'total '
     &       //cc(i)//weights_info(kk),1.0d0,0.5d0,5.5d0)

         call rbook(l+  2,'Higgs pT '
     &       //cc(i)//weights_info(kk),8.0d0,0.d0,400.d0)
         call rbook(l+  3,'Higgs pT '
     &       //cc(i)//weights_info(kk),16.0d0,0.d0,800.d0)
         call rbook(l+  4,'Higgs logpT '
     &       //cc(i)//weights_info(kk),0.08d0,0.d0,4.d0)
         call rbook(l+  5,'Higgs eta '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)
         call rbook(l+  6,'Higgs y '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)

         call rbook(l+  7,'j1 pT '
     &       //cc(i)//weights_info(kk),8.0d0,0.d0,400.d0)
         call rbook(l+  8,'j1 pT '
     &       //cc(i)//weights_info(kk),16.0d0,0.d0,800.d0)
         call rbook(l+  9,'j1 logpT '
     &       //cc(i)//weights_info(kk),0.08d0,0.d0,4.d0)
         call rbook(l+ 10,'j1 eta '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)
         call rbook(l+ 11,'j1 y '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)

         call rbook(l+ 12,'j2 pT '
     &       //cc(i)//weights_info(kk),8.0d0,0.d0,400.d0)
         call rbook(l+ 13,'j2 pT '
     &       //cc(i)//weights_info(kk),16.0d0,0.d0,800.d0)
         call rbook(l+ 14,'j2 logpT '
     &       //cc(i)//weights_info(kk),0.08d0,0.d0,4.d0)
         call rbook(l+ 15,'j2 eta '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)
         call rbook(l+ 16,'j2 y '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)

         call rbook(l+ 17,'j3 pT '
     &       //cc(i)//weights_info(kk),8.0d0,0.d0,400.d0)
         call rbook(l+ 18,'j3 pT '
     &       //cc(i)//weights_info(kk),16.0d0,0.d0,800.d0)
         call rbook(l+ 19,'j3 logpT '
     &       //cc(i)//weights_info(kk),0.08d0,0.d0,4.d0)
         call rbook(l+ 20,'j3 eta '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)
         call rbook(l+ 21,'j3 y '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)

         call rbook(l+ 22,'H+j1 pT '
     &       //cc(i)//weights_info(kk),8.0d0,0.d0,400.d0)
         call rbook(l+ 23,'H+j1 pT '
     &       //cc(i)//weights_info(kk),16.0d0,0.d0,800.d0)
         call rbook(l+ 24,'H+j1 logpT '
     &       //cc(i)//weights_info(kk),0.08d0,0.d0,4.d0)
         call rbook(l+ 25,'H+j1 eta '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)
         call rbook(l+ 26,'H+j1 y '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)

         call rbook(l+ 27,'j1+j2 pT '
     &       //cc(i)//weights_info(kk),8.0d0,0.d0,400.d0)
         call rbook(l+ 28,'j1+j2 pT '
     &       //cc(i)//weights_info(kk),16.0d0,0.d0,800.d0)
         call rbook(l+ 29,'j1+j2 logpT '
     &       //cc(i)//weights_info(kk),0.08d0,0.d0,4.d0)
         call rbook(l+ 30,'j1+j2 eta '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)
         call rbook(l+ 31,'j1+j2 y '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)

         call rbook(l+ 32,'syst pT '
     &       //cc(i)//weights_info(kk),8.0d0,0.d0,400.d0)
         call rbook(l+ 33,'syst pT '
     &       //cc(i)//weights_info(kk),16.0d0,0.d0,800.d0)
         call rbook(l+ 34,'syst logpT '
     &       //cc(i)//weights_info(kk),0.08d0,0.d0,4.d0)
         call rbook(l+ 35,'syst eta '
     &       //cc(i)//weights_info(kk),0.4d0,-10.d0,10.d0)
         call rbook(l+ 36,'syst y '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)

         call rbook(l+ 37,'Dphi H-j1 '
     &       //cc(i)//weights_info(kk),pi/50.d0,0d0,pi)
         call rbook(l+ 38,'Dphi H-j2 '
     &       //cc(i)//weights_info(kk),pi/50.d0,0d0,pi)
         call rbook(l+ 39,'Dphi j1-j2 '
     &       //cc(i)//weights_info(kk),pi/50.d0,0d0,pi)

         call rbook(l+ 40,'DR H-j1 '
     &       //cc(i)//weights_info(kk),0.2d0,0d0,10.d0)
         call rbook(l+ 41,'DR H-j2 '
     &       //cc(i)//weights_info(kk),0.2d0,0d0,10.d0)
         call rbook(l+ 42,'DR j1-j2 '
     &       //cc(i)//weights_info(kk),0.2d0,0d0,10.d0)

         call rbook(l+ 43,'mj1j2 '
     &       //cc(i)//weights_info(kk),60.0d0,0d0,3000.d0)

c Nason-Oleari plots (hep-ph/0911.5299)
         call rbook(l+ 44,'|yj1-yj2| '
     &       //cc(i)//weights_info(kk),0.4d0,0.d0,10.d0)
         call rbook(l+ 45,'yj3_rel '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)
         call rbook(l+ 46,'njets '
     &       //cc(i)//weights_info(kk),1.d0,-0.5d0,9.5d0)
         call rbook(l+ 47,'ptrel_j1 '
     &       //cc(i)//weights_info(kk),4.d0,0.d0,200.d0)
         call rbook(l+ 48,'ptrel_j2 '
     &       //cc(i)//weights_info(kk),4.d0,0.d0,200.d0)
         call rbook(l+ 49,'P-veto '
     &       //cc(i)//weights_info(kk),
     1    ((vetomax-vetomin)/dble(nbinveto)),vetomin,vetomax)
         call rbook(l+ 50,'jveto pT '
     &       //cc(i)//weights_info(kk),
     1    ((vetomax-vetomin)/dble(nbinveto)),vetomin,vetomax)
         call rbook(l+ 51,'jveto pT '
     &       //cc(i)//weights_info(kk),
     1    ((2d0*vetomax-vetomin)/dble(nbinveto)),
     1    vetomin,2d0*vetomax)
         call rbook(l+ 52,'jveto logpT '
     &       //cc(i)//weights_info(kk),0.08d0,0.d0,4.d0)
         call rbook(l+ 53,'jveto eta '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)
         call rbook(l+ 54,'jveto y '
     &       //cc(i)//weights_info(kk),0.24d0,-6.d0,6.d0)
...
c
     ...
     &                mj1j2.ge.mj1j2min 
      ...
      l=(kk-1)*108+(i-1)*54
      if(flag)then
         call rfill(l+  1,1d0,www)
         call rfill(l+  2,ptH,www)
         call rfill(l+  3,ptH,www)
         if(ptH.gt.0d0) call rfill(l+  4,log10(ptH),www)
         call rfill(l+  5,etaH,www)
         call rfill(l+  6,yH,www)
         call rfill(l+ 46,njdble,www)

         if(njet.ge.1)then
            call rfill(l+  7,ptj1,www)
            call rfill(l+  8,ptj1,www)
            if (ptj1.gt.0d0) call rfill(l+  9,log10(ptj1),www)
            call rfill(l+ 10,etaj1,www)
            call rfill(l+ 11,yj1,www)
            call rfill(l+ 22,ptHj,www)
            call rfill(l+ 23,ptHj,www)
            if(ptHj.gt.0d0) call rfill(l+ 24,log10(ptHj),www)
            call rfill(l+ 25,etaHj,www)
            call rfill(l+ 26,yHj,www)
            call rfill(l+ 37,DphiHj1,www)
            call rfill(l+ 40,DRHj1,www)
            call rfill(l+ 47,ptrel_j1,www)
         endif 
         
         if(njet.ge.2)then
            call rfill(l+ 12,ptj2,www)
            call rfill(l+ 13,ptj2,www)
            if (ptj2.gt.0d0) call rfill(l+ 14,log10(ptj2),www)
            call rfill(l+ 15,etaj2,www)
            call rfill(l+ 16,yj2,www)
            call rfill(l+ 27,ptjj,www)
            call rfill(l+ 28,ptjj,www)
            if(ptjj.gt.0d0) call rfill(l+ 29,log10(ptjj),www)
            call rfill(l+ 30,etajj,www)
            call rfill(l+ 31,yjj,www)
            call rfill(l+ 32,ptsyst,www)
            call rfill(l+ 33,ptsyst,www)
            if(ptsyst.gt.0d0) call rfill(l+ 34,log10(ptsyst),www)
            call rfill(l+ 35,etasyst,www)
            call rfill(l+ 36,ysyst,www)
            call rfill(l+ 38,DphiHj2,www)
            call rfill(l+ 39,Dphij1j2,www)
            call rfill(l+ 41,DRHj2,www)
            call rfill(l+ 42,DRj1j2,www)
            call rfill(l+ 43,mj1j2,www)
            call rfill(l+ 44,Dyj1j2,www)
            call rfill(l+ 48,ptrel_j2,www)
         endif
         
         if(njet.ge.3)then
            call rfill(l+ 17,ptj3,www)
            call rfill(l+ 18,ptj3,www)
            if(ptj3.gt.0d0) call rfill(l+ 19,log10(ptj3),www)
            call rfill(l+ 20,etaj3,www)
            call rfill(l+ 21,yj3,www)
            call rfill(l+ 45,yj3rel,www)
         endif
         if (ijveto.gt.0) then
     ...
     $              /dble(nbinveto))) then
                  call rfill(l+49, (vetomax-vetomin)* dble(k)
     $                 /dble(nbinveto)*0.99, www/xsecup2)
               endif
            enddo
            call rfill(l+50,pt_veto,www)
            call rfill(l+51,pt_veto,www)
            if (pt_veto.gt.0d0) call rfill(l+52,dlog10(pt_veto),www)
            call rfill(l+53,getpseudorapv4(pjveto),www)
            call rfill(l+54,getrapidityv4(pjveto),www)
         endif
      endif
      enddo
      enddo
