MODULE cmatrix_base
CONTAINS
  FUNCTION CM2X2DET(A) RESULT(DET)
    IMPLICIT NONE
    COMPLEX(KIND(1d0)),DIMENSION(2,2),INTENT(IN)::A
    COMPLEX(KIND(1d0))::DET    
    DET = A(1,1)*A(2,2)-A(1,2)*A(2,1)
    RETURN
  END FUNCTION CM2X2DET

  FUNCTION CM3X3DET(A) RESULT(DET)    
    IMPLICIT NONE
    COMPLEX(KIND(1d0)),DIMENSION(3,3),INTENT(IN)::A
    COMPLEX(KIND(1d0))::DET
    DET =  A(1,1)*A(2,2)*A(3,3)  &
         ...
         - A(1,3)*A(2,2)*A(3,1)
    RETURN
  END FUNCTION CM3X3DET

  FUNCTION CM4X4DET(A) RESULT(DET)    
    IMPLICIT NONE
    COMPLEX(KIND(1d0)),DIMENSION(4,4),INTENT(IN)::A
    COMPLEX(KIND(1d0))::DET
    ...
    RETURN
  END FUNCTION CM4X4DET

  FUNCTION CM5X5DET(A) RESULT(DET)
    IMPLICIT NONE
    COMPLEX(KIND(1d0)),DIMENSION(5,5),INTENT(IN)::A
    COMPLEX(KIND(1d0))::DET, A11, A12, A13, A14, A15, A21, A22, A23, A24, &
  ...
  END FUNCTION CM5X5DET

  FUNCTION CM6X6DET(A) RESULT(DET)
    IMPLICIT NONE
    COMPLEX(KIND(1d0)),DIMENSION(6,6),INTENT(IN)::A
    COMPLEX(KIND(1d0)):: DET, A11, A12, A13, A14, A15, A16, A21, A22, A23, A24, &
    ...
    DET = -(A16*A25*A34*A43*A52-A15*A26*A34*A43*A52-A16*A24*A35*A43*             &
         ...
         A66
      RETURN
    END FUNCTION CM6X6DET

    RECURSIVE FUNCTION CMNXNDET(n,A) RESULT(DET)
      IMPLICIT NONE
      INTEGER,INTENT(IN)::n
      ...
      SELECT CASE(n)
         ...
         CASE DEFAULT
            DET=DCMPLX(0d0)
            DO i=1,n
               DET=DET+(-1)**(i+1)*A(1,i)*CMNXNDET(n-1,CMINOR(n,A,1,i))
            ENDDO
            RETURN
      END SELECT
    END FUNCTION CMNXNDET

    FUNCTION CMINOR(n,A,i,j)
      IMPLICIT NONE
      INTEGER,INTENT(IN)::n,i,j
      COMPLEX(KIND(1d0)),DIMENSION(n,n),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(n-1,n-1)::CMINOR
      INTEGER::k1,k2,i0,j0
      i0=1
      DO k1=1,n
         IF(k1.EQ.i)CYCLE
    ...
    FUNCTION CMINOR22(n,A,i1,i2,j1,j2)
      IMPLICIT NONE
      INTEGER,INTENT(IN)::n,i1,i2,j1,j2
      COMPLEX(KIND(1d0)),DIMENSION(n,n),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(n-2,n-2)::CMINOR22
      COMPLEX(KIND(1d0)),DIMENSION(n-1,n-1)::A11
      INTEGER::imax,imin,jmax,jmin
      imax=MAX(i1,i2)
      imin=MIN(i1,i2)
      jmax=MAX(j1,j2)
      jmin=MIN(j1,j2)
      A11(1:n-1,1:n-1)=CMINOR(n,A,imax,jmax)
      CMINOR22(1:n-2,1:n-2)=CMINOR(n-1,A11,imin,jmin)
      RETURN
    END FUNCTION CMINOR22

    FUNCTION SIGNED_CMINOR11(n,A,i,j)
      IMPLICIT NONE
      INTEGER,INTENT(IN)::n,i,j
      COMPLEX(KIND(1d0)),DIMENSION(n,n),INTENT(IN)::A
      COMPLEX(KIND(1d0))::SIGNED_CMINOR11
      SIGNED_CMINOR11=CMNXNDET(n-1,CMINOR(n,A,i,j))*(-1)**(i+j)
      RETURN
    END FUNCTION SIGNED_CMINOR11

    FUNCTION SIGNED_CMINOR22(n,A,i1,i2,j1,j2)
      IMPLICIT NONE
      INTEGER,INTENT(IN)::n,i1,i2,j1,j2
      COMPLEX(KIND(1d0)),DIMENSION(n,n),INTENT(IN)::A
      COMPLEX(KIND(1d0))::SIGNED_CMINOR22
      IF(n.LT.2)THEN
         SIGNED_CMINOR22=DCMPLX(0d0)
         RETURN
      ENDIF
      ...
      IF(n.EQ.2)THEN
         SIGNED_CMINOR22=DCMPLX(0d0)
         IF((i1-j2).EQ.0.AND.(i2-j1).EQ.0)SIGNED_CMINOR22=SIGNED_CMINOR22+DCMPLX(1d0)
         IF((i1-j1).EQ.0.AND.(i2-j2).EQ.0)SIGNED_CMINOR22=SIGNED_CMINOR22-DCMPLX(1d0)
         RETURN
      ENDIF
      SIGNED_CMINOR22=CMNXNDET(n-2,CMINOR22(n,A,i1,i2,j1,j2))*&
           (-1)**(i1+j1+i2+j2)*SIGN(1,i1-i2)*SIGN(1,j2-j1)
      RETURN
    END FUNCTION SIGNED_CMINOR22

    FUNCTION Y_CMATRIX_COLUMN_N(n,A,i,val) RESULT(res)
      ! replace all entries in the i-th column by val in n*n matrix A
      ! take the determinant
      IMPLICIT NONE
      INTEGER,INTENT(IN)::n,i
      COMPLEX(KIND(1d0)),INTENT(IN)::val
      COMPLEX(KIND(1d0)),DIMENSION(n,n),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(n,n)::Ai
      ...
      ENDDO
      res=CMNXNDET(n,Ai)
    END FUNCTION Y_CMATRIX_COLUMN_N

    SUBROUTINE CM2X2INV(A,AINV,OK_FLAG) 
      IMPLICIT NONE
      COMPLEX(KIND(1d0)),DIMENSION(2,2),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(2,2),INTENT(OUT)::AINV
      LOGICAL,INTENT(OUT)::OK_FLAG
      REAL(KIND(1d0)),PARAMETER::EPS = 1.0D-10
      COMPLEX(KIND(1d0))::DET
      COMPLEX(KIND(1d0)),DIMENSION(2,2)::COFACTOR
      DET=CM2X2DET(A)
      ...
      OK_FLAG = .TRUE.
      RETURN
    END SUBROUTINE CM2X2INV

    SUBROUTINE CM3X3INV(A,AINV,OK_FLAG)
      IMPLICIT NONE
      COMPLEX(KIND(1d0)),DIMENSION(3,3),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(3,3),INTENT(OUT)::AINV
      LOGICAL,INTENT(OUT)::OK_FLAG
      REAL(KIND(1d0)),PARAMETER::EPS = 1.0D-10
      COMPLEX(KIND(1d0))::DET
      COMPLEX(KIND(1d0)),DIMENSION(3,3)::COFACTOR
      DET = CM3X3DET(A)
      IF(ABS(DET).LE.EPS)THEN
         AINV = DCMPLX(0.0D0)
         OK_FLAG = .FALSE.
      ...
      OK_FLAG = .TRUE.
      RETURN
    END SUBROUTINE CM3X3INV

    SUBROUTINE CM4X4INV(A,AINV,OK_FLAG)
      IMPLICIT NONE
      COMPLEX(KIND(1d0)),DIMENSION(4,4),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(4,4),INTENT(OUT)::AINV
      LOGICAL,INTENT(OUT)::OK_FLAG
      REAL(KIND(1d0)),PARAMETER::EPS = 1.0D-10
      COMPLEX(KIND(1d0)):: DET
      COMPLEX(KIND(1d0)),DIMENSION(4,4)::COFACTOR
      ...
      OK_FLAG = .TRUE.
      RETURN
    END SUBROUTINE CM4X4INV

    SUBROUTINE CM5X5INV(A, AINV, OK_FLAG)
      IMPLICIT NONE
      COMPLEX(KIND(1d0)),DIMENSION(5,5),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(5,5),INTENT(OUT)::AINV
      LOGICAL,INTENT(OUT)::OK_FLAG
      REAL(KIND(1d0)),PARAMETER::EPS = 1.0D-10
      COMPLEX(KIND(1d0)):: DET, A11, A12, A13, A14, A15, A21, A22, A23, A24, &
           A25, A31, A32, A33, A34, A35, A41, A42, A43, A44, A45,   &
           A51, A52, A53, A54, A55
      COMPLEX(KIND(1d0)),DIMENSION(5,5)::COFACTOR
      ...
      OK_FLAG = .TRUE.
      RETURN
    END SUBROUTINE CM5X5INV

    SUBROUTINE CM6X6INV(A,AINV,OK_FLAG)
      IMPLICIT NONE
      COMPLEX(KIND(1d0)),DIMENSION(6,6),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(6,6),INTENT(OUT)::AINV
      LOGICAL,INTENT(OUT)::OK_FLAG
      REAL(KIND(1d0)),PARAMETER::EPS = 1.0D-10
      COMPLEX(KIND(1d0)):: DET, A11, A12, A13, A14, A15, A16, A21, A22, A23, A24, &
           A25, A26, A31, A32, A33, A34, A35, A36, A41, A42, A43, A44, A45, A46,   &
           A51, A52, A53, A54, A55, A56, A61, A62, A63, A64, A65, A66
      COMPLEX(KIND(1d0)),DIMENSION(6,6):: COFACTOR
      ...
      OK_FLAG = .TRUE.
      RETURN
    END SUBROUTINE CM6X6INV

    SUBROUTINE CMNXNINV(n,A,INVA,OK_FLAG)
      IMPLICIT NONE
      INTEGER,INTENT(IN)::n
      COMPLEX(KIND(1d0)),DIMENSION(n,n),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(n,n),INTENT(OUT)::INVA
      LOGICAL,INTENT(OUT)::OK_FLAG
      REAL(KIND(1d0)),PARAMETER::EPS = 1.0D-10
      COMPLEX(KIND(1d0))::DET
      COMPLEX(KIND(1d0)),DIMENSION(n,n)::COFACTOR
      INTEGER::i,j
      SELECT CASE(n)
         CASE(1)
            DET=A(1,1)
            ...
            RETURN
         CASE(2)
            CALL CM2X2INV(A,INVA,OK_FLAG)
            RETURN
         CASE(3)
            CALL CM3X3INV(A,INVA,OK_FLAG)
            RETURN
         CASE(4)
            CALL CM4X4INV(A,INVA,OK_FLAG)
            RETURN
         CASE(5)
            CALL CM5X5INV(A,INVA,OK_FLAG)
            RETURN
         CASE(6)
            CALL CM6X6INV(A,INVA,OK_FLAG)
            RETURN
         CASE DEFAULT
            DET=CMNXNDET(n,A)
            IF(ABS(DET).LT.EPS)THEN
            ...
            DO i=1,n
               DO j=1,n
                  COFACTOR(j,i)=(-1)**(i+j)*CMNXNDET(n-1,CMINOR(n,A,i,j))
               ENDDO
            ENDDO
            INVA=COFACTOR/ DET
            OK_FLAG=.TRUE.
            RETURN
      END SELECT
    END SUBROUTINE CMNXNINV

    FUNCTION ccrdot(N1,N2,A,b)
      ! A.b
      IMPLICIT NONE
      INTEGER,INTENT(IN)::N1,N2
      COMPLEX(KIND(1d0)),DIMENSION(N1,N2),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(N2),INTENT(IN)::b
      COMPLEX(KIND(1d0)),DIMENSION(N1)::ccrdot
      INTEGER::i,j
      DO i=1,N1
         ccrdot(i)=DCMPLX(0d0)
         DO j=1,N2
            ccrdot(i)=ccrdot(i)+A(i,j)*b(j)
         ENDDO
      ENDDO
      RETURN
    END FUNCTION ccrdot

    FUNCTION ccldot(N1,N2,A,b)
      ! b.A 
      IMPLICIT NONE
      INTEGER,INTENT(IN)::N1,N2
      COMPLEX(KIND(1d0)),DIMENSION(N1,N2),INTENT(IN)::A
      COMPLEX(KIND(1d0)),DIMENSION(N1),INTENT(IN)::b
      COMPLEX(KIND(1d0)),DIMENSION(N2)::ccldot
      INTEGER::i,j
      DO i=1,N2
         ccldot(i)=DCMPLX(0d0)
          DO j=1,N1
            ccldot(i)=ccldot(i)+A(j,i)*b(j)
         ENDDO
      ENDDO
      RETURN
    END FUNCTION ccldot
    ...
    FUNCTION CYNi(i,n,A)
      ...
      COMPLEX(KIND(1d0)),DIMENSION(n,n),INTENT(IN)::A
      COMPLEX(KIND(1d0))::CYNi
      COMPLEX(KIND(1d0)),DIMENSION(n,n)::At
