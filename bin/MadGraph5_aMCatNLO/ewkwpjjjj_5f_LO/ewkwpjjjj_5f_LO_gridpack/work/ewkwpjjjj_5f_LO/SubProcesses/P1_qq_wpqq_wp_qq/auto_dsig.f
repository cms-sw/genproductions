...
C     Process: c d > w+ s d QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: u u~ > w+ d u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: c c~ > w+ s c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: u u~ > w+ d u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: c c~ > w+ s c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: u u~ > w+ s c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: c c~ > w+ d u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: u u~ > w+ s c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: c c~ > w+ d u~ QCD=0 QED<=4 / t t h @1
...
C     Process: c s~ > w+ c c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: u d~ > w+ c c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: c s~ > w+ u u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: u d~ > w+ c c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: c s~ > w+ u u~ QCD=0 QED<=4 / t t h @1
...
C     Process: c s~ > w+ s s~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: u d~ > w+ s s~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: c s~ > w+ d d~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: u d~ > w+ s s~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: c s~ > w+ d d~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: u d~ > w+ b b~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: c s~ > w+ b b~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: u d~ > w+ b b~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: c s~ > w+ b b~ QCD=0 QED<=4 / t t h @1
...
C     Process: c b~ > w+ s b~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: d d~ > w+ d u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: s s~ > w+ s c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: d d~ > w+ d u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: s s~ > w+ s c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: d d~ > w+ s c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: s s~ > w+ d u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: d d~ > w+ s c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: s s~ > w+ d u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: d s~ > w+ d c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: s d~ > w+ s u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: d s~ > w+ d c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: s d~ > w+ s u~ QCD=0 QED<=4 / t t h @1
...
C     Process: d~ s~ > w+ c~ d~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: d~ b > w+ b u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: s~ b > w+ b c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: d~ b > w+ b u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: s~ b > w+ b c~ QCD=0 QED<=4 / t t h @1
...
C     Process: s~ b~ > w+ c~ b~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: b b~ > w+ d u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: b b~ > w+ s c~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > u d~ WEIGHTED<=2
C     Process: b b~ > w+ d u~ QCD=0 QED<=4 / t t h @1
C     *   Decay: w+ > c s~ WEIGHTED<=2
C     Process: b b~ > w+ s c~ QCD=0 QED<=4 / t t h @1
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        ENDIF
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u > u d~ u d
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u u > c s~ u d
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! u c > u d~ u s
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! u c > c s~ u s
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u c > u d~ c d
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! u c > c s~ c d
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! u d > u d~ d d
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! u s > u d~ d s
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! u u~ > u d~ d u~
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! u u~ > u d~ s c~
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! u c~ > u d~ d c~
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! u d~ > u d~ u u~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! u d~ > c s~ u u~
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! u d~ > u d~ c c~
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! u d~ > c s~ c c~
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! u d~ > u d~ d d~
        IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! u d~ > c s~ d d~
        IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! u d~ > u d~ s s~
        IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! u d~ > c s~ s s~
        IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! u d~ > u d~ b b~
        IF(IPROC.EQ.21) DSIGPROC=DSIG21(P1,WGT,IMODE)  ! u s~ > u d~ u c~
        IF(IPROC.EQ.22) DSIGPROC=DSIG22(P1,WGT,IMODE)  ! u s~ > c s~ u c~
        IF(IPROC.EQ.23) DSIGPROC=DSIG23(P1,WGT,IMODE)  ! u s~ > u d~ d s~
        IF(IPROC.EQ.24) DSIGPROC=DSIG24(P1,WGT,IMODE)  ! u s~ > c s~ d s~
        IF(IPROC.EQ.25) DSIGPROC=DSIG25(P1,WGT,IMODE)  ! u b > u d~ d b
        IF(IPROC.EQ.26) DSIGPROC=DSIG26(P1,WGT,IMODE)  ! u b~ > u d~ d b~
        IF(IPROC.EQ.27) DSIGPROC=DSIG27(P1,WGT,IMODE)  ! d d~ > u d~ d u~
        IF(IPROC.EQ.28) DSIGPROC=DSIG28(P1,WGT,IMODE)  ! d d~ > u d~ s c~
        IF(IPROC.EQ.29) DSIGPROC=DSIG29(P1,WGT,IMODE)  ! d s~ > u d~ d c~
        IF(IPROC.EQ.30) DSIGPROC=DSIG30(P1,WGT,IMODE)  ! u~ d~ > u d~ u~ u~
        IF(IPROC.EQ.31) DSIGPROC=DSIG31(P1,WGT,IMODE)  ! u~ s~ > u d~ u~ c~
        IF(IPROC.EQ.32) DSIGPROC=DSIG32(P1,WGT,IMODE)  ! d~ d~ > u d~ u~ d~
        IF(IPROC.EQ.33) DSIGPROC=DSIG33(P1,WGT,IMODE)  ! d~ d~ > c s~ u~ d~
        IF(IPROC.EQ.34) DSIGPROC=DSIG34(P1,WGT,IMODE)  ! d~ s~ > u d~ u~ s~
        IF(IPROC.EQ.35) DSIGPROC=DSIG35(P1,WGT,IMODE)  ! d~ s~ > c s~ u~ s~
        IF(IPROC.EQ.36) DSIGPROC=DSIG36(P1,WGT,IMODE)  ! d~ s~ > u d~ c~ d~
        IF(IPROC.EQ.37) DSIGPROC=DSIG37(P1,WGT,IMODE)  ! d~ s~ > c s~ c~ d~
        IF(IPROC.EQ.38) DSIGPROC=DSIG38(P1,WGT,IMODE)  ! d~ b > u d~ b u~
        IF(IPROC.EQ.39) DSIGPROC=DSIG39(P1,WGT,IMODE)  ! d~ b~ > u d~ u~ b~
        IF(IPROC.EQ.40) DSIGPROC=DSIG40(P1,WGT,IMODE)  ! b b~ > u d~ d u~
      ENDIF
