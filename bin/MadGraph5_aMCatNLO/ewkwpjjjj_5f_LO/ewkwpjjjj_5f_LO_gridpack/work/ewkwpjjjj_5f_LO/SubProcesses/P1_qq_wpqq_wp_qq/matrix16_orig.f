...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV2_1(W(1,2),W(1,5),GC_100,ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 10
      CALL FFV2_0(W(1,3),W(1,4),W(1,6),GC_100,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,1),W(1,11),W(1,7),GC_2,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,1),W(1,11),W(1,8),-GC_50,GC_58,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,1),W(1,4),W(1,9),GC_2,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,1),W(1,4),W(1,10),-GC_50,GC_58,AMP(14))
