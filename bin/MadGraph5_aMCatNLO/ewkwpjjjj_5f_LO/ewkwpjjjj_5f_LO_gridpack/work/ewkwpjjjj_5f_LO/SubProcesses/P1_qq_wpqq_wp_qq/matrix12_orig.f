...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV1P0_3(W(1,3),W(1,4),GC_2,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,6),W(1,2),W(1,7),GC_1,AMP(1))
      CALL FFV2_5_3(W(1,3),W(1,4),-GC_50,GC_58,MDL_MZ, FK_MDL_WZ,W(1,8)
     $ )
...
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(1)+AMP(2)+AMP(10)+AMP(11)+AMP(12)+AMP(13)+AMP(14)
