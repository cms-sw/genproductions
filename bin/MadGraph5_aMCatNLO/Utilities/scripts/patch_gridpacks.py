...
##########################################
        ...
        # # else:
            # # with open("/afs/cern.ch/work/p/perrozzi/private/git/Hbb/validations/runcmsgrid_backup_5k_mergeFix.sh", 'r') as f:
                        # # content = f.read()
        ...
        if merge == "" or tmpdir == "":
            if merge == "":
                ...
                os.system("sed -e '/\.\/run\.sh\ / {' -e 'r /afs/cern.ch/work/p/perrozzi/private/git/Hbb/validations/runcmsgrid_backup_5k_mergeFix.sh' -e 'd' -e '}' -i runcmsgrid.sh")
            if tmpdir == "":
            ...
            print 'tarring to gridpack.tar.xz'; sys.stdout.flush()
