...
C     ----------
     ...
     $   //' called only with calculatedborn = true'
      ...
      REAL*8 FUNCTION B_SF_007(P,HELL)
C     
C     Generated by MadGraph5_aMC@NLO v. %(version)s, %(date)s
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
     ...
     $ *AMP(1)+(-1.000000000000000D+00)*AMP(3)
      JAMP2(1) = ((0.000000000000000D+00,1.666666666666667D-01))*AMP(1)
     $ +(-1.666666666666667D-01)*AMP(2)
      JAMP2(2) = ((0.000000000000000D+00,-1.666666666666667D-01))
     $ *AMP(1)+(-1.666666666666667D-01)*AMP(3)
      JAMP2(3) = (5.000000000000000D-01)*AMP(2)+(5.000000000000000D-01)
     $ *AMP(3)
      B_SF_007 = 0.D0
      DO I = 1, NCOLOR1
        ZTEMP = (0.D0,0.D0)
