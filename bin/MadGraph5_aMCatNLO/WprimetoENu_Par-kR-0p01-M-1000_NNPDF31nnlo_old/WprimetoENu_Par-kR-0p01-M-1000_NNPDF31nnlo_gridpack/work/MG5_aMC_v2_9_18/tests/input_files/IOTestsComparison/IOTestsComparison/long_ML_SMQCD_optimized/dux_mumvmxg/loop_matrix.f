...
C         Coefficient construction for loop diagram with ID 3
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,2),1,4,LOOPCOEFS(0,1),1,29,H)
C         Coefficient construction for loop diagram with ID 4
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,5),2,4,LOOPCOEFS(0,2),1,30,H)
C         Coefficient construction for loop diagram with ID 5
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,8),2,4,LOOPCOEFS(0,3),1,31,H)
C         Coefficient construction for loop diagram with ID 6
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,12),3,4,LOOPCOEFS(0,4),1,32
     $     ,H)
C         Coefficient construction for loop diagram with ID 7
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,14),2,4,LOOPCOEFS(0,5),1,33
     $     ,H)
C         Coefficient construction for loop diagram with ID 8
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,16),3,4,LOOPCOEFS(0,6),1,34
     $     ,H)
C         Coefficient construction for loop diagram with ID 9
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,18),3,4,LOOPCOEFS(0,7),1,35
     $     ,H)
C         Coefficient construction for loop diagram with ID 10
          ...
          CALL FFV1L1P0_3(PL(0,19),W(1,9),GC_5,ZERO,ZERO,PL(0,20)
     $     ,COEFS)
          CALL UPDATE_WL_2_0(WL(1,0,1,19),4,COEFS,4,4,WL(1,0,1,20))
          CALL CREATE_LOOP_COEFS(WL(1,0,1,20),2,4,LOOPCOEFS(0,8),1,36
     $     ,H)
C         Coefficient construction for loop diagram with ID 11
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,22),1,4,LOOPCOEFS(0,9),1,37
     $     ,H)
C         Coefficient construction for loop diagram with ID 12
     ...
     $     ,COEFS)
          ...
          CALL CREATE_LOOP_COEFS(WL(1,0,1,25),2,4,LOOPCOEFS(0,10),1,38
     $     ,H)
C         Coefficient construction for loop diagram with ID 13
          ...
          CALL FFV1L2P0_3(PL(0,26),W(1,10),GC_5,ZERO,ZERO,PL(0,27)
     $     ,COEFS)
          CALL UPDATE_WL_2_0(WL(1,0,1,26),4,COEFS,4,4,WL(1,0,1,27))
          CALL CREATE_LOOP_COEFS(WL(1,0,1,27),2,4,LOOPCOEFS(0,11),1,39
     $     ,H)
        ENDIF
      ENDDO

      CALL ADD_COEFS(LOOPCOEFS(0,5),2,LOOPCOEFS(0,8),2)
      CALL ADD_COEFS(LOOPCOEFS(0,10),2,LOOPCOEFS(0,11),2)
...
C     CutTools call for loop numbers 1
      CALL LOOP_2(1,6,9,DCMPLX(ZERO),DCMPLX(ZERO),1,LOOPRES(1,1),S(1)
     $ ,1)
C     CutTools call for loop numbers 2
      CALL LOOP_3(2,2,7,6,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,LOOPRES(1,2),S(2),2)
C     CutTools call for loop numbers 3
      CALL LOOP_3(3,1,7,8,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,LOOPRES(1,3),S(3),3)
C     CutTools call for loop numbers 4
      CALL LOOP_4(4,1,2,5,7,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,LOOPRES(1,4),S(4),4)
C     CutTools call for loop numbers 5,8
      CALL LOOP_3(5,1,5,9,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,LOOPRES(1,5),S(5),5)
C     CutTools call for loop numbers 6
      CALL LOOP_4(6,1,5,2,7,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,LOOPRES(1,6),S(6),6)
C     CutTools call for loop numbers 7
      CALL LOOP_4(7,1,2,7,5,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO)
     $ ,DCMPLX(ZERO),3,LOOPRES(1,7),S(7),7)
C     CutTools call for loop numbers 9
      CALL LOOP_2(9,8,10,DCMPLX(ZERO),DCMPLX(ZERO),1,LOOPRES(1,8),S(8)
     $ ,8)
C     CutTools call for loop numbers 10,11
      CALL LOOP_3(10,2,5,10,DCMPLX(ZERO),DCMPLX(ZERO),DCMPLX(ZERO),2
     $ ,LOOPRES(1,9),S(9),9)
