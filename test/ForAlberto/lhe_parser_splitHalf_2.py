...
if '__main__' == __name__:    
    #lhe = EventFile('output_events_LL_test.lhe')
    #output = open('output_events_LL_2.lhe', 'w')
    #lhe = EventFile('output_events_LT.lhe')
    #output = open('output_events_LT_2.lhe', 'w')
    lhe = EventFile('output_events_TT.lhe')
    output = open('output_events_TT_2.lhe', 'w')
