...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/PYTHIA6_BuToKstarJPsi_EtaPtFilter_TuneZ2_7TeV_cff.py,v $'),
	annotation = cms.untracked.string('Summer11: Pythia6+EvtGen generation of Bu --> K* J/Psi, 7TeV, D6T tune'))
