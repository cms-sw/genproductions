...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.147),
    crossSection = cms.untracked.double(22100.),
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('em-enriching filtered QCD pthat 170-250, 7 TeV')
)
