...
generator = cms.EDFilter(
    ...
    PythiaParameters = cms.PSet(
	    ...
	    'MSTP(51)=10042         ! choice of proton parton-distribution set',
            'MSTP(52)=2             ! choice of proton parton-distribution-function library',
            ...
            'MDME(860,1) = 0', 
            'MDME(998,1) = 3  !=3 decadimenti accesi solo per antipcella', 
            'MDME(999,1) = 3', 
            'MDME(1000,1) = 3', 
            'MDME(1001,1) = 3', 
            'MDME(1002,1) = 3', 
            ...
            'MDME(1026,1) = 3', 
            'MDME(1027,1) = 3', 
            'MDME(997,1) = 2        !  Bc -> pi J/Psi acceso solo per particella'),
        parameterSets = cms.vstring('pythiaUESettings', 
            'processParameters')
    )
)

bcfilter = cms.EDFilter(
    "PythiaFilter",
