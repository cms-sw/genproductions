...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.00058),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/QCD_Pt_30To50_bEnriched_TuneZ2star_7TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('b-enriched QCD Pt [30,50] at 7 TeV')
)
