...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/QCD_Pt_10to25_fwdJet_TuneD6T_7TeV_pythia6_cff.py,v $'),
	annotation = cms.untracked.string('LowPU2010 sample with PYTHIA6: QCD dijet production, fwd jet preselection, pThat = 10 .. 25 GeV, TuneD6T')
)
