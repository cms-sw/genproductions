...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	...
	productionParameters = cms.vstring(
                ...
                'set RS/Model:Lambda_pi 2313*GeV',
                'set /Herwig/Particles/Graviton:NominalMass 1250*GeV',
	),
)

configurationMetadata = cms.untracked.PSet(
	version = cms.untracked.string('\$Revision: 1.2 $'),
	name = cms.untracked.string('\$Source: /cvs/CMSSW/UserCode/hinzmann/production/RSGravitonToWW_kMpl01_M_1250_Tune23_7TeV_herwiggpp_cff.py,v $'),
