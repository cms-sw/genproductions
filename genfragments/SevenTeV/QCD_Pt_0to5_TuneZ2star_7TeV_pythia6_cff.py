...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(4.844495e+10),
	filterEfficiency = cms.untracked.double(0.982788),
...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/QCD_Pt_0to5_TuneZ2star_7TeV_pythia6_cff.py,v $'),
	annotation = cms.untracked.string('Summer2011 sample with PYTHIA6: QCD dijet production, pThat = 0 .. 5 GeV, TuneZ2star')
)
