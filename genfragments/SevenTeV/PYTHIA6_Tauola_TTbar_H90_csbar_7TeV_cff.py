...
configurationMetadata = cms.untracked.PSet(
        ...
        name = cms.untracked.string('$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/PYTHIA6_Tauola_TTbar_H90_csbar_7TeV_cff.py,v $'),
        annotation = cms.untracked.string('PYTHIA6-TTbar Hplus90 To CSbar')
        )
