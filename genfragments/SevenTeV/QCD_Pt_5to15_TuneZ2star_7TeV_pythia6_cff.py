...
generator = cms.EDFilter('Pythia6GeneratorFilter',
	...
	crossSection = cms.untracked.double(3.674572e+10),
...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/QCD_Pt_5to15_TuneZ2star_7TeV_pythia6_cff.py,v $'),
	annotation = cms.untracked.string('Summer2011 sample with PYTHIA6: QCD dijet production, pThat = 5 .. 15 GeV, TuneZ2star')
)
