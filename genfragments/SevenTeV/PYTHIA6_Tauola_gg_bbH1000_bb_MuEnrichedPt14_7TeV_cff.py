...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/PYTHIA6_Tauola_gg_bbH1000_bb_MuEnrichedPt14_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 - SUSY gg->bbH(1000)->bb MuEnriched w/ pT>=14. |eta|<=2.5, with Tauola at 7TeV')
    )
