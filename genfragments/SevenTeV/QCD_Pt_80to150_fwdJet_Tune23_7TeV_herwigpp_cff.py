...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	...
	productionParameters = cms.vstring(
		...
		'set /Herwig/Cuts/JetKtCut:MaxKT 150  *GeV',
...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('\$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/QCD_Pt_80to150_fwdJet_Tune23_7TeV_herwigpp_cff.py,v $'),
	annotation = cms.untracked.string('LowPU2010 sample with HERWIGPP: QCD dijet production, pThat = 80 .. 150 GeV, Tune23')
)
