...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/ZH_HToZZTo4L_M_150_TuneZ2star_8TeV_pythia6_tauola_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 ZH, H->ZZ->4l mH=150GeV with TAUOLA at 8TeV')
)
