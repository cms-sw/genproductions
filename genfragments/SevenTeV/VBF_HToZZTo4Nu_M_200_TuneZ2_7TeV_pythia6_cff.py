...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/VBF_HToZZTo4Nu_M_200_TuneZ2_7TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 VBF H, H->ZZ->4nu mH=200GeV at 7TeV')
)
