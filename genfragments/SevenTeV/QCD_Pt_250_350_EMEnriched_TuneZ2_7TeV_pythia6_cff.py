...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.127),
    crossSection = cms.untracked.double(2900),
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=1               ! QCD high pT processes',
                                        ...
                                        'CKIN(4)=350.          ! maximum pt hat for hard interactions'
                                        ),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/QCD_Pt_80_170_EMEnriched_TuneZ2_7TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('em-enriching filtered QCD pthat 80-170, 7 TeV')
)
