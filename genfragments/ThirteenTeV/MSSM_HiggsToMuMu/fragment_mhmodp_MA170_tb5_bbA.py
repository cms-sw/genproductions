...
BLOCK MASS
   ...
   2000005     1.00226018E+03   # MSf(2,4,3)
        25     1.15097086E+02   # Mh0
        35     1.78063754E+02   # MHH
        36     1.70000000E+02   # MA0
        37     1.87787474E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     9.19973945E-01   # Delta Mh0
        35     1.59486376E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.39069620E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -4.55692424E-01   # Alpha
BLOCK DALPHA
               1.10201194E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.91182981E-01   # UH(1,1)
     1   2     1.32500180E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.32500180E-01   # UH(2,1)
     2   2     9.91182981E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.18324319E-02   # Gamma(h0)
     5.87047131E-04   2        22        22   # BR(h0 -> photon photon)
     1.65574472E-04   2        22        23   # BR(h0 -> photon Z)
     2.17206005E-03   2        23        23   # BR(h0 -> Z Z)
     2.16596827E-02   2       -24        24   # BR(h0 -> W W)
     1.37657443E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.78064801E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.46088430E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.94361322E-02   2       -15        15   # BR(h0 -> Tau tau)
     5.34694053E-08   2        -2         2   # BR(h0 -> Up up)
     7.40521544E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.28716912E-06   2        -1         1   # BR(h0 -> Down down)
     3.23253391E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.54137854E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.05443214E-01   # Gamma(HH)
     2.10690651E-05   2        22        22   # BR(HH -> photon photon)
     1.08385005E-04   2        22        23   # BR(HH -> photon Z)
     1.63706987E-02   2        23        23   # BR(HH -> Z Z)
     3.39493442E-01   2       -24        24   # BR(HH -> W W)
     3.04563271E-03   2        21        21   # BR(HH -> gluon gluon)
     5.57483741E-09   2       -11        11   # BR(HH -> Electron electron)
     2.48005158E-04   2       -13        13   # BR(HH -> Muon muon)
     7.11436529E-02   2       -15        15   # BR(HH -> Tau tau)
     2.02039640E-09   2        -2         2   # BR(HH -> Up up)
     2.79875788E-04   2        -4         4   # BR(HH -> Charm charm)
     8.46466577E-07   2        -1         1   # BR(HH -> Down down)
     2.12579344E-04   2        -3         3   # BR(HH -> Strange strange)
     5.55906560E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.31689339E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     3.11475282E-07   2        23        36   # BR(HH -> Z A0)
DECAY        36     9.29401912E-02   # Gamma(A0)
    -9.02320874E-06   2        22        22   # BR(A0 -> photon photon)
    -6.96476051E-06   2        22        23   # BR(A0 -> photon Z)
    -4.36377297E-04   2        21        21   # BR(A0 -> gluon gluon)
    -7.16743382E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.18850306E-04   2       -13        13   # BR(A0 -> Muon muon)
    -9.15129586E-02   2       -15        15   # BR(A0 -> Tau tau)
    -4.13290184E-10   2        -2         2   # BR(A0 -> Up up)
    -5.75773404E-05   2        -4         4   # BR(A0 -> Charm charm)
    -1.09817995E-06   2        -1         1   # BR(A0 -> Down down)
    -2.75793815E-04   2        -3         3   # BR(A0 -> Strange strange)
    -7.23145573E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.83951583E-01   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -2.84193245E-04   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.87868143E-02   # Gamma(Hp)
     4.13583962E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.76819919E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     5.00075400E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     5.51314133E-06   2        -1         2   # BR(Hp -> Down up)
     6.19262763E-05   2        -3         2   # BR(Hp -> Strange up)
     3.85850277E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.38195252E-05   2        -1         4   # BR(Hp -> Down charm)
     1.68170283E-03   2        -3         4   # BR(Hp -> Strange charm)
     5.40319900E-03   2        -5         4   # BR(Hp -> Bottom charm)
     3.33033644E-05   2        -1         6   # BR(Hp -> Down top)
     7.26080601E-04   2        -3         6   # BR(Hp -> Strange top)
     4.79550619E-01   2        -5         6   # BR(Hp -> Bottom top)
     1.05214734E-02   2        24        25   # BR(Hp -> W h0)
     5.48675526E-06   2        24        35   # BR(Hp -> W HH)
     1.14650989E-04   2        24        36   # BR(Hp -> W A0)
