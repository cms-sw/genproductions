...
BLOCK MASS
   ...
   2000005     1.00173863E+03   # MSf(2,4,3)
        25     1.18864624E+02   # Mh0
        35     1.55518449E+02   # MHH
        36     1.50000000E+02   # MA0
        37     1.70083071E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.76044283E-01   # Delta Mh0
        35     1.03967149E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.32490116E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -4.48054082E-01   # Alpha
BLOCK DALPHA
               1.96643060E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.80858875E-01   # UH(1,1)
     1   2     1.94719972E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.94719972E-01   # UH(2,1)
     2   2     9.80858875E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     2.83547293E-02   # Gamma(h0)
     2.67872575E-04   2        22        22   # BR(h0 -> photon photon)
     9.98314960E-05   2        22        23   # BR(h0 -> photon Z)
     1.50873303E-03   2        23        23   # BR(h0 -> Z Z)
     1.40878547E-02   2       -24        24   # BR(h0 -> W W)
     5.61924513E-03   2        21        21   # BR(h0 -> gluon gluon)
     8.16566121E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.63217625E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.04062556E-01   2       -15        15   # BR(h0 -> Tau tau)
     2.25394548E-08   2        -2         2   # BR(h0 -> Up up)
     3.12176635E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.32806272E-06   2        -1         1   # BR(h0 -> Down down)
     3.33519579E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.70534045E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.49860032E-01   # Gamma(HH)
    -9.18491200E-06   2        22        22   # BR(HH -> photon photon)
    -4.21969802E-05   2        22        23   # BR(HH -> photon Z)
    -1.57074687E-03   2        23        23   # BR(HH -> Z Z)
    -1.91145545E-02   2       -24        24   # BR(HH -> W W)
    -2.40746694E-03   2        21        21   # BR(HH -> gluon gluon)
    -8.68148135E-09   2       -11        11   # BR(HH -> Electron electron)
     3.86193251E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.10446483E-01   2       -15        15   # BR(HH -> Tau tau)
    -1.20917944E-09   2        -2         2   # BR(HH -> Up up)
    -1.67548049E-04   2        -4         4   # BR(HH -> Charm charm)
    -1.33410368E-06   2        -1         1   # BR(HH -> Down down)
    -3.35037054E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.65519212E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -3.20372508E-08   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.71973341E-01   # Gamma(A0)
     1.55496195E-06   2        22        22   # BR(A0 -> photon photon)
     1.18904825E-06   2        22        23   # BR(A0 -> photon Z)
     5.49077787E-04   2        21        21   # BR(A0 -> gluon gluon)
     8.80161783E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.91534012E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.12054039E-01   2       -15        15   # BR(A0 -> Tau tau)
     7.82333770E-11   2        -2         2   # BR(A0 -> Up up)
     1.09543169E-05   2        -4         4   # BR(A0 -> Charm charm)
     1.36261998E-06   2        -1         1   # BR(A0 -> Down down)
     3.42198659E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.86633564E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     1.45160029E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     2.23018168E-02   # Gamma(Hp)
     8.07813346E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.45365110E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.76710347E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.08875464E-05   2        -1         2   # BR(Hp -> Down up)
     1.22018468E-04   2        -3         2   # BR(Hp -> Strange up)
     7.50781898E-05   2        -5         2   # BR(Hp -> Bottom up)
     4.59177456E-06   2        -1         4   # BR(Hp -> Down charm)
     2.81602707E-03   2        -3         4   # BR(Hp -> Strange charm)
     1.05125411E-02   2        -5         4   # BR(Hp -> Bottom charm)
     4.35519586E-03   2        -5         6   # BR(Hp -> Bottom top)
     1.73544103E-03   2        24        25   # BR(Hp -> W h0)
     3.21110312E-05   2        24        35   # BR(Hp -> W HH)
     1.72029325E-04   2        24        36   # BR(Hp -> W A0)
