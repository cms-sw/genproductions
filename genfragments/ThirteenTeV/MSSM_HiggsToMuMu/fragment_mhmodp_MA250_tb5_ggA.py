...
BLOCK MASS
   ...
   2000005     1.00226018E+03   # MSf(2,4,3)
        25     1.18529234E+02   # Mh0
        35     2.54153699E+02   # MHH
        36     2.50000000E+02   # MA0
        37     2.62586727E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     9.23031677E-01   # Delta Mh0
        35     8.60073803E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.16903388E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -2.87998683E-01   # Alpha
BLOCK DALPHA
               2.62750587E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99252248E-01   # UH(1,1)
     1   2     3.86645256E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -3.86645256E-02   # UH(2,1)
     2   2     9.99252248E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     5.64842768E-03   # Gamma(h0)
     1.39686190E-03   2        22        22   # BR(h0 -> photon photon)
     5.71694372E-04   2        22        23   # BR(h0 -> photon Z)
     7.97169253E-03   2        23        23   # BR(h0 -> Z Z)
     7.49106265E-02   2       -24        24   # BR(h0 -> W W)
     3.92105544E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.97875783E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.10422583E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.93005642E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.30694370E-07   2        -2         2   # BR(h0 -> Up up)
     1.81006791E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.15366145E-06   2        -1         1   # BR(h0 -> Down down)
     2.89725727E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.67935887E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.53959611E-01   # Gamma(HH)
     7.17941503E-06   2        22        22   # BR(HH -> photon photon)
     1.21884750E-05   2        22        23   # BR(HH -> photon Z)
     4.16461985E-02   2        23        23   # BR(HH -> Z Z)
     9.77730095E-02   2       -24        24   # BR(HH -> W W)
     1.62642669E-03   2        21        21   # BR(HH -> gluon gluon)
     3.73885501E-09   2       -11        11   # BR(HH -> Electron electron)
     1.66346425E-04   2       -13        13   # BR(HH -> Muon muon)
     4.77210772E-02   2       -15        15   # BR(HH -> Tau tau)
     4.58802322E-10   2        -2         2   # BR(HH -> Up up)
     6.34802418E-05   2        -4         4   # BR(HH -> Charm charm)
     5.36073673E-07   2        -1         1   # BR(HH -> Down down)
     1.34629433E-04   2        -3         3   # BR(HH -> Strange strange)
     3.51590468E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.13848185E-01   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     4.02047540E-02   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     5.18449559E-09   2        23        36   # BR(HH -> Z A0)
     3.05205511E-01   2        25        25   # BR(HH -> h0 h0)
DECAY        36     3.08106500E-01   # Gamma(A0)
    -1.89690306E-05   2        22        22   # BR(A0 -> photon photon)
    -2.71652051E-05   2        22        23   # BR(A0 -> photon Z)
    -5.40366543E-04   2        21        21   # BR(A0 -> gluon gluon)
    -3.16642163E-09   2       -11        11   # BR(A0 -> Electron electron)
     1.40877548E-04   2       -13        13   # BR(A0 -> Muon muon)
    -4.04159686E-02   2       -15        15   # BR(A0 -> Tau tau)
    -1.66884450E-10   2        -2         2   # BR(A0 -> Up up)
    -2.31697181E-05   2        -4         4   # BR(A0 -> Charm charm)
    -4.55209373E-07   2        -1         1   # BR(A0 -> Down down)
    -1.14321227E-04   2        -3         3   # BR(A0 -> Strange strange)
    -2.98884617E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -2.99465302E-01   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -3.38788340E-01   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -2.15804440E-02   2        23        25   # BR(A0 -> Z h0)
    -5.70283202E-37   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     3.58381359E-01   # Gamma(Hp)
     3.03163960E-09   2       -11        12   # BR(Hp -> Electron nu_e)
     1.29611997E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     3.66595709E-02   2       -15        16   # BR(Hp -> Tau nu_tau)
     3.82305178E-07   2        -1         2   # BR(Hp -> Down up)
     4.32187385E-06   2        -3         2   # BR(Hp -> Strange up)
     2.69416481E-06   2        -5         2   # BR(Hp -> Bottom up)
     9.64517389E-07   2        -1         4   # BR(Hp -> Down charm)
     1.16622259E-04   2        -3         4   # BR(Hp -> Strange charm)
     3.77291840E-04   2        -5         4   # BR(Hp -> Bottom charm)
     3.32667475E-05   2        -1         6   # BR(Hp -> Down top)
     7.25359100E-04   2        -3         6   # BR(Hp -> Strange top)
     5.97984122E-01   2        -5         6   # BR(Hp -> Bottom top)
     3.27403186E-01   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     3.65613177E-02   2        24        25   # BR(Hp -> W h0)
     1.54018045E-07   2        24        35   # BR(Hp -> W HH)
     1.13137117E-06   2        24        36   # BR(Hp -> W A0)
