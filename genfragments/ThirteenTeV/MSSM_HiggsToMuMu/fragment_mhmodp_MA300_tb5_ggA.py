...
BLOCK MASS
   ...
   2000005     1.00226018E+03   # MSf(2,4,3)
        25     1.19147282E+02   # Mh0
        35     3.03324193E+02   # MHH
        36     3.00000000E+02   # MA0
        37     3.10791737E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     9.06849915E-01   # Delta Mh0
        35     6.36110669E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.13519211E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -2.55935761E-01   # Alpha
BLOCK DALPHA
               1.49971236E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99723566E-01   # UH(1,1)
     1   2     2.35115214E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -2.35115214E-02   # UH(2,1)
     2   2     9.99723566E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     4.72988237E-03   # Gamma(h0)
     1.69697684E-03   2        22        22   # BR(h0 -> photon photon)
     7.33209118E-04   2        22        23   # BR(h0 -> photon Z)
     1.04329487E-02   2        23        23   # BR(h0 -> Z Z)
     9.68921477E-02   2       -24        24   # BR(h0 -> W W)
     4.92291652E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.65558094E-09   2       -11        11   # BR(h0 -> Electron electron)
     2.96047799E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.51998206E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.59529585E-07   2        -2         2   # BR(h0 -> Up up)
     2.20942990E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.10088540E-06   2        -1         1   # BR(h0 -> Down down)
     2.76471735E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.33147646E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     4.59838604E-01   # Gamma(HH)
     1.09012241E-05   2        22        22   # BR(HH -> photon photon)
     1.33118725E-05   2        22        23   # BR(HH -> photon Z)
     2.02005801E-02   2        23        23   # BR(HH -> Z Z)
     4.51625737E-02   2       -24        24   # BR(HH -> W W)
     1.37244162E-03   2        21        21   # BR(HH -> gluon gluon)
     2.49989440E-09   2       -11        11   # BR(HH -> Electron electron)
     1.11229398E-04   2       -13        13   # BR(HH -> Muon muon)
     3.18973653E-02   2       -15        15   # BR(HH -> Tau tau)
     2.29942146E-10   2        -2         2   # BR(HH -> Up up)
     3.18146729E-05   2        -4         4   # BR(HH -> Charm charm)
     3.48515545E-07   2        -1         1   # BR(HH -> Down down)
     8.75264568E-05   2        -3         3   # BR(HH -> Strange strange)
     2.28272096E-01   2        -5         5   # BR(HH -> Bottom bottom)
     9.24354070E-02   2  -1000024   1000024   # BR(HH -> Chargino1 chargino1)
     1.08368824E-01   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     1.01801830E-01   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     1.56241242E-01   2   1000022   1000025   # BR(HH -> neutralino1 neutralino3)
     3.04103949E-03   2   1000023   1000023   # BR(HH -> neutralino2 neutralino2)
     9.51822298E-10   2        23        36   # BR(HH -> Z A0)
     2.10951464E-01   2        25        25   # BR(HH -> h0 h0)
DECAY        36     9.41461453E-01   # Gamma(A0)
    -2.45152672E-05   2        22        22   # BR(A0 -> photon photon)
    -4.42319749E-05   2        22        23   # BR(A0 -> photon Z)
    -6.47056198E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.24163516E-09   2       -11        11   # BR(A0 -> Electron electron)
     5.52447100E-05   2       -13        13   # BR(A0 -> Muon muon)
    -1.58408760E-02   2       -15        15   # BR(A0 -> Tau tau)
    -6.20463679E-11   2        -2         2   # BR(A0 -> Up up)
    -8.61181233E-06   2        -4         4   # BR(A0 -> Charm charm)
    -1.73373082E-07   2        -1         1   # BR(A0 -> Down down)
    -4.35410532E-05   2        -3         3   # BR(A0 -> Strange strange)
    -1.13633998E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -4.64157994E-01   2  -1000024   1000024   # BR(A0 -> Chargino1 chargino1)
    -1.31133615E-01   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -2.22369426E-01   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -1.61809335E-03   2   1000022   1000025   # BR(A0 -> neutralino1 neutralino3)
    -3.88953581E-02   2   1000023   1000023   # BR(A0 -> neutralino2 neutralino2)
    -1.15272631E-02   2        23        25   # BR(A0 -> Z h0)
    -2.30939804E-35   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     6.33914303E-01   # Gamma(Hp)
     2.02856593E-09   2       -11        12   # BR(Hp -> Electron nu_e)
     8.67274942E-05   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.45307211E-02   2       -15        16   # BR(Hp -> Tau nu_tau)
     2.49014939E-07   2        -1         2   # BR(Hp -> Down up)
     2.82365409E-06   2        -3         2   # BR(Hp -> Strange up)
     1.76045905E-06   2        -5         2   # BR(Hp -> Bottom up)
     6.30166634E-07   2        -1         4   # BR(Hp -> Down charm)
     7.59631566E-05   2        -3         4   # BR(Hp -> Strange charm)
     2.46538926E-04   2        -5         4   # BR(Hp -> Bottom charm)
     3.23690152E-05   2        -1         6   # BR(Hp -> Down top)
     7.05788789E-04   2        -3         6   # BR(Hp -> Strange top)
     5.86863630E-01   2        -5         6   # BR(Hp -> Bottom top)
     3.19333805E-01   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     4.47048400E-02   2   1000023   1000024   # BR(Hp -> neutralino2 chargino1)
     2.34138019E-02   2        24        25   # BR(Hp -> W h0)
     4.81627263E-08   2        24        35   # BR(Hp -> W HH)
     3.01313225E-07   2        24        36   # BR(Hp -> W A0)
