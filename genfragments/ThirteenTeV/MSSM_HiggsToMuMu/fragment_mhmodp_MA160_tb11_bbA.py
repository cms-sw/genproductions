...
BLOCK MASS
   ...
   2000005     1.00257434E+03   # MSf(2,4,3)
        25     1.22119691E+02   # Mh0
        35     1.62605782E+02   # MHH
        36     1.60000000E+02   # MA0
        37     1.79224540E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.53062946E-01   # Delta Mh0
        35     4.57940087E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.02133773E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -2.93738846E-01   # Alpha
BLOCK DALPHA
               1.17666235E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.92678431E-01   # UH(1,1)
     1   2     1.20787134E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.20787134E-01   # UH(2,1)
     2   2     9.92678431E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     2.43858161E-02   # Gamma(h0)
     3.55023997E-04   2        22        22   # BR(h0 -> photon photon)
     1.78774759E-04   2        22        23   # BR(h0 -> photon Z)
     2.91584769E-03   2        23        23   # BR(h0 -> Z Z)
     2.55265817E-02   2       -24        24   # BR(h0 -> W W)
     8.21934526E-03   2        21        21   # BR(h0 -> gluon gluon)
     8.17115825E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.63465118E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.03946611E-01   2       -15        15   # BR(h0 -> Tau tau)
     2.99970543E-08   2        -2         2   # BR(h0 -> Up up)
     4.15477850E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.31328476E-06   2        -1         1   # BR(h0 -> Down down)
     3.29805876E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.54008414E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     3.24150975E-01   # Gamma(HH)
     2.54530250E-06   2        22        22   # BR(HH -> photon photon)
     1.40476630E-05   2        22        23   # BR(HH -> photon Z)
     5.36113290E-04   2        23        23   # BR(HH -> Z Z)
     2.00284970E-02   2       -24        24   # BR(HH -> W W)
     1.30374234E-03   2        21        21   # BR(HH -> gluon gluon)
     8.93548898E-09   2       -11        11   # BR(HH -> Electron electron)
     3.97498036E-04   2       -13        13   # BR(HH -> Muon muon)
     1.13367366E-01   2       -15        15   # BR(HH -> Tau tau)
     2.54126964E-10   2        -2         2   # BR(HH -> Up up)
     3.52319793E-05   2        -4         4   # BR(HH -> Charm charm)
     1.34781860E-06   2        -1         1   # BR(HH -> Down down)
     3.38477734E-04   2        -3         3   # BR(HH -> Strange strange)
     8.63975123E-01   2        -5         5   # BR(HH -> Bottom bottom)
     3.81655210E-10   2        23        36   # BR(HH -> Z A0)
DECAY        36     3.37464784E-01   # Gamma(A0)
    -7.04865547E-07   2        22        22   # BR(A0 -> photon photon)
    -7.98501363E-07   2        22        23   # BR(A0 -> photon Z)
    -5.92985592E-04   2        21        21   # BR(A0 -> gluon gluon)
    -9.08562120E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.04175461E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.15334255E-01   2       -15        15   # BR(A0 -> Tau tau)
    -2.17048991E-11   2        -2         2   # BR(A0 -> Up up)
    -3.04100752E-06   2        -4         4   # BR(A0 -> Charm charm)
    -1.37513114E-06   2        -1         1   # BR(A0 -> Down down)
    -3.45336968E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.83309512E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -7.80617727E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     4.47314671E-02   # Gamma(Hp)
     8.02379653E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.43042065E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.70161638E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.06465233E-05   2        -1         2   # BR(Hp -> Down up)
     1.19518486E-04   2        -3         2   # BR(Hp -> Strange up)
     7.26482434E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.60810814E-06   2        -1         4   # BR(Hp -> Down charm)
     2.68931552E-03   2        -3         4   # BR(Hp -> Strange charm)
     1.01723328E-02   2        -5         4   # BR(Hp -> Bottom charm)
     5.44213433E-07   2        -1         6   # BR(Hp -> Down top)
     1.18670047E-05   2        -3         6   # BR(Hp -> Strange top)
     1.25938247E-02   2        -5         6   # BR(Hp -> Bottom top)
     6.32749161E-04   2        24        25   # BR(Hp -> W h0)
     3.28692921E-05   2        24        35   # BR(Hp -> W HH)
     6.99367250E-05   2        24        36   # BR(Hp -> W A0)
