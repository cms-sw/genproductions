...
BLOCK MASS
   ...
   2000005     1.00594745E+03   # MSf(2,4,3)
        25     1.24537272E+02   # Mh0
        35     2.00549059E+02   # MHH
        36     2.00000000E+02   # MA0
        37     2.16560913E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.22177000E-01   # Delta Mh0
        35     1.22003789E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.94941121E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.04127801E-01   # Alpha
BLOCK DALPHA
               1.74453682E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99600134E-01   # UH(1,1)
     1   2     2.82767193E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -2.82767193E-02   # UH(2,1)
     2   2     9.99600134E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.11369762E-02   # Gamma(h0)
     8.30033949E-04   2        22        22   # BR(h0 -> photon photon)
     5.09911299E-04   2        22        23   # BR(h0 -> photon Z)
     9.06378985E-03   2        23        23   # BR(h0 -> Z Z)
     7.55663440E-02   2       -24        24   # BR(h0 -> W W)
     2.26812710E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.70215245E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.42605060E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.76689644E-02   2       -15        15   # BR(h0 -> Tau tau)
     7.15888036E-08   2        -2         2   # BR(h0 -> Up up)
     9.91573610E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.21987731E-06   2        -1         1   # BR(h0 -> Down down)
     3.06343909E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.83113701E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.29049285E+00   # Gamma(HH)
    -7.20089376E-07   2        22        22   # BR(HH -> photon photon)
    -3.85426499E-07   2        22        23   # BR(HH -> photon Z)
    -8.60524922E-04   2        23        23   # BR(HH -> Z Z)
    -2.43766325E-03   2       -24        24   # BR(HH -> W W)
    -6.25540064E-04   2        21        21   # BR(HH -> gluon gluon)
    -9.94501938E-09   2       -11        11   # BR(HH -> Electron electron)
     4.42435200E-04   2       -13        13   # BR(HH -> Muon muon)
    -1.25111330E-01   2       -15        15   # BR(HH -> Tau tau)
    -9.17250449E-12   2        -2         2   # BR(HH -> Up up)
    -1.26987264E-06   2        -4         4   # BR(HH -> Charm charm)
    -1.39968780E-06   2        -1         1   # BR(HH -> Down down)
    -3.51493552E-04   2        -3         3   # BR(HH -> Strange strange)
    -8.65400001E-01   2        -5         5   # BR(HH -> Bottom bottom)
    -4.76722776E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     1.31248017E+00   # Gamma(A0)
     2.78416417E-07   2        22        22   # BR(A0 -> photon photon)
     6.36427246E-07   2        22        23   # BR(A0 -> photon Z)
     4.88278989E-04   2        21        21   # BR(A0 -> gluon gluon)
     9.78136564E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.35154702E-04   2       -13        13   # BR(A0 -> Muon muon)
     1.23078491E-01   2       -15        15   # BR(A0 -> Tau tau)
     1.86047049E-12   2        -2         2   # BR(A0 -> Up up)
     2.60620257E-07   2        -4         4   # BR(A0 -> Charm charm)
     1.37729514E-06   2        -1         1   # BR(A0 -> Down down)
     3.45870374E-04   2        -3         3   # BR(A0 -> Strange strange)
     8.52351907E-01   2        -5         5   # BR(A0 -> Bottom bottom)
     2.32922488E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
     5.48619969E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     3.29017353E-01   # Gamma(Hp)
     4.35744051E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.86294070E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     5.26893165E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     5.49976242E-06   2        -1         2   # BR(Hp -> Down up)
     6.19693636E-05   2        -3         2   # BR(Hp -> Strange up)
     3.63389995E-05   2        -5         2   # BR(Hp -> Bottom up)
     3.01583813E-07   2        -1         4   # BR(Hp -> Down charm)
     1.37742331E-03   2        -3         4   # BR(Hp -> Strange charm)
     5.08840317E-03   2        -5         4   # BR(Hp -> Bottom charm)
     7.81551293E-07   2        -1         6   # BR(Hp -> Down top)
     1.72880282E-05   2        -3         6   # BR(Hp -> Strange top)
     4.63706114E-01   2        -5         6   # BR(Hp -> Bottom top)
     9.41068544E-04   2        24        25   # BR(Hp -> W h0)
     3.96566724E-06   2        24        35   # BR(Hp -> W HH)
     4.69652182E-06   2        24        36   # BR(Hp -> W A0)
