...
BLOCK MASS
   ...
   2000005     1.01129043E+03   # MSf(2,4,3)
        25     1.25102789E+02   # Mh0
        35     2.50228834E+02   # MHH
        36     2.50000000E+02   # MA0
        37     2.65069651E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.30484512E-01   # Delta Mh0
        35     6.30759334E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     2.14589048E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -4.62342608E-02   # Alpha
BLOCK DALPHA
               3.91947049E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99960105E-01   # UH(1,1)
     1   2     8.93244658E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -8.93244658E-03   # UH(2,1)
     2   2     9.99960105E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     7.23561814E-03   # Gamma(h0)
     1.28358298E-03   2        22        22   # BR(h0 -> photon photon)
     8.21888807E-04   2        22        23   # BR(h0 -> photon Z)
     1.50158890E-02   2        23        23   # BR(h0 -> Z Z)
     1.23790567E-01   2       -24        24   # BR(h0 -> W W)
     3.71999594E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.21311263E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.20852055E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.11131321E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.11354852E-07   2        -2         2   # BR(h0 -> Up up)
     1.54238448E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.12786875E-06   2        -1         1   # BR(h0 -> Down down)
     2.83233205E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.14745804E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     4.44159712E+00   # Gamma(HH)
     6.60744622E-07   2        22        22   # BR(HH -> photon photon)
     4.49151833E-07   2        22        23   # BR(HH -> photon Z)
     8.46647533E-05   2        23        23   # BR(HH -> Z Z)
     2.00085869E-04   2       -24        24   # BR(HH -> W W)
     4.20925469E-04   2        21        21   # BR(HH -> gluon gluon)
     1.13527727E-08   2       -11        11   # BR(HH -> Electron electron)
     5.05097144E-04   2       -13        13   # BR(HH -> Muon muon)
     1.40769101E-01   2       -15        15   # BR(HH -> Tau tau)
     5.74744169E-13   2        -2         2   # BR(HH -> Up up)
     7.95189193E-08   2        -4         4   # BR(HH -> Charm charm)
     1.45661742E-06   2        -1         1   # BR(HH -> Down down)
     3.65770994E-04   2        -3         3   # BR(HH -> Strange strange)
     8.51149383E-01   2        -5         5   # BR(HH -> Bottom bottom)
     5.50833884E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     9.63657476E-04   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     3.03184020E-05   2        25        25   # BR(HH -> h0 h0)
DECAY        36     4.51499118E+00   # Gamma(A0)
    -1.83595401E-07   2        22        22   # BR(A0 -> photon photon)
    -6.40128637E-07   2        22        23   # BR(A0 -> photon Z)
    -3.86436147E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.11445506E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.95833358E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.38185126E-01   2       -15        15   # BR(A0 -> Tau tau)
    -1.78189930E-13   2        -2         2   # BR(A0 -> Up up)
    -2.50274312E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.42980905E-06   2        -1         1   # BR(A0 -> Down down)
    -3.59039211E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.35921065E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.16147669E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -1.29919527E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -4.34907292E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     2.03843685E+00   # Gamma(Hp)
     2.63638625E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.12713691E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     3.18800934E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     3.12453151E-06   2        -1         2   # BR(Hp -> Down up)
     3.53380765E-05   2        -3         2   # BR(Hp -> Strange up)
     1.95646728E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.44228233E-07   2        -1         4   # BR(Hp -> Down charm)
     7.81900116E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.73962607E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.23875382E-07   2        -1         6   # BR(Hp -> Down top)
     3.06811707E-06   2        -3         6   # BR(Hp -> Strange top)
     6.31608696E-01   2        -5         6   # BR(Hp -> Bottom top)
     4.46534843E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     2.25896520E-04   2        24        25   # BR(Hp -> W h0)
     4.50027069E-07   2        24        35   # BR(Hp -> W HH)
     4.85609495E-07   2        24        36   # BR(Hp -> W A0)
