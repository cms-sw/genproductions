...
BLOCK MASS
   ...
   2000005     1.01459737E+03   # MSf(2,4,3)
        25     1.25262699E+02   # Mh0
        35     2.50157284E+02   # MHH
        36     2.50000000E+02   # MA0
        37     2.66412699E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.54375039E-01   # Delta Mh0
        35     9.22475645E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     4.01995409E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -3.66801345E-02   # Alpha
BLOCK DALPHA
               2.82278242E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99970695E-01   # UH(1,1)
     1   2     7.65570852E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -7.65570852E-03   # UH(2,1)
     2   2     9.99970695E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     7.33806062E-03   # Gamma(h0)
     1.27009794E-03   2        22        22   # BR(h0 -> photon photon)
     8.20804264E-04   2        22        23   # BR(h0 -> photon Z)
     1.51058289E-02   2        23        23   # BR(h0 -> Z Z)
     1.24139647E-01   2       -24        24   # BR(h0 -> W W)
     3.67881881E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.43194994E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.30586343E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.34389398E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.09965841E-07   2        -2         2   # BR(h0 -> Up up)
     1.52315007E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.14287581E-06   2        -1         1   # BR(h0 -> Down down)
     2.86996271E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.12586150E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     6.98057004E+00   # Gamma(HH)
     5.51342977E-07   2        22        22   # BR(HH -> photon photon)
     3.26492097E-07   2        22        23   # BR(HH -> photon Z)
     3.60354767E-05   2        23        23   # BR(HH -> Z Z)
     8.51723828E-05   2       -24        24   # BR(HH -> W W)
     4.06410843E-04   2        21        21   # BR(HH -> gluon gluon)
     1.21346984E-08   2       -11        11   # BR(HH -> Electron electron)
     5.39885998E-04   2       -13        13   # BR(HH -> Muon muon)
     1.49043917E-01   2       -15        15   # BR(HH -> Tau tau)
     2.19078183E-13   2        -2         2   # BR(HH -> Up up)
     3.03088782E-08   2        -4         4   # BR(HH -> Charm charm)
     1.49978760E-06   2        -1         1   # BR(HH -> Down down)
     3.76596839E-04   2        -3         3   # BR(HH -> Strange strange)
     8.45482793E-01   2        -5         5   # BR(HH -> Bottom bottom)
     3.45608454E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     5.70684717E-04   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
DECAY        36     7.05685959E+00   # Gamma(A0)
    -1.18153289E-07   2        22        22   # BR(A0 -> photon photon)
    -3.54550188E-07   2        22        23   # BR(A0 -> photon Z)
    -3.98789759E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.19949039E-08   2       -11        11   # BR(A0 -> Electron electron)
     5.33666700E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.47324396E-01   2       -15        15   # BR(A0 -> Tau tau)
    -6.18948465E-14   2        -2         2   # BR(A0 -> Up up)
    -8.73904871E-09   2        -4         4   # BR(A0 -> Charm charm)
    -1.48233308E-06   2        -1         1   # BR(A0 -> Down down)
    -3.72214070E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.36069330E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -7.25162841E-03   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -8.02948991E-03   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -1.85095321E-05   2        23        25   # BR(A0 -> Z h0)
DECAY        37     3.23782689E+00   # Gamma(Hp)
     2.75763339E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.17897383E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     3.33462858E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     3.20201058E-06   2        -1         2   # BR(Hp -> Down up)
     3.62162335E-05   2        -3         2   # BR(Hp -> Strange up)
     1.93286851E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.45617382E-07   2        -1         4   # BR(Hp -> Down charm)
     8.01207686E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.70658217E-03   2        -5         4   # BR(Hp -> Bottom charm)
     4.81396484E-08   2        -1         6   # BR(Hp -> Down top)
     1.43229187E-06   2        -3         6   # BR(Hp -> Strange top)
     6.33112590E-01   2        -5         6   # BR(Hp -> Bottom top)
     2.85778830E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     9.85920622E-05   2        24        25   # BR(Hp -> W h0)
     4.45001304E-07   2        24        35   # BR(Hp -> W HH)
     4.66836482E-07   2        24        36   # BR(Hp -> W A0)
