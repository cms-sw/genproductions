...
BLOCK MASS
   ...
   2000005     1.00482428E+03   # MSf(2,4,3)
        25     1.20801945E+02   # Mh0
        35     1.34240031E+02   # MHH
        36     1.30000000E+02   # MA0
        37     1.53728146E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     5.87417885E-01   # Delta Mh0
        35     1.24157441E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     6.28110956E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -6.03484314E-01   # Alpha
BLOCK DALPHA
               6.65209655E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.06196414E-01   # UH(1,1)
     1   2     4.22857020E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -4.22857020E-01   # UH(2,1)
     2   2     9.06196414E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     2.08552368E-01   # Gamma(h0)
     3.56451153E-05   2        22        22   # BR(h0 -> photon photon)
     1.30980684E-05   2        22        23   # BR(h0 -> photon Z)
     2.18014118E-04   2        23        23   # BR(h0 -> Z Z)
     1.95994207E-03   2       -24        24   # BR(h0 -> W W)
     7.66167893E-04   2        21        21   # BR(h0 -> gluon gluon)
     8.97796566E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.99351792E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.13346393E-01   2       -15        15   # BR(h0 -> Tau tau)
     2.53236539E-09   2        -2         2   # BR(h0 -> Up up)
     3.50748722E-04   2        -4         4   # BR(h0 -> Charm charm)
     1.40342713E-06   2        -1         1   # BR(h0 -> Down down)
     3.52431092E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.82556793E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     4.53488880E-01   # Gamma(HH)
     3.71941050E-06   2        22        22   # BR(HH -> photon photon)
     8.25181209E-06   2        22        23   # BR(HH -> photon Z)
     1.84603754E-04   2        23        23   # BR(HH -> Z Z)
     1.32094665E-03   2       -24        24   # BR(HH -> W W)
     1.76424533E-03   2        21        21   # BR(HH -> gluon gluon)
     9.26302142E-09   2       -11        11   # BR(HH -> Electron electron)
     4.12044629E-04   2       -13        13   # BR(HH -> Muon muon)
     1.16755646E-01   2       -15        15   # BR(HH -> Tau tau)
     6.20007112E-10   2        -2         2   # BR(HH -> Up up)
     8.58826140E-05   2        -4         4   # BR(HH -> Charm charm)
     1.40988163E-06   2        -1         1   # BR(HH -> Down down)
     3.54050638E-04   2        -3         3   # BR(HH -> Strange strange)
     8.79109187E-01   2        -5         5   # BR(HH -> Bottom bottom)
     2.31891720E-09   2        23        36   # BR(HH -> Z A0)
DECAY        36     6.56103831E-01   # Gamma(A0)
    -2.33541195E-07   2        22        22   # BR(A0 -> photon photon)
    -5.57507201E-08   2        22        23   # BR(A0 -> photon Z)
    -9.36918304E-04   2        21        21   # BR(A0 -> gluon gluon)
    -9.18368754E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.08512760E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.15888157E-01   2       -15        15   # BR(A0 -> Tau tau)
    -3.98557231E-12   2        -2         2   # BR(A0 -> Up up)
    -5.69021293E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.40896695E-06   2        -1         1   # BR(A0 -> Down down)
    -3.53821592E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.82410287E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -2.67231147E-08   2        23        25   # BR(A0 -> Z h0)
DECAY        37     9.04267022E-02   # Gamma(Hp)
     8.13138910E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47641892E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.83101270E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.09560226E-05   2        -1         2   # BR(Hp -> Down up)
     1.22502924E-04   2        -3         2   # BR(Hp -> Strange up)
     7.26468440E-05   2        -5         2   # BR(Hp -> Bottom up)
     6.93881753E-07   2        -1         4   # BR(Hp -> Down charm)
     2.74597898E-03   2        -3         4   # BR(Hp -> Strange charm)
     1.01717344E-02   2        -5         4   # BR(Hp -> Bottom charm)
     5.54521203E-05   2        -5         6   # BR(Hp -> Bottom top)
     1.22592188E-04   2        24        25   # BR(Hp -> W h0)
     2.62693379E-05   2        24        35   # BR(Hp -> W HH)
     9.34035288E-05   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.37671319E+00   # Gamma(top)
     9.96050117E-01   2         5        24   # BR(top -> bottom W)
     3.94988250E-03   2         5        37   # BR(top -> bottom Hp)
"""
