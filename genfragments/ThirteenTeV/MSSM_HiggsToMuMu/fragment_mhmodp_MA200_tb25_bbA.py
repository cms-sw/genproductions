...
BLOCK MASS
   ...
   2000005     1.00778084E+03   # MSf(2,4,3)
        25     1.24784100E+02   # Mh0
        35     2.00394773E+02   # MHH
        36     2.00000000E+02   # MA0
        37     2.17160627E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.22157289E-01   # Delta Mh0
        35     9.46957475E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     9.29750630E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -8.47515437E-02   # Alpha
BLOCK DALPHA
               1.36737705E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99712964E-01   # UH(1,1)
     1   2     2.39580986E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -2.39580986E-02   # UH(2,1)
     2   2     9.99712964E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.13473188E-02   # Gamma(h0)
     8.18777780E-04   2        22        22   # BR(h0 -> photon photon)
     5.10910269E-04   2        22        23   # BR(h0 -> photon Z)
     9.18490817E-03   2        23        23   # BR(h0 -> Z Z)
     7.62002299E-02   2       -24        24   # BR(h0 -> W W)
     2.24215523E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.85760400E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.49520002E-04   2       -13        13   # BR(h0 -> Muon muon)
     9.93497953E-02   2       -15        15   # BR(h0 -> Tau tau)
     7.05660583E-08   2        -2         2   # BR(h0 -> Up up)
     9.77411272E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.23077887E-06   2        -1         1   # BR(h0 -> Down down)
     3.09077650E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.81079807E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.96113135E+00   # Gamma(HH)
     6.18539420E-07   2        22        22   # BR(HH -> photon photon)
     2.25997818E-07   2        22        23   # BR(HH -> photon Z)
     3.84921363E-04   2        23        23   # BR(HH -> Z Z)
     1.09206169E-03   2       -24        24   # BR(HH -> W W)
     5.86488392E-04   2        21        21   # BR(HH -> gluon gluon)
     1.03289282E-08   2       -11        11   # BR(HH -> Electron electron)
     4.59514499E-04   2       -13        13   # BR(HH -> Muon muon)
     1.29314060E-01   2       -15        15   # BR(HH -> Tau tau)
     3.92728881E-12   2        -2         2   # BR(HH -> Up up)
     5.43709712E-07   2        -4         4   # BR(HH -> Charm charm)
     1.42659554E-06   2        -1         1   # BR(HH -> Down down)
     3.58243281E-04   2        -3         3   # BR(HH -> Strange strange)
     8.64798771E-01   2        -5         5   # BR(HH -> Bottom bottom)
     3.00311536E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     1.98162914E+00   # Gamma(A0)
    -1.74622166E-07   2        22        22   # BR(A0 -> photon photon)
    -3.68756443E-07   2        22        23   # BR(A0 -> photon Z)
    -5.16321898E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.02122642E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.54324600E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.27879572E-01   2       -15        15   # BR(A0 -> Tau tau)
    -7.59915384E-13   2        -2         2   # BR(A0 -> Up up)
    -1.06736432E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.41091493E-06   2        -1         1   # BR(A0 -> Down down)
    -3.54305720E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.56053905E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.47370648E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -2.43494358E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     5.11388019E-01   # Gamma(Hp)
     4.39259093E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.87796860E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     5.31143880E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     5.48644632E-06   2        -1         2   # BR(Hp -> Down up)
     6.18213929E-05   2        -3         2   # BR(Hp -> Strange up)
     3.55481974E-05   2        -5         2   # BR(Hp -> Bottom up)
     2.68880479E-07   2        -1         4   # BR(Hp -> Down charm)
     1.37335063E-03   2        -3         4   # BR(Hp -> Strange charm)
     4.97767174E-03   2        -5         4   # BR(Hp -> Bottom charm)
     3.28949518E-07   2        -1         6   # BR(Hp -> Down top)
     7.42713453E-06   2        -3         6   # BR(Hp -> Strange top)
     4.60075513E-01   2        -5         6   # BR(Hp -> Bottom top)
     4.33883612E-04   2        24        25   # BR(Hp -> W h0)
     3.20515767E-06   2        24        35   # BR(Hp -> W HH)
     3.60198430E-06   2        24        36   # BR(Hp -> W A0)
