...
BLOCK MASS
   ...
   2000005     1.00173863E+03   # MSf(2,4,3)
        25     1.17190560E+02   # Mh0
        35     1.47235446E+02   # MHH
        36     1.40000000E+02   # MA0
        37     1.61311964E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.34983775E-01   # Delta Mh0
        35     1.31469630E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.41214972E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -5.58400082E-01   # Alpha
BLOCK DALPHA
               2.88864952E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.61623403E-01   # UH(1,1)
     1   2     2.74372795E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -2.74372795E-01   # UH(2,1)
     2   2     9.61623403E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     4.14067493E-02   # Gamma(h0)
     1.65057995E-04   2        22        22   # BR(h0 -> photon photon)
     4.87047298E-05   2        22        23   # BR(h0 -> photon Z)
     7.45131434E-04   2        23        23   # BR(h0 -> Z Z)
     7.17587723E-03   2       -24        24   # BR(h0 -> W W)
     3.09590226E-03   2        21        21   # BR(h0 -> gluon gluon)
     8.27087908E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.67896254E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.05354229E-01   2       -15        15   # BR(h0 -> Tau tau)
     1.34998714E-08   2        -2         2   # BR(h0 -> Up up)
     1.86974974E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.34632614E-06   2        -1         1   # BR(h0 -> Down down)
     3.38105330E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.80837978E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.25711725E-01   # Gamma(HH)
     1.50703363E-05   2        22        22   # BR(HH -> photon photon)
     5.31231526E-05   2        22        23   # BR(HH -> photon Z)
     1.56813124E-03   2        23        23   # BR(HH -> Z Z)
     1.25708910E-02   2       -24        24   # BR(HH -> W W)
     3.09588447E-03   2        21        21   # BR(HH -> gluon gluon)
     8.66757956E-09   2       -11        11   # BR(HH -> Electron electron)
     3.85568470E-04   2       -13        13   # BR(HH -> Muon muon)
     1.10246173E-01   2       -15        15   # BR(HH -> Tau tau)
     2.07539578E-09   2        -2         2   # BR(HH -> Up up)
     2.87513203E-04   2        -4         4   # BR(HH -> Charm charm)
     1.34401590E-06   2        -1         1   # BR(HH -> Down down)
     3.37525409E-04   2        -3         3   # BR(HH -> Strange strange)
     8.71438632E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.32896474E-07   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.62398946E-01   # Gamma(A0)
    -1.23726258E-06   2        22        22   # BR(A0 -> photon photon)
    -7.35517191E-07   2        22        23   # BR(A0 -> photon Z)
    -6.29152097E-04   2        21        21   # BR(A0 -> gluon gluon)
    -8.70509330E-09   2       -11        11   # BR(A0 -> Electron electron)
     3.87232237E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.10821959E-01   2       -15        15   # BR(A0 -> Tau tau)
    -7.89727466E-11   2        -2         2   # BR(A0 -> Up up)
    -1.10862092E-05   2        -4         4   # BR(A0 -> Charm charm)
    -1.36408238E-06   2        -1         1   # BR(A0 -> Down down)
    -3.42565006E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.87798739E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -5.92054778E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     2.10995638E-02   # Gamma(Hp)
     8.09810272E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.46218827E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.79100908E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.10170508E-05   2        -1         2   # BR(Hp -> Down up)
     1.23320339E-04   2        -3         2   # BR(Hp -> Strange up)
     7.58690919E-05   2        -5         2   # BR(Hp -> Bottom up)
     4.64070718E-06   2        -1         4   # BR(Hp -> Down charm)
     2.84948539E-03   2        -3         4   # BR(Hp -> Strange charm)
     1.06231450E-02   2        -5         4   # BR(Hp -> Bottom charm)
     2.00793989E-03   2        -5         6   # BR(Hp -> Bottom top)
     1.47500684E-03   2        24        25   # BR(Hp -> W h0)
     2.61110982E-05   2        24        35   # BR(Hp -> W HH)
     2.40287623E-04   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.37242658E+00   # Gamma(top)
     9.99161159E-01   2         5        24   # BR(top -> bottom W)
     8.38840837E-04   2         5        37   # BR(top -> bottom Hp)
"""
