...
BLOCK MASS
   ...
   2000005     1.00778084E+03   # MSf(2,4,3)
        25     1.24875797E+02   # Mh0
        35     2.50334973E+02   # MHH
        36     2.50000000E+02   # MA0
        37     2.63948159E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.19311526E-01   # Delta Mh0
        35     7.13771593E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     6.73674398E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -6.33791851E-02   # Alpha
BLOCK DALPHA
               5.68395133E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99937182E-01   # UH(1,1)
     1   2     1.12085638E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -1.12085638E-02   # UH(2,1)
     2   2     9.99937182E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     7.11121209E-03   # Gamma(h0)
     1.30082724E-03   2        22        22   # BR(h0 -> photon photon)
     8.21644813E-04   2        22        23   # BR(h0 -> photon Z)
     1.48474663E-02   2        23        23   # BR(h0 -> Z Z)
     1.22953884E-01   2       -24        24   # BR(h0 -> W W)
     3.76600799E-02   2        21        21   # BR(h0 -> gluon gluon)
     7.00662451E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.11666999E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.89061696E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.13013723E-07   2        -2         2   # BR(h0 -> Up up)
     1.56535510E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.11348789E-06   2        -1         1   # BR(h0 -> Down down)
     2.79627144E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.17263850E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.39672294E+00   # Gamma(HH)
     9.01559008E-07   2        22        22   # BR(HH -> photon photon)
     7.18441860E-07   2        22        23   # BR(HH -> photon Z)
     2.75659503E-04   2        23        23   # BR(HH -> Z Z)
     6.51336897E-04   2       -24        24   # BR(HH -> W W)
     4.51803135E-04   2        21        21   # BR(HH -> gluon gluon)
     1.05517816E-08   2       -11        11   # BR(HH -> Electron electron)
     4.69460167E-04   2       -13        13   # BR(HH -> Muon muon)
     1.32099690E-01   2       -15        15   # BR(HH -> Tau tau)
     2.09905062E-12   2        -2         2   # BR(HH -> Up up)
     2.90424572E-07   2        -4         4   # BR(HH -> Charm charm)
     1.40585943E-06   2        -1         1   # BR(HH -> Down down)
     3.53039126E-04   2        -3         3   # BR(HH -> Strange strange)
     8.52771081E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.04485918E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     1.99858910E-03   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     4.77422937E-04   2        25        25   # BR(HH -> h0 h0)
DECAY        36     2.47568229E+00   # Gamma(A0)
    -4.36201253E-07   2        22        22   # BR(A0 -> photon photon)
    -1.38040983E-06   2        22        23   # BR(A0 -> photon Z)
    -3.53124040E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.01888546E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.53313299E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.27554584E-01   2       -15        15   # BR(A0 -> Tau tau)
    -7.00894680E-13   2        -2         2   # BR(A0 -> Up up)
    -9.80156308E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.35753379E-06   2        -1         1   # BR(A0 -> Down down)
    -3.40903668E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.23910676E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -2.21228733E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -2.51208043E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -1.40439651E-04   2        23        25   # BR(A0 -> Z h0)
    -1.83433946E-38   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     1.11510098E+00   # Gamma(Hp)
     2.44846930E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.04679658E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.96077140E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     2.96202040E-06   2        -1         2   # BR(Hp -> Down up)
     3.34988293E-05   2        -3         2   # BR(Hp -> Strange up)
     1.92668799E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.45700127E-07   2        -1         4   # BR(Hp -> Down charm)
     7.41460923E-04   2        -3         4   # BR(Hp -> Strange charm)
     2.69792541E-03   2        -5         4   # BR(Hp -> Bottom charm)
     4.36459293E-07   2        -1         6   # BR(Hp -> Down top)
     9.85848327E-06   2        -3         6   # BR(Hp -> Strange top)
     6.16892651E-01   2        -5         6   # BR(Hp -> Bottom top)
     8.17718155E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     7.04875712E-04   2        24        25   # BR(Hp -> W h0)
     5.36086796E-07   2        24        35   # BR(Hp -> W HH)
     6.05013565E-07   2        24        36   # BR(Hp -> W A0)
