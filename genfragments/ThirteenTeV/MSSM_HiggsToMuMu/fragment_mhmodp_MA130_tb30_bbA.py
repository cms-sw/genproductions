...
BLOCK MASS
   ...
   2000005     1.00956179E+03   # MSf(2,4,3)
        25     1.23184755E+02   # Mh0
        35     1.32098330E+02   # MHH
        36     1.30000000E+02   # MA0
        37     1.56147281E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     6.17227271E-01   # Delta Mh0
        35     1.05172253E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     2.23291305E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -4.83891293E-01   # Alpha
BLOCK DALPHA
               8.12721363E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.26006333E-01   # UH(1,1)
     1   2     3.77507975E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -3.77507975E-01   # UH(2,1)
     2   2     9.26006333E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     4.40823205E-01   # Gamma(h0)
     2.06378685E-05   2        22        22   # BR(h0 -> photon photon)
     9.30764255E-06   2        22        23   # BR(h0 -> photon Z)
     1.56588487E-04   2        23        23   # BR(h0 -> Z Z)
     1.34156083E-03   2       -24        24   # BR(h0 -> W W)
     5.90293126E-04   2        21        21   # BR(h0 -> gluon gluon)
     9.86675292E-09   2       -11        11   # BR(h0 -> Electron electron)
     4.38888871E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.23050467E-01   2       -15        15   # BR(h0 -> Tau tau)
     1.38468668E-09   2        -2         2   # BR(h0 -> Up up)
     1.91791487E-04   2        -4         4   # BR(h0 -> Charm charm)
     1.46491217E-06   2        -1         1   # BR(h0 -> Down down)
     3.67850696E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.73831138E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.47341671E+00   # Gamma(HH)
     5.47508123E-07   2        22        22   # BR(HH -> photon photon)
     1.25849843E-06   2        22        23   # BR(HH -> photon Z)
     3.17970569E-05   2        23        23   # BR(HH -> Z Z)
     2.32868860E-04   2       -24        24   # BR(HH -> W W)
     1.23733767E-03   2        21        21   # BR(HH -> gluon gluon)
     1.01433288E-08   2       -11        11   # BR(HH -> Electron electron)
     4.51201001E-04   2       -13        13   # BR(HH -> Muon muon)
     1.26263668E-01   2       -15        15   # BR(HH -> Tau tau)
     1.34974246E-10   2        -2         2   # BR(HH -> Up up)
     1.86963786E-05   2        -4         4   # BR(HH -> Charm charm)
     1.47443620E-06   2        -1         1   # BR(HH -> Down down)
     3.70240075E-04   2        -3         3   # BR(HH -> Strange strange)
     8.71390901E-01   2        -5         5   # BR(HH -> Bottom bottom)
     2.40161904E-11   2        23        36   # BR(HH -> Z A0)
DECAY        36     1.90623197E+00   # Gamma(A0)
    -2.80974783E-07   2        22        22   # BR(A0 -> photon photon)
    -1.07276922E-08   2        22        23   # BR(A0 -> photon Z)
    -9.84190683E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.00722077E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.48036369E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.25511901E-01   2       -15        15   # BR(A0 -> Tau tau)
    -4.18641802E-13   2        -2         2   # BR(A0 -> Up up)
    -6.09186006E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.47095106E-06   2        -1         1   # BR(A0 -> Down down)
    -3.69365652E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.72684671E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.48890111E-09   2        23        25   # BR(A0 -> Z h0)
DECAY        37     2.85737339E-01   # Gamma(Hp)
     8.13992013E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.48006630E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.84140776E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.06565518E-05   2        -1         2   # BR(Hp -> Down up)
     1.19191723E-04   2        -3         2   # BR(Hp -> Strange up)
     6.71847386E-05   2        -5         2   # BR(Hp -> Bottom up)
     4.96056109E-07   2        -1         4   # BR(Hp -> Down charm)
     2.66678625E-03   2        -3         4   # BR(Hp -> Strange charm)
     9.40699090E-03   2        -5         4   # BR(Hp -> Bottom charm)
     6.86536689E-06   2        -5         6   # BR(Hp -> Bottom top)
     2.77073694E-05   2        24        25   # BR(Hp -> W h0)
     2.56687884E-05   2        24        35   # BR(Hp -> W HH)
     4.75284614E-05   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.38232096E+00   # Gamma(top)
     9.92009363E-01   2         5        24   # BR(top -> bottom W)
     7.99063665E-03   2         5        37   # BR(top -> bottom Hp)
"""
