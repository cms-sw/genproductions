...
BLOCK MASS
   ...
   2000005     1.00956179E+03   # MSf(2,4,3)
        25     1.24942583E+02   # Mh0
        35     2.00306013E+02   # MHH
        36     2.00000000E+02   # MA0
        37     2.17853587E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.26940049E-01   # Delta Mh0
        35     8.06159595E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.79844524E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -7.17315735E-02   # Alpha
BLOCK DALPHA
               1.12114260E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99779073E-01   # UH(1,1)
     1   2     2.10191400E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -2.10191400E-02   # UH(2,1)
     2   2     9.99779073E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.15126311E-02   # Gamma(h0)
     8.09610642E-04   2        22        22   # BR(h0 -> photon photon)
     5.10169345E-04   2        22        23   # BR(h0 -> photon Z)
     9.23955319E-03   2        23        23   # BR(h0 -> Z Z)
     7.64126427E-02   2       -24        24   # BR(h0 -> W W)
     2.21892418E-02   2        21        21   # BR(h0 -> gluon gluon)
     8.01946790E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.56720099E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.01096754E-01   2       -15        15   # BR(h0 -> Tau tau)
     6.97299488E-08   2        -2         2   # BR(h0 -> Up up)
     9.65832812E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.24226862E-06   2        -1         1   # BR(h0 -> Down down)
     3.11958988E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.79413702E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.75036335E+00   # Gamma(HH)
     5.60951352E-07   2        22        22   # BR(HH -> photon photon)
     1.66043723E-07   2        22        23   # BR(HH -> photon Z)
     2.01423082E-04   2        23        23   # BR(HH -> Z Z)
     5.71968969E-04   2       -24        24   # BR(HH -> W W)
     5.64955693E-04   2        21        21   # BR(HH -> gluon gluon)
     1.07014690E-08   2       -11        11   # BR(HH -> Electron electron)
     4.76088113E-04   2       -13        13   # BR(HH -> Muon muon)
     1.33334986E-01   2       -15        15   # BR(HH -> Tau tau)
     1.97133508E-12   2        -2         2   # BR(HH -> Up up)
     2.72919246E-07   2        -4         4   # BR(HH -> Charm charm)
     1.45048720E-06   2        -1         1   # BR(HH -> Down down)
     3.64235386E-04   2        -3         3   # BR(HH -> Strange strange)
     8.62405832E-01   2        -5         5   # BR(HH -> Bottom bottom)
     2.07804969E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     2.77022237E+00   # Gamma(A0)
    -1.41484645E-07   2        22        22   # BR(A0 -> photon photon)
    -2.33319304E-07   2        22        23   # BR(A0 -> photon Z)
    -5.31279000E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.06125655E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.72133299E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.32253660E-01   2       -15        15   # BR(A0 -> Tau tau)
    -3.63228324E-13   2        -2         2   # BR(A0 -> Up up)
    -5.11637783E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.43874263E-06   2        -1         1   # BR(A0 -> Down down)
    -3.61286297E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.56157914E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -1.02205859E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -1.26614987E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     7.35876308E-01   # Gamma(Hp)
     4.40973619E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.88529874E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     5.33217506E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     5.45045195E-06   2        -1         2   # BR(Hp -> Down up)
     6.14183331E-05   2        -3         2   # BR(Hp -> Strange up)
     3.46435466E-05   2        -5         2   # BR(Hp -> Bottom up)
     2.55629682E-07   2        -1         4   # BR(Hp -> Down charm)
     1.36405814E-03   2        -3         4   # BR(Hp -> Strange charm)
     4.85099918E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.62760844E-07   2        -1         6   # BR(Hp -> Down top)
     3.80934334E-06   2        -3         6   # BR(Hp -> Strange top)
     4.58332837E-01   2        -5         6   # BR(Hp -> Bottom top)
     2.37681492E-04   2        24        25   # BR(Hp -> W h0)
     2.79095469E-06   2        24        35   # BR(Hp -> W HH)
     3.04369439E-06   2        24        36   # BR(Hp -> W A0)
