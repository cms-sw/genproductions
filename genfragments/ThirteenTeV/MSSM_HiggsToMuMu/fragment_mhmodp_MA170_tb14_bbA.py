...
BLOCK MASS
   ...
   2000005     1.00369029E+03   # MSf(2,4,3)
        25     1.23475858E+02   # Mh0
        35     1.71425955E+02   # MHH
        36     1.70000000E+02   # MA0
        37     1.88498126E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.37559351E-01   # Delta Mh0
        35     2.24425532E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     7.08551814E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -2.02430672E-01   # Alpha
BLOCK DALPHA
               6.53787466E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.97156030E-01   # UH(1,1)
     1   2     7.53647867E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -7.53647867E-02   # UH(2,1)
     2   2     9.97156030E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.93191346E-02   # Gamma(h0)
     4.68518389E-04   2        22        22   # BR(h0 -> photon photon)
     2.64098754E-04   2        22        23   # BR(h0 -> photon Z)
     4.49960046E-03   2        23        23   # BR(h0 -> Z Z)
     3.83235327E-02   2       -24        24   # BR(h0 -> W W)
     1.16021162E-02   2        21        21   # BR(h0 -> gluon gluon)
     8.10918746E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.60709761E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.03001510E-01   2       -15        15   # BR(h0 -> Tau tau)
     3.98785913E-08   2        -2         2   # BR(h0 -> Up up)
     5.52350457E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.29336900E-06   2        -1         1   # BR(h0 -> Down down)
     3.24802218E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.35630265E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     5.59175768E-01   # Gamma(HH)
     8.06632610E-07   2        22        22   # BR(HH -> photon photon)
     3.37920811E-06   2        22        23   # BR(HH -> photon Z)
     3.15234238E-04   2        23        23   # BR(HH -> Z Z)
     1.22562176E-02   2       -24        24   # BR(HH -> W W)
     9.51945011E-04   2        21        21   # BR(HH -> gluon gluon)
     9.27636538E-09   2       -11        11   # BR(HH -> Electron electron)
     4.12668588E-04   2       -13        13   # BR(HH -> Muon muon)
     1.17363012E-01   2       -15        15   # BR(HH -> Tau tau)
     7.27092539E-11   2        -2         2   # BR(HH -> Up up)
     1.00753976E-05   2        -4         4   # BR(HH -> Charm charm)
     1.37121893E-06   2        -1         1   # BR(HH -> Down down)
     3.44350655E-04   2        -3         3   # BR(HH -> Strange strange)
     8.68340930E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.12505576E-11   2        23        36   # BR(HH -> Z A0)
DECAY        36     5.65748660E-01   # Gamma(A0)
    -4.25223684E-07   2        22        22   # BR(A0 -> photon photon)
    -6.26270456E-07   2        22        23   # BR(A0 -> photon Z)
    -5.96167314E-04   2        21        21   # BR(A0 -> gluon gluon)
    -9.37001757E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.16834409E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.18597312E-01   2       -15        15   # BR(A0 -> Tau tau)
    -8.19064612E-12   2        -2         2   # BR(A0 -> Up up)
    -1.14813663E-06   2        -4         4   # BR(A0 -> Charm charm)
    -1.38749483E-06   2        -1         1   # BR(A0 -> Down down)
    -3.48438182E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.80032221E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -5.43123479E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     8.68597477E-02   # Gamma(Hp)
     7.03970971E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.00969336E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     8.51191225E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     9.20492405E-06   2        -1         2   # BR(Hp -> Down up)
     1.03438964E-04   2        -3         2   # BR(Hp -> Strange up)
     6.21177359E-05   2        -5         2   # BR(Hp -> Bottom up)
     7.87740362E-07   2        -1         4   # BR(Hp -> Down charm)
     2.31171914E-03   2        -3         4   # BR(Hp -> Strange charm)
     8.69790426E-03   2        -5         4   # BR(Hp -> Bottom charm)
     1.00246602E-06   2        -1         6   # BR(Hp -> Down top)
     2.19206886E-05   2        -3         6   # BR(Hp -> Strange top)
     1.34248750E-01   2        -5         6   # BR(Hp -> Bottom top)
     2.92157162E-04   2        24        25   # BR(Hp -> W h0)
     1.99380472E-05   2        24        35   # BR(Hp -> W HH)
     3.00702073E-05   2        24        36   # BR(Hp -> W A0)
