...
BLOCK MASS
   ...
   2000005     1.01617952E+03   # MSf(2,4,3)
        25     1.25339672E+02   # Mh0
        35     2.25109362E+02   # MHH
        36     2.25000000E+02   # MA0
        37     2.44006329E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.75355656E-01   # Delta Mh0
        35     1.26231567E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     5.75135140E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -3.78151337E-02   # Alpha
BLOCK DALPHA
               3.45684159E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99950284E-01   # UH(1,1)
     1   2     9.97140915E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -9.97140915E-03   # UH(2,1)
     2   2     9.99950284E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     8.93571461E-03   # Gamma(h0)
     1.04793904E-03   2        22        22   # BR(h0 -> photon photon)
     6.78617359E-04   2        22        23   # BR(h0 -> photon Z)
     1.25229418E-02   2        23        23   # BR(h0 -> Z Z)
     1.02757687E-01   2       -24        24   # BR(h0 -> W W)
     2.97006300E-02   2        21        21   # BR(h0 -> gluon gluon)
     8.05067993E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.58108584E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.00658265E-01   2       -15        15   # BR(h0 -> Tau tau)
     9.03346428E-08   2        -2         2   # BR(h0 -> Up up)
     1.25123839E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.21162770E-06   2        -1         1   # BR(h0 -> Down down)
     3.04253925E-04   2        -3         3   # BR(h0 -> Strange strange)
     7.39457863E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     7.66418847E+00   # Gamma(HH)
     4.88114727E-07   2        22        22   # BR(HH -> photon photon)
     1.83434740E-07   2        22        23   # BR(HH -> photon Z)
     3.00676429E-05   2        23        23   # BR(HH -> Z Z)
     7.54501828E-05   2       -24        24   # BR(HH -> W W)
     4.57713008E-04   2        21        21   # BR(HH -> gluon gluon)
     1.23819226E-08   2       -11        11   # BR(HH -> Electron electron)
     5.50867955E-04   2       -13        13   # BR(HH -> Muon muon)
     1.51376439E-01   2       -15        15   # BR(HH -> Tau tau)
     1.94902066E-13   2        -2         2   # BR(HH -> Up up)
     2.69679607E-08   2        -4         4   # BR(HH -> Charm charm)
     1.52793865E-06   2        -1         1   # BR(HH -> Down down)
     3.83656010E-04   2        -3         3   # BR(HH -> Strange strange)
     8.45256032E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.86753570E-03   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     7.70116444E+00   # Gamma(A0)
    -1.17440737E-07   2        22        22   # BR(A0 -> photon photon)
    -1.31785658E-07   2        22        23   # BR(A0 -> photon Z)
    -4.67645897E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.23359673E-08   2       -11        11   # BR(A0 -> Electron electron)
     5.48823882E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.50828112E-01   2       -15        15   # BR(A0 -> Tau tau)
    -4.16768704E-14   2        -2         2   # BR(A0 -> Up up)
    -5.91990954E-09   2        -4         4   # BR(A0 -> Charm charm)
    -1.52217391E-06   2        -1         1   # BR(A0 -> Down down)
    -3.82208608E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.42593048E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -5.17538329E-03   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -2.98864352E-06   2        23        25   # BR(A0 -> Z h0)
DECAY        37     2.95935244E+00   # Gamma(Hp)
     3.41157258E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     1.45855303E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     4.12532464E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     3.97921591E-06   2        -1         2   # BR(Hp -> Down up)
     4.49326149E-05   2        -3         2   # BR(Hp -> Strange up)
     2.35545836E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.80117257E-07   2        -1         4   # BR(Hp -> Down charm)
     9.95639134E-04   2        -3         4   # BR(Hp -> Strange charm)
     3.29830219E-03   2        -5         4   # BR(Hp -> Bottom charm)
     2.92462257E-08   2        -1         6   # BR(Hp -> Down top)
     9.88194204E-07   2        -3         6   # BR(Hp -> Strange top)
     5.69853290E-01   2        -5         6   # BR(Hp -> Bottom top)
     1.17105212E-02   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     7.54705287E-05   2        24        25   # BR(Hp -> W h0)
     1.01585794E-06   2        24        35   # BR(Hp -> W HH)
     1.04558669E-06   2        24        36   # BR(Hp -> W A0)
