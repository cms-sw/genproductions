...
BLOCK MASS
   ...
   2000005     1.00778084E+03   # MSf(2,4,3)
        25     1.24515779E+02   # Mh0
        35     1.60667061E+02   # MHH
        36     1.60000000E+02   # MA0
        37     1.81010738E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.28100720E-01   # Delta Mh0
        35     1.11012606E-02   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     1.14136742E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.46614749E-01   # Alpha
BLOCK DALPHA
               6.07111919E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.97645076E-01   # UH(1,1)
     1   2     6.85879103E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -6.85879103E-02   # UH(2,1)
     2   2     9.97645076E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     3.03697284E-02   # Gamma(h0)
     3.09049176E-04   2        22        22   # BR(h0 -> photon photon)
     1.85288761E-04   2        22        23   # BR(h0 -> photon Z)
     3.28689644E-03   2        23        23   # BR(h0 -> Z Z)
     2.74151811E-02   2       -24        24   # BR(h0 -> W W)
     7.29146151E-03   2        21        21   # BR(h0 -> gluon gluon)
     8.84158418E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.93288938E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.11290875E-01   2       -15        15   # BR(h0 -> Tau tau)
     2.59529784E-08   2        -2         2   # BR(h0 -> Up up)
     3.59474444E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.35999087E-06   2        -1         1   # BR(h0 -> Down down)
     3.41519090E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.45890301E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     1.59705295E+00   # Gamma(HH)
     1.93044049E-07   2        22        22   # BR(HH -> photon photon)
     3.69185921E-07   2        22        23   # BR(HH -> photon Z)
     2.58451419E-05   2        23        23   # BR(HH -> Z Z)
     4.91589261E-04   2       -24        24   # BR(HH -> W W)
     8.10559287E-04   2        21        21   # BR(HH -> gluon gluon)
     1.00491256E-08   2       -11        11   # BR(HH -> Electron electron)
     4.47036939E-04   2       -13        13   # BR(HH -> Muon muon)
     1.25782118E-01   2       -15        15   # BR(HH -> Tau tau)
     1.25743516E-11   2        -2         2   # BR(HH -> Up up)
     1.74341539E-06   2        -4         4   # BR(HH -> Charm charm)
     1.44063630E-06   2        -1         1   # BR(HH -> Down down)
     3.61765132E-04   2        -3         3   # BR(HH -> Strange strange)
     8.72077330E-01   2        -5         5   # BR(HH -> Bottom bottom)
DECAY        36     1.61799613E+00   # Gamma(A0)
    -1.78944260E-07   2        22        22   # BR(A0 -> photon photon)
    -9.50835355E-08   2        22        23   # BR(A0 -> photon Z)
    -7.39719471E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.00322239E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.46285295E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.25628848E-01   2       -15        15   # BR(A0 -> Tau tau)
    -8.06440558E-13   2        -2         2   # BR(A0 -> Up up)
    -1.14285306E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.43961035E-06   2        -1         1   # BR(A0 -> Down down)
    -3.61507735E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.72821471E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -3.31245109E-07   2        23        25   # BR(A0 -> Z h0)
DECAY        37     2.38378217E-01   # Gamma(Hp)
     7.85467093E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.35811428E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.49716237E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.01158076E-05   2        -1         2   # BR(Hp -> Down up)
     1.13578523E-04   2        -3         2   # BR(Hp -> Strange up)
     6.52882457E-05   2        -5         2   # BR(Hp -> Bottom up)
     4.93973170E-07   2        -1         4   # BR(Hp -> Down charm)
     2.53207966E-03   2        -3         4   # BR(Hp -> Strange charm)
     9.14176873E-03   2        -5         4   # BR(Hp -> Bottom charm)
     3.25412961E-08   2        -1         6   # BR(Hp -> Down top)
     7.31983647E-07   2        -3         6   # BR(Hp -> Strange top)
     3.49926125E-02   2        -5         6   # BR(Hp -> Bottom top)
     3.14137856E-05   2        24        25   # BR(Hp -> W h0)
     1.71457358E-05   2        24        35   # BR(Hp -> W HH)
     2.03087502E-05   2        24        36   # BR(Hp -> W A0)
