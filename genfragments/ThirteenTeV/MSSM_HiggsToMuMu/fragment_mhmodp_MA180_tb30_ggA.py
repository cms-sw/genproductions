...
BLOCK MASS
   ...
   2000005     1.00956179E+03   # MSf(2,4,3)
        25     1.24882662E+02   # Mh0
        35     1.80371445E+02   # MHH
        36     1.80000000E+02   # MA0
        37     1.99685147E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.30267128E-01   # Delta Mh0
        35     9.15517390E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     2.00453081E-01   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -8.87944359E-02   # Alpha
BLOCK DALPHA
               1.98359983E-03   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99468028E-01   # UH(1,1)
     1   2     3.26138193E-02   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -3.26138193E-02   # UH(2,1)
     2   2     9.99468028E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     1.66630780E-02   # Gamma(h0)
     5.62115437E-04   2        22        22   # BR(h0 -> photon photon)
     3.50583704E-04   2        22        23   # BR(h0 -> photon Z)
     6.32579432E-03   2        23        23   # BR(h0 -> Z Z)
     5.23776201E-02   2       -24        24   # BR(h0 -> W W)
     1.46533398E-02   2        21        21   # BR(h0 -> gluon gluon)
     8.52004780E-09   2       -11        11   # BR(h0 -> Electron electron)
     3.78986744E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.07149584E-01   2       -15        15   # BR(h0 -> Tau tau)
     4.80306695E-08   2        -2         2   # BR(h0 -> Up up)
     6.65274889E-03   2        -4         4   # BR(h0 -> Charm charm)
     1.30685526E-06   2        -1         1   # BR(h0 -> Down down)
     3.28174539E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.11219689E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.50298822E+00   # Gamma(HH)
     4.66045022E-07   2        22        22   # BR(HH -> photon photon)
     1.04355086E-07   2        22        23   # BR(HH -> photon Z)
     5.43422539E-05   2        23        23   # BR(HH -> Z Z)
     7.35471050E-04   2       -24        24   # BR(HH -> W W)
     6.44000265E-04   2        21        21   # BR(HH -> gluon gluon)
     1.05693880E-08   2       -11        11   # BR(HH -> Electron electron)
     4.70197291E-04   2       -13        13   # BR(HH -> Muon muon)
     1.31679879E-01   2       -15        15   # BR(HH -> Tau tau)
     3.10736710E-12   2        -2         2   # BR(HH -> Up up)
     4.30488066E-07   2        -4         4   # BR(HH -> Charm charm)
     1.45749398E-06   2        -1         1   # BR(HH -> Down down)
     3.65993112E-04   2        -3         3   # BR(HH -> Strange strange)
     8.65888421E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.59226900E-04   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
DECAY        36     2.51794391E+00   # Gamma(A0)
    -1.53555159E-07   2        22        22   # BR(A0 -> photon photon)
    -1.23429563E-07   2        22        23   # BR(A0 -> photon Z)
    -6.17396475E-04   2        21        21   # BR(A0 -> gluon gluon)
    -1.05218501E-08   2       -11        11   # BR(A0 -> Electron electron)
     4.68082845E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.31126885E-01   2       -15        15   # BR(A0 -> Tau tau)
    -3.73834872E-13   2        -2         2   # BR(A0 -> Up up)
    -5.28886100E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.45149054E-06   2        -1         1   # BR(A0 -> Down down)
    -3.64485736E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.63272484E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -4.14835311E-03   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -5.21522688E-07   2        23        25   # BR(A0 -> Z h0)
DECAY        37     5.04792415E-01   # Gamma(Hp)
     5.89231092E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     2.51914511E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     7.12469783E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     7.38960094E-06   2        -1         2   # BR(Hp -> Down up)
     8.31290471E-05   2        -3         2   # BR(Hp -> Strange up)
     4.68831600E-05   2        -5         2   # BR(Hp -> Bottom up)
     3.45987428E-07   2        -1         4   # BR(Hp -> Down charm)
     1.84933485E-03   2        -3         4   # BR(Hp -> Strange charm)
     6.56477661E-03   2        -5         4   # BR(Hp -> Bottom charm)
     9.98271917E-08   2        -1         6   # BR(Hp -> Down top)
     2.33468384E-06   2        -3         6   # BR(Hp -> Strange top)
     2.76419092E-01   2        -5         6   # BR(Hp -> Bottom top)
     2.41077972E-05   2        24        25   # BR(Hp -> W h0)
     6.43297157E-06   2        24        35   # BR(Hp -> W HH)
     7.08601434E-06   2        24        36   # BR(Hp -> W A0)
