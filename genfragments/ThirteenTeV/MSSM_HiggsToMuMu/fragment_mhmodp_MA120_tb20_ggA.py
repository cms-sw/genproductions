...
BLOCK MASS
   ...
   2000005     1.00594745E+03   # MSf(2,4,3)
        25     1.16736848E+02   # Mh0
        35     1.28380213E+02   # MHH
        36     1.20000000E+02   # MA0
        37     1.45838003E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     2.84783027E-01   # Delta Mh0
        35     4.26097014E-01   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     2.95817829E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -1.00342696E+00   # Alpha
BLOCK DALPHA
               8.72748687E-02   # Delta Alpha
...
BLOCK CVHMIX
     1   1     6.79017473E-01   # UH(1,1)
     1   2     7.34122109E-01   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1     7.34122109E-01   # UH(2,1)
     2   2    -6.79017473E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     6.01917628E-01   # Gamma(h0)
     7.11059014E-06   2        22        22   # BR(h0 -> photon photon)
     1.02249747E-06   2        22        23   # BR(h0 -> photon Z)
     1.95314927E-05   2        23        23   # BR(h0 -> Z Z)
     1.89597121E-04   2       -24        24   # BR(h0 -> W W)
     7.12896068E-04   2        21        21   # BR(h0 -> gluon gluon)
     9.20311041E-09   2       -11        11   # BR(h0 -> Electron electron)
     4.09362288E-04   2       -13        13   # BR(h0 -> Muon muon)
     1.15755285E-01   2       -15        15   # BR(h0 -> Tau tau)
     3.46854718E-10   2        -2         2   # BR(h0 -> Up up)
     4.80405383E-05   2        -4         4   # BR(h0 -> Charm charm)
     1.42684866E-06   2        -1         1   # BR(h0 -> Down down)
     3.58305972E-04   2        -3         3   # BR(h0 -> Strange strange)
     8.82497412E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.39655828E-01   # Gamma(HH)
     2.00317915E-05   2        22        22   # BR(HH -> photon photon)
     2.50602923E-05   2        22        23   # BR(HH -> photon Z)
     4.48574196E-04   2        23        23   # BR(HH -> Z Z)
     3.47727246E-03   2       -24        24   # BR(HH -> W W)
     3.19081746E-03   2        21        21   # BR(HH -> gluon gluon)
     9.42689113E-09   2       -11        11   # BR(HH -> Electron electron)
     4.19328375E-04   2       -13        13   # BR(HH -> Muon muon)
     1.18365278E-01   2       -15        15   # BR(HH -> Tau tau)
     2.50290393E-09   2        -2         2   # BR(HH -> Up up)
     3.46685094E-04   2        -4         4   # BR(HH -> Charm charm)
     1.42486258E-06   2        -1         1   # BR(HH -> Down down)
     3.57805576E-04   2        -3         3   # BR(HH -> Strange strange)
     8.73347652E-01   2        -5         5   # BR(HH -> Bottom bottom)
     5.77485695E-08   2        23        36   # BR(HH -> Z A0)
DECAY        36     8.35656572E-01   # Gamma(A0)
    -2.68014077E-07   2        22        22   # BR(A0 -> photon photon)
    -1.55275814E-08   2        22        23   # BR(A0 -> photon Z)
    -1.06380360E-03   2        21        21   # BR(A0 -> gluon gluon)
    -9.26765998E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.12238257E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.16599589E-01   2       -15        15   # BR(A0 -> Tau tau)
    -2.17429630E-12   2        -2         2   # BR(A0 -> Up up)
    -3.15649650E-07   2        -4         4   # BR(A0 -> Charm charm)
    -1.42606634E-06   2        -1         1   # BR(A0 -> Down down)
    -3.58109314E-04   2        -3         3   # BR(A0 -> Strange strange)
    -8.81564225E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -3.10763822E-10   2        23        25   # BR(A0 -> Z h0)
DECAY        37     1.18714258E-01   # Gamma(Hp)
     8.13276122E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     3.47700518E-03   2       -13        14   # BR(Hp -> Muon nu_mu)
     9.83237956E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     1.09956924E-05   2        -1         2   # BR(Hp -> Down up)
     1.22792994E-04   2        -3         2   # BR(Hp -> Strange up)
     7.19421246E-05   2        -5         2   # BR(Hp -> Bottom up)
     5.97541035E-07   2        -1         4   # BR(Hp -> Down charm)
     2.75365042E-03   2        -3         4   # BR(Hp -> Strange charm)
     1.00729033E-02   2        -5         4   # BR(Hp -> Bottom charm)
     1.59541573E-05   2        -5         6   # BR(Hp -> Bottom top)
     1.24938673E-04   2        24        25   # BR(Hp -> W h0)
     5.31235535E-06   2        24        35   # BR(Hp -> W HH)
     1.05869901E-04   2        24        36   # BR(Hp -> W A0)
DECAY         6     1.38424397E+00   # Gamma(top)
     9.90631248E-01   2         5        24   # BR(top -> bottom W)
     9.36875249E-03   2         5        37   # BR(top -> bottom Hp)
"""
