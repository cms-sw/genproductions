...
BLOCK MASS
   ...
   2000005     1.00778084E+03   # MSf(2,4,3)
        25     1.24910231E+02   # Mh0
        35     3.00392812E+02   # MHH
        36     3.00000000E+02   # MA0
        37     3.11900381E+02   # MHp
...
BLOCK DMASS
         0     1.73200000E+02   # Q
        25     7.14625247E-01   # Delta Mh0
        35     6.03088571E-03   # Delta MHH
        36     0.00000000E+00   # Delta MA0
        37     4.91027231E-02   # Delta MHp
BLOCK NMIX
...
BLOCK ALPHA
              -5.47262791E-02   # Alpha
BLOCK DALPHA
               3.21682066E-04   # Delta Alpha
...
BLOCK CVHMIX
     1   1     9.99977861E-01   # UH(1,1)
     1   2     6.65407789E-03   # UH(1,2)
     1   3     0.00000000E+00   # UH(1,3)
     2   1    -6.65407789E-03   # UH(2,1)
     2   2     9.99977861E-01   # UH(2,2)
     2   3     0.00000000E+00   # UH(2,3)
     3   1     0.00000000E+00   # UH(3,1)
     3   2     0.00000000E+00   # UH(3,2)
     3   3     1.00000000E+00   # UH(3,3)
DECAY        25     5.73275718E-03   # Gamma(h0)
     1.61069379E-03   2        22        22   # BR(h0 -> photon photon)
     1.02185056E-03   2        22        23   # BR(h0 -> photon Z)
     1.85033037E-02   2        23        23   # BR(h0 -> Z Z)
     1.53123657E-01   2       -24        24   # BR(h0 -> W W)
     4.77067966E-02   2        21        21   # BR(h0 -> gluon gluon)
     6.48341988E-09   2       -11        11   # BR(h0 -> Electron electron)
     2.88393956E-04   2       -13        13   # BR(h0 -> Muon muon)
     8.24503892E-02   2       -15        15   # BR(h0 -> Tau tau)
     1.40358021E-07   2        -2         2   # BR(h0 -> Up up)
     1.94410168E-02   2        -4         4   # BR(h0 -> Charm charm)
     1.03967970E-06   2        -1         1   # BR(h0 -> Down down)
     2.61094053E-04   2        -3         3   # BR(h0 -> Strange strange)
     6.75591618E-01   2        -5         5   # BR(h0 -> Bottom bottom)
DECAY        35     2.88511572E+00   # Gamma(HH)
     1.49192626E-06   2        22        22   # BR(HH -> photon photon)
     2.07854079E-06   2        22        23   # BR(HH -> photon Z)
     1.96785140E-04   2        23        23   # BR(HH -> Z Z)
     4.40727987E-04   2       -24        24   # BR(HH -> W W)
     3.67579622E-04   2        21        21   # BR(HH -> gluon gluon)
     1.04869568E-08   2       -11        11   # BR(HH -> Electron electron)
     4.66601541E-04   2       -13        13   # BR(HH -> Muon muon)
     1.31248086E-01   2       -15        15   # BR(HH -> Tau tau)
     1.46473357E-12   2        -2         2   # BR(HH -> Up up)
     2.02654444E-07   2        -4         4   # BR(HH -> Charm charm)
     1.35721901E-06   2        -1         1   # BR(HH -> Down down)
     3.40826723E-04   2        -3         3   # BR(HH -> Strange strange)
     8.23380788E-01   2        -5         5   # BR(HH -> Bottom bottom)
     1.33936141E-03   2  -1000024   1000024   # BR(HH -> Chargino1 chargino1)
     1.55894697E-02   2   1000022   1000022   # BR(HH -> neutralino1 neutralino1)
     1.90488720E-02   2   1000022   1000023   # BR(HH -> neutralino1 neutralino2)
     5.40585183E-03   2   1000022   1000025   # BR(HH -> neutralino1 neutralino3)
     2.16990956E-03   2        25        25   # BR(HH -> h0 h0)
DECAY        36     3.15011510E+00   # Gamma(A0)
    -3.51909990E-06   2        22        22   # BR(A0 -> photon photon)
    -1.00002408E-05   2        22        23   # BR(A0 -> photon Z)
    -2.24160991E-04   2        21        21   # BR(A0 -> gluon gluon)
    -9.58835863E-09   2       -11        11   # BR(A0 -> Electron electron)
     4.26619815E-04   2       -13        13   # BR(A0 -> Muon muon)
    -1.19968703E-01   2       -15        15   # BR(A0 -> Tau tau)
    -6.02985190E-13   2        -2         2   # BR(A0 -> Up up)
    -8.42313771E-08   2        -4         4   # BR(A0 -> Charm charm)
    -1.24060812E-06   2        -1         1   # BR(A0 -> Down down)
    -3.11543282E-04   2        -3         3   # BR(A0 -> Strange strange)
    -7.52931200E-01   2        -5         5   # BR(A0 -> Bottom bottom)
    -4.99187177E-02   2  -1000024   1000024   # BR(A0 -> Chargino1 chargino1)
    -2.38056191E-02   2   1000022   1000022   # BR(A0 -> neutralino1 neutralino1)
    -5.21555439E-02   2   1000022   1000023   # BR(A0 -> neutralino1 neutralino2)
    -4.27571761E-05   2   1000022   1000025   # BR(A0 -> neutralino1 neutralino3)
    -2.00280998E-04   2        23        25   # BR(A0 -> Z h0)
    -1.64380093E-37   2        25        25   # BR(A0 -> h0 h0)
DECAY        37     1.77108694E+00   # Gamma(Hp)
     1.82165549E-08   2       -11        12   # BR(Hp -> Electron nu_e)
     7.78814303E-04   2       -13        14   # BR(Hp -> Muon nu_mu)
     2.20286375E-01   2       -15        16   # BR(Hp -> Tau nu_tau)
     2.14576425E-06   2        -1         2   # BR(Hp -> Down up)
     2.43407452E-05   2        -3         2   # BR(Hp -> Strange up)
     1.40015738E-05   2        -5         2   # BR(Hp -> Bottom up)
     1.05869292E-07   2        -1         4   # BR(Hp -> Down charm)
     5.37140784E-04   2        -3         4   # BR(Hp -> Strange charm)
     1.96065542E-03   2        -5         4   # BR(Hp -> Bottom charm)
     4.67891002E-07   2        -1         6   # BR(Hp -> Down top)
     1.05697685E-05   2        -3         6   # BR(Hp -> Strange top)
     6.61930858E-01   2        -5         6   # BR(Hp -> Bottom top)
     1.07288462E-01   2   1000022   1000024   # BR(Hp -> neutralino1 chargino1)
     6.65997373E-03   2   1000023   1000024   # BR(Hp -> neutralino2 chargino1)
     5.05747697E-04   2        24        25   # BR(Hp -> W h0)
     1.48370894E-07   2        24        35   # BR(Hp -> W HH)
     1.75326421E-07   2        24        36   # BR(Hp -> W A0)
