...
#   'cm13TeV',  # cm13TeV does not exist yet, this means:
    'powhegNewDefaults',
    'HbbZllParameters',
    'basicSetup',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/FourteenTeV/HERWIGPP_POWHEG_H125_bbbar_Z_ll_13TeV_cff.py,v $'),
