...
externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
                                     ...
                                     args = cms.vstring('slc5_ia32_gcc434/powheg/V1.0/src', #repository of powheg source code
                                                        ...
                                                        'WW',     # process name
                                                        'slc5_amd64_gcc472/13TeV/powheg/WplusWminusToTauNuTauNu_CT10_13TeV-powheg/v1/WplusWminusToTauNuTauNu_CT10_13TeV-powheg.input', # location of input data card  
