...
_generator = cms.EDFilter("Pythia8GeneratorFilter",
    ...
    ExternalDecays = cms.PSet(
        EvtGen130 = cms.untracked.PSet(
            ...
            particle_property_file = cms.FileInPath('GeneratorInterface/EvtGenInterface/data/evt_2014_bsmass_8p5gev.pdl'),
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring(
            ...
            'Top:gg2ttbar = on',
            'Top:qqbar2ttbar = on',
            '531:m0 = 8.5',  # override Bs mass in Pythia
            '533:m0 = 8.577021', # override Bs* mass in Pythia
        ),
