...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/afs/cern.ch/user/m/mpitt/public/exclusive_tautau/gridpacks/GGToTauTau_Inclusive_M_50GeV_TuneCP5_madgraphLO_reweight_slc7_amd64_gcc700_CMSSW_10_6_19_tarball.tar.xz'),
...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        unresolved_photons = cms.vstring('PartonLevel:MPI = off'),
        parameterSets = cms.vstring('pythia8CommonSettings','pythia8CP5Settings','pythia8PSweightsSettings','unresolved_photons')  
    ),
