...
generator = cms.EDFilter("SherpaGeneratorFilter",
  ...
  SherpaProcess = cms.string('ADDGravitonToDiPhoton_MS5000_NED2_KK1_M-2000To3000_13TeV-sherpa'),
  SherpackLocation = cms.string('slc6_amd64_gcc481/13TeV/sherpa/2.1.1/ADDGravToGG/v1/'),
  SherpackChecksum = cms.string('f1a69d6b6c420db546659744546f6868'),
