...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    PythiaParameters = cms.PSet(
        ...
        exclusive_process = cms.vstring( # recomendation from https://superchic.hepforge.org/superchic4.pdf with Remnants=off for elastic to allow photon kt smearing to be kept
