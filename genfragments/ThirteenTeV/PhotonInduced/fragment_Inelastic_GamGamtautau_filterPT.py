...
generator = cms.EDFilter("Pythia8HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        inclusive_process = cms.vstring( # recomendation from https://superchic.hepforge.org/superchic4.pdf
        ...
        parameterSets = cms.vstring('pythia8CommonSettings','pythia8CP5Settings','pythia8PSweightsSettings','inclusive_process')      
    ),
