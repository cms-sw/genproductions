...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('\$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/ThirteenTeV/HERWIGPP_POWHEG_H125_bbbar_W_lnu_13TeV_cff.py,v $'),
