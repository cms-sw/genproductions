# cfg file for Chi_{b1,b2}(2P) -> Upsilon(2S) gamma,  we are neglecting Chi_b0. Masses and widths are matched between pythia, evtgen and PDG 2016
#
...
Particle chi_b1 10.25546 0.00000
Particle chi_b2 10.26865 0.00000
...
pwaveMassfilter = cms.EDFilter("MCParticlePairFilter",
    ...
    ParticleID1 = cms.untracked.vint32(100553),
    ParticleID2 = cms.untracked.vint32(22),
    MinInvMass = cms.untracked.double(10.24),
    MaxInvMass = cms.untracked.double(10.28),
)
