...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/FourteenTeV/WH_ZH_HToGG_M_125_TuneZ2star_14TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 WH/ZH, H->2gamma mH=125GeV with TAUOLA at 14TeV')
)
