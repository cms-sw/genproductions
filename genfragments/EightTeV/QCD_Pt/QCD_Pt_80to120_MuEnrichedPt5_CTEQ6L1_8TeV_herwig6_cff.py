...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/QCD_Pt_80to120_MuEnrichedPt5_CTEQ6L1_8TeV_herwig6_cff.py,v $'),
	annotation = cms.untracked.string('Herwig+Jimmy generation of QCD events, MuEnrichedPt5, 8 TeV, CTEQ6L1, pthat [80,120] GeV')
)

source = cms.Source("EmptySource")
generator = cms.EDFilter("Herwig6GeneratorFilter",
	comEnergy = cms.double(8000.0),
	crossSection = cms.untracked.double(833630.),
	...
	HerwigParameters = cms.PSet(
		herwigQCDjets = cms.vstring(
			...
			'PTMAX     = 120.    ! minimum pt in hadronic jet',
