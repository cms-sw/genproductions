...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(0.1033),
    crossSection = cms.untracked.double(3.570),                         
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/QCD_Pt_800To1000_MuEnrichedPt5_TuneZ2star_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 QCD at 8TeV, 1000>pthat>800, with INCLUSIVE muon preselection (pt(mu) > 5)')
)
