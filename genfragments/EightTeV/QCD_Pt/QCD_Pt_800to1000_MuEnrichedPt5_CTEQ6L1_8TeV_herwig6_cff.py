...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/QCD_Pt_800to1000_MuEnrichedPt5_CTEQ6L1_8TeV_herwig6_cff.py,v $'),
	annotation = cms.untracked.string('Herwig+Jimmy generation of QCD events, MuEnrichedPt5, 8 TeV, CTEQ6L1, pthat [800,1000] GeV')
)

source = cms.Source("EmptySource")
generator = cms.EDFilter("Herwig6GeneratorFilter",
	comEnergy = cms.double(8000.0),
	crossSection = cms.untracked.double(2.997),
	...
	HerwigParameters = cms.PSet(
		herwigQCDjets = cms.vstring(
			...
			'PTMAX     = 1000.    ! minimum pt in hadronic jet',
