...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    filterEfficiency = cms.untracked.double(1.01e-2),
    crossSection = cms.untracked.double(2.886e+8),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/QCD_Pt_20_30_EMEnriched_TuneZ2_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('em-enriching filtered QCD pthat 20-30, 8 TeV')
)
