...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/WZJetsTo3LNu_TuneZ2_8TeV-madgraph/v2',
    'WZJetsTo3LNu_TuneZ2_8TeV-madgraph', 'false','false','wjets','5','15','true','0','2'),
