...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string("WJetsToLNu_matchingdown_8TeV_madgraph_unweighted_events_final.lhe"),
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/WJetsToLNu_matchingdown_8TeV_madgraph_tarball/v2',
    'WJetsToLNu_matchingdown_8TeV_madgraph','false','true','wjets','5','15','true','0','4'),
