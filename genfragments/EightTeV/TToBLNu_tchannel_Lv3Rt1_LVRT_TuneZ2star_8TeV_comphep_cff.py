...
name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/TToBLNu_tchannel_Lv3Rt1_LVRT_TuneZ2star_8TeV_comphep_cff.py,v $'),
