...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA_Tauola_TB_H180_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TB Hplus180, with Tauola at 8TeV')
    )
