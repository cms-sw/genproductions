...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0         ! User defined processes',
            ...
            'PMAS(37,1) = 190.   ! charged Higgs mass ',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA_Tauola_TB_H190_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TB Hplus190, with Tauola at 8TeV')
    )
