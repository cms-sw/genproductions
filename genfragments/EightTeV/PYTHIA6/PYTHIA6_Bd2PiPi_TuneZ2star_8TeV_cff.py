...
generator = cms.EDFilter(
    ...
    crossSection = cms.untracked.double(254397.),
    filterEfficiency = cms.untracked.double(0.000408),
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bd_pipi.dec'),
