...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs_server/repositories/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/PYTHIA6_Tauola_SM_ttH120_bb_MuEnrichedPt10_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 ggHtt,qqHtt, H->bb mH=120 MuEnriched pT>=10 |eta|<=2.5 with TAUOLA at 8TeV')
)
