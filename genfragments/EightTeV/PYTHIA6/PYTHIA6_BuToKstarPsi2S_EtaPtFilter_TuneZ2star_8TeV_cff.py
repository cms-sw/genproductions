...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_BuToKstarJPsi2S_EtaPtFilter_TuneZ2star_8TeV_cff.py,v $'),
	annotation = cms.untracked.string('Summer12: Pythia6+EvtGen generation of Bu --> K* Psi(2S), 8TeV, D6T tune'))
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
	...
	user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bu_Psi2SKstar.dec'),
