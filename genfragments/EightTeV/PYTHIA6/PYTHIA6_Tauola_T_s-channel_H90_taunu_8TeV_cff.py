...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
	    ...
	    'CKIN(1)    = 20    ! not get stuck in a region of phase space where the cross section vanishes.',
            ...
            'PMAS(37,1) = 90.   ! charged Higgs mass ',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Tauola_TTbar_H90_taunu_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TTbar Hplus90 To TauNu, with Tauola at 8TeV')
    )
