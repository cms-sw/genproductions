...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('MSEL=0         ! User defined processes',
            'MSUB(142)  = 1      ! W` production',
            'PMAS(34,1) = 80.385 ! Set W` mass identical to W (widths already are!)',
	    'CKIN(1)    = 20    ! not get stuck in a region of phase space where the cross section vanishes.',
            # Set W'+ decay only to bbar t.
            'MDME(311,1) = 0   ! W` decay into dbar u',
            'MDME(312,1) = 0   ! W` decay into dbar c',
            'MDME(313,1) = 0   ! W` decay into dbar t',
            'MDME(314,1) = 0   ! W` decay into dbar t`',
            'MDME(315,1) = 0   ! W` decay into sbar u',
            'MDME(316,1) = 0   ! W` decay into sbar c',
            'MDME(317,1) = 0   ! W` decay into sbar t',
            'MDME(318,1) = 0   ! W` decay into sbar t`',
            'MDME(319,1) = 0   ! W` decay into bbar u',
            'MDME(320,1) = 0   ! W` decay into bbar u',
            'MDME(321,1) = 1   ! W` decay into bbar t',
            'MDME(322,1) = 0   ! W` decay into bbar u',
            'MDME(323,1) = 0   ! W` decay into b`bar u',
            'MDME(324,1) = 0   ! W` decay into b`bar u',
            'MDME(325,1) = 0   ! W` decay into b`bar u',
            'MDME(326,1) = 0   ! W` decay into b`bar u',
            'MDME(327,1) = 0   ! W` decay into e+ nu',
            'MDME(328,1) = 0   ! W` decay into mu+ nu',
            'MDME(329,1) = 0   ! W` decay into tau+ nu',
            'MDME(330,1) = 0   ! W` decay into tau`+ nu',
            'MDME(331,1) = 0   ! W` decay into W+ Z0',
            'MDME(332,1) = 0   ! W` decay into W+ gamma',
            'MDME(333,1) = 0   ! W` decay into W+ h0',

            # Set the masses of the higgs
            'PMAS(6,1)  = 172.5  ! top quark mass',                                        
            'PMAS(37,1) = 155.   ! charged Higgs mass ',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Tauola_TTbar_H155_taunu_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-TTbar Hplus155 To TauNu, with Tauola at 8TeV')
    )
