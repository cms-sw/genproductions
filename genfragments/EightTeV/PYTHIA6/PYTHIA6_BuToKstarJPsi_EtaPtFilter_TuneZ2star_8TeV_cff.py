...
configurationMetadata = cms.untracked.PSet(
	...
	name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/PYTHIA6_BuToKstarJPsi_EtaPtFilter_TuneZ2_8TeV_cff.py,v $'),
	annotation = cms.untracked.string('Summer11: Pythia6+EvtGen generation of Bu --> K* J/Psi, 8TeV, D6T tune'))
...
generator = cms.EDFilter("Pythia6GeneratorFilter",
	...
	user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bu_JpsiKstar_mumuKpi_cc.dec'),
