...
pipigenfilter = cms.EDFilter("MCParticlePairFilter",
    ...
    MinEta = cms.untracked.vdouble(-2.2, -2.5),
...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Bs2Jpsif0_TuneZ2star_8TeV_cff.py,v $'),
