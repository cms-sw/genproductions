...
generator = cms.EDFilter(
    ...
    ExternalDecays = cms.PSet(
        EvtGen = cms.untracked.PSet(
             ...
             user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Bs_mumugamma.dec'),
...
configurationMetadata = cms.untracked.PSet(
    ...
    ('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/PYTHIA6_Bs2MuMuGamma_TuneZ2star_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('Bs -> mu+ mu- gamma at 8TeV')
    )
