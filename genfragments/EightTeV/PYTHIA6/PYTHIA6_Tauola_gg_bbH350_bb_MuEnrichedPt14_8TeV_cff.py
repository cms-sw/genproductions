...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/SevenTeV/PYTHIA6_Tauola_gg_bbH350_bb_MuEnrichedPt14_8TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 - SUSY gg->bbH(350)->bb MuEnriched w/ pT>=14. |eta|<=2.5, with Tauola at 8TeV')
    )
