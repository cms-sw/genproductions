...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/PYTHIA6_Tauola_TTbar_H150_taunu_7TeV_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6-T t-channel Hplus150 To TauNu, with Tauola at 8TeV')
    )
