...
generator = cms.EDFilter("Pythia6GeneratorFilter",   
    ...
    crossSection  = cms.untracked.double(0.00007825),
...
#    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/RSGravMuMu_kMpl001_M_1500_TuneZ2star_8TeV_pythia6_cff.py,v $'),
#    annotation = cms.untracked.string('PYTHIA6 RS Graviton to mumu, k/Mpl = 0.01, mass = 1500 at sqrt(s) = 8TeV')
#)
