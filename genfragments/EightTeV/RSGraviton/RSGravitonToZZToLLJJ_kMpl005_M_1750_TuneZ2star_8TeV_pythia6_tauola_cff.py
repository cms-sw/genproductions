...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(0.0001985),
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(5,1)= 4.8         ! b quark mass', 
                                        ...
                                        'PMAS(347,1)= 1750.0     ! mass of RS Graviton', 
                                        ...
                                        'MDME(174,1)=    4   !Z to d               dbar', 
                                        'MDME(175,1)=    4   !Z to u               ubar', 
                                        'MDME(176,1)=    4   !Z to s               sbar', 
                                        'MDME(177,1)=    4   !Z to c               cbar', 
                                        'MDME(178,1)=    4   !Z to b               bbar', 
                                        'MDME(179,1)=    4   !Z to t               tbar', 
                                        'MDME(182,1)=    5   !Z to e-              e+', 
                                        'MDME(183,1)=    0   !Z to nu_e            nu_ebar', 
                                        'MDME(184,1)=    5   !Z to mu-             mu+', 
                                        'MDME(185,1)=    0   !Z to nu_mu           nu_mubar', 
                                        'MDME(186,1)=    5   !Z to tau-            tau+', 
