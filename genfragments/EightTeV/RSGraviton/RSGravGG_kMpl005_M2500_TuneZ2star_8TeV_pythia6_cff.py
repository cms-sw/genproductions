...
generator = cms.EDFilter("Pythia6GeneratorFilter",
                         ...
                         #numberOfEvents = cms.double(1000)                     
                         maxEventsToPrint = cms.untracked.int32(0),
                         crossSection  = cms.untracked.double(7.226e-05),
                         PythiaParameters = cms.PSet(pythiaUESettingsBlock,
                                                     processParameters = cms.vstring('PMAS(347,1)= 2500.         !mass of RS Graviton',
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /afs/cern.ch/project/cvs/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/RSGravGG_kMpl005_M2500_TuneZ2star_8TeV_pythia6_cff.py,v $'),
            annotation = cms.untracked.string('PYTHIA6 RS Graviton to gammagamma, k/Mpl = 0.05, mass = 2500 at sqrt(s) = 8TeV')
    )
