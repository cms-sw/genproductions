...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed = 100
...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string("TTJets_8TeV-madgraph_final.lhe"),
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.4.8/8TeV_Summer12/TTJets_8TeV-madgraph_gridpack/v1/',
    'TTJets_8TeV-madgraph','true','false','ttbar','5','40','true','0','3'),
