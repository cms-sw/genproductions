...
# that you want decayed by EvtGen
			...
			user_decay_file = cms.FileInPath('GeneratorInterface/ExternalDecays/data/Onia_Xb10900_Upsilon1Spipi.dec'),
	...
	PythiaParameters = cms.PSet(
		...
		processParameters = cms.vstring(
			'MSEL=62          ! Quarkonia', 
			'PMAS(296,1)  = 10.9000    ! change Upsilon(2S) mass to Xb',
			'KFPR(461,1)  = 100553     ! change 461 to Xb + g', 
			'PMAS(365,1)  = 10.9050   ! change bb~ mass larger than Xb',
			'PMAS(366,1)  = 10.9050   ! change bb~ mass larger than Xb',
			'PMAS(367,1)  = 10.9050   ! change bb~ mass larger than Xb',
