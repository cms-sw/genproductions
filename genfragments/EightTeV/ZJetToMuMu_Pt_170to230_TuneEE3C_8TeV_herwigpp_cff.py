...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	...
	crossSection = cms.untracked.double(7.702934e-01),
	...
	productionParameters = cms.vstring(
		...
		'set /Herwig/Cuts/JetKtCut:MaxKT 230 *GeV',
	),
)
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Sumer2012 sample with HERWIGPP: Z + Jet production, Z -> mumu, pThat = 170 .. 230 GeV, TuneEE3C')
)
