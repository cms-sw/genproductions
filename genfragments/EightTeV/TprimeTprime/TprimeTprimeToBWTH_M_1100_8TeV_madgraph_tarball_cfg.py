...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    outputFile = cms.string("TprimeTprimeToBWTH_M-1100_8TeV-madgraph_unweighted_events_final.lhe"),
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/TprimeTprimetoInclusive/v1','TprimeTprimeToBWTH_M-1100_8TeV-madgraph',
