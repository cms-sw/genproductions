...
generator = cms.EDFilter("Pythia6HadronizerFilter",
    ...
    PythiaParameters = cms.PSet(
	    ...
	    'MWID(8)=2',
            ...
            'PMAS(8,1) = 700.0D0  ! tprime quarks mass',
            'PMAS(8,2) = 7.0D0',
            'PMAS(8,3) = 70.0D0',
 ...
 'VCKM(4,4) = 0.91000000D0',
            ...
            'BRAT(213)=0.0146     !h decay into c cbar',
            'BRAT(214)=0.2896     !h decay into b bbar',
            ...
            'BRAT(220)=0.0317     !h decay into tau+ tau-',
            'BRAT(221)=0.0     !h decay into tau4+ tau4-',
            'BRAT(222)=0.0430     !h decay into g g',
            'BRAT(223)=0.5     !h decay into gamma gamma',
            'BRAT(224)=0.0     !h decay into gamma Z',
            'BRAT(225)=0.0132     !h decay into Z Z',
            'BRAT(226)=0.1079     !h decay into W+ W-'
            ),
