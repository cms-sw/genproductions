...
generator = cms.EDFilter("ThePEGGeneratorFilter",
	...
	crossSection = cms.untracked.double(3.689593e-05),
	...
	productionParameters = cms.vstring(
		...
		'set /Herwig/Cuts/JetKtCut:MaxKT 1800*GeV',
...
configurationMetadata = cms.untracked.PSet(
	...
	annotation = cms.untracked.string('Sumer2012 sample with HERWIGPP: Prompt photon production, pThat = 1400 .. 1800 GeV, TuneEE3C')
)
