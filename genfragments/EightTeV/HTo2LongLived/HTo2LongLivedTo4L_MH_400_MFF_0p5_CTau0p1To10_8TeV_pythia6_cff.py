...
MASS_HIGGS = '400' # GeV (mass of resonance that decays to long-lived particle pair - GeV)
MASS_X     = '0p5' # (mass of long-lived particle - GeV)
CTAU_X     = '0p1To10' # (c*tau with units of long-lived particle - mm - central c*tau if more than one value being generated)
FERMIONS   = '4L' # type of fermions produced when long-lived exotic decays
