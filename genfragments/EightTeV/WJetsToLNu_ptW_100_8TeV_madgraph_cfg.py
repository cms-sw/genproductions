...
process.externalLHEProducer = cms.EDProducer('ExternalLHEProducer',
    ...
    args = cms.vstring('slc5_ia32_gcc434/madgraph/V5_1.3.30/8TeV_Summer12/WJetsToLNu_PtW-100_8TeV-madgraph/v1',
    'WJetsToLNu_PtW-100_8TeV-madgraph','false','true','wjets','5','20','true','3','99'),
