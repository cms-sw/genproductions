...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/WH_ZH_HToZG_M_150_TuneZ2star_8TeV_pythia6_tauola_cff.py,v $'),
    annotation = cms.untracked.string('PYTHIA6 WH/ZH, H->Zgamma mH=150GeV with TAUOLA at 8TeV')
)
