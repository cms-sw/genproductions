...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(6.249),
...
configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/QstarToGJ_M_700_fhalf_8TeV_pythia6_cff.py,v $'),
    annotation = cms.untracked.string('qstar Mass = 0.7 TeV fhalf at 8 TeV')
)
