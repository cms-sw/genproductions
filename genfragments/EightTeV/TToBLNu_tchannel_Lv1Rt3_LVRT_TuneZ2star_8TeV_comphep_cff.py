...
name = cms.untracked.string('$Source: /local/reps/CMSSW/CMSSW/Configuration/GenProduction/python/EightTeV/TToBLNu_tchannel_Lv1Rt3_LVRT_TuneZ2star_8TeV_comphep_cff.py,v $'),
