...
# with command line options: UndergroundCosmicMu_cfi.py -s GEN,SIM -n 1 --conditions POSTLS162_V1::All --datatier GEN-SIM --eventcontent RAWSIM --scenario cosmics --fileout step1.root --no_exec --python_filename step1_GEN-SIM_3p8T_cfg.py --customise_commands=process.generator.MinP=cms.double(7.0) n
